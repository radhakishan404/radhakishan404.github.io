    ...
    return (
        <div>
            ...
            <main id="content" className="main page-content" aria-label="Content">
                <div className="container-full" id="home-detail">
