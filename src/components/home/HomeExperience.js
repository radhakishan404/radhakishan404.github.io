...
export function MacbookScroll() {
    const keyboardRows = [
        ...
        {
            keys: [
                { label: "caps", size: "xwide" },
                "A", "S", "D", "F", "G", "H", "J", "K", "L", ";", "'",
                { label: "return", size: "xwide" }
            ]
        },
        {
            keys: [
                { label: "shift", size: "shift" },
                "Z", "X", "C", "V", "B", "N", "M", ",", ".", "/",
                { label: "shift", size: "shift" }
            ]
        },
        {
            keys: [
                "fn", "control", "option",
                { label: "command", size: "command" },
                { label: "", size: "space", ariaLabel: "space" },
                { label: "command", size: "command" },
                { label: "option", size: "wide" },
                { label: "arrows", size: "arrows", type: "arrows" }
            ]
        }
    ];
                ...
                <div className="macbook-stage" aria-label="InfoLive marketplace displayed on an opening laptop">
                    <div className="macbook">
                        ...
                        <div className="macbook__base">
                            ...
                            <div className="macbook__deck" aria-hidden="true">
                                <span className="macbook__speaker" />
                                <div className="macbook__keyboard">
                                    {keyboardRows.map((row, rowIndex) => (
                                        <div
                                            className={`macbook__key-row ${row.className || ""}`}
                                        ...
                                        >
                                            {row.keys.map((key, keyIndex) => {
                                                const keyData = typeof key === "string"
                                                    ? { label: key }
                                                    : key;
                                                const modifier = keyData.size
                                                    ? ` macbook__key--${keyData.size}`
                                                    : "";

                                                return (
                                                    <span
                                                        className={`macbook__key${modifier}`}
                                                        aria-label={keyData.ariaLabel}
                                                        key={`${keyData.label}-${keyIndex}`}
                                                    >
                                                        {keyData.type === "arrows" ? (
                                                            <span className="macbook__arrow-cluster">
                                                                <i>↑</i>
                                                                <i>←</i>
                                                                <i>↓</i>
                                                                <i>→</i>
