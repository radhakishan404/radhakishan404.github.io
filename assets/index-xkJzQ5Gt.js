(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))l(c);new MutationObserver(c=>{for(const h of c)if(h.type==="childList")for(const m of h.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&l(m)}).observe(document,{childList:!0,subtree:!0});function s(c){const h={};return c.integrity&&(h.integrity=c.integrity),c.referrerPolicy&&(h.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?h.credentials="include":c.crossOrigin==="anonymous"?h.credentials="omit":h.credentials="same-origin",h}function l(c){if(c.ep)return;c.ep=!0;const h=s(c);fetch(c.href,h)}})();function Wr(o){return o&&o.__esModule&&Object.prototype.hasOwnProperty.call(o,"default")?o.default:o}var Bi={exports:{}},zt={};var Gi,ld;function cs(){if(ld)return Gi;ld=1;var o=Object.getOwnPropertySymbols,r=Object.prototype.hasOwnProperty,s=Object.prototype.propertyIsEnumerable;function l(h){if(h==null)throw new TypeError("Object.assign cannot be called with null or undefined");return Object(h)}function c(){try{if(!Object.assign)return!1;var h=new String("abc");if(h[5]="de",Object.getOwnPropertyNames(h)[0]==="5")return!1;for(var m={},b=0;b<10;b++)m["_"+String.fromCharCode(b)]=b;var g=Object.getOwnPropertyNames(m).map(function(y){return m[y]});if(g.join("")!=="0123456789")return!1;var v={};return"abcdefghijklmnopqrst".split("").forEach(function(y){v[y]=y}),Object.keys(Object.assign({},v)).join("")==="abcdefghijklmnopqrst"}catch{return!1}}return Gi=c()?Object.assign:function(h,m){for(var b,g=l(h),v,y=1;y<arguments.length;y++){b=Object(arguments[y]);for(var S in b)r.call(b,S)&&(g[S]=b[S]);if(o){v=o(b);for(var T=0;T<v.length;T++)s.call(b,v[T])&&(g[v[T]]=b[v[T]])}}return g},Gi}var Hi={exports:{}},ye={};var cd;function Sh(){if(cd)return ye;cd=1;var o=cs(),r=60103,s=60106;ye.Fragment=60107,ye.StrictMode=60108,ye.Profiler=60114;var l=60109,c=60110,h=60112;ye.Suspense=60113;var m=60115,b=60116;if(typeof Symbol=="function"&&Symbol.for){var g=Symbol.for;r=g("react.element"),s=g("react.portal"),ye.Fragment=g("react.fragment"),ye.StrictMode=g("react.strict_mode"),ye.Profiler=g("react.profiler"),l=g("react.provider"),c=g("react.context"),h=g("react.forward_ref"),ye.Suspense=g("react.suspense"),m=g("react.memo"),b=g("react.lazy")}var v=typeof Symbol=="function"&&Symbol.iterator;function y(A){return A===null||typeof A!="object"?null:(A=v&&A[v]||A["@@iterator"],typeof A=="function"?A:null)}function S(A){for(var z="https://reactjs.org/docs/error-decoder.html?invariant="+A,_=1;_<arguments.length;_++)z+="&args[]="+encodeURIComponent(arguments[_]);return"Minified React error #"+A+"; visit "+z+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var T={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},B={};function D(A,z,_){this.props=A,this.context=z,this.refs=B,this.updater=_||T}D.prototype.isReactComponent={},D.prototype.setState=function(A,z){if(typeof A!="object"&&typeof A!="function"&&A!=null)throw Error(S(85));this.updater.enqueueSetState(this,A,z,"setState")},D.prototype.forceUpdate=function(A){this.updater.enqueueForceUpdate(this,A,"forceUpdate")};function P(){}P.prototype=D.prototype;function V(A,z,_){this.props=A,this.context=z,this.refs=B,this.updater=_||T}var R=V.prototype=new P;R.constructor=V,o(R,D.prototype),R.isPureReactComponent=!0;var G={current:null},H=Object.prototype.hasOwnProperty,te={key:!0,ref:!0,__self:!0,__source:!0};function M(A,z,_){var q,I={},j=null,F=null;if(z!=null)for(q in z.ref!==void 0&&(F=z.ref),z.key!==void 0&&(j=""+z.key),z)H.call(z,q)&&!te.hasOwnProperty(q)&&(I[q]=z[q]);var J=arguments.length-2;if(J===1)I.children=_;else if(1<J){for(var X=Array(J),be=0;be<J;be++)X[be]=arguments[be+2];I.children=X}if(A&&A.defaultProps)for(q in J=A.defaultProps,J)I[q]===void 0&&(I[q]=J[q]);return{$$typeof:r,type:A,key:j,ref:F,props:I,_owner:G.current}}function U(A,z){return{$$typeof:r,type:A.type,key:z,ref:A.ref,props:A.props,_owner:A._owner}}function $(A){return typeof A=="object"&&A!==null&&A.$$typeof===r}function Y(A){var z={"=":"=0",":":"=2"};return"$"+A.replace(/[=:]/g,function(_){return z[_]})}var de=/\/+/g;function ne(A,z){return typeof A=="object"&&A!==null&&A.key!=null?Y(""+A.key):z.toString(36)}function pe(A,z,_,q,I){var j=typeof A;(j==="undefined"||j==="boolean")&&(A=null);var F=!1;if(A===null)F=!0;else switch(j){case"string":case"number":F=!0;break;case"object":switch(A.$$typeof){case r:case s:F=!0}}if(F)return F=A,I=I(F),A=q===""?"."+ne(F,0):q,Array.isArray(I)?(_="",A!=null&&(_=A.replace(de,"$&/")+"/"),pe(I,z,_,"",function(be){return be})):I!=null&&($(I)&&(I=U(I,_+(!I.key||F&&F.key===I.key?"":(""+I.key).replace(de,"$&/")+"/")+A)),z.push(I)),1;if(F=0,q=q===""?".":q+":",Array.isArray(A))for(var J=0;J<A.length;J++){j=A[J];var X=q+ne(j,J);F+=pe(j,z,_,X,I)}else if(X=y(A),typeof X=="function")for(A=X.call(A),J=0;!(j=A.next()).done;)j=j.value,X=q+ne(j,J++),F+=pe(j,z,_,X,I);else if(j==="object")throw z=""+A,Error(S(31,z==="[object Object]"?"object with keys {"+Object.keys(A).join(", ")+"}":z));return F}function ee(A,z,_){if(A==null)return A;var q=[],I=0;return pe(A,q,"","",function(j){return z.call(_,j,I++)}),q}function oe(A){if(A._status===-1){var z=A._result;z=z(),A._status=0,A._result=z,z.then(function(_){A._status===0&&(_=_.default,A._status=1,A._result=_)},function(_){A._status===0&&(A._status=2,A._result=_)})}if(A._status===1)return A._result;throw A._result}var ge={current:null};function le(){var A=ge.current;if(A===null)throw Error(S(321));return A}var Pe={ReactCurrentDispatcher:ge,ReactCurrentBatchConfig:{transition:0},ReactCurrentOwner:G,IsSomeRendererActing:{current:!1},assign:o};return ye.Children={map:ee,forEach:function(A,z,_){ee(A,function(){z.apply(this,arguments)},_)},count:function(A){var z=0;return ee(A,function(){z++}),z},toArray:function(A){return ee(A,function(z){return z})||[]},only:function(A){if(!$(A))throw Error(S(143));return A}},ye.Component=D,ye.PureComponent=V,ye.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Pe,ye.cloneElement=function(A,z,_){if(A==null)throw Error(S(267,A));var q=o({},A.props),I=A.key,j=A.ref,F=A._owner;if(z!=null){if(z.ref!==void 0&&(j=z.ref,F=G.current),z.key!==void 0&&(I=""+z.key),A.type&&A.type.defaultProps)var J=A.type.defaultProps;for(X in z)H.call(z,X)&&!te.hasOwnProperty(X)&&(q[X]=z[X]===void 0&&J!==void 0?J[X]:z[X])}var X=arguments.length-2;if(X===1)q.children=_;else if(1<X){J=Array(X);for(var be=0;be<X;be++)J[be]=arguments[be+2];q.children=J}return{$$typeof:r,type:A.type,key:I,ref:j,props:q,_owner:F}},ye.createContext=function(A,z){return z===void 0&&(z=null),A={$$typeof:c,_calculateChangedBits:z,_currentValue:A,_currentValue2:A,_threadCount:0,Provider:null,Consumer:null},A.Provider={$$typeof:l,_context:A},A.Consumer=A},ye.createElement=M,ye.createFactory=function(A){var z=M.bind(null,A);return z.type=A,z},ye.createRef=function(){return{current:null}},ye.forwardRef=function(A){return{$$typeof:h,render:A}},ye.isValidElement=$,ye.lazy=function(A){return{$$typeof:b,_payload:{_status:-1,_result:A},_init:oe}},ye.memo=function(A,z){return{$$typeof:m,type:A,compare:z===void 0?null:z}},ye.useCallback=function(A,z){return le().useCallback(A,z)},ye.useContext=function(A,z){return le().useContext(A,z)},ye.useDebugValue=function(){},ye.useEffect=function(A,z){return le().useEffect(A,z)},ye.useImperativeHandle=function(A,z,_){return le().useImperativeHandle(A,z,_)},ye.useLayoutEffect=function(A,z){return le().useLayoutEffect(A,z)},ye.useMemo=function(A,z){return le().useMemo(A,z)},ye.useReducer=function(A,z,_){return le().useReducer(A,z,_)},ye.useRef=function(A){return le().useRef(A)},ye.useState=function(A){return le().useState(A)},ye.version="17.0.2",ye}var dd;function ds(){return dd||(dd=1,Hi.exports=Sh()),Hi.exports}var pd;function Th(){if(pd)return zt;pd=1,cs();var o=ds(),r=60103;if(zt.Fragment=60107,typeof Symbol=="function"&&Symbol.for){var s=Symbol.for;r=s("react.element"),zt.Fragment=s("react.fragment")}var l=o.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,c=Object.prototype.hasOwnProperty,h={key:!0,ref:!0,__self:!0,__source:!0};function m(b,g,v){var y,S={},T=null,B=null;v!==void 0&&(T=""+v),g.key!==void 0&&(T=""+g.key),g.ref!==void 0&&(B=g.ref);for(y in g)c.call(g,y)&&!h.hasOwnProperty(y)&&(S[y]=g[y]);if(b&&b.defaultProps)for(y in g=b.defaultProps,g)S[y]===void 0&&(S[y]=g[y]);return{$$typeof:r,type:b,key:T,ref:B,props:S,_owner:l.current}}return zt.jsx=m,zt.jsxs=m,zt}var ud;function Ah(){return ud||(ud=1,Bi.exports=Th()),Bi.exports}var p=Ah(),ae=ds();const ve=Wr(ae);var _i={exports:{}},Xe={},qi={exports:{}},Ui={};var hd;function Ih(){return hd||(hd=1,(function(o){var r,s,l,c;if(typeof performance=="object"&&typeof performance.now=="function"){var h=performance;o.unstable_now=function(){return h.now()}}else{var m=Date,b=m.now();o.unstable_now=function(){return m.now()-b}}if(typeof window>"u"||typeof MessageChannel!="function"){var g=null,v=null,y=function(){if(g!==null)try{var I=o.unstable_now();g(!0,I),g=null}catch(j){throw setTimeout(y,0),j}};r=function(I){g!==null?setTimeout(r,0,I):(g=I,setTimeout(y,0))},s=function(I,j){v=setTimeout(I,j)},l=function(){clearTimeout(v)},o.unstable_shouldYield=function(){return!1},c=o.unstable_forceFrameRate=function(){}}else{var S=window.setTimeout,T=window.clearTimeout;if(typeof console<"u"){var B=window.cancelAnimationFrame;typeof window.requestAnimationFrame!="function"&&console.error("This browser doesn't support requestAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills"),typeof B!="function"&&console.error("This browser doesn't support cancelAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills")}var D=!1,P=null,V=-1,R=5,G=0;o.unstable_shouldYield=function(){return o.unstable_now()>=G},c=function(){},o.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<I?Math.floor(1e3/I):5};var H=new MessageChannel,te=H.port2;H.port1.onmessage=function(){if(P!==null){var I=o.unstable_now();G=I+R;try{P(!0,I)?te.postMessage(null):(D=!1,P=null)}catch(j){throw te.postMessage(null),j}}else D=!1},r=function(I){P=I,D||(D=!0,te.postMessage(null))},s=function(I,j){V=S(function(){I(o.unstable_now())},j)},l=function(){T(V),V=-1}}function M(I,j){var F=I.length;I.push(j);e:for(;;){var J=F-1>>>1,X=I[J];if(X!==void 0&&0<Y(X,j))I[J]=j,I[F]=X,F=J;else break e}}function U(I){return I=I[0],I===void 0?null:I}function $(I){var j=I[0];if(j!==void 0){var F=I.pop();if(F!==j){I[0]=F;e:for(var J=0,X=I.length;J<X;){var be=2*(J+1)-1,Ce=I[be],je=be+1,Ue=I[je];if(Ce!==void 0&&0>Y(Ce,F))Ue!==void 0&&0>Y(Ue,Ce)?(I[J]=Ue,I[je]=F,J=je):(I[J]=Ce,I[be]=F,J=be);else if(Ue!==void 0&&0>Y(Ue,F))I[J]=Ue,I[je]=F,J=je;else break e}}return j}return null}function Y(I,j){var F=I.sortIndex-j.sortIndex;return F!==0?F:I.id-j.id}var de=[],ne=[],pe=1,ee=null,oe=3,ge=!1,le=!1,Pe=!1;function A(I){for(var j=U(ne);j!==null;){if(j.callback===null)$(ne);else if(j.startTime<=I)$(ne),j.sortIndex=j.expirationTime,M(de,j);else break;j=U(ne)}}function z(I){if(Pe=!1,A(I),!le)if(U(de)!==null)le=!0,r(_);else{var j=U(ne);j!==null&&s(z,j.startTime-I)}}function _(I,j){le=!1,Pe&&(Pe=!1,l()),ge=!0;var F=oe;try{for(A(j),ee=U(de);ee!==null&&(!(ee.expirationTime>j)||I&&!o.unstable_shouldYield());){var J=ee.callback;if(typeof J=="function"){ee.callback=null,oe=ee.priorityLevel;var X=J(ee.expirationTime<=j);j=o.unstable_now(),typeof X=="function"?ee.callback=X:ee===U(de)&&$(de),A(j)}else $(de);ee=U(de)}if(ee!==null)var be=!0;else{var Ce=U(ne);Ce!==null&&s(z,Ce.startTime-j),be=!1}return be}finally{ee=null,oe=F,ge=!1}}var q=c;o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(I){I.callback=null},o.unstable_continueExecution=function(){le||ge||(le=!0,r(_))},o.unstable_getCurrentPriorityLevel=function(){return oe},o.unstable_getFirstCallbackNode=function(){return U(de)},o.unstable_next=function(I){switch(oe){case 1:case 2:case 3:var j=3;break;default:j=oe}var F=oe;oe=j;try{return I()}finally{oe=F}},o.unstable_pauseExecution=function(){},o.unstable_requestPaint=q,o.unstable_runWithPriority=function(I,j){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var F=oe;oe=I;try{return j()}finally{oe=F}},o.unstable_scheduleCallback=function(I,j,F){var J=o.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?J+F:J):F=J,I){case 1:var X=-1;break;case 2:X=250;break;case 5:X=1073741823;break;case 4:X=1e4;break;default:X=5e3}return X=F+X,I={id:pe++,callback:j,priorityLevel:I,startTime:F,expirationTime:X,sortIndex:-1},F>J?(I.sortIndex=F,M(ne,I),U(de)===null&&I===U(ne)&&(Pe?l():Pe=!0,s(z,F-J))):(I.sortIndex=X,M(de,I),le||ge||(le=!0,r(_))),I},o.unstable_wrapCallback=function(I){var j=oe;return function(){var F=oe;oe=j;try{return I.apply(this,arguments)}finally{oe=F}}}})(Ui)),Ui}var md;function Eh(){return md||(md=1,qi.exports=Ih()),qi.exports}var gd;function Ph(){if(gd)return Xe;gd=1;var o=ds(),r=cs(),s=Eh();function l(e){for(var n="https://reactjs.org/docs/error-decoder.html?invariant="+e,t=1;t<arguments.length;t++)n+="&args[]="+encodeURIComponent(arguments[t]);return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!o)throw Error(l(227));var c=new Set,h={};function m(e,n){b(e,n),b(e+"Capture",n)}function b(e,n){for(h[e]=n,e=0;e<n.length;e++)c.add(n[e])}var g=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),v=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,y=Object.prototype.hasOwnProperty,S={},T={};function B(e){return y.call(T,e)?!0:y.call(S,e)?!1:v.test(e)?T[e]=!0:(S[e]=!0,!1)}function D(e,n,t,a){if(t!==null&&t.type===0)return!1;switch(typeof n){case"function":case"symbol":return!0;case"boolean":return a?!1:t!==null?!t.acceptsBooleans:(e=e.toLowerCase().slice(0,5),e!=="data-"&&e!=="aria-");default:return!1}}function P(e,n,t,a){if(n===null||typeof n>"u"||D(e,n,t,a))return!0;if(a)return!1;if(t!==null)switch(t.type){case 3:return!n;case 4:return n===!1;case 5:return isNaN(n);case 6:return isNaN(n)||1>n}return!1}function V(e,n,t,a,i,d,u){this.acceptsBooleans=n===2||n===3||n===4,this.attributeName=a,this.attributeNamespace=i,this.mustUseProperty=t,this.propertyName=e,this.type=n,this.sanitizeURL=d,this.removeEmptyString=u}var R={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(e){R[e]=new V(e,0,!1,e,null,!1,!1)}),[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var n=e[0];R[n]=new V(n,1,!1,e[1],null,!1,!1)}),["contentEditable","draggable","spellCheck","value"].forEach(function(e){R[e]=new V(e,2,!1,e.toLowerCase(),null,!1,!1)}),["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){R[e]=new V(e,2,!1,e,null,!1,!1)}),"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(e){R[e]=new V(e,3,!1,e.toLowerCase(),null,!1,!1)}),["checked","multiple","muted","selected"].forEach(function(e){R[e]=new V(e,3,!0,e,null,!1,!1)}),["capture","download"].forEach(function(e){R[e]=new V(e,4,!1,e,null,!1,!1)}),["cols","rows","size","span"].forEach(function(e){R[e]=new V(e,6,!1,e,null,!1,!1)}),["rowSpan","start"].forEach(function(e){R[e]=new V(e,5,!1,e.toLowerCase(),null,!1,!1)});var G=/[\-:]([a-z])/g;function H(e){return e[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(e){var n=e.replace(G,H);R[n]=new V(n,1,!1,e,null,!1,!1)}),"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(e){var n=e.replace(G,H);R[n]=new V(n,1,!1,e,"http://www.w3.org/1999/xlink",!1,!1)}),["xml:base","xml:lang","xml:space"].forEach(function(e){var n=e.replace(G,H);R[n]=new V(n,1,!1,e,"http://www.w3.org/XML/1998/namespace",!1,!1)}),["tabIndex","crossOrigin"].forEach(function(e){R[e]=new V(e,1,!1,e.toLowerCase(),null,!1,!1)}),R.xlinkHref=new V("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1),["src","href","action","formAction"].forEach(function(e){R[e]=new V(e,1,!1,e.toLowerCase(),null,!0,!0)});function te(e,n,t,a){var i=R.hasOwnProperty(n)?R[n]:null,d=i!==null?i.type===0:a?!1:!(!(2<n.length)||n[0]!=="o"&&n[0]!=="O"||n[1]!=="n"&&n[1]!=="N");d||(P(n,t,i,a)&&(t=null),a||i===null?B(n)&&(t===null?e.removeAttribute(n):e.setAttribute(n,""+t)):i.mustUseProperty?e[i.propertyName]=t===null?i.type===3?!1:"":t:(n=i.attributeName,a=i.attributeNamespace,t===null?e.removeAttribute(n):(i=i.type,t=i===3||i===4&&t===!0?"":""+t,a?e.setAttributeNS(a,n,t):e.setAttribute(n,t))))}var M=o.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,U=60103,$=60106,Y=60107,de=60108,ne=60114,pe=60109,ee=60110,oe=60112,ge=60113,le=60120,Pe=60115,A=60116,z=60121,_=60128,q=60129,I=60130,j=60131;if(typeof Symbol=="function"&&Symbol.for){var F=Symbol.for;U=F("react.element"),$=F("react.portal"),Y=F("react.fragment"),de=F("react.strict_mode"),ne=F("react.profiler"),pe=F("react.provider"),ee=F("react.context"),oe=F("react.forward_ref"),ge=F("react.suspense"),le=F("react.suspense_list"),Pe=F("react.memo"),A=F("react.lazy"),z=F("react.block"),F("react.scope"),_=F("react.opaque.id"),q=F("react.debug_trace_mode"),I=F("react.offscreen"),j=F("react.legacy_hidden")}var J=typeof Symbol=="function"&&Symbol.iterator;function X(e){return e===null||typeof e!="object"?null:(e=J&&e[J]||e["@@iterator"],typeof e=="function"?e:null)}var be;function Ce(e){if(be===void 0)try{throw Error()}catch(t){var n=t.stack.trim().match(/\n( *(at )?)/);be=n&&n[1]||""}return`
`+be+e}var je=!1;function Ue(e,n){if(!e||je)return"";je=!0;var t=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{if(n)if(n=function(){throw Error()},Object.defineProperty(n.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(n,[])}catch(x){var a=x}Reflect.construct(e,[],n)}else{try{n.call()}catch(x){a=x}e.call(n.prototype)}else{try{throw Error()}catch(x){a=x}e()}}catch(x){if(x&&a&&typeof x.stack=="string"){for(var i=x.stack.split(`
`),d=a.stack.split(`
`),u=i.length-1,f=d.length-1;1<=u&&0<=f&&i[u]!==d[f];)f--;for(;1<=u&&0<=f;u--,f--)if(i[u]!==d[f]){if(u!==1||f!==1)do if(u--,f--,0>f||i[u]!==d[f])return`
`+i[u].replace(" at new "," at ");while(1<=u&&0<=f);break}}}finally{je=!1,Error.prepareStackTrace=t}return(e=e?e.displayName||e.name:"")?Ce(e):""}function Rp(e){switch(e.tag){case 5:return Ce(e.type);case 16:return Ce("Lazy");case 13:return Ce("Suspense");case 19:return Ce("SuspenseList");case 0:case 2:case 15:return e=Ue(e.type,!1),e;case 11:return e=Ue(e.type.render,!1),e;case 22:return e=Ue(e.type._render,!1),e;case 1:return e=Ue(e.type,!0),e;default:return""}}function dt(e){if(e==null)return null;if(typeof e=="function")return e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case Y:return"Fragment";case $:return"Portal";case ne:return"Profiler";case de:return"StrictMode";case ge:return"Suspense";case le:return"SuspenseList"}if(typeof e=="object")switch(e.$$typeof){case ee:return(e.displayName||"Context")+".Consumer";case pe:return(e._context.displayName||"Context")+".Provider";case oe:var n=e.render;return n=n.displayName||n.name||"",e.displayName||(n!==""?"ForwardRef("+n+")":"ForwardRef");case Pe:return dt(e.type);case z:return dt(e._render);case A:n=e._payload,e=e._init;try{return dt(e(n))}catch{}}return null}function Sn(e){switch(typeof e){case"boolean":case"number":case"object":case"string":case"undefined":return e;default:return""}}function Es(e){var n=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(n==="checkbox"||n==="radio")}function jp(e){var n=Es(e)?"checked":"value",t=Object.getOwnPropertyDescriptor(e.constructor.prototype,n),a=""+e[n];if(!e.hasOwnProperty(n)&&typeof t<"u"&&typeof t.get=="function"&&typeof t.set=="function"){var i=t.get,d=t.set;return Object.defineProperty(e,n,{configurable:!0,get:function(){return i.call(this)},set:function(u){a=""+u,d.call(this,u)}}),Object.defineProperty(e,n,{enumerable:t.enumerable}),{getValue:function(){return a},setValue:function(u){a=""+u},stopTracking:function(){e._valueTracker=null,delete e[n]}}}}function Oa(e){e._valueTracker||(e._valueTracker=jp(e))}function Ps(e){if(!e)return!1;var n=e._valueTracker;if(!n)return!0;var t=n.getValue(),a="";return e&&(a=Es(e)?e.checked?"true":"false":e.value),e=a,e!==t?(n.setValue(e),!0):!1}function Ba(e){if(e=e||(typeof document<"u"?document:void 0),typeof e>"u")return null;try{return e.activeElement||e.body}catch{return e.body}}function Qr(e,n){var t=n.checked;return r({},n,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:t??e._wrapperState.initialChecked})}function Ms(e,n){var t=n.defaultValue==null?"":n.defaultValue,a=n.checked!=null?n.checked:n.defaultChecked;t=Sn(n.value!=null?n.value:t),e._wrapperState={initialChecked:a,initialValue:t,controlled:n.type==="checkbox"||n.type==="radio"?n.checked!=null:n.value!=null}}function Ls(e,n){n=n.checked,n!=null&&te(e,"checked",n,!1)}function Xr(e,n){Ls(e,n);var t=Sn(n.value),a=n.type;if(t!=null)a==="number"?(t===0&&e.value===""||e.value!=t)&&(e.value=""+t):e.value!==""+t&&(e.value=""+t);else if(a==="submit"||a==="reset"){e.removeAttribute("value");return}n.hasOwnProperty("value")?Zr(e,n.type,t):n.hasOwnProperty("defaultValue")&&Zr(e,n.type,Sn(n.defaultValue)),n.checked==null&&n.defaultChecked!=null&&(e.defaultChecked=!!n.defaultChecked)}function Rs(e,n,t){if(n.hasOwnProperty("value")||n.hasOwnProperty("defaultValue")){var a=n.type;if(!(a!=="submit"&&a!=="reset"||n.value!==void 0&&n.value!==null))return;n=""+e._wrapperState.initialValue,t||n===e.value||(e.value=n),e.defaultValue=n}t=e.name,t!==""&&(e.name=""),e.defaultChecked=!!e._wrapperState.initialChecked,t!==""&&(e.name=t)}function Zr(e,n,t){(n!=="number"||Ba(e.ownerDocument)!==e)&&(t==null?e.defaultValue=""+e._wrapperState.initialValue:e.defaultValue!==""+t&&(e.defaultValue=""+t))}function Np(e){var n="";return o.Children.forEach(e,function(t){t!=null&&(n+=t)}),n}function eo(e,n){return e=r({children:void 0},n),(n=Np(n.children))&&(e.children=n),e}function pt(e,n,t,a){if(e=e.options,n){n={};for(var i=0;i<t.length;i++)n["$"+t[i]]=!0;for(t=0;t<e.length;t++)i=n.hasOwnProperty("$"+e[t].value),e[t].selected!==i&&(e[t].selected=i),i&&a&&(e[t].defaultSelected=!0)}else{for(t=""+Sn(t),n=null,i=0;i<e.length;i++){if(e[i].value===t){e[i].selected=!0,a&&(e[i].defaultSelected=!0);return}n!==null||e[i].disabled||(n=e[i])}n!==null&&(n.selected=!0)}}function no(e,n){if(n.dangerouslySetInnerHTML!=null)throw Error(l(91));return r({},n,{value:void 0,defaultValue:void 0,children:""+e._wrapperState.initialValue})}function js(e,n){var t=n.value;if(t==null){if(t=n.children,n=n.defaultValue,t!=null){if(n!=null)throw Error(l(92));if(Array.isArray(t)){if(!(1>=t.length))throw Error(l(93));t=t[0]}n=t}n==null&&(n=""),t=n}e._wrapperState={initialValue:Sn(t)}}function Ns(e,n){var t=Sn(n.value),a=Sn(n.defaultValue);t!=null&&(t=""+t,t!==e.value&&(e.value=t),n.defaultValue==null&&e.defaultValue!==t&&(e.defaultValue=t)),a!=null&&(e.defaultValue=""+a)}function Ds(e){var n=e.textContent;n===e._wrapperState.initialValue&&n!==""&&n!==null&&(e.value=n)}var to={html:"http://www.w3.org/1999/xhtml",svg:"http://www.w3.org/2000/svg"};function Fs(e){switch(e){case"svg":return"http://www.w3.org/2000/svg";case"math":return"http://www.w3.org/1998/Math/MathML";default:return"http://www.w3.org/1999/xhtml"}}function ao(e,n){return e==null||e==="http://www.w3.org/1999/xhtml"?Fs(n):e==="http://www.w3.org/2000/svg"&&n==="foreignObject"?"http://www.w3.org/1999/xhtml":e}var Ga,zs=(function(e){return typeof MSApp<"u"&&MSApp.execUnsafeLocalFunction?function(n,t,a,i){MSApp.execUnsafeLocalFunction(function(){return e(n,t,a,i)})}:e})(function(e,n){if(e.namespaceURI!==to.svg||"innerHTML"in e)e.innerHTML=n;else{for(Ga=Ga||document.createElement("div"),Ga.innerHTML="<svg>"+n.valueOf().toString()+"</svg>",n=Ga.firstChild;e.firstChild;)e.removeChild(e.firstChild);for(;n.firstChild;)e.appendChild(n.firstChild)}});function Ut(e,n){if(n){var t=e.firstChild;if(t&&t===e.lastChild&&t.nodeType===3){t.nodeValue=n;return}}e.textContent=n}var Wt={animationIterationCount:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},Dp=["Webkit","ms","Moz","O"];Object.keys(Wt).forEach(function(e){Dp.forEach(function(n){n=n+e.charAt(0).toUpperCase()+e.substring(1),Wt[n]=Wt[e]})});function Os(e,n,t){return n==null||typeof n=="boolean"||n===""?"":t||typeof n!="number"||n===0||Wt.hasOwnProperty(e)&&Wt[e]?(""+n).trim():n+"px"}function Bs(e,n){e=e.style;for(var t in n)if(n.hasOwnProperty(t)){var a=t.indexOf("--")===0,i=Os(t,n[t],a);t==="float"&&(t="cssFloat"),a?e.setProperty(t,i):e[t]=i}}var Fp=r({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0});function ro(e,n){if(n){if(Fp[e]&&(n.children!=null||n.dangerouslySetInnerHTML!=null))throw Error(l(137,e));if(n.dangerouslySetInnerHTML!=null){if(n.children!=null)throw Error(l(60));if(!(typeof n.dangerouslySetInnerHTML=="object"&&"__html"in n.dangerouslySetInnerHTML))throw Error(l(61))}if(n.style!=null&&typeof n.style!="object")throw Error(l(62))}}function oo(e,n){if(e.indexOf("-")===-1)return typeof n.is=="string";switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}function io(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var so=null,ut=null,ht=null;function Gs(e){if(e=da(e)){if(typeof so!="function")throw Error(l(280));var n=e.stateNode;n&&(n=rr(n),so(e.stateNode,e.type,n))}}function Hs(e){ut?ht?ht.push(e):ht=[e]:ut=e}function _s(){if(ut){var e=ut,n=ht;if(ht=ut=null,Gs(e),n)for(e=0;e<n.length;e++)Gs(n[e])}}function lo(e,n){return e(n)}function qs(e,n,t,a,i){return e(n,t,a,i)}function co(){}var Us=lo,$n=!1,po=!1;function uo(){(ut!==null||ht!==null)&&(co(),_s())}function zp(e,n,t){if(po)return e(n,t);po=!0;try{return Us(e,n,t)}finally{po=!1,uo()}}function Yt(e,n){var t=e.stateNode;if(t===null)return null;var a=rr(t);if(a===null)return null;t=a[n];e:switch(n){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(a=!a.disabled)||(e=e.type,a=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!a;break e;default:e=!1}if(e)return null;if(t&&typeof t!="function")throw Error(l(231,n,typeof t));return t}var ho=!1;if(g)try{var Vt={};Object.defineProperty(Vt,"passive",{get:function(){ho=!0}}),window.addEventListener("test",Vt,Vt),window.removeEventListener("test",Vt,Vt)}catch{ho=!1}function Op(e,n,t,a,i,d,u,f,x){var E=Array.prototype.slice.call(arguments,3);try{n.apply(t,E)}catch(W){this.onError(W)}}var $t=!1,Ha=null,_a=!1,mo=null,Bp={onError:function(e){$t=!0,Ha=e}};function Gp(e,n,t,a,i,d,u,f,x){$t=!1,Ha=null,Op.apply(Bp,arguments)}function Hp(e,n,t,a,i,d,u,f,x){if(Gp.apply(this,arguments),$t){if($t){var E=Ha;$t=!1,Ha=null}else throw Error(l(198));_a||(_a=!0,mo=E)}}function Kn(e){var n=e,t=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&1026)!==0&&(t=n.return),e=n.return;while(e)}return n.tag===3?t:null}function Ws(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function Ys(e){if(Kn(e)!==e)throw Error(l(188))}function _p(e){var n=e.alternate;if(!n){if(n=Kn(e),n===null)throw Error(l(188));return n!==e?null:e}for(var t=e,a=n;;){var i=t.return;if(i===null)break;var d=i.alternate;if(d===null){if(a=i.return,a!==null){t=a;continue}break}if(i.child===d.child){for(d=i.child;d;){if(d===t)return Ys(i),e;if(d===a)return Ys(i),n;d=d.sibling}throw Error(l(188))}if(t.return!==a.return)t=i,a=d;else{for(var u=!1,f=i.child;f;){if(f===t){u=!0,t=i,a=d;break}if(f===a){u=!0,a=i,t=d;break}f=f.sibling}if(!u){for(f=d.child;f;){if(f===t){u=!0,t=d,a=i;break}if(f===a){u=!0,a=d,t=i;break}f=f.sibling}if(!u)throw Error(l(189))}}if(t.alternate!==a)throw Error(l(190))}if(t.tag!==3)throw Error(l(188));return t.stateNode.current===t?e:n}function Vs(e){if(e=_p(e),!e)return null;for(var n=e;;){if(n.tag===5||n.tag===6)return n;if(n.child)n.child.return=n,n=n.child;else{if(n===e)break;for(;!n.sibling;){if(!n.return||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}}return null}function $s(e,n){for(var t=e.alternate;n!==null;){if(n===e||n===t)return!0;n=n.return}return!1}var Ks,go,Js,Qs,fo=!1,dn=[],Tn=null,An=null,In=null,Kt=new Map,Jt=new Map,Qt=[],Xs="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");function vo(e,n,t,a,i){return{blockedOn:e,domEventName:n,eventSystemFlags:t|16,nativeEvent:i,targetContainers:[a]}}function Zs(e,n){switch(e){case"focusin":case"focusout":Tn=null;break;case"dragenter":case"dragleave":An=null;break;case"mouseover":case"mouseout":In=null;break;case"pointerover":case"pointerout":Kt.delete(n.pointerId);break;case"gotpointercapture":case"lostpointercapture":Jt.delete(n.pointerId)}}function Xt(e,n,t,a,i,d){return e===null||e.nativeEvent!==d?(e=vo(n,t,a,i,d),n!==null&&(n=da(n),n!==null&&go(n)),e):(e.eventSystemFlags|=a,n=e.targetContainers,i!==null&&n.indexOf(i)===-1&&n.push(i),e)}function qp(e,n,t,a,i){switch(n){case"focusin":return Tn=Xt(Tn,e,n,t,a,i),!0;case"dragenter":return An=Xt(An,e,n,t,a,i),!0;case"mouseover":return In=Xt(In,e,n,t,a,i),!0;case"pointerover":var d=i.pointerId;return Kt.set(d,Xt(Kt.get(d)||null,e,n,t,a,i)),!0;case"gotpointercapture":return d=i.pointerId,Jt.set(d,Xt(Jt.get(d)||null,e,n,t,a,i)),!0}return!1}function Up(e){var n=Jn(e.target);if(n!==null){var t=Kn(n);if(t!==null){if(n=t.tag,n===13){if(n=Ws(t),n!==null){e.blockedOn=n,Qs(e.lanePriority,function(){s.unstable_runWithPriority(e.priority,function(){Js(t)})});return}}else if(n===3&&t.stateNode.hydrate){e.blockedOn=t.tag===3?t.stateNode.containerInfo:null;return}}}e.blockedOn=null}function qa(e){if(e.blockedOn!==null)return!1;for(var n=e.targetContainers;0<n.length;){var t=Co(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(t!==null)return n=da(t),n!==null&&go(n),e.blockedOn=t,!1;n.shift()}return!0}function el(e,n,t){qa(e)&&t.delete(n)}function Wp(){for(fo=!1;0<dn.length;){var e=dn[0];if(e.blockedOn!==null){e=da(e.blockedOn),e!==null&&Ks(e);break}for(var n=e.targetContainers;0<n.length;){var t=Co(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(t!==null){e.blockedOn=t;break}n.shift()}e.blockedOn===null&&dn.shift()}Tn!==null&&qa(Tn)&&(Tn=null),An!==null&&qa(An)&&(An=null),In!==null&&qa(In)&&(In=null),Kt.forEach(el),Jt.forEach(el)}function Zt(e,n){e.blockedOn===n&&(e.blockedOn=null,fo||(fo=!0,s.unstable_scheduleCallback(s.unstable_NormalPriority,Wp)))}function nl(e){function n(i){return Zt(i,e)}if(0<dn.length){Zt(dn[0],e);for(var t=1;t<dn.length;t++){var a=dn[t];a.blockedOn===e&&(a.blockedOn=null)}}for(Tn!==null&&Zt(Tn,e),An!==null&&Zt(An,e),In!==null&&Zt(In,e),Kt.forEach(n),Jt.forEach(n),t=0;t<Qt.length;t++)a=Qt[t],a.blockedOn===e&&(a.blockedOn=null);for(;0<Qt.length&&(t=Qt[0],t.blockedOn===null);)Up(t),t.blockedOn===null&&Qt.shift()}function Ua(e,n){var t={};return t[e.toLowerCase()]=n.toLowerCase(),t["Webkit"+e]="webkit"+n,t["Moz"+e]="moz"+n,t}var mt={animationend:Ua("Animation","AnimationEnd"),animationiteration:Ua("Animation","AnimationIteration"),animationstart:Ua("Animation","AnimationStart"),transitionend:Ua("Transition","TransitionEnd")},bo={},tl={};g&&(tl=document.createElement("div").style,"AnimationEvent"in window||(delete mt.animationend.animation,delete mt.animationiteration.animation,delete mt.animationstart.animation),"TransitionEvent"in window||delete mt.transitionend.transition);function Wa(e){if(bo[e])return bo[e];if(!mt[e])return e;var n=mt[e],t;for(t in n)if(n.hasOwnProperty(t)&&t in tl)return bo[e]=n[t];return e}var al=Wa("animationend"),rl=Wa("animationiteration"),ol=Wa("animationstart"),il=Wa("transitionend"),sl=new Map,yo=new Map,Yp=["abort","abort",al,"animationEnd",rl,"animationIteration",ol,"animationStart","canplay","canPlay","canplaythrough","canPlayThrough","durationchange","durationChange","emptied","emptied","encrypted","encrypted","ended","ended","error","error","gotpointercapture","gotPointerCapture","load","load","loadeddata","loadedData","loadedmetadata","loadedMetadata","loadstart","loadStart","lostpointercapture","lostPointerCapture","playing","playing","progress","progress","seeking","seeking","stalled","stalled","suspend","suspend","timeupdate","timeUpdate",il,"transitionEnd","waiting","waiting"];function xo(e,n){for(var t=0;t<e.length;t+=2){var a=e[t],i=e[t+1];i="on"+(i[0].toUpperCase()+i.slice(1)),yo.set(a,n),sl.set(a,i),m(i,[a])}}var Vp=s.unstable_now;Vp();var Se=8;function gt(e){if((1&e)!==0)return Se=15,1;if((2&e)!==0)return Se=14,2;if((4&e)!==0)return Se=13,4;var n=24&e;return n!==0?(Se=12,n):(e&32)!==0?(Se=11,32):(n=192&e,n!==0?(Se=10,n):(e&256)!==0?(Se=9,256):(n=3584&e,n!==0?(Se=8,n):(e&4096)!==0?(Se=7,4096):(n=4186112&e,n!==0?(Se=6,n):(n=62914560&e,n!==0?(Se=5,n):e&67108864?(Se=4,67108864):(e&134217728)!==0?(Se=3,134217728):(n=805306368&e,n!==0?(Se=2,n):(1073741824&e)!==0?(Se=1,1073741824):(Se=8,e))))))}function $p(e){switch(e){case 99:return 15;case 98:return 10;case 97:case 96:return 8;case 95:return 2;default:return 0}}function Kp(e){switch(e){case 15:case 14:return 99;case 13:case 12:case 11:case 10:return 98;case 9:case 8:case 7:case 6:case 4:case 5:return 97;case 3:case 2:case 1:return 95;case 0:return 90;default:throw Error(l(358,e))}}function ea(e,n){var t=e.pendingLanes;if(t===0)return Se=0;var a=0,i=0,d=e.expiredLanes,u=e.suspendedLanes,f=e.pingedLanes;if(d!==0)a=d,i=Se=15;else if(d=t&134217727,d!==0){var x=d&~u;x!==0?(a=gt(x),i=Se):(f&=d,f!==0&&(a=gt(f),i=Se))}else d=t&~u,d!==0?(a=gt(d),i=Se):f!==0&&(a=gt(f),i=Se);if(a===0)return 0;if(a=31-En(a),a=t&((0>a?0:1<<a)<<1)-1,n!==0&&n!==a&&(n&u)===0){if(gt(n),i<=Se)return n;Se=i}if(n=e.entangledLanes,n!==0)for(e=e.entanglements,n&=a;0<n;)t=31-En(n),i=1<<t,a|=e[t],n&=~i;return a}function ll(e){return e=e.pendingLanes&-1073741825,e!==0?e:e&1073741824?1073741824:0}function Ya(e,n){switch(e){case 15:return 1;case 14:return 2;case 12:return e=ft(24&~n),e===0?Ya(10,n):e;case 10:return e=ft(192&~n),e===0?Ya(8,n):e;case 8:return e=ft(3584&~n),e===0&&(e=ft(4186112&~n),e===0&&(e=512)),e;case 2:return n=ft(805306368&~n),n===0&&(n=268435456),n}throw Error(l(358,e))}function ft(e){return e&-e}function wo(e){for(var n=[],t=0;31>t;t++)n.push(e);return n}function Va(e,n,t){e.pendingLanes|=n;var a=n-1;e.suspendedLanes&=a,e.pingedLanes&=a,e=e.eventTimes,n=31-En(n),e[n]=t}var En=Math.clz32?Math.clz32:Xp,Jp=Math.log,Qp=Math.LN2;function Xp(e){return e===0?32:31-(Jp(e)/Qp|0)|0}var Zp=s.unstable_UserBlockingPriority,eu=s.unstable_runWithPriority,$a=!0;function nu(e,n,t,a){$n||co();var i=ko,d=$n;$n=!0;try{qs(i,e,n,t,a)}finally{($n=d)||uo()}}function tu(e,n,t,a){eu(Zp,ko.bind(null,e,n,t,a))}function ko(e,n,t,a){if($a){var i;if((i=(n&4)===0)&&0<dn.length&&-1<Xs.indexOf(e))e=vo(null,e,n,t,a),dn.push(e);else{var d=Co(e,n,t,a);if(d===null)i&&Zs(e,a);else{if(i){if(-1<Xs.indexOf(e)){e=vo(d,e,n,t,a),dn.push(e);return}if(qp(d,e,n,t,a))return;Zs(e,a)}zl(e,n,a,null,t)}}}}function Co(e,n,t,a){var i=io(a);if(i=Jn(i),i!==null){var d=Kn(i);if(d===null)i=null;else{var u=d.tag;if(u===13){if(i=Ws(d),i!==null)return i;i=null}else if(u===3){if(d.stateNode.hydrate)return d.tag===3?d.stateNode.containerInfo:null;i=null}else d!==i&&(i=null)}}return zl(e,n,a,i,t),null}var Pn=null,So=null,Ka=null;function cl(){if(Ka)return Ka;var e,n=So,t=n.length,a,i="value"in Pn?Pn.value:Pn.textContent,d=i.length;for(e=0;e<t&&n[e]===i[e];e++);var u=t-e;for(a=1;a<=u&&n[t-a]===i[d-a];a++);return Ka=i.slice(e,1<a?1-a:void 0)}function Ja(e){var n=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&n===13&&(e=13)):e=n,e===10&&(e=13),32<=e||e===13?e:0}function Qa(){return!0}function dl(){return!1}function Je(e){function n(t,a,i,d,u){this._reactName=t,this._targetInst=i,this.type=a,this.nativeEvent=d,this.target=u,this.currentTarget=null;for(var f in e)e.hasOwnProperty(f)&&(t=e[f],this[f]=t?t(d):d[f]);return this.isDefaultPrevented=(d.defaultPrevented!=null?d.defaultPrevented:d.returnValue===!1)?Qa:dl,this.isPropagationStopped=dl,this}return r(n.prototype,{preventDefault:function(){this.defaultPrevented=!0;var t=this.nativeEvent;t&&(t.preventDefault?t.preventDefault():typeof t.returnValue!="unknown"&&(t.returnValue=!1),this.isDefaultPrevented=Qa)},stopPropagation:function(){var t=this.nativeEvent;t&&(t.stopPropagation?t.stopPropagation():typeof t.cancelBubble!="unknown"&&(t.cancelBubble=!0),this.isPropagationStopped=Qa)},persist:function(){},isPersistent:Qa}),n}var vt={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},To=Je(vt),na=r({},vt,{view:0,detail:0}),au=Je(na),Ao,Io,ta,Xa=r({},na,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:Po,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==ta&&(ta&&e.type==="mousemove"?(Ao=e.screenX-ta.screenX,Io=e.screenY-ta.screenY):Io=Ao=0,ta=e),Ao)},movementY:function(e){return"movementY"in e?e.movementY:Io}}),pl=Je(Xa),ru=r({},Xa,{dataTransfer:0}),ou=Je(ru),iu=r({},na,{relatedTarget:0}),Eo=Je(iu),su=r({},vt,{animationName:0,elapsedTime:0,pseudoElement:0}),lu=Je(su),cu=r({},vt,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),du=Je(cu),pu=r({},vt,{data:0}),ul=Je(pu),uu={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},hu={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},mu={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function gu(e){var n=this.nativeEvent;return n.getModifierState?n.getModifierState(e):(e=mu[e])?!!n[e]:!1}function Po(){return gu}var fu=r({},na,{key:function(e){if(e.key){var n=uu[e.key]||e.key;if(n!=="Unidentified")return n}return e.type==="keypress"?(e=Ja(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?hu[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:Po,charCode:function(e){return e.type==="keypress"?Ja(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?Ja(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),vu=Je(fu),bu=r({},Xa,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),hl=Je(bu),yu=r({},na,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:Po}),xu=Je(yu),wu=r({},vt,{propertyName:0,elapsedTime:0,pseudoElement:0}),ku=Je(wu),Cu=r({},Xa,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),Su=Je(Cu),Tu=[9,13,27,32],Mo=g&&"CompositionEvent"in window,aa=null;g&&"documentMode"in document&&(aa=document.documentMode);var Au=g&&"TextEvent"in window&&!aa,ml=g&&(!Mo||aa&&8<aa&&11>=aa),gl=" ",fl=!1;function vl(e,n){switch(e){case"keyup":return Tu.indexOf(n.keyCode)!==-1;case"keydown":return n.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function bl(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var bt=!1;function Iu(e,n){switch(e){case"compositionend":return bl(n);case"keypress":return n.which!==32?null:(fl=!0,gl);case"textInput":return e=n.data,e===gl&&fl?null:e;default:return null}}function Eu(e,n){if(bt)return e==="compositionend"||!Mo&&vl(e,n)?(e=cl(),Ka=So=Pn=null,bt=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(n.ctrlKey||n.altKey||n.metaKey)||n.ctrlKey&&n.altKey){if(n.char&&1<n.char.length)return n.char;if(n.which)return String.fromCharCode(n.which)}return null;case"compositionend":return ml&&n.locale!=="ko"?null:n.data;default:return null}}var Pu={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function yl(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n==="input"?!!Pu[e.type]:n==="textarea"}function xl(e,n,t,a){Hs(a),n=er(n,"onChange"),0<n.length&&(t=new To("onChange","change",null,t,a),e.push({event:t,listeners:n}))}var ra=null,oa=null;function Mu(e){Rl(e,0)}function Za(e){var n=Ct(e);if(Ps(n))return e}function Lu(e,n){if(e==="change")return n}var wl=!1;if(g){var Lo;if(g){var Ro="oninput"in document;if(!Ro){var kl=document.createElement("div");kl.setAttribute("oninput","return;"),Ro=typeof kl.oninput=="function"}Lo=Ro}else Lo=!1;wl=Lo&&(!document.documentMode||9<document.documentMode)}function Cl(){ra&&(ra.detachEvent("onpropertychange",Sl),oa=ra=null)}function Sl(e){if(e.propertyName==="value"&&Za(oa)){var n=[];if(xl(n,oa,e,io(e)),e=Mu,$n)e(n);else{$n=!0;try{lo(e,n)}finally{$n=!1,uo()}}}}function Ru(e,n,t){e==="focusin"?(Cl(),ra=n,oa=t,ra.attachEvent("onpropertychange",Sl)):e==="focusout"&&Cl()}function ju(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return Za(oa)}function Nu(e,n){if(e==="click")return Za(n)}function Du(e,n){if(e==="input"||e==="change")return Za(n)}function Fu(e,n){return e===n&&(e!==0||1/e===1/n)||e!==e&&n!==n}var Ze=typeof Object.is=="function"?Object.is:Fu,zu=Object.prototype.hasOwnProperty;function ia(e,n){if(Ze(e,n))return!0;if(typeof e!="object"||e===null||typeof n!="object"||n===null)return!1;var t=Object.keys(e),a=Object.keys(n);if(t.length!==a.length)return!1;for(a=0;a<t.length;a++)if(!zu.call(n,t[a])||!Ze(e[t[a]],n[t[a]]))return!1;return!0}function Tl(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function Al(e,n){var t=Tl(e);e=0;for(var a;t;){if(t.nodeType===3){if(a=e+t.textContent.length,e<=n&&a>=n)return{node:t,offset:n-e};e=a}e:{for(;t;){if(t.nextSibling){t=t.nextSibling;break e}t=t.parentNode}t=void 0}t=Tl(t)}}function Il(e,n){return e&&n?e===n?!0:e&&e.nodeType===3?!1:n&&n.nodeType===3?Il(e,n.parentNode):"contains"in e?e.contains(n):e.compareDocumentPosition?!!(e.compareDocumentPosition(n)&16):!1:!1}function El(){for(var e=window,n=Ba();n instanceof e.HTMLIFrameElement;){try{var t=typeof n.contentWindow.location.href=="string"}catch{t=!1}if(t)e=n.contentWindow;else break;n=Ba(e.document)}return n}function jo(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n&&(n==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||n==="textarea"||e.contentEditable==="true")}var Ou=g&&"documentMode"in document&&11>=document.documentMode,yt=null,No=null,sa=null,Do=!1;function Pl(e,n,t){var a=t.window===t?t.document:t.nodeType===9?t:t.ownerDocument;Do||yt==null||yt!==Ba(a)||(a=yt,"selectionStart"in a&&jo(a)?a={start:a.selectionStart,end:a.selectionEnd}:(a=(a.ownerDocument&&a.ownerDocument.defaultView||window).getSelection(),a={anchorNode:a.anchorNode,anchorOffset:a.anchorOffset,focusNode:a.focusNode,focusOffset:a.focusOffset}),sa&&ia(sa,a)||(sa=a,a=er(No,"onSelect"),0<a.length&&(n=new To("onSelect","select",null,n,t),e.push({event:n,listeners:a}),n.target=yt)))}xo("cancel cancel click click close close contextmenu contextMenu copy copy cut cut auxclick auxClick dblclick doubleClick dragend dragEnd dragstart dragStart drop drop focusin focus focusout blur input input invalid invalid keydown keyDown keypress keyPress keyup keyUp mousedown mouseDown mouseup mouseUp paste paste pause pause play play pointercancel pointerCancel pointerdown pointerDown pointerup pointerUp ratechange rateChange reset reset seeked seeked submit submit touchcancel touchCancel touchend touchEnd touchstart touchStart volumechange volumeChange".split(" "),0),xo("drag drag dragenter dragEnter dragexit dragExit dragleave dragLeave dragover dragOver mousemove mouseMove mouseout mouseOut mouseover mouseOver pointermove pointerMove pointerout pointerOut pointerover pointerOver scroll scroll toggle toggle touchmove touchMove wheel wheel".split(" "),1),xo(Yp,2);for(var Ml="change selectionchange textInput compositionstart compositionend compositionupdate".split(" "),Fo=0;Fo<Ml.length;Fo++)yo.set(Ml[Fo],0);b("onMouseEnter",["mouseout","mouseover"]),b("onMouseLeave",["mouseout","mouseover"]),b("onPointerEnter",["pointerout","pointerover"]),b("onPointerLeave",["pointerout","pointerover"]),m("onChange","change click focusin focusout input keydown keyup selectionchange".split(" ")),m("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")),m("onBeforeInput",["compositionend","keypress","textInput","paste"]),m("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" ")),m("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" ")),m("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var la="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),Bu=new Set("cancel close invalid load scroll toggle".split(" ").concat(la));function Ll(e,n,t){var a=e.type||"unknown-event";e.currentTarget=t,Hp(a,n,void 0,e),e.currentTarget=null}function Rl(e,n){n=(n&4)!==0;for(var t=0;t<e.length;t++){var a=e[t],i=a.event;a=a.listeners;e:{var d=void 0;if(n)for(var u=a.length-1;0<=u;u--){var f=a[u],x=f.instance,E=f.currentTarget;if(f=f.listener,x!==d&&i.isPropagationStopped())break e;Ll(i,f,E),d=x}else for(u=0;u<a.length;u++){if(f=a[u],x=f.instance,E=f.currentTarget,f=f.listener,x!==d&&i.isPropagationStopped())break e;Ll(i,f,E),d=x}}}if(_a)throw e=mo,_a=!1,mo=null,e}function Te(e,n){var t=ql(n),a=e+"__bubble";t.has(a)||(Fl(n,e,2,!1),t.add(a))}var jl="_reactListening"+Math.random().toString(36).slice(2);function Nl(e){e[jl]||(e[jl]=!0,c.forEach(function(n){Bu.has(n)||Dl(n,!1,e,null),Dl(n,!0,e,null)}))}function Dl(e,n,t,a){var i=4<arguments.length&&arguments[4]!==void 0?arguments[4]:0,d=t;e==="selectionchange"&&t.nodeType!==9&&(d=t.ownerDocument);var u=ql(d),f=e+"__"+(n?"capture":"bubble");u.has(f)||(n&&(i|=4),Fl(d,e,i,n),u.add(f))}function Fl(e,n,t,a){var i=yo.get(n);switch(i===void 0?2:i){case 0:i=nu;break;case 1:i=tu;break;default:i=ko}t=i.bind(null,n,t,e),i=void 0,!ho||n!=="touchstart"&&n!=="touchmove"&&n!=="wheel"||(i=!0),a?i!==void 0?e.addEventListener(n,t,{capture:!0,passive:i}):e.addEventListener(n,t,!0):i!==void 0?e.addEventListener(n,t,{passive:i}):e.addEventListener(n,t,!1)}function zl(e,n,t,a,i){var d=a;if((n&1)===0&&(n&2)===0&&a!==null)e:for(;;){if(a===null)return;var u=a.tag;if(u===3||u===4){var f=a.stateNode.containerInfo;if(f===i||f.nodeType===8&&f.parentNode===i)break;if(u===4)for(u=a.return;u!==null;){var x=u.tag;if((x===3||x===4)&&(x=u.stateNode.containerInfo,x===i||x.nodeType===8&&x.parentNode===i))return;u=u.return}for(;f!==null;){if(u=Jn(f),u===null)return;if(x=u.tag,x===5||x===6){a=d=u;continue e}f=f.parentNode}}a=a.return}zp(function(){var E=d,W=io(t),ce=[];e:{var O=sl.get(e);if(O!==void 0){var Z=To,se=e;switch(e){case"keypress":if(Ja(t)===0)break e;case"keydown":case"keyup":Z=vu;break;case"focusin":se="focus",Z=Eo;break;case"focusout":se="blur",Z=Eo;break;case"beforeblur":case"afterblur":Z=Eo;break;case"click":if(t.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":Z=pl;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":Z=ou;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":Z=xu;break;case al:case rl:case ol:Z=lu;break;case il:Z=ku;break;case"scroll":Z=au;break;case"wheel":Z=Su;break;case"copy":case"cut":case"paste":Z=du;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":Z=hl}var re=(n&4)!==0,C=!re&&e==="scroll",w=re?O!==null?O+"Capture":null:O;re=[];for(var k=E,L;k!==null;){L=k;var N=L.stateNode;if(L.tag===5&&N!==null&&(L=N,w!==null&&(N=Yt(k,w),N!=null&&re.push(ca(k,N,L)))),C)break;k=k.return}0<re.length&&(O=new Z(O,se,null,t,W),ce.push({event:O,listeners:re}))}}if((n&7)===0){e:{if(O=e==="mouseover"||e==="pointerover",Z=e==="mouseout"||e==="pointerout",O&&(n&16)===0&&(se=t.relatedTarget||t.fromElement)&&(Jn(se)||se[kt]))break e;if((Z||O)&&(O=W.window===W?W:(O=W.ownerDocument)?O.defaultView||O.parentWindow:window,Z?(se=t.relatedTarget||t.toElement,Z=E,se=se?Jn(se):null,se!==null&&(C=Kn(se),se!==C||se.tag!==5&&se.tag!==6)&&(se=null)):(Z=null,se=E),Z!==se)){if(re=pl,N="onMouseLeave",w="onMouseEnter",k="mouse",(e==="pointerout"||e==="pointerover")&&(re=hl,N="onPointerLeave",w="onPointerEnter",k="pointer"),C=Z==null?O:Ct(Z),L=se==null?O:Ct(se),O=new re(N,k+"leave",Z,t,W),O.target=C,O.relatedTarget=L,N=null,Jn(W)===E&&(re=new re(w,k+"enter",se,t,W),re.target=L,re.relatedTarget=C,N=re),C=N,Z&&se)n:{for(re=Z,w=se,k=0,L=re;L;L=xt(L))k++;for(L=0,N=w;N;N=xt(N))L++;for(;0<k-L;)re=xt(re),k--;for(;0<L-k;)w=xt(w),L--;for(;k--;){if(re===w||w!==null&&re===w.alternate)break n;re=xt(re),w=xt(w)}re=null}else re=null;Z!==null&&Ol(ce,O,Z,re,!1),se!==null&&C!==null&&Ol(ce,C,se,re,!0)}}e:{if(O=E?Ct(E):window,Z=O.nodeName&&O.nodeName.toLowerCase(),Z==="select"||Z==="input"&&O.type==="file")var ue=Lu;else if(yl(O))if(wl)ue=Du;else{ue=ju;var Q=Ru}else(Z=O.nodeName)&&Z.toLowerCase()==="input"&&(O.type==="checkbox"||O.type==="radio")&&(ue=Nu);if(ue&&(ue=ue(e,E))){xl(ce,ue,t,W);break e}Q&&Q(e,O,E),e==="focusout"&&(Q=O._wrapperState)&&Q.controlled&&O.type==="number"&&Zr(O,"number",O.value)}switch(Q=E?Ct(E):window,e){case"focusin":(yl(Q)||Q.contentEditable==="true")&&(yt=Q,No=E,sa=null);break;case"focusout":sa=No=yt=null;break;case"mousedown":Do=!0;break;case"contextmenu":case"mouseup":case"dragend":Do=!1,Pl(ce,t,W);break;case"selectionchange":if(Ou)break;case"keydown":case"keyup":Pl(ce,t,W)}var he;if(Mo)e:{switch(e){case"compositionstart":var fe="onCompositionStart";break e;case"compositionend":fe="onCompositionEnd";break e;case"compositionupdate":fe="onCompositionUpdate";break e}fe=void 0}else bt?vl(e,t)&&(fe="onCompositionEnd"):e==="keydown"&&t.keyCode===229&&(fe="onCompositionStart");fe&&(ml&&t.locale!=="ko"&&(bt||fe!=="onCompositionStart"?fe==="onCompositionEnd"&&bt&&(he=cl()):(Pn=W,So="value"in Pn?Pn.value:Pn.textContent,bt=!0)),Q=er(E,fe),0<Q.length&&(fe=new ul(fe,e,null,t,W),ce.push({event:fe,listeners:Q}),he?fe.data=he:(he=bl(t),he!==null&&(fe.data=he)))),(he=Au?Iu(e,t):Eu(e,t))&&(E=er(E,"onBeforeInput"),0<E.length&&(W=new ul("onBeforeInput","beforeinput",null,t,W),ce.push({event:W,listeners:E}),W.data=he))}Rl(ce,n)})}function ca(e,n,t){return{instance:e,listener:n,currentTarget:t}}function er(e,n){for(var t=n+"Capture",a=[];e!==null;){var i=e,d=i.stateNode;i.tag===5&&d!==null&&(i=d,d=Yt(e,t),d!=null&&a.unshift(ca(e,d,i)),d=Yt(e,n),d!=null&&a.push(ca(e,d,i))),e=e.return}return a}function xt(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5);return e||null}function Ol(e,n,t,a,i){for(var d=n._reactName,u=[];t!==null&&t!==a;){var f=t,x=f.alternate,E=f.stateNode;if(x!==null&&x===a)break;f.tag===5&&E!==null&&(f=E,i?(x=Yt(t,d),x!=null&&u.unshift(ca(t,x,f))):i||(x=Yt(t,d),x!=null&&u.push(ca(t,x,f)))),t=t.return}u.length!==0&&e.push({event:n,listeners:u})}function nr(){}var zo=null,Oo=null;function Bl(e,n){switch(e){case"button":case"input":case"select":case"textarea":return!!n.autoFocus}return!1}function Bo(e,n){return e==="textarea"||e==="option"||e==="noscript"||typeof n.children=="string"||typeof n.children=="number"||typeof n.dangerouslySetInnerHTML=="object"&&n.dangerouslySetInnerHTML!==null&&n.dangerouslySetInnerHTML.__html!=null}var Gl=typeof setTimeout=="function"?setTimeout:void 0,Gu=typeof clearTimeout=="function"?clearTimeout:void 0;function Go(e){e.nodeType===1?e.textContent="":e.nodeType===9&&(e=e.body,e!=null&&(e.textContent=""))}function wt(e){for(;e!=null;e=e.nextSibling){var n=e.nodeType;if(n===1||n===3)break}return e}function Hl(e){e=e.previousSibling;for(var n=0;e;){if(e.nodeType===8){var t=e.data;if(t==="$"||t==="$!"||t==="$?"){if(n===0)return e;n--}else t==="/$"&&n++}e=e.previousSibling}return null}var Ho=0;function Hu(e){return{$$typeof:_,toString:e,valueOf:e}}var tr=Math.random().toString(36).slice(2),Mn="__reactFiber$"+tr,ar="__reactProps$"+tr,kt="__reactContainer$"+tr,_l="__reactEvents$"+tr;function Jn(e){var n=e[Mn];if(n)return n;for(var t=e.parentNode;t;){if(n=t[kt]||t[Mn]){if(t=n.alternate,n.child!==null||t!==null&&t.child!==null)for(e=Hl(e);e!==null;){if(t=e[Mn])return t;e=Hl(e)}return n}e=t,t=e.parentNode}return null}function da(e){return e=e[Mn]||e[kt],!e||e.tag!==5&&e.tag!==6&&e.tag!==13&&e.tag!==3?null:e}function Ct(e){if(e.tag===5||e.tag===6)return e.stateNode;throw Error(l(33))}function rr(e){return e[ar]||null}function ql(e){var n=e[_l];return n===void 0&&(n=e[_l]=new Set),n}var _o=[],St=-1;function Ln(e){return{current:e}}function Ae(e){0>St||(e.current=_o[St],_o[St]=null,St--)}function Ie(e,n){St++,_o[St]=e.current,e.current=n}var Rn={},ze=Ln(Rn),We=Ln(!1),Qn=Rn;function Tt(e,n){var t=e.type.contextTypes;if(!t)return Rn;var a=e.stateNode;if(a&&a.__reactInternalMemoizedUnmaskedChildContext===n)return a.__reactInternalMemoizedMaskedChildContext;var i={},d;for(d in t)i[d]=n[d];return a&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=n,e.__reactInternalMemoizedMaskedChildContext=i),i}function Ye(e){return e=e.childContextTypes,e!=null}function or(){Ae(We),Ae(ze)}function Ul(e,n,t){if(ze.current!==Rn)throw Error(l(168));Ie(ze,n),Ie(We,t)}function Wl(e,n,t){var a=e.stateNode;if(e=n.childContextTypes,typeof a.getChildContext!="function")return t;a=a.getChildContext();for(var i in a)if(!(i in e))throw Error(l(108,dt(n)||"Unknown",i));return r({},t,a)}function ir(e){return e=(e=e.stateNode)&&e.__reactInternalMemoizedMergedChildContext||Rn,Qn=ze.current,Ie(ze,e),Ie(We,We.current),!0}function Yl(e,n,t){var a=e.stateNode;if(!a)throw Error(l(169));t?(e=Wl(e,n,Qn),a.__reactInternalMemoizedMergedChildContext=e,Ae(We),Ae(ze),Ie(ze,e)):Ae(We),Ie(We,t)}var qo=null,Xn=null,_u=s.unstable_runWithPriority,Uo=s.unstable_scheduleCallback,Wo=s.unstable_cancelCallback,qu=s.unstable_shouldYield,Vl=s.unstable_requestPaint,Yo=s.unstable_now,Uu=s.unstable_getCurrentPriorityLevel,sr=s.unstable_ImmediatePriority,$l=s.unstable_UserBlockingPriority,Kl=s.unstable_NormalPriority,Jl=s.unstable_LowPriority,Ql=s.unstable_IdlePriority,Vo={},Wu=Vl!==void 0?Vl:function(){},bn=null,lr=null,$o=!1,Xl=Yo(),Oe=1e4>Xl?Yo:function(){return Yo()-Xl};function At(){switch(Uu()){case sr:return 99;case $l:return 98;case Kl:return 97;case Jl:return 96;case Ql:return 95;default:throw Error(l(332))}}function Zl(e){switch(e){case 99:return sr;case 98:return $l;case 97:return Kl;case 96:return Jl;case 95:return Ql;default:throw Error(l(332))}}function Zn(e,n){return e=Zl(e),_u(e,n)}function pa(e,n,t){return e=Zl(e),Uo(e,n,t)}function pn(){if(lr!==null){var e=lr;lr=null,Wo(e)}ec()}function ec(){if(!$o&&bn!==null){$o=!0;var e=0;try{var n=bn;Zn(99,function(){for(;e<n.length;e++){var t=n[e];do t=t(!0);while(t!==null)}}),bn=null}catch(t){throw bn!==null&&(bn=bn.slice(e+1)),Uo(sr,pn),t}finally{$o=!1}}}var Yu=M.ReactCurrentBatchConfig;function rn(e,n){if(e&&e.defaultProps){n=r({},n),e=e.defaultProps;for(var t in e)n[t]===void 0&&(n[t]=e[t]);return n}return n}var cr=Ln(null),dr=null,It=null,pr=null;function Ko(){pr=It=dr=null}function Jo(e){var n=cr.current;Ae(cr),e.type._context._currentValue=n}function nc(e,n){for(;e!==null;){var t=e.alternate;if((e.childLanes&n)===n){if(t===null||(t.childLanes&n)===n)break;t.childLanes|=n}else e.childLanes|=n,t!==null&&(t.childLanes|=n);e=e.return}}function Et(e,n){dr=e,pr=It=null,e=e.dependencies,e!==null&&e.firstContext!==null&&((e.lanes&n)!==0&&(on=!0),e.firstContext=null)}function en(e,n){if(pr!==e&&n!==!1&&n!==0)if((typeof n!="number"||n===1073741823)&&(pr=e,n=1073741823),n={context:e,observedBits:n,next:null},It===null){if(dr===null)throw Error(l(308));It=n,dr.dependencies={lanes:0,firstContext:n,responders:null}}else It=It.next=n;return e._currentValue}var jn=!1;function Qo(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null},effects:null}}function tc(e,n){e=e.updateQueue,n.updateQueue===e&&(n.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,effects:e.effects})}function Nn(e,n){return{eventTime:e,lane:n,tag:0,payload:null,callback:null,next:null}}function Dn(e,n){if(e=e.updateQueue,e!==null){e=e.shared;var t=e.pending;t===null?n.next=n:(n.next=t.next,t.next=n),e.pending=n}}function ac(e,n){var t=e.updateQueue,a=e.alternate;if(a!==null&&(a=a.updateQueue,t===a)){var i=null,d=null;if(t=t.firstBaseUpdate,t!==null){do{var u={eventTime:t.eventTime,lane:t.lane,tag:t.tag,payload:t.payload,callback:t.callback,next:null};d===null?i=d=u:d=d.next=u,t=t.next}while(t!==null);d===null?i=d=n:d=d.next=n}else i=d=n;t={baseState:a.baseState,firstBaseUpdate:i,lastBaseUpdate:d,shared:a.shared,effects:a.effects},e.updateQueue=t;return}e=t.lastBaseUpdate,e===null?t.firstBaseUpdate=n:e.next=n,t.lastBaseUpdate=n}function ua(e,n,t,a){var i=e.updateQueue;jn=!1;var d=i.firstBaseUpdate,u=i.lastBaseUpdate,f=i.shared.pending;if(f!==null){i.shared.pending=null;var x=f,E=x.next;x.next=null,u===null?d=E:u.next=E,u=x;var W=e.alternate;if(W!==null){W=W.updateQueue;var ce=W.lastBaseUpdate;ce!==u&&(ce===null?W.firstBaseUpdate=E:ce.next=E,W.lastBaseUpdate=x)}}if(d!==null){ce=i.baseState,u=0,W=E=x=null;do{f=d.lane;var O=d.eventTime;if((a&f)===f){W!==null&&(W=W.next={eventTime:O,lane:0,tag:d.tag,payload:d.payload,callback:d.callback,next:null});e:{var Z=e,se=d;switch(f=n,O=t,se.tag){case 1:if(Z=se.payload,typeof Z=="function"){ce=Z.call(O,ce,f);break e}ce=Z;break e;case 3:Z.flags=Z.flags&-4097|64;case 0:if(Z=se.payload,f=typeof Z=="function"?Z.call(O,ce,f):Z,f==null)break e;ce=r({},ce,f);break e;case 2:jn=!0}}d.callback!==null&&(e.flags|=32,f=i.effects,f===null?i.effects=[d]:f.push(d))}else O={eventTime:O,lane:f,tag:d.tag,payload:d.payload,callback:d.callback,next:null},W===null?(E=W=O,x=ce):W=W.next=O,u|=f;if(d=d.next,d===null){if(f=i.shared.pending,f===null)break;d=f.next,f.next=null,i.lastBaseUpdate=f,i.shared.pending=null}}while(!0);W===null&&(x=ce),i.baseState=x,i.firstBaseUpdate=E,i.lastBaseUpdate=W,Sa|=u,e.lanes=u,e.memoizedState=ce}}function rc(e,n,t){if(e=n.effects,n.effects=null,e!==null)for(n=0;n<e.length;n++){var a=e[n],i=a.callback;if(i!==null){if(a.callback=null,a=t,typeof i!="function")throw Error(l(191,i));i.call(a)}}}var oc=new o.Component().refs;function ur(e,n,t,a){n=e.memoizedState,t=t(a,n),t=t==null?n:r({},n,t),e.memoizedState=t,e.lanes===0&&(e.updateQueue.baseState=t)}var hr={isMounted:function(e){return(e=e._reactInternals)?Kn(e)===e:!1},enqueueSetState:function(e,n,t){e=e._reactInternals;var a=Qe(),i=On(e),d=Nn(a,i);d.payload=n,t!=null&&(d.callback=t),Dn(e,d),Bn(e,i,a)},enqueueReplaceState:function(e,n,t){e=e._reactInternals;var a=Qe(),i=On(e),d=Nn(a,i);d.tag=1,d.payload=n,t!=null&&(d.callback=t),Dn(e,d),Bn(e,i,a)},enqueueForceUpdate:function(e,n){e=e._reactInternals;var t=Qe(),a=On(e),i=Nn(t,a);i.tag=2,n!=null&&(i.callback=n),Dn(e,i),Bn(e,a,t)}};function ic(e,n,t,a,i,d,u){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(a,d,u):n.prototype&&n.prototype.isPureReactComponent?!ia(t,a)||!ia(i,d):!0}function sc(e,n,t){var a=!1,i=Rn,d=n.contextType;return typeof d=="object"&&d!==null?d=en(d):(i=Ye(n)?Qn:ze.current,a=n.contextTypes,d=(a=a!=null)?Tt(e,i):Rn),n=new n(t,d),e.memoizedState=n.state!==null&&n.state!==void 0?n.state:null,n.updater=hr,e.stateNode=n,n._reactInternals=e,a&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=i,e.__reactInternalMemoizedMaskedChildContext=d),n}function lc(e,n,t,a){e=n.state,typeof n.componentWillReceiveProps=="function"&&n.componentWillReceiveProps(t,a),typeof n.UNSAFE_componentWillReceiveProps=="function"&&n.UNSAFE_componentWillReceiveProps(t,a),n.state!==e&&hr.enqueueReplaceState(n,n.state,null)}function Xo(e,n,t,a){var i=e.stateNode;i.props=t,i.state=e.memoizedState,i.refs=oc,Qo(e);var d=n.contextType;typeof d=="object"&&d!==null?i.context=en(d):(d=Ye(n)?Qn:ze.current,i.context=Tt(e,d)),ua(e,t,i,a),i.state=e.memoizedState,d=n.getDerivedStateFromProps,typeof d=="function"&&(ur(e,n,d,t),i.state=e.memoizedState),typeof n.getDerivedStateFromProps=="function"||typeof i.getSnapshotBeforeUpdate=="function"||typeof i.UNSAFE_componentWillMount!="function"&&typeof i.componentWillMount!="function"||(n=i.state,typeof i.componentWillMount=="function"&&i.componentWillMount(),typeof i.UNSAFE_componentWillMount=="function"&&i.UNSAFE_componentWillMount(),n!==i.state&&hr.enqueueReplaceState(i,i.state,null),ua(e,t,i,a),i.state=e.memoizedState),typeof i.componentDidMount=="function"&&(e.flags|=4)}var mr=Array.isArray;function ha(e,n,t){if(e=t.ref,e!==null&&typeof e!="function"&&typeof e!="object"){if(t._owner){if(t=t._owner,t){if(t.tag!==1)throw Error(l(309));var a=t.stateNode}if(!a)throw Error(l(147,e));var i=""+e;return n!==null&&n.ref!==null&&typeof n.ref=="function"&&n.ref._stringRef===i?n.ref:(n=function(d){var u=a.refs;u===oc&&(u=a.refs={}),d===null?delete u[i]:u[i]=d},n._stringRef=i,n)}if(typeof e!="string")throw Error(l(284));if(!t._owner)throw Error(l(290,e))}return e}function gr(e,n){if(e.type!=="textarea")throw Error(l(31,Object.prototype.toString.call(n)==="[object Object]"?"object with keys {"+Object.keys(n).join(", ")+"}":n))}function cc(e){function n(C,w){if(e){var k=C.lastEffect;k!==null?(k.nextEffect=w,C.lastEffect=w):C.firstEffect=C.lastEffect=w,w.nextEffect=null,w.flags=8}}function t(C,w){if(!e)return null;for(;w!==null;)n(C,w),w=w.sibling;return null}function a(C,w){for(C=new Map;w!==null;)w.key!==null?C.set(w.key,w):C.set(w.index,w),w=w.sibling;return C}function i(C,w){return C=_n(C,w),C.index=0,C.sibling=null,C}function d(C,w,k){return C.index=k,e?(k=C.alternate,k!==null?(k=k.index,k<w?(C.flags=2,w):k):(C.flags=2,w)):w}function u(C){return e&&C.alternate===null&&(C.flags=2),C}function f(C,w,k,L){return w===null||w.tag!==6?(w=Ni(k,C.mode,L),w.return=C,w):(w=i(w,k),w.return=C,w)}function x(C,w,k,L){return w!==null&&w.elementType===k.type?(L=i(w,k.props),L.ref=ha(C,w,k),L.return=C,L):(L=jr(k.type,k.key,k.props,null,C.mode,L),L.ref=ha(C,w,k),L.return=C,L)}function E(C,w,k,L){return w===null||w.tag!==4||w.stateNode.containerInfo!==k.containerInfo||w.stateNode.implementation!==k.implementation?(w=Di(k,C.mode,L),w.return=C,w):(w=i(w,k.children||[]),w.return=C,w)}function W(C,w,k,L,N){return w===null||w.tag!==7?(w=Ft(k,C.mode,L,N),w.return=C,w):(w=i(w,k),w.return=C,w)}function ce(C,w,k){if(typeof w=="string"||typeof w=="number")return w=Ni(""+w,C.mode,k),w.return=C,w;if(typeof w=="object"&&w!==null){switch(w.$$typeof){case U:return k=jr(w.type,w.key,w.props,null,C.mode,k),k.ref=ha(C,null,w),k.return=C,k;case $:return w=Di(w,C.mode,k),w.return=C,w}if(mr(w)||X(w))return w=Ft(w,C.mode,k,null),w.return=C,w;gr(C,w)}return null}function O(C,w,k,L){var N=w!==null?w.key:null;if(typeof k=="string"||typeof k=="number")return N!==null?null:f(C,w,""+k,L);if(typeof k=="object"&&k!==null){switch(k.$$typeof){case U:return k.key===N?k.type===Y?W(C,w,k.props.children,L,N):x(C,w,k,L):null;case $:return k.key===N?E(C,w,k,L):null}if(mr(k)||X(k))return N!==null?null:W(C,w,k,L,null);gr(C,k)}return null}function Z(C,w,k,L,N){if(typeof L=="string"||typeof L=="number")return C=C.get(k)||null,f(w,C,""+L,N);if(typeof L=="object"&&L!==null){switch(L.$$typeof){case U:return C=C.get(L.key===null?k:L.key)||null,L.type===Y?W(w,C,L.props.children,N,L.key):x(w,C,L,N);case $:return C=C.get(L.key===null?k:L.key)||null,E(w,C,L,N)}if(mr(L)||X(L))return C=C.get(k)||null,W(w,C,L,N,null);gr(w,L)}return null}function se(C,w,k,L){for(var N=null,ue=null,Q=w,he=w=0,fe=null;Q!==null&&he<k.length;he++){Q.index>he?(fe=Q,Q=null):fe=Q.sibling;var me=O(C,Q,k[he],L);if(me===null){Q===null&&(Q=fe);break}e&&Q&&me.alternate===null&&n(C,Q),w=d(me,w,he),ue===null?N=me:ue.sibling=me,ue=me,Q=fe}if(he===k.length)return t(C,Q),N;if(Q===null){for(;he<k.length;he++)Q=ce(C,k[he],L),Q!==null&&(w=d(Q,w,he),ue===null?N=Q:ue.sibling=Q,ue=Q);return N}for(Q=a(C,Q);he<k.length;he++)fe=Z(Q,C,he,k[he],L),fe!==null&&(e&&fe.alternate!==null&&Q.delete(fe.key===null?he:fe.key),w=d(fe,w,he),ue===null?N=fe:ue.sibling=fe,ue=fe);return e&&Q.forEach(function(qn){return n(C,qn)}),N}function re(C,w,k,L){var N=X(k);if(typeof N!="function")throw Error(l(150));if(k=N.call(k),k==null)throw Error(l(151));for(var ue=N=null,Q=w,he=w=0,fe=null,me=k.next();Q!==null&&!me.done;he++,me=k.next()){Q.index>he?(fe=Q,Q=null):fe=Q.sibling;var qn=O(C,Q,me.value,L);if(qn===null){Q===null&&(Q=fe);break}e&&Q&&qn.alternate===null&&n(C,Q),w=d(qn,w,he),ue===null?N=qn:ue.sibling=qn,ue=qn,Q=fe}if(me.done)return t(C,Q),N;if(Q===null){for(;!me.done;he++,me=k.next())me=ce(C,me.value,L),me!==null&&(w=d(me,w,he),ue===null?N=me:ue.sibling=me,ue=me);return N}for(Q=a(C,Q);!me.done;he++,me=k.next())me=Z(Q,C,he,me.value,L),me!==null&&(e&&me.alternate!==null&&Q.delete(me.key===null?he:me.key),w=d(me,w,he),ue===null?N=me:ue.sibling=me,ue=me);return e&&Q.forEach(function(Ch){return n(C,Ch)}),N}return function(C,w,k,L){var N=typeof k=="object"&&k!==null&&k.type===Y&&k.key===null;N&&(k=k.props.children);var ue=typeof k=="object"&&k!==null;if(ue)switch(k.$$typeof){case U:e:{for(ue=k.key,N=w;N!==null;){if(N.key===ue){switch(N.tag){case 7:if(k.type===Y){t(C,N.sibling),w=i(N,k.props.children),w.return=C,C=w;break e}break;default:if(N.elementType===k.type){t(C,N.sibling),w=i(N,k.props),w.ref=ha(C,N,k),w.return=C,C=w;break e}}t(C,N);break}else n(C,N);N=N.sibling}k.type===Y?(w=Ft(k.props.children,C.mode,L,k.key),w.return=C,C=w):(L=jr(k.type,k.key,k.props,null,C.mode,L),L.ref=ha(C,w,k),L.return=C,C=L)}return u(C);case $:e:{for(N=k.key;w!==null;){if(w.key===N)if(w.tag===4&&w.stateNode.containerInfo===k.containerInfo&&w.stateNode.implementation===k.implementation){t(C,w.sibling),w=i(w,k.children||[]),w.return=C,C=w;break e}else{t(C,w);break}else n(C,w);w=w.sibling}w=Di(k,C.mode,L),w.return=C,C=w}return u(C)}if(typeof k=="string"||typeof k=="number")return k=""+k,w!==null&&w.tag===6?(t(C,w.sibling),w=i(w,k),w.return=C,C=w):(t(C,w),w=Ni(k,C.mode,L),w.return=C,C=w),u(C);if(mr(k))return se(C,w,k,L);if(X(k))return re(C,w,k,L);if(ue&&gr(C,k),typeof k>"u"&&!N)switch(C.tag){case 1:case 22:case 0:case 11:case 15:throw Error(l(152,dt(C.type)||"Component"))}return t(C,w)}}var fr=cc(!0),dc=cc(!1),ma={},un=Ln(ma),ga=Ln(ma),fa=Ln(ma);function et(e){if(e===ma)throw Error(l(174));return e}function Zo(e,n){switch(Ie(fa,n),Ie(ga,e),Ie(un,ma),e=n.nodeType,e){case 9:case 11:n=(n=n.documentElement)?n.namespaceURI:ao(null,"");break;default:e=e===8?n.parentNode:n,n=e.namespaceURI||null,e=e.tagName,n=ao(n,e)}Ae(un),Ie(un,n)}function Pt(){Ae(un),Ae(ga),Ae(fa)}function pc(e){et(fa.current);var n=et(un.current),t=ao(n,e.type);n!==t&&(Ie(ga,e),Ie(un,t))}function ei(e){ga.current===e&&(Ae(un),Ae(ga))}var Ee=Ln(0);function vr(e){for(var n=e;n!==null;){if(n.tag===13){var t=n.memoizedState;if(t!==null&&(t=t.dehydrated,t===null||t.data==="$?"||t.data==="$!"))return n}else if(n.tag===19&&n.memoizedProps.revealOrder!==void 0){if((n.flags&64)!==0)return n}else if(n.child!==null){n.child.return=n,n=n.child;continue}if(n===e)break;for(;n.sibling===null;){if(n.return===null||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}return null}var yn=null,Fn=null,hn=!1;function uc(e,n){var t=an(5,null,null,0);t.elementType="DELETED",t.type="DELETED",t.stateNode=n,t.return=e,t.flags=8,e.lastEffect!==null?(e.lastEffect.nextEffect=t,e.lastEffect=t):e.firstEffect=e.lastEffect=t}function hc(e,n){switch(e.tag){case 5:var t=e.type;return n=n.nodeType!==1||t.toLowerCase()!==n.nodeName.toLowerCase()?null:n,n!==null?(e.stateNode=n,!0):!1;case 6:return n=e.pendingProps===""||n.nodeType!==3?null:n,n!==null?(e.stateNode=n,!0):!1;case 13:return!1;default:return!1}}function ni(e){if(hn){var n=Fn;if(n){var t=n;if(!hc(e,n)){if(n=wt(t.nextSibling),!n||!hc(e,n)){e.flags=e.flags&-1025|2,hn=!1,yn=e;return}uc(yn,t)}yn=e,Fn=wt(n.firstChild)}else e.flags=e.flags&-1025|2,hn=!1,yn=e}}function mc(e){for(e=e.return;e!==null&&e.tag!==5&&e.tag!==3&&e.tag!==13;)e=e.return;yn=e}function br(e){if(e!==yn)return!1;if(!hn)return mc(e),hn=!0,!1;var n=e.type;if(e.tag!==5||n!=="head"&&n!=="body"&&!Bo(n,e.memoizedProps))for(n=Fn;n;)uc(e,n),n=wt(n.nextSibling);if(mc(e),e.tag===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(l(317));e:{for(e=e.nextSibling,n=0;e;){if(e.nodeType===8){var t=e.data;if(t==="/$"){if(n===0){Fn=wt(e.nextSibling);break e}n--}else t!=="$"&&t!=="$!"&&t!=="$?"||n++}e=e.nextSibling}Fn=null}}else Fn=yn?wt(e.stateNode.nextSibling):null;return!0}function ti(){Fn=yn=null,hn=!1}var Mt=[];function ai(){for(var e=0;e<Mt.length;e++)Mt[e]._workInProgressVersionPrimary=null;Mt.length=0}var va=M.ReactCurrentDispatcher,nn=M.ReactCurrentBatchConfig,ba=0,Me=null,Be=null,Ne=null,yr=!1,ya=!1;function Ve(){throw Error(l(321))}function ri(e,n){if(n===null)return!1;for(var t=0;t<n.length&&t<e.length;t++)if(!Ze(e[t],n[t]))return!1;return!0}function oi(e,n,t,a,i,d){if(ba=d,Me=n,n.memoizedState=null,n.updateQueue=null,n.lanes=0,va.current=e===null||e.memoizedState===null?$u:Ku,e=t(a,i),ya){d=0;do{if(ya=!1,!(25>d))throw Error(l(301));d+=1,Ne=Be=null,n.updateQueue=null,va.current=Ju,e=t(a,i)}while(ya)}if(va.current=Cr,n=Be!==null&&Be.next!==null,ba=0,Ne=Be=Me=null,yr=!1,n)throw Error(l(300));return e}function nt(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return Ne===null?Me.memoizedState=Ne=e:Ne=Ne.next=e,Ne}function tt(){if(Be===null){var e=Me.alternate;e=e!==null?e.memoizedState:null}else e=Be.next;var n=Ne===null?Me.memoizedState:Ne.next;if(n!==null)Ne=n,Be=e;else{if(e===null)throw Error(l(310));Be=e,e={memoizedState:Be.memoizedState,baseState:Be.baseState,baseQueue:Be.baseQueue,queue:Be.queue,next:null},Ne===null?Me.memoizedState=Ne=e:Ne=Ne.next=e}return Ne}function mn(e,n){return typeof n=="function"?n(e):n}function xa(e){var n=tt(),t=n.queue;if(t===null)throw Error(l(311));t.lastRenderedReducer=e;var a=Be,i=a.baseQueue,d=t.pending;if(d!==null){if(i!==null){var u=i.next;i.next=d.next,d.next=u}a.baseQueue=i=d,t.pending=null}if(i!==null){i=i.next,a=a.baseState;var f=u=d=null,x=i;do{var E=x.lane;if((ba&E)===E)f!==null&&(f=f.next={lane:0,action:x.action,eagerReducer:x.eagerReducer,eagerState:x.eagerState,next:null}),a=x.eagerReducer===e?x.eagerState:e(a,x.action);else{var W={lane:E,action:x.action,eagerReducer:x.eagerReducer,eagerState:x.eagerState,next:null};f===null?(u=f=W,d=a):f=f.next=W,Me.lanes|=E,Sa|=E}x=x.next}while(x!==null&&x!==i);f===null?d=a:f.next=u,Ze(a,n.memoizedState)||(on=!0),n.memoizedState=a,n.baseState=d,n.baseQueue=f,t.lastRenderedState=a}return[n.memoizedState,t.dispatch]}function wa(e){var n=tt(),t=n.queue;if(t===null)throw Error(l(311));t.lastRenderedReducer=e;var a=t.dispatch,i=t.pending,d=n.memoizedState;if(i!==null){t.pending=null;var u=i=i.next;do d=e(d,u.action),u=u.next;while(u!==i);Ze(d,n.memoizedState)||(on=!0),n.memoizedState=d,n.baseQueue===null&&(n.baseState=d),t.lastRenderedState=d}return[d,a]}function gc(e,n,t){var a=n._getVersion;a=a(n._source);var i=n._workInProgressVersionPrimary;if(i!==null?e=i===a:(e=e.mutableReadLanes,(e=(ba&e)===e)&&(n._workInProgressVersionPrimary=a,Mt.push(n))),e)return t(n._source);throw Mt.push(n),Error(l(350))}function fc(e,n,t,a){var i=He;if(i===null)throw Error(l(349));var d=n._getVersion,u=d(n._source),f=va.current,x=f.useState(function(){return gc(i,n,t)}),E=x[1],W=x[0];x=Ne;var ce=e.memoizedState,O=ce.refs,Z=O.getSnapshot,se=ce.source;ce=ce.subscribe;var re=Me;return e.memoizedState={refs:O,source:n,subscribe:a},f.useEffect(function(){O.getSnapshot=t,O.setSnapshot=E;var C=d(n._source);if(!Ze(u,C)){C=t(n._source),Ze(W,C)||(E(C),C=On(re),i.mutableReadLanes|=C&i.pendingLanes),C=i.mutableReadLanes,i.entangledLanes|=C;for(var w=i.entanglements,k=C;0<k;){var L=31-En(k),N=1<<L;w[L]|=C,k&=~N}}},[t,n,a]),f.useEffect(function(){return a(n._source,function(){var C=O.getSnapshot,w=O.setSnapshot;try{w(C(n._source));var k=On(re);i.mutableReadLanes|=k&i.pendingLanes}catch(L){w(function(){throw L})}})},[n,a]),Ze(Z,t)&&Ze(se,n)&&Ze(ce,a)||(e={pending:null,dispatch:null,lastRenderedReducer:mn,lastRenderedState:W},e.dispatch=E=ci.bind(null,Me,e),x.queue=e,x.baseQueue=null,W=gc(i,n,t),x.memoizedState=x.baseState=W),W}function vc(e,n,t){var a=tt();return fc(a,e,n,t)}function ka(e){var n=nt();return typeof e=="function"&&(e=e()),n.memoizedState=n.baseState=e,e=n.queue={pending:null,dispatch:null,lastRenderedReducer:mn,lastRenderedState:e},e=e.dispatch=ci.bind(null,Me,e),[n.memoizedState,e]}function xr(e,n,t,a){return e={tag:e,create:n,destroy:t,deps:a,next:null},n=Me.updateQueue,n===null?(n={lastEffect:null},Me.updateQueue=n,n.lastEffect=e.next=e):(t=n.lastEffect,t===null?n.lastEffect=e.next=e:(a=t.next,t.next=e,e.next=a,n.lastEffect=e)),e}function bc(e){var n=nt();return e={current:e},n.memoizedState=e}function wr(){return tt().memoizedState}function ii(e,n,t,a){var i=nt();Me.flags|=e,i.memoizedState=xr(1|n,t,void 0,a===void 0?null:a)}function si(e,n,t,a){var i=tt();a=a===void 0?null:a;var d=void 0;if(Be!==null){var u=Be.memoizedState;if(d=u.destroy,a!==null&&ri(a,u.deps)){xr(n,t,d,a);return}}Me.flags|=e,i.memoizedState=xr(1|n,t,d,a)}function yc(e,n){return ii(516,4,e,n)}function kr(e,n){return si(516,4,e,n)}function xc(e,n){return si(4,2,e,n)}function wc(e,n){if(typeof n=="function")return e=e(),n(e),function(){n(null)};if(n!=null)return e=e(),n.current=e,function(){n.current=null}}function kc(e,n,t){return t=t!=null?t.concat([e]):null,si(4,2,wc.bind(null,n,e),t)}function li(){}function Cc(e,n){var t=tt();n=n===void 0?null:n;var a=t.memoizedState;return a!==null&&n!==null&&ri(n,a[1])?a[0]:(t.memoizedState=[e,n],e)}function Sc(e,n){var t=tt();n=n===void 0?null:n;var a=t.memoizedState;return a!==null&&n!==null&&ri(n,a[1])?a[0]:(e=e(),t.memoizedState=[e,n],e)}function Vu(e,n){var t=At();Zn(98>t?98:t,function(){e(!0)}),Zn(97<t?97:t,function(){var a=nn.transition;nn.transition=1;try{e(!1),n()}finally{nn.transition=a}})}function ci(e,n,t){var a=Qe(),i=On(e),d={lane:i,action:t,eagerReducer:null,eagerState:null,next:null},u=n.pending;if(u===null?d.next=d:(d.next=u.next,u.next=d),n.pending=d,u=e.alternate,e===Me||u!==null&&u===Me)ya=yr=!0;else{if(e.lanes===0&&(u===null||u.lanes===0)&&(u=n.lastRenderedReducer,u!==null))try{var f=n.lastRenderedState,x=u(f,t);if(d.eagerReducer=u,d.eagerState=x,Ze(x,f))return}catch{}Bn(e,i,a)}}var Cr={readContext:en,useCallback:Ve,useContext:Ve,useEffect:Ve,useImperativeHandle:Ve,useLayoutEffect:Ve,useMemo:Ve,useReducer:Ve,useRef:Ve,useState:Ve,useDebugValue:Ve,useDeferredValue:Ve,useTransition:Ve,useMutableSource:Ve,useOpaqueIdentifier:Ve,unstable_isNewReconciler:!1},$u={readContext:en,useCallback:function(e,n){return nt().memoizedState=[e,n===void 0?null:n],e},useContext:en,useEffect:yc,useImperativeHandle:function(e,n,t){return t=t!=null?t.concat([e]):null,ii(4,2,wc.bind(null,n,e),t)},useLayoutEffect:function(e,n){return ii(4,2,e,n)},useMemo:function(e,n){var t=nt();return n=n===void 0?null:n,e=e(),t.memoizedState=[e,n],e},useReducer:function(e,n,t){var a=nt();return n=t!==void 0?t(n):n,a.memoizedState=a.baseState=n,e=a.queue={pending:null,dispatch:null,lastRenderedReducer:e,lastRenderedState:n},e=e.dispatch=ci.bind(null,Me,e),[a.memoizedState,e]},useRef:bc,useState:ka,useDebugValue:li,useDeferredValue:function(e){var n=ka(e),t=n[0],a=n[1];return yc(function(){var i=nn.transition;nn.transition=1;try{a(e)}finally{nn.transition=i}},[e]),t},useTransition:function(){var e=ka(!1),n=e[0];return e=Vu.bind(null,e[1]),bc(e),[e,n]},useMutableSource:function(e,n,t){var a=nt();return a.memoizedState={refs:{getSnapshot:n,setSnapshot:null},source:e,subscribe:t},fc(a,e,n,t)},useOpaqueIdentifier:function(){if(hn){var e=!1,n=Hu(function(){throw e||(e=!0,t("r:"+(Ho++).toString(36))),Error(l(355))}),t=ka(n)[1];return(Me.mode&2)===0&&(Me.flags|=516,xr(5,function(){t("r:"+(Ho++).toString(36))},void 0,null)),n}return n="r:"+(Ho++).toString(36),ka(n),n},unstable_isNewReconciler:!1},Ku={readContext:en,useCallback:Cc,useContext:en,useEffect:kr,useImperativeHandle:kc,useLayoutEffect:xc,useMemo:Sc,useReducer:xa,useRef:wr,useState:function(){return xa(mn)},useDebugValue:li,useDeferredValue:function(e){var n=xa(mn),t=n[0],a=n[1];return kr(function(){var i=nn.transition;nn.transition=1;try{a(e)}finally{nn.transition=i}},[e]),t},useTransition:function(){var e=xa(mn)[0];return[wr().current,e]},useMutableSource:vc,useOpaqueIdentifier:function(){return xa(mn)[0]},unstable_isNewReconciler:!1},Ju={readContext:en,useCallback:Cc,useContext:en,useEffect:kr,useImperativeHandle:kc,useLayoutEffect:xc,useMemo:Sc,useReducer:wa,useRef:wr,useState:function(){return wa(mn)},useDebugValue:li,useDeferredValue:function(e){var n=wa(mn),t=n[0],a=n[1];return kr(function(){var i=nn.transition;nn.transition=1;try{a(e)}finally{nn.transition=i}},[e]),t},useTransition:function(){var e=wa(mn)[0];return[wr().current,e]},useMutableSource:vc,useOpaqueIdentifier:function(){return wa(mn)[0]},unstable_isNewReconciler:!1},Qu=M.ReactCurrentOwner,on=!1;function $e(e,n,t,a){n.child=e===null?dc(n,null,t,a):fr(n,e.child,t,a)}function Tc(e,n,t,a,i){t=t.render;var d=n.ref;return Et(n,i),a=oi(e,n,t,a,d,i),e!==null&&!on?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~i,xn(e,n,i)):(n.flags|=1,$e(e,n,a,i),n.child)}function Ac(e,n,t,a,i,d){if(e===null){var u=t.type;return typeof u=="function"&&!Ri(u)&&u.defaultProps===void 0&&t.compare===null&&t.defaultProps===void 0?(n.tag=15,n.type=u,Ic(e,n,u,a,i,d)):(e=jr(t.type,null,a,n,n.mode,d),e.ref=n.ref,e.return=n,n.child=e)}return u=e.child,(i&d)===0&&(i=u.memoizedProps,t=t.compare,t=t!==null?t:ia,t(i,a)&&e.ref===n.ref)?xn(e,n,d):(n.flags|=1,e=_n(u,a),e.ref=n.ref,e.return=n,n.child=e)}function Ic(e,n,t,a,i,d){if(e!==null&&ia(e.memoizedProps,a)&&e.ref===n.ref)if(on=!1,(d&i)!==0)(e.flags&16384)!==0&&(on=!0);else return n.lanes=e.lanes,xn(e,n,d);return pi(e,n,t,a,d)}function di(e,n,t){var a=n.pendingProps,i=a.children,d=e!==null?e.memoizedState:null;if(a.mode==="hidden"||a.mode==="unstable-defer-without-hiding")if((n.mode&4)===0)n.memoizedState={baseLanes:0},Rr(n,t);else if((t&1073741824)!==0)n.memoizedState={baseLanes:0},Rr(n,d!==null?d.baseLanes:t);else return e=d!==null?d.baseLanes|t:t,n.lanes=n.childLanes=1073741824,n.memoizedState={baseLanes:e},Rr(n,e),null;else d!==null?(a=d.baseLanes|t,n.memoizedState=null):a=t,Rr(n,a);return $e(e,n,i,t),n.child}function Ec(e,n){var t=n.ref;(e===null&&t!==null||e!==null&&e.ref!==t)&&(n.flags|=128)}function pi(e,n,t,a,i){var d=Ye(t)?Qn:ze.current;return d=Tt(n,d),Et(n,i),t=oi(e,n,t,a,d,i),e!==null&&!on?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~i,xn(e,n,i)):(n.flags|=1,$e(e,n,t,i),n.child)}function Pc(e,n,t,a,i){if(Ye(t)){var d=!0;ir(n)}else d=!1;if(Et(n,i),n.stateNode===null)e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),sc(n,t,a),Xo(n,t,a,i),a=!0;else if(e===null){var u=n.stateNode,f=n.memoizedProps;u.props=f;var x=u.context,E=t.contextType;typeof E=="object"&&E!==null?E=en(E):(E=Ye(t)?Qn:ze.current,E=Tt(n,E));var W=t.getDerivedStateFromProps,ce=typeof W=="function"||typeof u.getSnapshotBeforeUpdate=="function";ce||typeof u.UNSAFE_componentWillReceiveProps!="function"&&typeof u.componentWillReceiveProps!="function"||(f!==a||x!==E)&&lc(n,u,a,E),jn=!1;var O=n.memoizedState;u.state=O,ua(n,a,u,i),x=n.memoizedState,f!==a||O!==x||We.current||jn?(typeof W=="function"&&(ur(n,t,W,a),x=n.memoizedState),(f=jn||ic(n,t,f,a,O,x,E))?(ce||typeof u.UNSAFE_componentWillMount!="function"&&typeof u.componentWillMount!="function"||(typeof u.componentWillMount=="function"&&u.componentWillMount(),typeof u.UNSAFE_componentWillMount=="function"&&u.UNSAFE_componentWillMount()),typeof u.componentDidMount=="function"&&(n.flags|=4)):(typeof u.componentDidMount=="function"&&(n.flags|=4),n.memoizedProps=a,n.memoizedState=x),u.props=a,u.state=x,u.context=E,a=f):(typeof u.componentDidMount=="function"&&(n.flags|=4),a=!1)}else{u=n.stateNode,tc(e,n),f=n.memoizedProps,E=n.type===n.elementType?f:rn(n.type,f),u.props=E,ce=n.pendingProps,O=u.context,x=t.contextType,typeof x=="object"&&x!==null?x=en(x):(x=Ye(t)?Qn:ze.current,x=Tt(n,x));var Z=t.getDerivedStateFromProps;(W=typeof Z=="function"||typeof u.getSnapshotBeforeUpdate=="function")||typeof u.UNSAFE_componentWillReceiveProps!="function"&&typeof u.componentWillReceiveProps!="function"||(f!==ce||O!==x)&&lc(n,u,a,x),jn=!1,O=n.memoizedState,u.state=O,ua(n,a,u,i);var se=n.memoizedState;f!==ce||O!==se||We.current||jn?(typeof Z=="function"&&(ur(n,t,Z,a),se=n.memoizedState),(E=jn||ic(n,t,E,a,O,se,x))?(W||typeof u.UNSAFE_componentWillUpdate!="function"&&typeof u.componentWillUpdate!="function"||(typeof u.componentWillUpdate=="function"&&u.componentWillUpdate(a,se,x),typeof u.UNSAFE_componentWillUpdate=="function"&&u.UNSAFE_componentWillUpdate(a,se,x)),typeof u.componentDidUpdate=="function"&&(n.flags|=4),typeof u.getSnapshotBeforeUpdate=="function"&&(n.flags|=256)):(typeof u.componentDidUpdate!="function"||f===e.memoizedProps&&O===e.memoizedState||(n.flags|=4),typeof u.getSnapshotBeforeUpdate!="function"||f===e.memoizedProps&&O===e.memoizedState||(n.flags|=256),n.memoizedProps=a,n.memoizedState=se),u.props=a,u.state=se,u.context=x,a=E):(typeof u.componentDidUpdate!="function"||f===e.memoizedProps&&O===e.memoizedState||(n.flags|=4),typeof u.getSnapshotBeforeUpdate!="function"||f===e.memoizedProps&&O===e.memoizedState||(n.flags|=256),a=!1)}return ui(e,n,t,a,d,i)}function ui(e,n,t,a,i,d){Ec(e,n);var u=(n.flags&64)!==0;if(!a&&!u)return i&&Yl(n,t,!1),xn(e,n,d);a=n.stateNode,Qu.current=n;var f=u&&typeof t.getDerivedStateFromError!="function"?null:a.render();return n.flags|=1,e!==null&&u?(n.child=fr(n,e.child,null,d),n.child=fr(n,null,f,d)):$e(e,n,f,d),n.memoizedState=a.state,i&&Yl(n,t,!0),n.child}function Mc(e){var n=e.stateNode;n.pendingContext?Ul(e,n.pendingContext,n.pendingContext!==n.context):n.context&&Ul(e,n.context,!1),Zo(e,n.containerInfo)}var Sr={dehydrated:null,retryLane:0};function Lc(e,n,t){var a=n.pendingProps,i=Ee.current,d=!1,u;return(u=(n.flags&64)!==0)||(u=e!==null&&e.memoizedState===null?!1:(i&2)!==0),u?(d=!0,n.flags&=-65):e!==null&&e.memoizedState===null||a.fallback===void 0||a.unstable_avoidThisFallback===!0||(i|=1),Ie(Ee,i&1),e===null?(a.fallback!==void 0&&ni(n),e=a.children,i=a.fallback,d?(e=Rc(n,e,i,t),n.child.memoizedState={baseLanes:t},n.memoizedState=Sr,e):typeof a.unstable_expectedLoadTime=="number"?(e=Rc(n,e,i,t),n.child.memoizedState={baseLanes:t},n.memoizedState=Sr,n.lanes=33554432,e):(t=ji({mode:"visible",children:e},n.mode,t,null),t.return=n,n.child=t)):e.memoizedState!==null?d?(a=Nc(e,n,a.children,a.fallback,t),d=n.child,i=e.child.memoizedState,d.memoizedState=i===null?{baseLanes:t}:{baseLanes:i.baseLanes|t},d.childLanes=e.childLanes&~t,n.memoizedState=Sr,a):(t=jc(e,n,a.children,t),n.memoizedState=null,t):d?(a=Nc(e,n,a.children,a.fallback,t),d=n.child,i=e.child.memoizedState,d.memoizedState=i===null?{baseLanes:t}:{baseLanes:i.baseLanes|t},d.childLanes=e.childLanes&~t,n.memoizedState=Sr,a):(t=jc(e,n,a.children,t),n.memoizedState=null,t)}function Rc(e,n,t,a){var i=e.mode,d=e.child;return n={mode:"hidden",children:n},(i&2)===0&&d!==null?(d.childLanes=0,d.pendingProps=n):d=ji(n,i,0,null),t=Ft(t,i,a,null),d.return=e,t.return=e,d.sibling=t,e.child=d,t}function jc(e,n,t,a){var i=e.child;return e=i.sibling,t=_n(i,{mode:"visible",children:t}),(n.mode&2)===0&&(t.lanes=a),t.return=n,t.sibling=null,e!==null&&(e.nextEffect=null,e.flags=8,n.firstEffect=n.lastEffect=e),n.child=t}function Nc(e,n,t,a,i){var d=n.mode,u=e.child;e=u.sibling;var f={mode:"hidden",children:t};return(d&2)===0&&n.child!==u?(t=n.child,t.childLanes=0,t.pendingProps=f,u=t.lastEffect,u!==null?(n.firstEffect=t.firstEffect,n.lastEffect=u,u.nextEffect=null):n.firstEffect=n.lastEffect=null):t=_n(u,f),e!==null?a=_n(e,a):(a=Ft(a,d,i,null),a.flags|=2),a.return=n,t.return=n,t.sibling=a,n.child=t,a}function Dc(e,n){e.lanes|=n;var t=e.alternate;t!==null&&(t.lanes|=n),nc(e.return,n)}function hi(e,n,t,a,i,d){var u=e.memoizedState;u===null?e.memoizedState={isBackwards:n,rendering:null,renderingStartTime:0,last:a,tail:t,tailMode:i,lastEffect:d}:(u.isBackwards=n,u.rendering=null,u.renderingStartTime=0,u.last=a,u.tail=t,u.tailMode=i,u.lastEffect=d)}function Fc(e,n,t){var a=n.pendingProps,i=a.revealOrder,d=a.tail;if($e(e,n,a.children,t),a=Ee.current,(a&2)!==0)a=a&1|2,n.flags|=64;else{if(e!==null&&(e.flags&64)!==0)e:for(e=n.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&Dc(e,t);else if(e.tag===19)Dc(e,t);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===n)break e;for(;e.sibling===null;){if(e.return===null||e.return===n)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}a&=1}if(Ie(Ee,a),(n.mode&2)===0)n.memoizedState=null;else switch(i){case"forwards":for(t=n.child,i=null;t!==null;)e=t.alternate,e!==null&&vr(e)===null&&(i=t),t=t.sibling;t=i,t===null?(i=n.child,n.child=null):(i=t.sibling,t.sibling=null),hi(n,!1,i,t,d,n.lastEffect);break;case"backwards":for(t=null,i=n.child,n.child=null;i!==null;){if(e=i.alternate,e!==null&&vr(e)===null){n.child=i;break}e=i.sibling,i.sibling=t,t=i,i=e}hi(n,!0,t,null,d,n.lastEffect);break;case"together":hi(n,!1,null,null,void 0,n.lastEffect);break;default:n.memoizedState=null}return n.child}function xn(e,n,t){if(e!==null&&(n.dependencies=e.dependencies),Sa|=n.lanes,(t&n.childLanes)!==0){if(e!==null&&n.child!==e.child)throw Error(l(153));if(n.child!==null){for(e=n.child,t=_n(e,e.pendingProps),n.child=t,t.return=n;e.sibling!==null;)e=e.sibling,t=t.sibling=_n(e,e.pendingProps),t.return=n;t.sibling=null}return n.child}return null}var zc,mi,Oc,Bc;zc=function(e,n){for(var t=n.child;t!==null;){if(t.tag===5||t.tag===6)e.appendChild(t.stateNode);else if(t.tag!==4&&t.child!==null){t.child.return=t,t=t.child;continue}if(t===n)break;for(;t.sibling===null;){if(t.return===null||t.return===n)return;t=t.return}t.sibling.return=t.return,t=t.sibling}},mi=function(){},Oc=function(e,n,t,a){var i=e.memoizedProps;if(i!==a){e=n.stateNode,et(un.current);var d=null;switch(t){case"input":i=Qr(e,i),a=Qr(e,a),d=[];break;case"option":i=eo(e,i),a=eo(e,a),d=[];break;case"select":i=r({},i,{value:void 0}),a=r({},a,{value:void 0}),d=[];break;case"textarea":i=no(e,i),a=no(e,a),d=[];break;default:typeof i.onClick!="function"&&typeof a.onClick=="function"&&(e.onclick=nr)}ro(t,a);var u;t=null;for(E in i)if(!a.hasOwnProperty(E)&&i.hasOwnProperty(E)&&i[E]!=null)if(E==="style"){var f=i[E];for(u in f)f.hasOwnProperty(u)&&(t||(t={}),t[u]="")}else E!=="dangerouslySetInnerHTML"&&E!=="children"&&E!=="suppressContentEditableWarning"&&E!=="suppressHydrationWarning"&&E!=="autoFocus"&&(h.hasOwnProperty(E)?d||(d=[]):(d=d||[]).push(E,null));for(E in a){var x=a[E];if(f=i?.[E],a.hasOwnProperty(E)&&x!==f&&(x!=null||f!=null))if(E==="style")if(f){for(u in f)!f.hasOwnProperty(u)||x&&x.hasOwnProperty(u)||(t||(t={}),t[u]="");for(u in x)x.hasOwnProperty(u)&&f[u]!==x[u]&&(t||(t={}),t[u]=x[u])}else t||(d||(d=[]),d.push(E,t)),t=x;else E==="dangerouslySetInnerHTML"?(x=x?x.__html:void 0,f=f?f.__html:void 0,x!=null&&f!==x&&(d=d||[]).push(E,x)):E==="children"?typeof x!="string"&&typeof x!="number"||(d=d||[]).push(E,""+x):E!=="suppressContentEditableWarning"&&E!=="suppressHydrationWarning"&&(h.hasOwnProperty(E)?(x!=null&&E==="onScroll"&&Te("scroll",e),d||f===x||(d=[])):typeof x=="object"&&x!==null&&x.$$typeof===_?x.toString():(d=d||[]).push(E,x))}t&&(d=d||[]).push("style",t);var E=d;(n.updateQueue=E)&&(n.flags|=4)}},Bc=function(e,n,t,a){t!==a&&(n.flags|=4)};function Ca(e,n){if(!hn)switch(e.tailMode){case"hidden":n=e.tail;for(var t=null;n!==null;)n.alternate!==null&&(t=n),n=n.sibling;t===null?e.tail=null:t.sibling=null;break;case"collapsed":t=e.tail;for(var a=null;t!==null;)t.alternate!==null&&(a=t),t=t.sibling;a===null?n||e.tail===null?e.tail=null:e.tail.sibling=null:a.sibling=null}}function Xu(e,n,t){var a=n.pendingProps;switch(n.tag){case 2:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return null;case 1:return Ye(n.type)&&or(),null;case 3:return Pt(),Ae(We),Ae(ze),ai(),a=n.stateNode,a.pendingContext&&(a.context=a.pendingContext,a.pendingContext=null),(e===null||e.child===null)&&(br(n)?n.flags|=4:a.hydrate||(n.flags|=256)),mi(n),null;case 5:ei(n);var i=et(fa.current);if(t=n.type,e!==null&&n.stateNode!=null)Oc(e,n,t,a,i),e.ref!==n.ref&&(n.flags|=128);else{if(!a){if(n.stateNode===null)throw Error(l(166));return null}if(e=et(un.current),br(n)){a=n.stateNode,t=n.type;var d=n.memoizedProps;switch(a[Mn]=n,a[ar]=d,t){case"dialog":Te("cancel",a),Te("close",a);break;case"iframe":case"object":case"embed":Te("load",a);break;case"video":case"audio":for(e=0;e<la.length;e++)Te(la[e],a);break;case"source":Te("error",a);break;case"img":case"image":case"link":Te("error",a),Te("load",a);break;case"details":Te("toggle",a);break;case"input":Ms(a,d),Te("invalid",a);break;case"select":a._wrapperState={wasMultiple:!!d.multiple},Te("invalid",a);break;case"textarea":js(a,d),Te("invalid",a)}ro(t,d),e=null;for(var u in d)d.hasOwnProperty(u)&&(i=d[u],u==="children"?typeof i=="string"?a.textContent!==i&&(e=["children",i]):typeof i=="number"&&a.textContent!==""+i&&(e=["children",""+i]):h.hasOwnProperty(u)&&i!=null&&u==="onScroll"&&Te("scroll",a));switch(t){case"input":Oa(a),Rs(a,d,!0);break;case"textarea":Oa(a),Ds(a);break;case"select":case"option":break;default:typeof d.onClick=="function"&&(a.onclick=nr)}a=e,n.updateQueue=a,a!==null&&(n.flags|=4)}else{switch(u=i.nodeType===9?i:i.ownerDocument,e===to.html&&(e=Fs(t)),e===to.html?t==="script"?(e=u.createElement("div"),e.innerHTML="<script><\/script>",e=e.removeChild(e.firstChild)):typeof a.is=="string"?e=u.createElement(t,{is:a.is}):(e=u.createElement(t),t==="select"&&(u=e,a.multiple?u.multiple=!0:a.size&&(u.size=a.size))):e=u.createElementNS(e,t),e[Mn]=n,e[ar]=a,zc(e,n,!1,!1),n.stateNode=e,u=oo(t,a),t){case"dialog":Te("cancel",e),Te("close",e),i=a;break;case"iframe":case"object":case"embed":Te("load",e),i=a;break;case"video":case"audio":for(i=0;i<la.length;i++)Te(la[i],e);i=a;break;case"source":Te("error",e),i=a;break;case"img":case"image":case"link":Te("error",e),Te("load",e),i=a;break;case"details":Te("toggle",e),i=a;break;case"input":Ms(e,a),i=Qr(e,a),Te("invalid",e);break;case"option":i=eo(e,a);break;case"select":e._wrapperState={wasMultiple:!!a.multiple},i=r({},a,{value:void 0}),Te("invalid",e);break;case"textarea":js(e,a),i=no(e,a),Te("invalid",e);break;default:i=a}ro(t,i);var f=i;for(d in f)if(f.hasOwnProperty(d)){var x=f[d];d==="style"?Bs(e,x):d==="dangerouslySetInnerHTML"?(x=x?x.__html:void 0,x!=null&&zs(e,x)):d==="children"?typeof x=="string"?(t!=="textarea"||x!=="")&&Ut(e,x):typeof x=="number"&&Ut(e,""+x):d!=="suppressContentEditableWarning"&&d!=="suppressHydrationWarning"&&d!=="autoFocus"&&(h.hasOwnProperty(d)?x!=null&&d==="onScroll"&&Te("scroll",e):x!=null&&te(e,d,x,u))}switch(t){case"input":Oa(e),Rs(e,a,!1);break;case"textarea":Oa(e),Ds(e);break;case"option":a.value!=null&&e.setAttribute("value",""+Sn(a.value));break;case"select":e.multiple=!!a.multiple,d=a.value,d!=null?pt(e,!!a.multiple,d,!1):a.defaultValue!=null&&pt(e,!!a.multiple,a.defaultValue,!0);break;default:typeof i.onClick=="function"&&(e.onclick=nr)}Bl(t,a)&&(n.flags|=4)}n.ref!==null&&(n.flags|=128)}return null;case 6:if(e&&n.stateNode!=null)Bc(e,n,e.memoizedProps,a);else{if(typeof a!="string"&&n.stateNode===null)throw Error(l(166));t=et(fa.current),et(un.current),br(n)?(a=n.stateNode,t=n.memoizedProps,a[Mn]=n,a.nodeValue!==t&&(n.flags|=4)):(a=(t.nodeType===9?t:t.ownerDocument).createTextNode(a),a[Mn]=n,n.stateNode=a)}return null;case 13:return Ae(Ee),a=n.memoizedState,(n.flags&64)!==0?(n.lanes=t,n):(a=a!==null,t=!1,e===null?n.memoizedProps.fallback!==void 0&&br(n):t=e.memoizedState!==null,a&&!t&&(n.mode&2)!==0&&(e===null&&n.memoizedProps.unstable_avoidThisFallback!==!0||(Ee.current&1)!==0?De===0&&(De=3):((De===0||De===3)&&(De=4),He===null||(Sa&134217727)===0&&(Rt&134217727)===0||Nt(He,Ge))),(a||t)&&(n.flags|=4),null);case 4:return Pt(),mi(n),e===null&&Nl(n.stateNode.containerInfo),null;case 10:return Jo(n),null;case 17:return Ye(n.type)&&or(),null;case 19:if(Ae(Ee),a=n.memoizedState,a===null)return null;if(d=(n.flags&64)!==0,u=a.rendering,u===null)if(d)Ca(a,!1);else{if(De!==0||e!==null&&(e.flags&64)!==0)for(e=n.child;e!==null;){if(u=vr(e),u!==null){for(n.flags|=64,Ca(a,!1),d=u.updateQueue,d!==null&&(n.updateQueue=d,n.flags|=4),a.lastEffect===null&&(n.firstEffect=null),n.lastEffect=a.lastEffect,a=t,t=n.child;t!==null;)d=t,e=a,d.flags&=2,d.nextEffect=null,d.firstEffect=null,d.lastEffect=null,u=d.alternate,u===null?(d.childLanes=0,d.lanes=e,d.child=null,d.memoizedProps=null,d.memoizedState=null,d.updateQueue=null,d.dependencies=null,d.stateNode=null):(d.childLanes=u.childLanes,d.lanes=u.lanes,d.child=u.child,d.memoizedProps=u.memoizedProps,d.memoizedState=u.memoizedState,d.updateQueue=u.updateQueue,d.type=u.type,e=u.dependencies,d.dependencies=e===null?null:{lanes:e.lanes,firstContext:e.firstContext}),t=t.sibling;return Ie(Ee,Ee.current&1|2),n.child}e=e.sibling}a.tail!==null&&Oe()>Ti&&(n.flags|=64,d=!0,Ca(a,!1),n.lanes=33554432)}else{if(!d)if(e=vr(u),e!==null){if(n.flags|=64,d=!0,t=e.updateQueue,t!==null&&(n.updateQueue=t,n.flags|=4),Ca(a,!0),a.tail===null&&a.tailMode==="hidden"&&!u.alternate&&!hn)return n=n.lastEffect=a.lastEffect,n!==null&&(n.nextEffect=null),null}else 2*Oe()-a.renderingStartTime>Ti&&t!==1073741824&&(n.flags|=64,d=!0,Ca(a,!1),n.lanes=33554432);a.isBackwards?(u.sibling=n.child,n.child=u):(t=a.last,t!==null?t.sibling=u:n.child=u,a.last=u)}return a.tail!==null?(t=a.tail,a.rendering=t,a.tail=t.sibling,a.lastEffect=n.lastEffect,a.renderingStartTime=Oe(),t.sibling=null,n=Ee.current,Ie(Ee,d?n&1|2:n&1),t):null;case 23:case 24:return Li(),e!==null&&e.memoizedState!==null!=(n.memoizedState!==null)&&a.mode!=="unstable-defer-without-hiding"&&(n.flags|=4),null}throw Error(l(156,n.tag))}function Zu(e){switch(e.tag){case 1:Ye(e.type)&&or();var n=e.flags;return n&4096?(e.flags=n&-4097|64,e):null;case 3:if(Pt(),Ae(We),Ae(ze),ai(),n=e.flags,(n&64)!==0)throw Error(l(285));return e.flags=n&-4097|64,e;case 5:return ei(e),null;case 13:return Ae(Ee),n=e.flags,n&4096?(e.flags=n&-4097|64,e):null;case 19:return Ae(Ee),null;case 4:return Pt(),null;case 10:return Jo(e),null;case 23:case 24:return Li(),null;default:return null}}function gi(e,n){try{var t="",a=n;do t+=Rp(a),a=a.return;while(a);var i=t}catch(d){i=`
Error generating stack: `+d.message+`
`+d.stack}return{value:e,source:n,stack:i}}function fi(e,n){try{console.error(n.value)}catch(t){setTimeout(function(){throw t})}}var eh=typeof WeakMap=="function"?WeakMap:Map;function Gc(e,n,t){t=Nn(-1,t),t.tag=3,t.payload={element:null};var a=n.value;return t.callback=function(){Ir||(Ir=!0,Ai=a),fi(e,n)},t}function Hc(e,n,t){t=Nn(-1,t),t.tag=3;var a=e.type.getDerivedStateFromError;if(typeof a=="function"){var i=n.value;t.payload=function(){return fi(e,n),a(i)}}var d=e.stateNode;return d!==null&&typeof d.componentDidCatch=="function"&&(t.callback=function(){typeof a!="function"&&(gn===null?gn=new Set([this]):gn.add(this),fi(e,n));var u=n.stack;this.componentDidCatch(n.value,{componentStack:u!==null?u:""})}),t}var nh=typeof WeakSet=="function"?WeakSet:Set;function _c(e){var n=e.ref;if(n!==null)if(typeof n=="function")try{n(null)}catch(t){Hn(e,t)}else n.current=null}function th(e,n){switch(n.tag){case 0:case 11:case 15:case 22:return;case 1:if(n.flags&256&&e!==null){var t=e.memoizedProps,a=e.memoizedState;e=n.stateNode,n=e.getSnapshotBeforeUpdate(n.elementType===n.type?t:rn(n.type,t),a),e.__reactInternalSnapshotBeforeUpdate=n}return;case 3:n.flags&256&&Go(n.stateNode.containerInfo);return;case 5:case 6:case 4:case 17:return}throw Error(l(163))}function ah(e,n,t){switch(t.tag){case 0:case 11:case 15:case 22:if(n=t.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{if((e.tag&3)===3){var a=e.create;e.destroy=a()}e=e.next}while(e!==n)}if(n=t.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{var i=e;a=i.next,i=i.tag,(i&4)!==0&&(i&1)!==0&&(ad(t,e),ph(t,e)),e=a}while(e!==n)}return;case 1:e=t.stateNode,t.flags&4&&(n===null?e.componentDidMount():(a=t.elementType===t.type?n.memoizedProps:rn(t.type,n.memoizedProps),e.componentDidUpdate(a,n.memoizedState,e.__reactInternalSnapshotBeforeUpdate))),n=t.updateQueue,n!==null&&rc(t,n,e);return;case 3:if(n=t.updateQueue,n!==null){if(e=null,t.child!==null)switch(t.child.tag){case 5:e=t.child.stateNode;break;case 1:e=t.child.stateNode}rc(t,n,e)}return;case 5:e=t.stateNode,n===null&&t.flags&4&&Bl(t.type,t.memoizedProps)&&e.focus();return;case 6:return;case 4:return;case 12:return;case 13:t.memoizedState===null&&(t=t.alternate,t!==null&&(t=t.memoizedState,t!==null&&(t=t.dehydrated,t!==null&&nl(t))));return;case 19:case 17:case 20:case 21:case 23:case 24:return}throw Error(l(163))}function qc(e,n){for(var t=e;;){if(t.tag===5){var a=t.stateNode;if(n)a=a.style,typeof a.setProperty=="function"?a.setProperty("display","none","important"):a.display="none";else{a=t.stateNode;var i=t.memoizedProps.style;i=i!=null&&i.hasOwnProperty("display")?i.display:null,a.style.display=Os("display",i)}}else if(t.tag===6)t.stateNode.nodeValue=n?"":t.memoizedProps;else if((t.tag!==23&&t.tag!==24||t.memoizedState===null||t===e)&&t.child!==null){t.child.return=t,t=t.child;continue}if(t===e)break;for(;t.sibling===null;){if(t.return===null||t.return===e)return;t=t.return}t.sibling.return=t.return,t=t.sibling}}function Uc(e,n){if(Xn&&typeof Xn.onCommitFiberUnmount=="function")try{Xn.onCommitFiberUnmount(qo,n)}catch{}switch(n.tag){case 0:case 11:case 14:case 15:case 22:if(e=n.updateQueue,e!==null&&(e=e.lastEffect,e!==null)){var t=e=e.next;do{var a=t,i=a.destroy;if(a=a.tag,i!==void 0)if((a&4)!==0)ad(n,t);else{a=n;try{i()}catch(d){Hn(a,d)}}t=t.next}while(t!==e)}break;case 1:if(_c(n),e=n.stateNode,typeof e.componentWillUnmount=="function")try{e.props=n.memoizedProps,e.state=n.memoizedState,e.componentWillUnmount()}catch(d){Hn(n,d)}break;case 5:_c(n);break;case 4:$c(e,n)}}function Wc(e){e.alternate=null,e.child=null,e.dependencies=null,e.firstEffect=null,e.lastEffect=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.return=null,e.updateQueue=null}function Yc(e){return e.tag===5||e.tag===3||e.tag===4}function Vc(e){e:{for(var n=e.return;n!==null;){if(Yc(n))break e;n=n.return}throw Error(l(160))}var t=n;switch(n=t.stateNode,t.tag){case 5:var a=!1;break;case 3:n=n.containerInfo,a=!0;break;case 4:n=n.containerInfo,a=!0;break;default:throw Error(l(161))}t.flags&16&&(Ut(n,""),t.flags&=-17);e:n:for(t=e;;){for(;t.sibling===null;){if(t.return===null||Yc(t.return)){t=null;break e}t=t.return}for(t.sibling.return=t.return,t=t.sibling;t.tag!==5&&t.tag!==6&&t.tag!==18;){if(t.flags&2||t.child===null||t.tag===4)continue n;t.child.return=t,t=t.child}if(!(t.flags&2)){t=t.stateNode;break e}}a?vi(e,t,n):bi(e,t,n)}function vi(e,n,t){var a=e.tag,i=a===5||a===6;if(i)e=i?e.stateNode:e.stateNode.instance,n?t.nodeType===8?t.parentNode.insertBefore(e,n):t.insertBefore(e,n):(t.nodeType===8?(n=t.parentNode,n.insertBefore(e,t)):(n=t,n.appendChild(e)),t=t._reactRootContainer,t!=null||n.onclick!==null||(n.onclick=nr));else if(a!==4&&(e=e.child,e!==null))for(vi(e,n,t),e=e.sibling;e!==null;)vi(e,n,t),e=e.sibling}function bi(e,n,t){var a=e.tag,i=a===5||a===6;if(i)e=i?e.stateNode:e.stateNode.instance,n?t.insertBefore(e,n):t.appendChild(e);else if(a!==4&&(e=e.child,e!==null))for(bi(e,n,t),e=e.sibling;e!==null;)bi(e,n,t),e=e.sibling}function $c(e,n){for(var t=n,a=!1,i,d;;){if(!a){a=t.return;e:for(;;){if(a===null)throw Error(l(160));switch(i=a.stateNode,a.tag){case 5:d=!1;break e;case 3:i=i.containerInfo,d=!0;break e;case 4:i=i.containerInfo,d=!0;break e}a=a.return}a=!0}if(t.tag===5||t.tag===6){e:for(var u=e,f=t,x=f;;)if(Uc(u,x),x.child!==null&&x.tag!==4)x.child.return=x,x=x.child;else{if(x===f)break e;for(;x.sibling===null;){if(x.return===null||x.return===f)break e;x=x.return}x.sibling.return=x.return,x=x.sibling}d?(u=i,f=t.stateNode,u.nodeType===8?u.parentNode.removeChild(f):u.removeChild(f)):i.removeChild(t.stateNode)}else if(t.tag===4){if(t.child!==null){i=t.stateNode.containerInfo,d=!0,t.child.return=t,t=t.child;continue}}else if(Uc(e,t),t.child!==null){t.child.return=t,t=t.child;continue}if(t===n)break;for(;t.sibling===null;){if(t.return===null||t.return===n)return;t=t.return,t.tag===4&&(a=!1)}t.sibling.return=t.return,t=t.sibling}}function yi(e,n){switch(n.tag){case 0:case 11:case 14:case 15:case 22:var t=n.updateQueue;if(t=t!==null?t.lastEffect:null,t!==null){var a=t=t.next;do(a.tag&3)===3&&(e=a.destroy,a.destroy=void 0,e!==void 0&&e()),a=a.next;while(a!==t)}return;case 1:return;case 5:if(t=n.stateNode,t!=null){a=n.memoizedProps;var i=e!==null?e.memoizedProps:a;e=n.type;var d=n.updateQueue;if(n.updateQueue=null,d!==null){for(t[ar]=a,e==="input"&&a.type==="radio"&&a.name!=null&&Ls(t,a),oo(e,i),n=oo(e,a),i=0;i<d.length;i+=2){var u=d[i],f=d[i+1];u==="style"?Bs(t,f):u==="dangerouslySetInnerHTML"?zs(t,f):u==="children"?Ut(t,f):te(t,u,f,n)}switch(e){case"input":Xr(t,a);break;case"textarea":Ns(t,a);break;case"select":e=t._wrapperState.wasMultiple,t._wrapperState.wasMultiple=!!a.multiple,d=a.value,d!=null?pt(t,!!a.multiple,d,!1):e!==!!a.multiple&&(a.defaultValue!=null?pt(t,!!a.multiple,a.defaultValue,!0):pt(t,!!a.multiple,a.multiple?[]:"",!1))}}}return;case 6:if(n.stateNode===null)throw Error(l(162));n.stateNode.nodeValue=n.memoizedProps;return;case 3:t=n.stateNode,t.hydrate&&(t.hydrate=!1,nl(t.containerInfo));return;case 12:return;case 13:n.memoizedState!==null&&(Si=Oe(),qc(n.child,!0)),Kc(n);return;case 19:Kc(n);return;case 17:return;case 23:case 24:qc(n,n.memoizedState!==null);return}throw Error(l(163))}function Kc(e){var n=e.updateQueue;if(n!==null){e.updateQueue=null;var t=e.stateNode;t===null&&(t=e.stateNode=new nh),n.forEach(function(a){var i=mh.bind(null,e,a);t.has(a)||(t.add(a),a.then(i,i))})}}function rh(e,n){return e!==null&&(e=e.memoizedState,e===null||e.dehydrated!==null)?(n=n.memoizedState,n!==null&&n.dehydrated===null):!1}var oh=Math.ceil,Tr=M.ReactCurrentDispatcher,xi=M.ReactCurrentOwner,ie=0,He=null,Le=null,Ge=0,at=0,wi=Ln(0),De=0,Ar=null,Lt=0,Sa=0,Rt=0,ki=0,Ci=null,Si=0,Ti=1/0;function jt(){Ti=Oe()+500}var K=null,Ir=!1,Ai=null,gn=null,zn=!1,Ta=null,Aa=90,Ii=[],Ei=[],wn=null,Ia=0,Pi=null,Er=-1,kn=0,Pr=0,Ea=null,Mr=!1;function Qe(){return(ie&48)!==0?Oe():Er!==-1?Er:Er=Oe()}function On(e){if(e=e.mode,(e&2)===0)return 1;if((e&4)===0)return At()===99?1:2;if(kn===0&&(kn=Lt),Yu.transition!==0){Pr!==0&&(Pr=Ci!==null?Ci.pendingLanes:0),e=kn;var n=4186112&~Pr;return n&=-n,n===0&&(e=4186112&~e,n=e&-e,n===0&&(n=8192)),n}return e=At(),(ie&4)!==0&&e===98?e=Ya(12,kn):(e=$p(e),e=Ya(e,kn)),e}function Bn(e,n,t){if(50<Ia)throw Ia=0,Pi=null,Error(l(185));if(e=Lr(e,n),e===null)return null;Va(e,n,t),e===He&&(Rt|=n,De===4&&Nt(e,Ge));var a=At();n===1?(ie&8)!==0&&(ie&48)===0?Mi(e):(tn(e,t),ie===0&&(jt(),pn())):((ie&4)===0||a!==98&&a!==99||(wn===null?wn=new Set([e]):wn.add(e)),tn(e,t)),Ci=e}function Lr(e,n){e.lanes|=n;var t=e.alternate;for(t!==null&&(t.lanes|=n),t=e,e=e.return;e!==null;)e.childLanes|=n,t=e.alternate,t!==null&&(t.childLanes|=n),t=e,e=e.return;return t.tag===3?t.stateNode:null}function tn(e,n){for(var t=e.callbackNode,a=e.suspendedLanes,i=e.pingedLanes,d=e.expirationTimes,u=e.pendingLanes;0<u;){var f=31-En(u),x=1<<f,E=d[f];if(E===-1){if((x&a)===0||(x&i)!==0){E=n,gt(x);var W=Se;d[f]=10<=W?E+250:6<=W?E+5e3:-1}}else E<=n&&(e.expiredLanes|=x);u&=~x}if(a=ea(e,e===He?Ge:0),n=Se,a===0)t!==null&&(t!==Vo&&Wo(t),e.callbackNode=null,e.callbackPriority=0);else{if(t!==null){if(e.callbackPriority===n)return;t!==Vo&&Wo(t)}n===15?(t=Mi.bind(null,e),bn===null?(bn=[t],lr=Uo(sr,ec)):bn.push(t),t=Vo):n===14?t=pa(99,Mi.bind(null,e)):(t=Kp(n),t=pa(t,Jc.bind(null,e))),e.callbackPriority=n,e.callbackNode=t}}function Jc(e){if(Er=-1,Pr=kn=0,(ie&48)!==0)throw Error(l(327));var n=e.callbackNode;if(Gn()&&e.callbackNode!==n)return null;var t=ea(e,e===He?Ge:0);if(t===0)return null;var a=t,i=ie;ie|=16;var d=ed();(He!==e||Ge!==a)&&(jt(),Dt(e,a));do try{lh();break}catch(f){Zc(e,f)}while(!0);if(Ko(),Tr.current=d,ie=i,Le!==null?a=0:(He=null,Ge=0,a=De),(Lt&Rt)!==0)Dt(e,0);else if(a!==0){if(a===2&&(ie|=64,e.hydrate&&(e.hydrate=!1,Go(e.containerInfo)),t=ll(e),t!==0&&(a=Pa(e,t))),a===1)throw n=Ar,Dt(e,0),Nt(e,t),tn(e,Oe()),n;switch(e.finishedWork=e.current.alternate,e.finishedLanes=t,a){case 0:case 1:throw Error(l(345));case 2:rt(e);break;case 3:if(Nt(e,t),(t&62914560)===t&&(a=Si+500-Oe(),10<a)){if(ea(e,0)!==0)break;if(i=e.suspendedLanes,(i&t)!==t){Qe(),e.pingedLanes|=e.suspendedLanes&i;break}e.timeoutHandle=Gl(rt.bind(null,e),a);break}rt(e);break;case 4:if(Nt(e,t),(t&4186112)===t)break;for(a=e.eventTimes,i=-1;0<t;){var u=31-En(t);d=1<<u,u=a[u],u>i&&(i=u),t&=~d}if(t=i,t=Oe()-t,t=(120>t?120:480>t?480:1080>t?1080:1920>t?1920:3e3>t?3e3:4320>t?4320:1960*oh(t/1960))-t,10<t){e.timeoutHandle=Gl(rt.bind(null,e),t);break}rt(e);break;case 5:rt(e);break;default:throw Error(l(329))}}return tn(e,Oe()),e.callbackNode===n?Jc.bind(null,e):null}function Nt(e,n){for(n&=~ki,n&=~Rt,e.suspendedLanes|=n,e.pingedLanes&=~n,e=e.expirationTimes;0<n;){var t=31-En(n),a=1<<t;e[t]=-1,n&=~a}}function Mi(e){if((ie&48)!==0)throw Error(l(327));if(Gn(),e===He&&(e.expiredLanes&Ge)!==0){var n=Ge,t=Pa(e,n);(Lt&Rt)!==0&&(n=ea(e,n),t=Pa(e,n))}else n=ea(e,0),t=Pa(e,n);if(e.tag!==0&&t===2&&(ie|=64,e.hydrate&&(e.hydrate=!1,Go(e.containerInfo)),n=ll(e),n!==0&&(t=Pa(e,n))),t===1)throw t=Ar,Dt(e,0),Nt(e,n),tn(e,Oe()),t;return e.finishedWork=e.current.alternate,e.finishedLanes=n,rt(e),tn(e,Oe()),null}function ih(){if(wn!==null){var e=wn;wn=null,e.forEach(function(n){n.expiredLanes|=24&n.pendingLanes,tn(n,Oe())})}pn()}function Qc(e,n){var t=ie;ie|=1;try{return e(n)}finally{ie=t,ie===0&&(jt(),pn())}}function Xc(e,n){var t=ie;ie&=-2,ie|=8;try{return e(n)}finally{ie=t,ie===0&&(jt(),pn())}}function Rr(e,n){Ie(wi,at),at|=n,Lt|=n}function Li(){at=wi.current,Ae(wi)}function Dt(e,n){e.finishedWork=null,e.finishedLanes=0;var t=e.timeoutHandle;if(t!==-1&&(e.timeoutHandle=-1,Gu(t)),Le!==null)for(t=Le.return;t!==null;){var a=t;switch(a.tag){case 1:a=a.type.childContextTypes,a!=null&&or();break;case 3:Pt(),Ae(We),Ae(ze),ai();break;case 5:ei(a);break;case 4:Pt();break;case 13:Ae(Ee);break;case 19:Ae(Ee);break;case 10:Jo(a);break;case 23:case 24:Li()}t=t.return}He=e,Le=_n(e.current,null),Ge=at=Lt=n,De=0,Ar=null,ki=Rt=Sa=0}function Zc(e,n){do{var t=Le;try{if(Ko(),va.current=Cr,yr){for(var a=Me.memoizedState;a!==null;){var i=a.queue;i!==null&&(i.pending=null),a=a.next}yr=!1}if(ba=0,Ne=Be=Me=null,ya=!1,xi.current=null,t===null||t.return===null){De=1,Ar=n,Le=null;break}e:{var d=e,u=t.return,f=t,x=n;if(n=Ge,f.flags|=2048,f.firstEffect=f.lastEffect=null,x!==null&&typeof x=="object"&&typeof x.then=="function"){var E=x;if((f.mode&2)===0){var W=f.alternate;W?(f.updateQueue=W.updateQueue,f.memoizedState=W.memoizedState,f.lanes=W.lanes):(f.updateQueue=null,f.memoizedState=null)}var ce=(Ee.current&1)!==0,O=u;do{var Z;if(Z=O.tag===13){var se=O.memoizedState;if(se!==null)Z=se.dehydrated!==null;else{var re=O.memoizedProps;Z=re.fallback===void 0?!1:re.unstable_avoidThisFallback!==!0?!0:!ce}}if(Z){var C=O.updateQueue;if(C===null){var w=new Set;w.add(E),O.updateQueue=w}else C.add(E);if((O.mode&2)===0){if(O.flags|=64,f.flags|=16384,f.flags&=-2981,f.tag===1)if(f.alternate===null)f.tag=17;else{var k=Nn(-1,1);k.tag=2,Dn(f,k)}f.lanes|=1;break e}x=void 0,f=n;var L=d.pingCache;if(L===null?(L=d.pingCache=new eh,x=new Set,L.set(E,x)):(x=L.get(E),x===void 0&&(x=new Set,L.set(E,x))),!x.has(f)){x.add(f);var N=hh.bind(null,d,E,f);E.then(N,N)}O.flags|=4096,O.lanes=n;break e}O=O.return}while(O!==null);x=Error((dt(f.type)||"A React component")+` suspended while rendering, but no fallback UI was specified.

Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.`)}De!==5&&(De=2),x=gi(x,f),O=u;do{switch(O.tag){case 3:d=x,O.flags|=4096,n&=-n,O.lanes|=n;var ue=Gc(O,d,n);ac(O,ue);break e;case 1:d=x;var Q=O.type,he=O.stateNode;if((O.flags&64)===0&&(typeof Q.getDerivedStateFromError=="function"||he!==null&&typeof he.componentDidCatch=="function"&&(gn===null||!gn.has(he)))){O.flags|=4096,n&=-n,O.lanes|=n;var fe=Hc(O,d,n);ac(O,fe);break e}}O=O.return}while(O!==null)}td(t)}catch(me){n=me,Le===t&&t!==null&&(Le=t=t.return);continue}break}while(!0)}function ed(){var e=Tr.current;return Tr.current=Cr,e===null?Cr:e}function Pa(e,n){var t=ie;ie|=16;var a=ed();He===e&&Ge===n||Dt(e,n);do try{sh();break}catch(i){Zc(e,i)}while(!0);if(Ko(),ie=t,Tr.current=a,Le!==null)throw Error(l(261));return He=null,Ge=0,De}function sh(){for(;Le!==null;)nd(Le)}function lh(){for(;Le!==null&&!qu();)nd(Le)}function nd(e){var n=od(e.alternate,e,at);e.memoizedProps=e.pendingProps,n===null?td(e):Le=n,xi.current=null}function td(e){var n=e;do{var t=n.alternate;if(e=n.return,(n.flags&2048)===0){if(t=Xu(t,n,at),t!==null){Le=t;return}if(t=n,t.tag!==24&&t.tag!==23||t.memoizedState===null||(at&1073741824)!==0||(t.mode&4)===0){for(var a=0,i=t.child;i!==null;)a|=i.lanes|i.childLanes,i=i.sibling;t.childLanes=a}e!==null&&(e.flags&2048)===0&&(e.firstEffect===null&&(e.firstEffect=n.firstEffect),n.lastEffect!==null&&(e.lastEffect!==null&&(e.lastEffect.nextEffect=n.firstEffect),e.lastEffect=n.lastEffect),1<n.flags&&(e.lastEffect!==null?e.lastEffect.nextEffect=n:e.firstEffect=n,e.lastEffect=n))}else{if(t=Zu(n),t!==null){t.flags&=2047,Le=t;return}e!==null&&(e.firstEffect=e.lastEffect=null,e.flags|=2048)}if(n=n.sibling,n!==null){Le=n;return}Le=n=e}while(n!==null);De===0&&(De=5)}function rt(e){var n=At();return Zn(99,ch.bind(null,e,n)),null}function ch(e,n){do Gn();while(Ta!==null);if((ie&48)!==0)throw Error(l(327));var t=e.finishedWork;if(t===null)return null;if(e.finishedWork=null,e.finishedLanes=0,t===e.current)throw Error(l(177));e.callbackNode=null;var a=t.lanes|t.childLanes,i=a,d=e.pendingLanes&~i;e.pendingLanes=i,e.suspendedLanes=0,e.pingedLanes=0,e.expiredLanes&=i,e.mutableReadLanes&=i,e.entangledLanes&=i,i=e.entanglements;for(var u=e.eventTimes,f=e.expirationTimes;0<d;){var x=31-En(d),E=1<<x;i[x]=0,u[x]=-1,f[x]=-1,d&=~E}if(wn!==null&&(a&24)===0&&wn.has(e)&&wn.delete(e),e===He&&(Le=He=null,Ge=0),1<t.flags?t.lastEffect!==null?(t.lastEffect.nextEffect=t,a=t.firstEffect):a=t:a=t.firstEffect,a!==null){if(i=ie,ie|=32,xi.current=null,zo=$a,u=El(),jo(u)){if("selectionStart"in u)f={start:u.selectionStart,end:u.selectionEnd};else e:if(f=(f=u.ownerDocument)&&f.defaultView||window,(E=f.getSelection&&f.getSelection())&&E.rangeCount!==0){f=E.anchorNode,d=E.anchorOffset,x=E.focusNode,E=E.focusOffset;try{f.nodeType,x.nodeType}catch{f=null;break e}var W=0,ce=-1,O=-1,Z=0,se=0,re=u,C=null;n:for(;;){for(var w;re!==f||d!==0&&re.nodeType!==3||(ce=W+d),re!==x||E!==0&&re.nodeType!==3||(O=W+E),re.nodeType===3&&(W+=re.nodeValue.length),(w=re.firstChild)!==null;)C=re,re=w;for(;;){if(re===u)break n;if(C===f&&++Z===d&&(ce=W),C===x&&++se===E&&(O=W),(w=re.nextSibling)!==null)break;re=C,C=re.parentNode}re=w}f=ce===-1||O===-1?null:{start:ce,end:O}}else f=null;f=f||{start:0,end:0}}else f=null;Oo={focusedElem:u,selectionRange:f},$a=!1,Ea=null,Mr=!1,K=a;do try{dh()}catch(me){if(K===null)throw Error(l(330));Hn(K,me),K=K.nextEffect}while(K!==null);Ea=null,K=a;do try{for(u=e;K!==null;){var k=K.flags;if(k&16&&Ut(K.stateNode,""),k&128){var L=K.alternate;if(L!==null){var N=L.ref;N!==null&&(typeof N=="function"?N(null):N.current=null)}}switch(k&1038){case 2:Vc(K),K.flags&=-3;break;case 6:Vc(K),K.flags&=-3,yi(K.alternate,K);break;case 1024:K.flags&=-1025;break;case 1028:K.flags&=-1025,yi(K.alternate,K);break;case 4:yi(K.alternate,K);break;case 8:f=K,$c(u,f);var ue=f.alternate;Wc(f),ue!==null&&Wc(ue)}K=K.nextEffect}}catch(me){if(K===null)throw Error(l(330));Hn(K,me),K=K.nextEffect}while(K!==null);if(N=Oo,L=El(),k=N.focusedElem,u=N.selectionRange,L!==k&&k&&k.ownerDocument&&Il(k.ownerDocument.documentElement,k)){for(u!==null&&jo(k)&&(L=u.start,N=u.end,N===void 0&&(N=L),"selectionStart"in k?(k.selectionStart=L,k.selectionEnd=Math.min(N,k.value.length)):(N=(L=k.ownerDocument||document)&&L.defaultView||window,N.getSelection&&(N=N.getSelection(),f=k.textContent.length,ue=Math.min(u.start,f),u=u.end===void 0?ue:Math.min(u.end,f),!N.extend&&ue>u&&(f=u,u=ue,ue=f),f=Al(k,ue),d=Al(k,u),f&&d&&(N.rangeCount!==1||N.anchorNode!==f.node||N.anchorOffset!==f.offset||N.focusNode!==d.node||N.focusOffset!==d.offset)&&(L=L.createRange(),L.setStart(f.node,f.offset),N.removeAllRanges(),ue>u?(N.addRange(L),N.extend(d.node,d.offset)):(L.setEnd(d.node,d.offset),N.addRange(L)))))),L=[],N=k;N=N.parentNode;)N.nodeType===1&&L.push({element:N,left:N.scrollLeft,top:N.scrollTop});for(typeof k.focus=="function"&&k.focus(),k=0;k<L.length;k++)N=L[k],N.element.scrollLeft=N.left,N.element.scrollTop=N.top}$a=!!zo,Oo=zo=null,e.current=t,K=a;do try{for(k=e;K!==null;){var Q=K.flags;if(Q&36&&ah(k,K.alternate,K),Q&128){L=void 0;var he=K.ref;if(he!==null){var fe=K.stateNode;K.tag,L=fe,typeof he=="function"?he(L):he.current=L}}K=K.nextEffect}}catch(me){if(K===null)throw Error(l(330));Hn(K,me),K=K.nextEffect}while(K!==null);K=null,Wu(),ie=i}else e.current=t;if(zn)zn=!1,Ta=e,Aa=n;else for(K=a;K!==null;)n=K.nextEffect,K.nextEffect=null,K.flags&8&&(Q=K,Q.sibling=null,Q.stateNode=null),K=n;if(a=e.pendingLanes,a===0&&(gn=null),a===1?e===Pi?Ia++:(Ia=0,Pi=e):Ia=0,t=t.stateNode,Xn&&typeof Xn.onCommitFiberRoot=="function")try{Xn.onCommitFiberRoot(qo,t,void 0,(t.current.flags&64)===64)}catch{}if(tn(e,Oe()),Ir)throw Ir=!1,e=Ai,Ai=null,e;return(ie&8)!==0||pn(),null}function dh(){for(;K!==null;){var e=K.alternate;Mr||Ea===null||((K.flags&8)!==0?$s(K,Ea)&&(Mr=!0):K.tag===13&&rh(e,K)&&$s(K,Ea)&&(Mr=!0));var n=K.flags;(n&256)!==0&&th(e,K),(n&512)===0||zn||(zn=!0,pa(97,function(){return Gn(),null})),K=K.nextEffect}}function Gn(){if(Aa!==90){var e=97<Aa?97:Aa;return Aa=90,Zn(e,uh)}return!1}function ph(e,n){Ii.push(n,e),zn||(zn=!0,pa(97,function(){return Gn(),null}))}function ad(e,n){Ei.push(n,e),zn||(zn=!0,pa(97,function(){return Gn(),null}))}function uh(){if(Ta===null)return!1;var e=Ta;if(Ta=null,(ie&48)!==0)throw Error(l(331));var n=ie;ie|=32;var t=Ei;Ei=[];for(var a=0;a<t.length;a+=2){var i=t[a],d=t[a+1],u=i.destroy;if(i.destroy=void 0,typeof u=="function")try{u()}catch(x){if(d===null)throw Error(l(330));Hn(d,x)}}for(t=Ii,Ii=[],a=0;a<t.length;a+=2){i=t[a],d=t[a+1];try{var f=i.create;i.destroy=f()}catch(x){if(d===null)throw Error(l(330));Hn(d,x)}}for(f=e.current.firstEffect;f!==null;)e=f.nextEffect,f.nextEffect=null,f.flags&8&&(f.sibling=null,f.stateNode=null),f=e;return ie=n,pn(),!0}function rd(e,n,t){n=gi(t,n),n=Gc(e,n,1),Dn(e,n),n=Qe(),e=Lr(e,1),e!==null&&(Va(e,1,n),tn(e,n))}function Hn(e,n){if(e.tag===3)rd(e,e,n);else for(var t=e.return;t!==null;){if(t.tag===3){rd(t,e,n);break}else if(t.tag===1){var a=t.stateNode;if(typeof t.type.getDerivedStateFromError=="function"||typeof a.componentDidCatch=="function"&&(gn===null||!gn.has(a))){e=gi(n,e);var i=Hc(t,e,1);if(Dn(t,i),i=Qe(),t=Lr(t,1),t!==null)Va(t,1,i),tn(t,i);else if(typeof a.componentDidCatch=="function"&&(gn===null||!gn.has(a)))try{a.componentDidCatch(n,e)}catch{}break}}t=t.return}}function hh(e,n,t){var a=e.pingCache;a!==null&&a.delete(n),n=Qe(),e.pingedLanes|=e.suspendedLanes&t,He===e&&(Ge&t)===t&&(De===4||De===3&&(Ge&62914560)===Ge&&500>Oe()-Si?Dt(e,0):ki|=t),tn(e,n)}function mh(e,n){var t=e.stateNode;t!==null&&t.delete(n),n=0,n===0&&(n=e.mode,(n&2)===0?n=1:(n&4)===0?n=At()===99?1:2:(kn===0&&(kn=Lt),n=ft(62914560&~kn),n===0&&(n=4194304))),t=Qe(),e=Lr(e,n),e!==null&&(Va(e,n,t),tn(e,t))}var od;od=function(e,n,t){var a=n.lanes;if(e!==null)if(e.memoizedProps!==n.pendingProps||We.current)on=!0;else if((t&a)!==0)on=(e.flags&16384)!==0;else{switch(on=!1,n.tag){case 3:Mc(n),ti();break;case 5:pc(n);break;case 1:Ye(n.type)&&ir(n);break;case 4:Zo(n,n.stateNode.containerInfo);break;case 10:a=n.memoizedProps.value;var i=n.type._context;Ie(cr,i._currentValue),i._currentValue=a;break;case 13:if(n.memoizedState!==null)return(t&n.child.childLanes)!==0?Lc(e,n,t):(Ie(Ee,Ee.current&1),n=xn(e,n,t),n!==null?n.sibling:null);Ie(Ee,Ee.current&1);break;case 19:if(a=(t&n.childLanes)!==0,(e.flags&64)!==0){if(a)return Fc(e,n,t);n.flags|=64}if(i=n.memoizedState,i!==null&&(i.rendering=null,i.tail=null,i.lastEffect=null),Ie(Ee,Ee.current),a)break;return null;case 23:case 24:return n.lanes=0,di(e,n,t)}return xn(e,n,t)}else on=!1;switch(n.lanes=0,n.tag){case 2:if(a=n.type,e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,i=Tt(n,ze.current),Et(n,t),i=oi(null,n,a,e,i,t),n.flags|=1,typeof i=="object"&&i!==null&&typeof i.render=="function"&&i.$$typeof===void 0){if(n.tag=1,n.memoizedState=null,n.updateQueue=null,Ye(a)){var d=!0;ir(n)}else d=!1;n.memoizedState=i.state!==null&&i.state!==void 0?i.state:null,Qo(n);var u=a.getDerivedStateFromProps;typeof u=="function"&&ur(n,a,u,e),i.updater=hr,n.stateNode=i,i._reactInternals=n,Xo(n,a,e,t),n=ui(null,n,a,!0,d,t)}else n.tag=0,$e(null,n,i,t),n=n.child;return n;case 16:i=n.elementType;e:{switch(e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,d=i._init,i=d(i._payload),n.type=i,d=n.tag=fh(i),e=rn(i,e),d){case 0:n=pi(null,n,i,e,t);break e;case 1:n=Pc(null,n,i,e,t);break e;case 11:n=Tc(null,n,i,e,t);break e;case 14:n=Ac(null,n,i,rn(i.type,e),a,t);break e}throw Error(l(306,i,""))}return n;case 0:return a=n.type,i=n.pendingProps,i=n.elementType===a?i:rn(a,i),pi(e,n,a,i,t);case 1:return a=n.type,i=n.pendingProps,i=n.elementType===a?i:rn(a,i),Pc(e,n,a,i,t);case 3:if(Mc(n),a=n.updateQueue,e===null||a===null)throw Error(l(282));if(a=n.pendingProps,i=n.memoizedState,i=i!==null?i.element:null,tc(e,n),ua(n,a,null,t),a=n.memoizedState.element,a===i)ti(),n=xn(e,n,t);else{if(i=n.stateNode,(d=i.hydrate)&&(Fn=wt(n.stateNode.containerInfo.firstChild),yn=n,d=hn=!0),d){if(e=i.mutableSourceEagerHydrationData,e!=null)for(i=0;i<e.length;i+=2)d=e[i],d._workInProgressVersionPrimary=e[i+1],Mt.push(d);for(t=dc(n,null,a,t),n.child=t;t;)t.flags=t.flags&-3|1024,t=t.sibling}else $e(e,n,a,t),ti();n=n.child}return n;case 5:return pc(n),e===null&&ni(n),a=n.type,i=n.pendingProps,d=e!==null?e.memoizedProps:null,u=i.children,Bo(a,i)?u=null:d!==null&&Bo(a,d)&&(n.flags|=16),Ec(e,n),$e(e,n,u,t),n.child;case 6:return e===null&&ni(n),null;case 13:return Lc(e,n,t);case 4:return Zo(n,n.stateNode.containerInfo),a=n.pendingProps,e===null?n.child=fr(n,null,a,t):$e(e,n,a,t),n.child;case 11:return a=n.type,i=n.pendingProps,i=n.elementType===a?i:rn(a,i),Tc(e,n,a,i,t);case 7:return $e(e,n,n.pendingProps,t),n.child;case 8:return $e(e,n,n.pendingProps.children,t),n.child;case 12:return $e(e,n,n.pendingProps.children,t),n.child;case 10:e:{a=n.type._context,i=n.pendingProps,u=n.memoizedProps,d=i.value;var f=n.type._context;if(Ie(cr,f._currentValue),f._currentValue=d,u!==null)if(f=u.value,d=Ze(f,d)?0:(typeof a._calculateChangedBits=="function"?a._calculateChangedBits(f,d):1073741823)|0,d===0){if(u.children===i.children&&!We.current){n=xn(e,n,t);break e}}else for(f=n.child,f!==null&&(f.return=n);f!==null;){var x=f.dependencies;if(x!==null){u=f.child;for(var E=x.firstContext;E!==null;){if(E.context===a&&(E.observedBits&d)!==0){f.tag===1&&(E=Nn(-1,t&-t),E.tag=2,Dn(f,E)),f.lanes|=t,E=f.alternate,E!==null&&(E.lanes|=t),nc(f.return,t),x.lanes|=t;break}E=E.next}}else u=f.tag===10&&f.type===n.type?null:f.child;if(u!==null)u.return=f;else for(u=f;u!==null;){if(u===n){u=null;break}if(f=u.sibling,f!==null){f.return=u.return,u=f;break}u=u.return}f=u}$e(e,n,i.children,t),n=n.child}return n;case 9:return i=n.type,d=n.pendingProps,a=d.children,Et(n,t),i=en(i,d.unstable_observedBits),a=a(i),n.flags|=1,$e(e,n,a,t),n.child;case 14:return i=n.type,d=rn(i,n.pendingProps),d=rn(i.type,d),Ac(e,n,i,d,a,t);case 15:return Ic(e,n,n.type,n.pendingProps,a,t);case 17:return a=n.type,i=n.pendingProps,i=n.elementType===a?i:rn(a,i),e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),n.tag=1,Ye(a)?(e=!0,ir(n)):e=!1,Et(n,t),sc(n,a,i),Xo(n,a,i,t),ui(null,n,a,!0,e,t);case 19:return Fc(e,n,t);case 23:return di(e,n,t);case 24:return di(e,n,t)}throw Error(l(156,n.tag))};function gh(e,n,t,a){this.tag=e,this.key=t,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.ref=null,this.pendingProps=n,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=a,this.flags=0,this.lastEffect=this.firstEffect=this.nextEffect=null,this.childLanes=this.lanes=0,this.alternate=null}function an(e,n,t,a){return new gh(e,n,t,a)}function Ri(e){return e=e.prototype,!(!e||!e.isReactComponent)}function fh(e){if(typeof e=="function")return Ri(e)?1:0;if(e!=null){if(e=e.$$typeof,e===oe)return 11;if(e===Pe)return 14}return 2}function _n(e,n){var t=e.alternate;return t===null?(t=an(e.tag,n,e.key,e.mode),t.elementType=e.elementType,t.type=e.type,t.stateNode=e.stateNode,t.alternate=e,e.alternate=t):(t.pendingProps=n,t.type=e.type,t.flags=0,t.nextEffect=null,t.firstEffect=null,t.lastEffect=null),t.childLanes=e.childLanes,t.lanes=e.lanes,t.child=e.child,t.memoizedProps=e.memoizedProps,t.memoizedState=e.memoizedState,t.updateQueue=e.updateQueue,n=e.dependencies,t.dependencies=n===null?null:{lanes:n.lanes,firstContext:n.firstContext},t.sibling=e.sibling,t.index=e.index,t.ref=e.ref,t}function jr(e,n,t,a,i,d){var u=2;if(a=e,typeof e=="function")Ri(e)&&(u=1);else if(typeof e=="string")u=5;else e:switch(e){case Y:return Ft(t.children,i,d,n);case q:u=8,i|=16;break;case de:u=8,i|=1;break;case ne:return e=an(12,t,n,i|8),e.elementType=ne,e.type=ne,e.lanes=d,e;case ge:return e=an(13,t,n,i),e.type=ge,e.elementType=ge,e.lanes=d,e;case le:return e=an(19,t,n,i),e.elementType=le,e.lanes=d,e;case I:return ji(t,i,d,n);case j:return e=an(24,t,n,i),e.elementType=j,e.lanes=d,e;default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case pe:u=10;break e;case ee:u=9;break e;case oe:u=11;break e;case Pe:u=14;break e;case A:u=16,a=null;break e;case z:u=22;break e}throw Error(l(130,e==null?e:typeof e,""))}return n=an(u,t,n,i),n.elementType=e,n.type=a,n.lanes=d,n}function Ft(e,n,t,a){return e=an(7,e,a,n),e.lanes=t,e}function ji(e,n,t,a){return e=an(23,e,a,n),e.elementType=I,e.lanes=t,e}function Ni(e,n,t){return e=an(6,e,null,n),e.lanes=t,e}function Di(e,n,t){return n=an(4,e.children!==null?e.children:[],e.key,n),n.lanes=t,n.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},n}function vh(e,n,t){this.tag=n,this.containerInfo=e,this.finishedWork=this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.pendingContext=this.context=null,this.hydrate=t,this.callbackNode=null,this.callbackPriority=0,this.eventTimes=wo(0),this.expirationTimes=wo(-1),this.entangledLanes=this.finishedLanes=this.mutableReadLanes=this.expiredLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=wo(0),this.mutableSourceEagerHydrationData=null}function bh(e,n,t){var a=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:$,key:a==null?null:""+a,children:e,containerInfo:n,implementation:t}}function Nr(e,n,t,a){var i=n.current,d=Qe(),u=On(i);e:if(t){t=t._reactInternals;n:{if(Kn(t)!==t||t.tag!==1)throw Error(l(170));var f=t;do{switch(f.tag){case 3:f=f.stateNode.context;break n;case 1:if(Ye(f.type)){f=f.stateNode.__reactInternalMemoizedMergedChildContext;break n}}f=f.return}while(f!==null);throw Error(l(171))}if(t.tag===1){var x=t.type;if(Ye(x)){t=Wl(t,x,f);break e}}t=f}else t=Rn;return n.context===null?n.context=t:n.pendingContext=t,n=Nn(d,u),n.payload={element:e},a=a===void 0?null:a,a!==null&&(n.callback=a),Dn(i,n),Bn(i,u,d),u}function Fi(e){return e=e.current,e.child?(e.child.tag===5,e.child.stateNode):null}function id(e,n){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var t=e.retryLane;e.retryLane=t!==0&&t<n?t:n}}function zi(e,n){id(e,n),(e=e.alternate)&&id(e,n)}function yh(){return null}function Oi(e,n,t){var a=t!=null&&t.hydrationOptions!=null&&t.hydrationOptions.mutableSources||null;if(t=new vh(e,n,t!=null&&t.hydrate===!0),n=an(3,null,null,n===2?7:n===1?3:0),t.current=n,n.stateNode=t,Qo(n),e[kt]=t.current,Nl(e.nodeType===8?e.parentNode:e),a)for(e=0;e<a.length;e++){n=a[e];var i=n._getVersion;i=i(n._source),t.mutableSourceEagerHydrationData==null?t.mutableSourceEagerHydrationData=[n,i]:t.mutableSourceEagerHydrationData.push(n,i)}this._internalRoot=t}Oi.prototype.render=function(e){Nr(e,this._internalRoot,null,null)},Oi.prototype.unmount=function(){var e=this._internalRoot,n=e.containerInfo;Nr(null,e,null,function(){n[kt]=null})};function Ma(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11&&(e.nodeType!==8||e.nodeValue!==" react-mount-point-unstable "))}function xh(e,n){if(n||(n=e?e.nodeType===9?e.documentElement:e.firstChild:null,n=!(!n||n.nodeType!==1||!n.hasAttribute("data-reactroot"))),!n)for(var t;t=e.lastChild;)e.removeChild(t);return new Oi(e,0,n?{hydrate:!0}:void 0)}function Dr(e,n,t,a,i){var d=t._reactRootContainer;if(d){var u=d._internalRoot;if(typeof i=="function"){var f=i;i=function(){var E=Fi(u);f.call(E)}}Nr(n,u,e,i)}else{if(d=t._reactRootContainer=xh(t,a),u=d._internalRoot,typeof i=="function"){var x=i;i=function(){var E=Fi(u);x.call(E)}}Xc(function(){Nr(n,u,e,i)})}return Fi(u)}Ks=function(e){if(e.tag===13){var n=Qe();Bn(e,4,n),zi(e,4)}},go=function(e){if(e.tag===13){var n=Qe();Bn(e,67108864,n),zi(e,67108864)}},Js=function(e){if(e.tag===13){var n=Qe(),t=On(e);Bn(e,t,n),zi(e,t)}},Qs=function(e,n){return n()},so=function(e,n,t){switch(n){case"input":if(Xr(e,t),n=t.name,t.type==="radio"&&n!=null){for(t=e;t.parentNode;)t=t.parentNode;for(t=t.querySelectorAll("input[name="+JSON.stringify(""+n)+'][type="radio"]'),n=0;n<t.length;n++){var a=t[n];if(a!==e&&a.form===e.form){var i=rr(a);if(!i)throw Error(l(90));Ps(a),Xr(a,i)}}}break;case"textarea":Ns(e,t);break;case"select":n=t.value,n!=null&&pt(e,!!t.multiple,n,!1)}},lo=Qc,qs=function(e,n,t,a,i){var d=ie;ie|=4;try{return Zn(98,e.bind(null,n,t,a,i))}finally{ie=d,ie===0&&(jt(),pn())}},co=function(){(ie&49)===0&&(ih(),Gn())},Us=function(e,n){var t=ie;ie|=2;try{return e(n)}finally{ie=t,ie===0&&(jt(),pn())}};function sd(e,n){var t=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!Ma(n))throw Error(l(200));return bh(e,n,null,t)}var wh={Events:[da,Ct,rr,Hs,_s,Gn,{current:!1}]},La={findFiberByHostInstance:Jn,bundleType:0,version:"17.0.2",rendererPackageName:"react-dom"},kh={bundleType:La.bundleType,version:La.version,rendererPackageName:La.rendererPackageName,rendererConfig:La.rendererConfig,overrideHookState:null,overrideHookStateDeletePath:null,overrideHookStateRenamePath:null,overrideProps:null,overridePropsDeletePath:null,overridePropsRenamePath:null,setSuspenseHandler:null,scheduleUpdate:null,currentDispatcherRef:M.ReactCurrentDispatcher,findHostInstanceByFiber:function(e){return e=Vs(e),e===null?null:e.stateNode},findFiberByHostInstance:La.findFiberByHostInstance||yh,findHostInstancesForRefresh:null,scheduleRefresh:null,scheduleRoot:null,setRefreshHandler:null,getCurrentFiber:null};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<"u"){var Fr=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!Fr.isDisabled&&Fr.supportsFiber)try{qo=Fr.inject(kh),Xn=Fr}catch{}}return Xe.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=wh,Xe.createPortal=sd,Xe.findDOMNode=function(e){if(e==null)return null;if(e.nodeType===1)return e;var n=e._reactInternals;if(n===void 0)throw typeof e.render=="function"?Error(l(188)):Error(l(268,Object.keys(e)));return e=Vs(n),e=e===null?null:e.stateNode,e},Xe.flushSync=function(e,n){var t=ie;if((t&48)!==0)return e(n);ie|=1;try{if(e)return Zn(99,e.bind(null,n))}finally{ie=t,pn()}},Xe.hydrate=function(e,n,t){if(!Ma(n))throw Error(l(200));return Dr(null,e,n,!0,t)},Xe.render=function(e,n,t){if(!Ma(n))throw Error(l(200));return Dr(null,e,n,!1,t)},Xe.unmountComponentAtNode=function(e){if(!Ma(e))throw Error(l(40));return e._reactRootContainer?(Xc(function(){Dr(null,null,e,!1,function(){e._reactRootContainer=null,e[kt]=null})}),!0):!1},Xe.unstable_batchedUpdates=Qc,Xe.unstable_createPortal=function(e,n){return sd(e,n,2<arguments.length&&arguments[2]!==void 0?arguments[2]:null)},Xe.unstable_renderSubtreeIntoContainer=function(e,n,t,a){if(!Ma(t))throw Error(l(200));if(e==null||e._reactInternals===void 0)throw Error(l(38));return Dr(e,n,t,!1,a)},Xe.version="17.0.2",Xe}var fd;function Mh(){if(fd)return _i.exports;fd=1;function o(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(o)}catch(r){console.error(r)}}return o(),_i.exports=Ph(),_i.exports}var ep=Mh();const Lh=Wr(ep);function as(o,r){return as=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(s,l){return s.__proto__=l,s},as(o,r)}function vn(o,r){o.prototype=Object.create(r.prototype),o.prototype.constructor=o,as(o,r)}var Wi={exports:{}},Yi,vd;function Rh(){if(vd)return Yi;vd=1;var o="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";return Yi=o,Yi}var Vi,bd;function jh(){if(bd)return Vi;bd=1;var o=Rh();function r(){}function s(){}return s.resetWarningCache=r,Vi=function(){function l(m,b,g,v,y,S){if(S!==o){var T=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw T.name="Invariant Violation",T}}l.isRequired=l;function c(){return l}var h={array:l,bigint:l,bool:l,func:l,number:l,object:l,string:l,symbol:l,any:l,arrayOf:c,element:l,elementType:l,instanceOf:c,node:l,objectOf:c,oneOf:c,oneOfType:c,shape:c,exact:c,checkPropTypes:s,resetWarningCache:r};return h.PropTypes=h,h},Vi}var yd;function Nh(){return yd||(yd=1,Wi.exports=jh()()),Wi.exports}var Dh=Nh();const xd=Wr(Dh);function Fe(){return Fe=Object.assign?Object.assign.bind():function(o){for(var r=1;r<arguments.length;r++){var s=arguments[r];for(var l in s)({}).hasOwnProperty.call(s,l)&&(o[l]=s[l])}return o},Fe.apply(null,arguments)}function zr(o){return o.charAt(0)==="/"}function $i(o,r){for(var s=r,l=s+1,c=o.length;l<c;s+=1,l+=1)o[s]=o[l];o.pop()}function Fh(o,r){r===void 0&&(r="");var s=o&&o.split("/")||[],l=r&&r.split("/")||[],c=o&&zr(o),h=r&&zr(r),m=c||h;if(o&&zr(o)?l=s:s.length&&(l.pop(),l=l.concat(s)),!l.length)return"/";var b;if(l.length){var g=l[l.length-1];b=g==="."||g===".."||g===""}else b=!1;for(var v=0,y=l.length;y>=0;y--){var S=l[y];S==="."?$i(l,y):S===".."?($i(l,y),v++):v&&($i(l,y),v--)}if(!m)for(;v--;v)l.unshift("..");m&&l[0]!==""&&(!l[0]||!zr(l[0]))&&l.unshift("");var T=l.join("/");return b&&T.substr(-1)!=="/"&&(T+="/"),T}function wd(o){return o.valueOf?o.valueOf():Object.prototype.valueOf.call(o)}function Br(o,r){if(o===r)return!0;if(o==null||r==null)return!1;if(Array.isArray(o))return Array.isArray(r)&&o.length===r.length&&o.every(function(c,h){return Br(c,r[h])});if(typeof o=="object"||typeof r=="object"){var s=wd(o),l=wd(r);return s!==o||l!==r?Br(s,l):Object.keys(Object.assign({},o,r)).every(function(c){return Br(o[c],r[c])})}return!1}var zh="Invariant failed";function Yn(o,r){throw new Error(zh)}function Fa(o){return o.charAt(0)==="/"?o:"/"+o}function kd(o){return o.charAt(0)==="/"?o.substr(1):o}function Oh(o,r){return o.toLowerCase().indexOf(r.toLowerCase())===0&&"/?#".indexOf(o.charAt(r.length))!==-1}function np(o,r){return Oh(o,r)?o.substr(r.length):o}function tp(o){return o.charAt(o.length-1)==="/"?o.slice(0,-1):o}function Bh(o){var r=o||"/",s="",l="",c=r.indexOf("#");c!==-1&&(l=r.substr(c),r=r.substr(0,c));var h=r.indexOf("?");return h!==-1&&(s=r.substr(h),r=r.substr(0,h)),{pathname:r,search:s==="?"?"":s,hash:l==="#"?"":l}}function Ke(o){var r=o.pathname,s=o.search,l=o.hash,c=r||"/";return s&&s!=="?"&&(c+=s.charAt(0)==="?"?s:"?"+s),l&&l!=="#"&&(c+=l.charAt(0)==="#"?l:"#"+l),c}function _e(o,r,s,l){var c;typeof o=="string"?(c=Bh(o),c.state=r):(c=Fe({},o),c.pathname===void 0&&(c.pathname=""),c.search?c.search.charAt(0)!=="?"&&(c.search="?"+c.search):c.search="",c.hash?c.hash.charAt(0)!=="#"&&(c.hash="#"+c.hash):c.hash="",r!==void 0&&c.state===void 0&&(c.state=r));try{c.pathname=decodeURI(c.pathname)}catch(h){throw h instanceof URIError?new URIError('Pathname "'+c.pathname+'" could not be decoded. This is likely caused by an invalid percent-encoding.'):h}return s&&(c.key=s),l?c.pathname?c.pathname.charAt(0)!=="/"&&(c.pathname=Fh(c.pathname,l.pathname)):c.pathname=l.pathname:c.pathname||(c.pathname="/"),c}function Gh(o,r){return o.pathname===r.pathname&&o.search===r.search&&o.hash===r.hash&&o.key===r.key&&Br(o.state,r.state)}function ps(){var o=null;function r(m){return o=m,function(){o===m&&(o=null)}}function s(m,b,g,v){if(o!=null){var y=typeof o=="function"?o(m,b):o;typeof y=="string"?typeof g=="function"?g(y,v):v(!0):v(y!==!1)}else v(!0)}var l=[];function c(m){var b=!0;function g(){b&&m.apply(void 0,arguments)}return l.push(g),function(){b=!1,l=l.filter(function(v){return v!==g})}}function h(){for(var m=arguments.length,b=new Array(m),g=0;g<m;g++)b[g]=arguments[g];l.forEach(function(v){return v.apply(void 0,b)})}return{setPrompt:r,confirmTransitionTo:s,appendListener:c,notifyListeners:h}}var ap=!!(typeof window<"u"&&window.document&&window.document.createElement);function rp(o,r){r(window.confirm(o))}function Hh(){var o=window.navigator.userAgent;return(o.indexOf("Android 2.")!==-1||o.indexOf("Android 4.0")!==-1)&&o.indexOf("Mobile Safari")!==-1&&o.indexOf("Chrome")===-1&&o.indexOf("Windows Phone")===-1?!1:window.history&&"pushState"in window.history}function _h(){return window.navigator.userAgent.indexOf("Trident")===-1}function qh(){return window.navigator.userAgent.indexOf("Firefox")===-1}function Uh(o){return o.state===void 0&&navigator.userAgent.indexOf("CriOS")===-1}var Cd="popstate",Sd="hashchange";function Td(){try{return window.history.state||{}}catch{return{}}}function Wh(o){o===void 0&&(o={}),ap||Yn();var r=window.history,s=Hh(),l=!_h(),c=o,h=c.forceRefresh,m=h===void 0?!1:h,b=c.getUserConfirmation,g=b===void 0?rp:b,v=c.keyLength,y=v===void 0?6:v,S=o.basename?tp(Fa(o.basename)):"";function T(_){var q=_||{},I=q.key,j=q.state,F=window.location,J=F.pathname,X=F.search,be=F.hash,Ce=J+X+be;return S&&(Ce=np(Ce,S)),_e(Ce,j,I)}function B(){return Math.random().toString(36).substr(2,y)}var D=ps();function P(_){Fe(z,_),z.length=r.length,D.notifyListeners(z.location,z.action)}function V(_){Uh(_)||H(T(_.state))}function R(){H(T(Td()))}var G=!1;function H(_){if(G)G=!1,P();else{var q="POP";D.confirmTransitionTo(_,q,g,function(I){I?P({action:q,location:_}):te(_)})}}function te(_){var q=z.location,I=U.indexOf(q.key);I===-1&&(I=0);var j=U.indexOf(_.key);j===-1&&(j=0);var F=I-j;F&&(G=!0,ne(F))}var M=T(Td()),U=[M.key];function $(_){return S+Ke(_)}function Y(_,q){var I="PUSH",j=_e(_,q,B(),z.location);D.confirmTransitionTo(j,I,g,function(F){if(F){var J=$(j),X=j.key,be=j.state;if(s)if(r.pushState({key:X,state:be},null,J),m)window.location.href=J;else{var Ce=U.indexOf(z.location.key),je=U.slice(0,Ce+1);je.push(j.key),U=je,P({action:I,location:j})}else window.location.href=J}})}function de(_,q){var I="REPLACE",j=_e(_,q,B(),z.location);D.confirmTransitionTo(j,I,g,function(F){if(F){var J=$(j),X=j.key,be=j.state;if(s)if(r.replaceState({key:X,state:be},null,J),m)window.location.replace(J);else{var Ce=U.indexOf(z.location.key);Ce!==-1&&(U[Ce]=j.key),P({action:I,location:j})}else window.location.replace(J)}})}function ne(_){r.go(_)}function pe(){ne(-1)}function ee(){ne(1)}var oe=0;function ge(_){oe+=_,oe===1&&_===1?(window.addEventListener(Cd,V),l&&window.addEventListener(Sd,R)):oe===0&&(window.removeEventListener(Cd,V),l&&window.removeEventListener(Sd,R))}var le=!1;function Pe(_){_===void 0&&(_=!1);var q=D.setPrompt(_);return le||(ge(1),le=!0),function(){return le&&(le=!1,ge(-1)),q()}}function A(_){var q=D.appendListener(_);return ge(1),function(){ge(-1),q()}}var z={length:r.length,action:"POP",location:M,createHref:$,push:Y,replace:de,go:ne,goBack:pe,goForward:ee,block:Pe,listen:A};return z}var Ad="hashchange",Yh={hashbang:{encodePath:function(r){return r.charAt(0)==="!"?r:"!/"+kd(r)},decodePath:function(r){return r.charAt(0)==="!"?r.substr(1):r}},noslash:{encodePath:kd,decodePath:Fa},slash:{encodePath:Fa,decodePath:Fa}};function op(o){var r=o.indexOf("#");return r===-1?o:o.slice(0,r)}function Ra(){var o=window.location.href,r=o.indexOf("#");return r===-1?"":o.substring(r+1)}function Vh(o){window.location.hash=o}function Ki(o){window.location.replace(op(window.location.href)+"#"+o)}function $h(o){o===void 0&&(o={}),ap||Yn();var r=window.history;qh();var s=o,l=s.getUserConfirmation,c=l===void 0?rp:l,h=s.hashType,m=h===void 0?"slash":h,b=o.basename?tp(Fa(o.basename)):"",g=Yh[m],v=g.encodePath,y=g.decodePath;function S(){var q=y(Ra());return b&&(q=np(q,b)),_e(q)}var T=ps();function B(q){Fe(_,q),_.length=r.length,T.notifyListeners(_.location,_.action)}var D=!1,P=null;function V(q,I){return q.pathname===I.pathname&&q.search===I.search&&q.hash===I.hash}function R(){var q=Ra(),I=v(q);if(q!==I)Ki(I);else{var j=S(),F=_.location;if(!D&&V(F,j)||P===Ke(j))return;P=null,G(j)}}function G(q){if(D)D=!1,B();else{var I="POP";T.confirmTransitionTo(q,I,c,function(j){j?B({action:I,location:q}):H(q)})}}function H(q){var I=_.location,j=$.lastIndexOf(Ke(I));j===-1&&(j=0);var F=$.lastIndexOf(Ke(q));F===-1&&(F=0);var J=j-F;J&&(D=!0,pe(J))}var te=Ra(),M=v(te);te!==M&&Ki(M);var U=S(),$=[Ke(U)];function Y(q){var I=document.querySelector("base"),j="";return I&&I.getAttribute("href")&&(j=op(window.location.href)),j+"#"+v(b+Ke(q))}function de(q,I){var j="PUSH",F=_e(q,void 0,void 0,_.location);T.confirmTransitionTo(F,j,c,function(J){if(J){var X=Ke(F),be=v(b+X),Ce=Ra()!==be;if(Ce){P=X,Vh(be);var je=$.lastIndexOf(Ke(_.location)),Ue=$.slice(0,je+1);Ue.push(X),$=Ue,B({action:j,location:F})}else B()}})}function ne(q,I){var j="REPLACE",F=_e(q,void 0,void 0,_.location);T.confirmTransitionTo(F,j,c,function(J){if(J){var X=Ke(F),be=v(b+X),Ce=Ra()!==be;Ce&&(P=X,Ki(be));var je=$.indexOf(Ke(_.location));je!==-1&&($[je]=X),B({action:j,location:F})}})}function pe(q){r.go(q)}function ee(){pe(-1)}function oe(){pe(1)}var ge=0;function le(q){ge+=q,ge===1&&q===1?window.addEventListener(Ad,R):ge===0&&window.removeEventListener(Ad,R)}var Pe=!1;function A(q){q===void 0&&(q=!1);var I=T.setPrompt(q);return Pe||(le(1),Pe=!0),function(){return Pe&&(Pe=!1,le(-1)),I()}}function z(q){var I=T.appendListener(q);return le(1),function(){le(-1),I()}}var _={length:r.length,action:"POP",location:U,createHref:Y,push:de,replace:ne,go:pe,goBack:ee,goForward:oe,block:A,listen:z};return _}function Id(o,r,s){return Math.min(Math.max(o,r),s)}function Kh(o){o===void 0&&(o={});var r=o,s=r.getUserConfirmation,l=r.initialEntries,c=l===void 0?["/"]:l,h=r.initialIndex,m=h===void 0?0:h,b=r.keyLength,g=b===void 0?6:b,v=ps();function y(Y){Fe($,Y),$.length=$.entries.length,v.notifyListeners($.location,$.action)}function S(){return Math.random().toString(36).substr(2,g)}var T=Id(m,0,c.length-1),B=c.map(function(Y){return typeof Y=="string"?_e(Y,void 0,S()):_e(Y,void 0,Y.key||S())}),D=Ke;function P(Y,de){var ne="PUSH",pe=_e(Y,de,S(),$.location);v.confirmTransitionTo(pe,ne,s,function(ee){if(ee){var oe=$.index,ge=oe+1,le=$.entries.slice(0);le.length>ge?le.splice(ge,le.length-ge,pe):le.push(pe),y({action:ne,location:pe,index:ge,entries:le})}})}function V(Y,de){var ne="REPLACE",pe=_e(Y,de,S(),$.location);v.confirmTransitionTo(pe,ne,s,function(ee){ee&&($.entries[$.index]=pe,y({action:ne,location:pe}))})}function R(Y){var de=Id($.index+Y,0,$.entries.length-1),ne="POP",pe=$.entries[de];v.confirmTransitionTo(pe,ne,s,function(ee){ee?y({action:ne,location:pe,index:de}):y()})}function G(){R(-1)}function H(){R(1)}function te(Y){var de=$.index+Y;return de>=0&&de<$.entries.length}function M(Y){return Y===void 0&&(Y=!1),v.setPrompt(Y)}function U(Y){return v.appendListener(Y)}var $={length:B.length,action:"POP",location:B[T],index:T,entries:B,createHref:D,push:P,replace:V,go:R,goBack:G,goForward:H,canGo:te,block:M,listen:U};return $}var ot={exports:{}},Ji,Ed;function Jh(){return Ed||(Ed=1,Ji=Array.isArray||function(o){return Object.prototype.toString.call(o)=="[object Array]"}),Ji}var Pd;function Qh(){if(Pd)return ot.exports;Pd=1;var o=Jh();ot.exports=V,ot.exports.parse=s,ot.exports.compile=c,ot.exports.tokensToFunction=b,ot.exports.tokensToRegExp=P;var r=new RegExp(["(\\\\.)","([\\/.])?(?:(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?|(\\*))"].join("|"),"g");function s(R,G){for(var H=[],te=0,M=0,U="",$=G&&G.delimiter||"/",Y;(Y=r.exec(R))!=null;){var de=Y[0],ne=Y[1],pe=Y.index;if(U+=R.slice(M,pe),M=pe+de.length,ne){U+=ne[1];continue}var ee=R[M],oe=Y[2],ge=Y[3],le=Y[4],Pe=Y[5],A=Y[6],z=Y[7];U&&(H.push(U),U="");var _=oe!=null&&ee!=null&&ee!==oe,q=A==="+"||A==="*",I=A==="?"||A==="*",j=oe||$,F=le||Pe,J=oe||(typeof H[H.length-1]=="string"?H[H.length-1]:"");H.push({name:ge||te++,prefix:oe||"",delimiter:j,optional:I,repeat:q,partial:_,asterisk:!!z,pattern:F?v(F):z?".*":l(j,J)})}return M<R.length&&(U+=R.substr(M)),U&&H.push(U),H}function l(R,G){return!G||G.indexOf(R)>-1?"[^"+g(R)+"]+?":g(G)+"|(?:(?!"+g(G)+")[^"+g(R)+"])+?"}function c(R,G){return b(s(R,G),G)}function h(R){return encodeURI(R).replace(/[\/?#]/g,function(G){return"%"+G.charCodeAt(0).toString(16).toUpperCase()})}function m(R){return encodeURI(R).replace(/[?#]/g,function(G){return"%"+G.charCodeAt(0).toString(16).toUpperCase()})}function b(R,G){for(var H=new Array(R.length),te=0;te<R.length;te++)typeof R[te]=="object"&&(H[te]=new RegExp("^(?:"+R[te].pattern+")$",S(G)));return function(M,U){for(var $="",Y=M||{},de=U||{},ne=de.pretty?h:encodeURIComponent,pe=0;pe<R.length;pe++){var ee=R[pe];if(typeof ee=="string"){$+=ee;continue}var oe=Y[ee.name],ge;if(oe==null)if(ee.optional){ee.partial&&($+=ee.prefix);continue}else throw new TypeError('Expected "'+ee.name+'" to be defined');if(o(oe)){if(!ee.repeat)throw new TypeError('Expected "'+ee.name+'" to not repeat, but received `'+JSON.stringify(oe)+"`");if(oe.length===0){if(ee.optional)continue;throw new TypeError('Expected "'+ee.name+'" to not be empty')}for(var le=0;le<oe.length;le++){if(ge=ne(oe[le]),!H[pe].test(ge))throw new TypeError('Expected all "'+ee.name+'" to match "'+ee.pattern+'", but received `'+JSON.stringify(ge)+"`");$+=(le===0?ee.prefix:ee.delimiter)+ge}continue}if(ge=ee.asterisk?m(oe):ne(oe),!H[pe].test(ge))throw new TypeError('Expected "'+ee.name+'" to match "'+ee.pattern+'", but received "'+ge+'"');$+=ee.prefix+ge}return $}}function g(R){return R.replace(/([.+*?=^!:${}()[\]|\/\\])/g,"\\$1")}function v(R){return R.replace(/([=!:$\/()])/g,"\\$1")}function y(R,G){return R.keys=G,R}function S(R){return R&&R.sensitive?"":"i"}function T(R,G){var H=R.source.match(/\((?!\?)/g);if(H)for(var te=0;te<H.length;te++)G.push({name:te,prefix:null,delimiter:null,optional:!1,repeat:!1,partial:!1,asterisk:!1,pattern:null});return y(R,G)}function B(R,G,H){for(var te=[],M=0;M<R.length;M++)te.push(V(R[M],G,H).source);var U=new RegExp("(?:"+te.join("|")+")",S(H));return y(U,G)}function D(R,G,H){return P(s(R,H),G,H)}function P(R,G,H){o(G)||(H=G||H,G=[]),H=H||{};for(var te=H.strict,M=H.end!==!1,U="",$=0;$<R.length;$++){var Y=R[$];if(typeof Y=="string")U+=g(Y);else{var de=g(Y.prefix),ne="(?:"+Y.pattern+")";G.push(Y),Y.repeat&&(ne+="(?:"+de+ne+")*"),Y.optional?Y.partial?ne=de+"("+ne+")?":ne="(?:"+de+"("+ne+"))?":ne=de+"("+ne+")",U+=ne}}var pe=g(H.delimiter||"/"),ee=U.slice(-pe.length)===pe;return te||(U=(ee?U.slice(0,-pe.length):U)+"(?:"+pe+"(?=$))?"),M?U+="$":U+=te&&ee?"":"(?="+pe+"|$)",y(new RegExp("^"+U,S(H)),G)}function V(R,G,H){return o(G)||(H=G||H,G=[]),H=H||{},R instanceof RegExp?T(R,G):o(R)?B(R,G,H):D(R,G,H)}return ot.exports}var Xh=Qh();const ip=Wr(Xh);var Qi={exports:{}},we={};var Md;function Zh(){if(Md)return we;Md=1;var o=typeof Symbol=="function"&&Symbol.for,r=o?Symbol.for("react.element"):60103,s=o?Symbol.for("react.portal"):60106,l=o?Symbol.for("react.fragment"):60107,c=o?Symbol.for("react.strict_mode"):60108,h=o?Symbol.for("react.profiler"):60114,m=o?Symbol.for("react.provider"):60109,b=o?Symbol.for("react.context"):60110,g=o?Symbol.for("react.async_mode"):60111,v=o?Symbol.for("react.concurrent_mode"):60111,y=o?Symbol.for("react.forward_ref"):60112,S=o?Symbol.for("react.suspense"):60113,T=o?Symbol.for("react.suspense_list"):60120,B=o?Symbol.for("react.memo"):60115,D=o?Symbol.for("react.lazy"):60116,P=o?Symbol.for("react.block"):60121,V=o?Symbol.for("react.fundamental"):60117,R=o?Symbol.for("react.responder"):60118,G=o?Symbol.for("react.scope"):60119;function H(M){if(typeof M=="object"&&M!==null){var U=M.$$typeof;switch(U){case r:switch(M=M.type,M){case g:case v:case l:case h:case c:case S:return M;default:switch(M=M&&M.$$typeof,M){case b:case y:case D:case B:case m:return M;default:return U}}case s:return U}}}function te(M){return H(M)===v}return we.AsyncMode=g,we.ConcurrentMode=v,we.ContextConsumer=b,we.ContextProvider=m,we.Element=r,we.ForwardRef=y,we.Fragment=l,we.Lazy=D,we.Memo=B,we.Portal=s,we.Profiler=h,we.StrictMode=c,we.Suspense=S,we.isAsyncMode=function(M){return te(M)||H(M)===g},we.isConcurrentMode=te,we.isContextConsumer=function(M){return H(M)===b},we.isContextProvider=function(M){return H(M)===m},we.isElement=function(M){return typeof M=="object"&&M!==null&&M.$$typeof===r},we.isForwardRef=function(M){return H(M)===y},we.isFragment=function(M){return H(M)===l},we.isLazy=function(M){return H(M)===D},we.isMemo=function(M){return H(M)===B},we.isPortal=function(M){return H(M)===s},we.isProfiler=function(M){return H(M)===h},we.isStrictMode=function(M){return H(M)===c},we.isSuspense=function(M){return H(M)===S},we.isValidElementType=function(M){return typeof M=="string"||typeof M=="function"||M===l||M===v||M===h||M===c||M===S||M===T||typeof M=="object"&&M!==null&&(M.$$typeof===D||M.$$typeof===B||M.$$typeof===m||M.$$typeof===b||M.$$typeof===y||M.$$typeof===V||M.$$typeof===R||M.$$typeof===G||M.$$typeof===P)},we.typeOf=H,we}var Ld;function sp(){return Ld||(Ld=1,Qi.exports=Zh()),Qi.exports}sp();function Yr(o,r){if(o==null)return{};var s={};for(var l in o)if({}.hasOwnProperty.call(o,l)){if(r.indexOf(l)!==-1)continue;s[l]=o[l]}return s}var Xi,Rd;function em(){if(Rd)return Xi;Rd=1;var o=sp(),r={childContextTypes:!0,contextType:!0,contextTypes:!0,defaultProps:!0,displayName:!0,getDefaultProps:!0,getDerivedStateFromError:!0,getDerivedStateFromProps:!0,mixins:!0,propTypes:!0,type:!0},s={name:!0,length:!0,prototype:!0,caller:!0,callee:!0,arguments:!0,arity:!0},l={$$typeof:!0,render:!0,defaultProps:!0,displayName:!0,propTypes:!0},c={$$typeof:!0,compare:!0,defaultProps:!0,displayName:!0,propTypes:!0,type:!0},h={};h[o.ForwardRef]=l,h[o.Memo]=c;function m(D){return o.isMemo(D)?c:h[D.$$typeof]||r}var b=Object.defineProperty,g=Object.getOwnPropertyNames,v=Object.getOwnPropertySymbols,y=Object.getOwnPropertyDescriptor,S=Object.getPrototypeOf,T=Object.prototype;function B(D,P,V){if(typeof P!="string"){if(T){var R=S(P);R&&R!==T&&B(D,R,V)}var G=g(P);v&&(G=G.concat(v(P)));for(var H=m(D),te=m(P),M=0;M<G.length;++M){var U=G[M];if(!s[U]&&!(V&&V[U])&&!(te&&te[U])&&!(H&&H[U])){var $=y(P,U);try{b(D,U,$)}catch{}}}}return D}return Xi=B,Xi}em();var Zi=1073741823,jd=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:{};function nm(){var o="__global_unique_id__";return jd[o]=(jd[o]||0)+1}function tm(o,r){return o===r?o!==0||1/o===1/r:o!==o&&r!==r}function am(o){var r=[];return{on:function(l){r.push(l)},off:function(l){r=r.filter(function(c){return c!==l})},get:function(){return o},set:function(l,c){o=l,r.forEach(function(h){return h(o,c)})}}}function rm(o){return Array.isArray(o)?o[0]:o}function om(o,r){var s,l,c="__create-react-context-"+nm()+"__",h=(function(b){vn(g,b);function g(){for(var y,S=arguments.length,T=new Array(S),B=0;B<S;B++)T[B]=arguments[B];return y=b.call.apply(b,[this].concat(T))||this,y.emitter=am(y.props.value),y}var v=g.prototype;return v.getChildContext=function(){var S;return S={},S[c]=this.emitter,S},v.componentWillReceiveProps=function(S){if(this.props.value!==S.value){var T=this.props.value,B=S.value,D;tm(T,B)?D=0:(D=typeof r=="function"?r(T,B):Zi,D|=0,D!==0&&this.emitter.set(S.value,D))}},v.render=function(){return this.props.children},g})(ve.Component);h.childContextTypes=(s={},s[c]=xd.object.isRequired,s);var m=(function(b){vn(g,b);function g(){for(var y,S=arguments.length,T=new Array(S),B=0;B<S;B++)T[B]=arguments[B];return y=b.call.apply(b,[this].concat(T))||this,y.observedBits=void 0,y.state={value:y.getValue()},y.onUpdate=function(D,P){var V=y.observedBits|0;(V&P)!==0&&y.setState({value:y.getValue()})},y}var v=g.prototype;return v.componentWillReceiveProps=function(S){var T=S.observedBits;this.observedBits=T??Zi},v.componentDidMount=function(){this.context[c]&&this.context[c].on(this.onUpdate);var S=this.props.observedBits;this.observedBits=S??Zi},v.componentWillUnmount=function(){this.context[c]&&this.context[c].off(this.onUpdate)},v.getValue=function(){return this.context[c]?this.context[c].get():o},v.render=function(){return rm(this.props.children)(this.state.value)},g})(ve.Component);return m.contextTypes=(l={},l[c]=xd.object,l),{Provider:h,Consumer:m}}var im=ve.createContext||om,lp=function(r){var s=im();return s.displayName=r,s},cp=lp("Router-History"),Wn=lp("Router"),Vr=(function(o){vn(r,o),r.computeRootMatch=function(c){return{path:"/",url:"/",params:{},isExact:c==="/"}};function r(l){var c;return c=o.call(this,l)||this,c.state={location:l.history.location},c._isMounted=!1,c._pendingLocation=null,l.staticContext||(c.unlisten=l.history.listen(function(h){c._pendingLocation=h})),c}var s=r.prototype;return s.componentDidMount=function(){var c=this;this._isMounted=!0,this.unlisten&&this.unlisten(),this.props.staticContext||(this.unlisten=this.props.history.listen(function(h){c._isMounted&&c.setState({location:h})})),this._pendingLocation&&this.setState({location:this._pendingLocation})},s.componentWillUnmount=function(){this.unlisten&&(this.unlisten(),this._isMounted=!1,this._pendingLocation=null)},s.render=function(){return ve.createElement(Wn.Provider,{value:{history:this.props.history,location:this.state.location,match:r.computeRootMatch(this.state.location.pathname),staticContext:this.props.staticContext}},ve.createElement(cp.Provider,{children:this.props.children||null,value:this.props.history}))},r})(ve.Component);ve.Component;var sm=(function(o){vn(r,o);function r(){return o.apply(this,arguments)||this}var s=r.prototype;return s.componentDidMount=function(){this.props.onMount&&this.props.onMount.call(this,this)},s.componentDidUpdate=function(c){this.props.onUpdate&&this.props.onUpdate.call(this,this,c)},s.componentWillUnmount=function(){this.props.onUnmount&&this.props.onUnmount.call(this,this)},s.render=function(){return null},r})(ve.Component),es={},lm=1e4,Nd=0;function cm(o){if(es[o])return es[o];var r=ip.compile(o);return Nd<lm&&(es[o]=r,Nd++),r}function Dd(o,r){return o===void 0&&(o="/"),r===void 0&&(r={}),o==="/"?o:cm(o)(r,{pretty:!0})}function Ot(o){var r=o.computedMatch,s=o.to,l=o.push,c=l===void 0?!1:l;return ve.createElement(Wn.Consumer,null,function(h){h||Yn();var m=h.history,b=h.staticContext,g=c?m.push:m.replace,v=_e(r?typeof s=="string"?Dd(s,r.params):Fe({},s,{pathname:Dd(s.pathname,r.params)}):s);return b?(g(v),null):ve.createElement(sm,{onMount:function(){g(v)},onUpdate:function(S,T){var B=_e(T.to);Gh(B,Fe({},v,{key:B.key}))||g(v)},to:s})})}var Fd={},dm=1e4,zd=0;function pm(o,r){var s=""+r.end+r.strict+r.sensitive,l=Fd[s]||(Fd[s]={});if(l[o])return l[o];var c=[],h=ip(o,c,r),m={regexp:h,keys:c};return zd<dm&&(l[o]=m,zd++),m}function us(o,r){r===void 0&&(r={}),(typeof r=="string"||Array.isArray(r))&&(r={path:r});var s=r,l=s.path,c=s.exact,h=c===void 0?!1:c,m=s.strict,b=m===void 0?!1:m,g=s.sensitive,v=g===void 0?!1:g,y=[].concat(l);return y.reduce(function(S,T){if(!T&&T!=="")return null;if(S)return S;var B=pm(T,{end:h,strict:b,sensitive:v}),D=B.regexp,P=B.keys,V=D.exec(o);if(!V)return null;var R=V[0],G=V.slice(1),H=o===R;return h&&!H?null:{path:T,url:T==="/"&&R===""?"/":R,isExact:H,params:P.reduce(function(te,M,U){return te[M.name]=G[U],te},{})}},null)}function um(o){return ve.Children.count(o)===0}var sn=(function(o){vn(r,o);function r(){return o.apply(this,arguments)||this}var s=r.prototype;return s.render=function(){var c=this;return ve.createElement(Wn.Consumer,null,function(h){h||Yn();var m=c.props.location||h.location,b=c.props.computedMatch?c.props.computedMatch:c.props.path?us(m.pathname,c.props):h.match,g=Fe({},h,{location:m,match:b}),v=c.props,y=v.children,S=v.component,T=v.render;return Array.isArray(y)&&um(y)&&(y=null),ve.createElement(Wn.Provider,{value:g},g.match?y?typeof y=="function"?y(g):y:S?ve.createElement(S,g):T?T(g):null:typeof y=="function"?y(g):null)})},r})(ve.Component);function hs(o){return o.charAt(0)==="/"?o:"/"+o}function hm(o,r){return o?Fe({},r,{pathname:hs(o)+r.pathname}):r}function mm(o,r){if(!o)return r;var s=hs(o);return r.pathname.indexOf(s)!==0?r:Fe({},r,{pathname:r.pathname.substr(s.length)})}function Od(o){return typeof o=="string"?o:Ke(o)}function ns(o){return function(){Yn()}}function Bd(){}ve.Component;var Gd=(function(o){vn(r,o);function r(){return o.apply(this,arguments)||this}var s=r.prototype;return s.render=function(){var c=this;return ve.createElement(Wn.Consumer,null,function(h){h||Yn();var m=c.props.location||h.location,b,g;return ve.Children.forEach(c.props.children,function(v){if(g==null&&ve.isValidElement(v)){b=v;var y=v.props.path||v.props.from;g=y?us(m.pathname,Fe({},v.props,{path:y})):h.match}}),g?ve.cloneElement(b,{location:m,computedMatch:g}):null})},r})(ve.Component),dp=ve.useContext;function pp(){return dp(cp)}function $r(){return dp(Wn).location}var gm=(function(o){vn(r,o);function r(){for(var l,c=arguments.length,h=new Array(c),m=0;m<c;m++)h[m]=arguments[m];return l=o.call.apply(o,[this].concat(h))||this,l.history=Wh(l.props),l}var s=r.prototype;return s.render=function(){return ve.createElement(Vr,{history:this.history,children:this.props.children})},r})(ve.Component);ve.Component;var rs=function(r,s){return typeof r=="function"?r(s):r},os=function(r,s){return typeof r=="string"?_e(r,null,null,s):r},ms=function(r){return r},Bt=ve.forwardRef;typeof Bt>"u"&&(Bt=ms);function fm(o){return!!(o.metaKey||o.altKey||o.ctrlKey||o.shiftKey)}var vm=Bt(function(o,r){var s=o.innerRef,l=o.navigate,c=o.onClick,h=Yr(o,["innerRef","navigate","onClick"]),m=h.target,b=Fe({},h,{onClick:function(v){try{c&&c(v)}catch(y){throw v.preventDefault(),y}!v.defaultPrevented&&v.button===0&&(!m||m==="_self")&&!fm(v)&&(v.preventDefault(),l())}});return ms!==Bt?b.ref=r||s:b.ref=s,ve.createElement("a",b)}),Re=Bt(function(o,r){var s=o.component,l=s===void 0?vm:s,c=o.replace,h=o.to,m=o.innerRef,b=Yr(o,["component","replace","to","innerRef"]);return ve.createElement(Wn.Consumer,null,function(g){g||Yn();var v=g.history,y=os(rs(h,g.location),g.location),S=y?v.createHref(y):"",T=Fe({},b,{href:S,navigate:function(){var D=rs(h,g.location),P=Ke(g.location)===Ke(os(D)),V=c||P?v.replace:v.push;V(D)}});return ms!==Bt?T.ref=r||m:T.innerRef=m,ve.createElement(l,T)})}),up=function(r){return r},Gr=ve.forwardRef;typeof Gr>"u"&&(Gr=up);function bm(){for(var o=arguments.length,r=new Array(o),s=0;s<o;s++)r[s]=arguments[s];return r.filter(function(l){return l}).join(" ")}var hp=Gr(function(o,r){var s=o["aria-current"],l=s===void 0?"page":s,c=o.activeClassName,h=c===void 0?"active":c,m=o.activeStyle,b=o.className,g=o.exact,v=o.isActive,y=o.location,S=o.sensitive,T=o.strict,B=o.style,D=o.to,P=o.innerRef,V=Yr(o,["aria-current","activeClassName","activeStyle","className","exact","isActive","location","sensitive","strict","style","to","innerRef"]);return ve.createElement(Wn.Consumer,null,function(R){R||Yn();var G=y||R.location,H=os(rs(D,G),G),te=H.pathname,M=te&&te.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1"),U=M?us(G.pathname,{path:M,exact:g,sensitive:S,strict:T}):null,$=!!(v?v(U,G):U),Y=typeof b=="function"?b($):b,de=typeof B=="function"?B($):B;$&&(Y=bm(Y,h),de=Fe({},de,m));var ne=Fe({"aria-current":$&&l||null,className:Y,style:de,to:H},V);return up!==Gr?ne.ref=r||P:ne.innerRef=P,ve.createElement(Re,ne)})});const Hd=[{id:"github",label:"GitHub",href:"https://github.com/radhakishan404"},{id:"linkedin",label:"LinkedIn",href:"https://www.linkedin.com/in/radhakishanjangid"},{id:"x",label:"X",href:"https://x.com/radhakishan404"},{id:"dev",label:"DEV",href:"https://dev.to/radhakishanjangid404"},{id:"instagram",label:"Instagram",href:"https://www.instagram.com/rk.codex"},{id:"youtube",label:"YouTube",href:"https://www.youtube.com/@rk-codex"},{id:"email",label:"Email",href:"mailto:radhakishanjangid404@gmail.com"}],ym=[{label:"radhakishanjangid404@gmail.com",href:"mailto:radhakishanjangid404@gmail.com",external:!1},{label:"GitHub",href:"https://github.com/radhakishan404",external:!0},{label:"LinkedIn",href:"https://www.linkedin.com/in/radhakishanjangid",external:!0},{label:"DEV",href:"https://dev.to/radhakishanjangid404",external:!0},{label:"Instagram (@rk.codex)",href:"https://www.instagram.com/rk.codex",external:!0},{label:"YouTube (@rk-codex)",href:"https://www.youtube.com/@rk-codex",external:!0}],xm=[{id:"reel-1",url:"https://www.instagram.com/reel/DYmMAsOAkkn/",title:"Latest Reel"},{id:"reel-2",url:"https://www.instagram.com/reel/DYmXsbZIzOC/",title:"Dev Content"},{id:"reel-3",url:"https://www.instagram.com/reel/DXeawN8CH29/",title:"Code Shorts"},{id:"reel-4",url:"https://www.instagram.com/reel/DW6FmJ3vnya/",title:"Tech Tips"}],wm=[{id:"yt-1",url:"https://youtu.be/q43dRwbXc7o",embedId:"q43dRwbXc7o",title:"Video 1"},{id:"yt-2",url:"https://youtu.be/cUN2iLUzJXA",embedId:"cUN2iLUzJXA",title:"Video 2"}];function km(o=[]){ae.useEffect(()=>{if(typeof window>"u"||typeof document>"u")return;const r=window.matchMedia("(prefers-reduced-motion: reduce)").matches,s=new WeakSet,l=!r&&"IntersectionObserver"in window?new IntersectionObserver(b=>{b.forEach(g=>{g.isIntersecting&&(g.target.classList.add("is-revealed"),l.unobserve(g.target))})},{threshold:.12,rootMargin:"0px 0px -8% 0px"}):null,c=b=>{if(!(!(b instanceof HTMLElement)||s.has(b))){if(s.add(b),r||!l){b.classList.add("is-revealed");return}l.observe(b)}},h=()=>{document.querySelectorAll("[data-reveal], [data-reveal-3d], .clip-reveal:not(.is-revealed)").forEach(c)};h();const m=new MutationObserver(h);return m.observe(document.body,{childList:!0,subtree:!0}),()=>{m.disconnect(),l&&l.disconnect()}},o)}function Cm(){const o=ae.useRef(null),r=ae.useRef(null);return ae.useEffect(()=>{const s=o.current,l=r.current;if(!s||!l)return;if(window.matchMedia("(pointer: coarse)").matches||window.matchMedia("(prefers-reduced-motion: reduce)").matches){s.style.display="none",l.style.display="none";return}let c=-100,h=-100,m=-100,b=-100,g=1,v=1;const y=B=>{c=B.clientX,h=B.clientY},S=B=>{v=B.target.closest("a, button, [data-cursor-hover], .project-card, .public-card, .skill-card, .article-list-item, .filter-chip")?2.2:1},T=()=>{m+=(c-m)*.15,b+=(h-b)*.15,g+=(v-g)*.12,s.style.transform=`translate(${c-4}px, ${h-4}px)`,l.style.transform=`translate(${m-18}px, ${b-18}px) scale(${g})`,requestAnimationFrame(T)};return document.addEventListener("mousemove",y),document.addEventListener("mouseover",S),requestAnimationFrame(T),document.documentElement.classList.add("has-custom-cursor"),()=>{document.removeEventListener("mousemove",y),document.removeEventListener("mouseover",S),document.documentElement.classList.remove("has-custom-cursor")}},[]),p.jsxs(p.Fragment,{children:[p.jsx("div",{ref:o,className:"cursor-dot"}),p.jsx("div",{ref:r,className:"cursor-ring"})]})}function Sm({children:o}){const r=$r(),[s,l]=ae.useState(!0),[c,h]=ae.useState(r.key);return ae.useEffect(()=>{if(r.key===c)return;l(!1);const m=setTimeout(()=>{h(r.key),window.scrollTo(0,0),l(!0)},300);return()=>clearTimeout(m)},[r.key,c]),p.jsx("div",{className:`page-transition${s?" is-visible":""}`,children:o})}function Tm(){const o=ae.useRef(null);return ae.useEffect(()=>{const r=o.current;if(!r)return;const s=()=>{const l=window.scrollY,c=document.documentElement.scrollHeight-window.innerHeight,h=c>0?Math.min(l/c,1):0;r.style.transform=`scaleX(${h})`};return window.addEventListener("scroll",s,{passive:!0}),s(),()=>window.removeEventListener("scroll",s)},[]),p.jsx("div",{ref:o,className:"scroll-progress"})}const mp=[{label:"Home",to:"/",icon:"M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0a1 1 0 01-1-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 01-1 1"},{label:"About",to:"/about",icon:"M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"},{label:"Projects",to:"/projects",icon:"M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"},{label:"Articles",to:"/articles",icon:"M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"},{label:"Contact",to:"/contact",icon:"M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"}];function Am({open:o,onClose:r}){const s=$r();return ae.useEffect(()=>{r()},[s.pathname]),ep.createPortal(p.jsx("div",{className:`mobile-overlay${o?" is-open":""}`,onClick:r,children:p.jsxs("nav",{className:`mobile-nav${o?" is-open":""}`,"aria-label":"Mobile",onClick:l=>l.stopPropagation(),children:[p.jsx("div",{className:"mobile-nav-links",children:mp.map((l,c)=>p.jsxs(hp,{exact:l.to==="/",activeClassName:"is-active",className:"mobile-nav-link",to:l.to,onClick:r,style:{transitionDelay:o?`${c*50+100}ms`:"0ms"},children:[p.jsx("svg",{className:"mobile-nav-icon",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round",children:p.jsx("path",{d:l.icon})}),p.jsx("span",{children:l.label}),p.jsx("svg",{className:"mobile-nav-arrow",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:p.jsx("path",{d:"M9 5l7 7-7 7"})})]},l.to))}),p.jsxs("div",{className:"mobile-nav-footer",children:[p.jsx("p",{children:"Radhakishan Jangid"}),p.jsx("span",{children:"Senior Software Engineer"})]})]})}),document.body)}function Im(){const[o,r]=ae.useState(!1),s=$r();return ae.useEffect(()=>{r(!1)},[s.pathname]),ae.useEffect(()=>(document.body.classList.toggle("nav-open",o),()=>document.body.classList.remove("nav-open")),[o]),p.jsxs(p.Fragment,{children:[p.jsx("header",{className:`site-header${o?" menu-active":""}`,children:p.jsxs("div",{className:"header-inner",children:[p.jsx(Re,{className:"brand-text",to:"/",onClick:()=>r(!1),children:"RK"}),p.jsx("nav",{className:"primary-nav","aria-label":"Primary",children:mp.map(l=>p.jsx(hp,{exact:l.to==="/",activeClassName:"is-active",className:"nav-link",to:l.to,children:l.label},l.to))}),p.jsxs("button",{type:"button",className:`hamburger${o?" is-open":""}`,"aria-label":"Toggle navigation","aria-expanded":o,onClick:()=>r(l=>!l),children:[p.jsx("span",{className:"hamburger-line"}),p.jsx("span",{className:"hamburger-line"}),p.jsx("span",{className:"hamburger-line"})]})]})}),p.jsx(Am,{open:o,onClose:()=>r(!1)})]})}function gp({children:o}){const r=$r();return km([r.pathname]),p.jsxs(p.Fragment,{children:[p.jsx(Cm,{}),p.jsx(Tm,{}),p.jsx(Im,{}),p.jsx(Sm,{children:p.jsx("main",{children:o},r.pathname)}),p.jsxs("footer",{className:"site-footer",children:[p.jsxs("div",{className:"footer-inner",children:[p.jsxs("div",{className:"footer-brand-col",children:[p.jsx("h3",{children:"Radhakishan Jangid"}),p.jsx("p",{children:"Senior software engineer building product systems, frontend experiences, and technical content."})]}),p.jsxs("div",{className:"footer-col",children:[p.jsx("h4",{children:"Pages"}),p.jsx(Re,{to:"/",children:"Home"}),p.jsx(Re,{to:"/about",children:"About"}),p.jsx(Re,{to:"/projects",children:"Projects"}),p.jsx(Re,{to:"/articles",children:"Articles"}),p.jsx(Re,{to:"/contact",children:"Contact"}),p.jsx("a",{href:"/privacy-policy.html",children:"Privacy Policy"})]}),p.jsxs("div",{className:"footer-col",children:[p.jsx("h4",{children:"Connect"}),Hd.map(s=>p.jsx("a",{href:s.href,target:s.id==="email"?void 0:"_blank",rel:s.id==="email"?void 0:"noreferrer",children:s.label},s.id))]})]}),p.jsxs("div",{className:"footer-bottom",children:[p.jsxs("span",{children:["© ",new Date().getFullYear()," Radhakishan Jangid"]}),p.jsx("div",{className:"footer-social-row",children:Hd.filter(s=>s.id!=="email").map(s=>p.jsx("a",{href:s.href,target:"_blank",rel:"noreferrer",children:s.label},s.id))})]})]})]})}const Em=`---
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="A copy-ready collection of ChatGPT image prompts for creating cinematic Indian brand posters, menus, and product visuals.">
<meta name="keywords" content="ai image prompts, chatgpt image prompts, prompt engineering, indian brands, menu design, product posters, rk codex">
<meta name="date" content="2026-04-23T18:20:00+05:30">
<meta name="category" content="Prompt System">
<meta name="theme-color" content="#080808">
<meta property="article:published_time" content="2026-04-23T18:20:00+05:30">
<meta property="og:image" content="/prompt-images/first-image.png">
<title>rk.codex — 10 ChatGPT Image Prompts</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
...
<style>
  :root {
    ...
    --accent: #c8f53d;
    --accent-soft: rgba(200,245,61,0.1);
    --accent2: #e8e4dc;
    --text: #e8e4dc;
    --muted: #666;
    --muted-2: #444;
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  body:has(.prompt-card:hover) .cursor-ring {
    width: 52px;
    height: 52px;
    border-color: rgba(200,245,61,0.7);
  }
  ...
  .nav-count strong { color: var(--accent); }
  ...
  .hero::after {
    ...
    width: 600px;
    height: 600px;
    background: radial-gradient(circle, rgba(200,245,61,0.12) 0%, transparent 70%);
    pointer-events: none;
  }
  ...
  .prompt-card:hover {
    ...
    box-shadow: 0 20px 70px rgba(200,245,61,0.08);
  }
  ...
  .prompt-card:hover .prompt-image-wrap img {
    filter: saturate(1.08) contrast(1.12) brightness(0.95);
  ...
  /* Highlight key words */
  .prompt-text em { color: var(--accent2); font-style: normal; font-weight: 500; }
  ...
  .btn-copy:hover {
    ...
    box-shadow: 0 8px 24px rgba(200,245,61,0.22);
  }
  ...
  .card-8 .card-emoji,
  .card-9 .card-emoji,
  .card-10 .card-emoji { background: rgba(200,245,61,0.08); }
  ...
  .card-8,
  .card-9,
  .card-10 { border-top: 2px solid var(--accent); }
  ...
  .toast {
    ...
    box-shadow: 0 8px 30px rgba(200,245,61,0.25);
  }
  ...
  .reel-tip-inner {
    background: rgba(200,245,61,0.06);
  ...
  @media (max-width: 600px) {
    ...
    .hero,
    .section-header,
    .prompts-grid { padding-left: 20px; padding-right: 20px; }
    .hero-title { font-size: clamp(48px, 14vw, 72px); }
    .section-header { flex-direction: column; align-items: flex-start; }
    .prompts-grid { grid-template-columns: 1fr; }
    .hero-stats { gap: 24px; }
    .stat-num { font-size: 28px; }
    .reel-tip-inner { flex-direction: column; text-align: center; }
...
<nav>
  <a href="#" class="nav-logo">rk<span>.codex</span></a>
  <div class="nav-right">
    <span class="nav-count"><strong>10</strong> image prompts ready</span>
    <a href="https://instagram.com/rk.codex" target="_blank" class="nav-ig">@rk.codex</a>
  </div>
</nav>
...
<section class="hero">
  <div class="hero-grid-bg"></div>
  <div class="badge"><span class="badge-dot"></span> ChatGPT Images 2.0 — New Model</div>
  <h1 class="hero-title">
    <span>10 INSANE</span>
    <span class="lime">AI IMAGE</span>
    <span class="outline">PROMPTS.</span>
  </h1>
  <p class="hero-sub">Real Indian brand concepts, cinematic menu posters, product visuals, and ready-to-copy prompts built for ChatGPT image generation.</p>
  <a href="https://instagram.com/rk.codex" target="_blank" class="insta-handle">
    <div class="insta-inner">
      <svg class="insta-icon" viewBox="0 0 24 24" fill="none">
        <defs>
  ...
  <div class="hero-stats">
    <div class="stat"><div class="stat-num">10</div><div class="stat-label">Prompts</div></div>
    <div class="stat"><div class="stat-num">🇮🇳</div><div class="stat-label">Indian Brands</div></div>
    <div class="stat"><div class="stat-num">2K</div><div class="stat-label">Resolution</div></div>
    <div class="stat"><div class="stat-num">FREE</div><div class="stat-label">To Use</div></div>
  </div>
</section>

<!-- REEL TIP -->
<div class="reel-tip">
  <div class="reel-tip-inner">
    <div class="tip-icon">🎬</div>
    <div>
      <div class="tip-title">How To Use For Your Reel</div>
      <div class="tip-text">
        <strong>Step 1</strong> — Copy any prompt below → <strong>Step 2</strong> — Paste in ChatGPT (use GPT-4o or Images 2.0) → <strong>Step 3</strong> — Screen record the generation → <strong>Step 4</strong> — Post the reveal on your reel. Drop the prompt in comments to boost engagement 🔥
      </div>
    </div>
  </div>
</div>
...
<div class="section-header">
  <div>
    ...
    <h2 class="section-title">Copy-ready image prompts with visual references.</h2>
  </div>
...
<div class="prompts-grid">
  ...
  <!-- 1. Barbeque Nation -->
  <div class="prompt-card card-1">
    <div class="card-header">
      <div class="card-left">
        <div class="card-emoji">🥘</div>
        <div class="card-info">
          <div class="card-num">Prompt 01</div>
          <div class="card-brand">Barbeque Nation</div>
          <div class="card-subtitle">Live Grill Night Menu</div>
        </div>
      </div>
      <a href="https://www.barbeque-nation.com" target="_blank" class="card-link">
        🔗 View Brand
      </a>
    </div>
    <div class="prompt-image-wrap">
      <img src="/prompt-images/first-image.png" alt="Generated Barbeque Nation prompt preview">
      <span class="image-caption">Generated Preview 01</span>
    </div>
    <div class="card-body">
      <div class="prompt-label">ChatGPT Prompt</div>
      <div class="prompt-text" id="p1">Design a premium dinner menu poster for Barbeque Nation India — India's most famous live grill buffet restaurant chain. Dark smoky black background with glowing orange and red ember fire effects around the border, like a live coal grill. Bold serif gold typography. Header: 'BARBEQUE NATION — Unlimited Grill Feast' with a small golden flame icon. Two columns: LEFT — Veg Starters on the Grill: 'Paneer Malai Tikka — cottage cheese, cream cheese marinade, charcoal grilled', 'Corn on the Cob — smoky butter glaze, chilli flakes', 'Stuffed Mushroom — garlic herb filling, grilled on skewers', 'Veg Seekh Kebab — minced vegetables, green chilli, coriander'. RIGHT — Non-Veg Starters: 'Chicken Tangdi Kebab — drumstick, spiced yoghurt marinade, tandoor finish', 'Mutton Galouti Kebab — melt-in-mouth minced lamb patty', 'Fish Tikka — basa fillet, ajwain, lemon marinade, grilled'. Footer: 'Live Grill at Your Table • Unlimited Refills • ₹799 per person'. Ember glow lighting, rustic wood table texture in background. Ultra-photorealistic, 2K resolution.</div>
    </div>
    <div class="card-footer">
      <button class="btn-copy" onclick="copyPrompt('p1', this)">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
        Copy Prompt
      </button>
      <button class="btn-expand" onclick="toggleExpand('p1', this)">
  ...
  <!-- 2. Wow! Momo -->
  <div class="prompt-card card-2">
    <div class="card-header">
      <div class="card-left">
        <div class="card-emoji">🥟</div>
        <div class="card-info">
          <div class="card-num">Prompt 02</div>
          <div class="card-brand">Wow! Momo</div>
          <div class="card-subtitle">Street Neon Stall Menu</div>
        </div>
      </div>
      <a href="https://www.wowmomo.in" target="_blank" class="card-link">🔗 View Brand</a>
    </div>
    <div class="prompt-image-wrap">
      <img src="/prompt-images/second image.png" alt="Generated Wow Momo prompt preview">
      <span class="image-caption">Generated Preview 02</span>
    </div>
    <div class="card-body">
      <div class="prompt-label">ChatGPT Prompt</div>
      <div class="prompt-text" id="p2">Create a vibrant neon-lit street food stall menu board for Wow! Momo — India's biggest momo chain, founded in Kolkata. Background: blurred rainy evening Indian street with auto-rickshaws and colorful neon shop signs in the bokeh. Foreground: bright red and white Wow! Momo logo banner. Menu displayed on a lit board with bold white and yellow text: 'STEAMED MOMOS — Classic Veg ₹120 | Chicken ₹140 | Paneer ₹130'. 'PAN FRIED MOMOS — Crispy bottom, soft top — Veg ₹140 | Chicken ₹160'. 'TANDOORI MOMOS — Charcoal smoked, spicy mayo dip — ₹160'. 'CHOCO MOMOS — Nutella filled, sugar dusted — ₹150'. 'MOMO BURGER — Momo patty in toasted bun, cheese, sriracha — ₹180'. Add steam rising from a momo basket illustration. Street lighting, monsoon mood, wet pavement reflection. Ultra-detailed, cinematic, 2K resolution.</div>
    </div>
    <div class="card-footer">
      <button class="btn-copy" onclick="copyPrompt('p2', this)">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
        Copy Prompt
      </button>
      <button class="btn-expand" onclick="toggleExpand('p2', this)">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
        Expand
      </button>
    </div>
  ...
  <!-- 3. Cafe Coffee Day -->
  <div class="prompt-card card-3">
    <div class="card-header">
      <div class="card-left">
        <div class="card-emoji">☕</div>
        <div class="card-info">
          <div class="card-num">Prompt 03</div>
          <div class="card-brand">Cafe Coffee Day</div>
          <div class="card-subtitle">Retro 90s College Café Menu</div>
        </div>
      </div>
      <a href="https://www.cafecoffeeday.com" target="_blank" class="card-link">🔗 View Brand</a>
    </div>
    <div class="prompt-image-wrap">
      <img src="/prompt-images/third images.png" alt="Generated Cafe Coffee Day prompt preview">
      <span class="image-caption">Generated Preview 03</span>
    </div>
    <div class="card-body">
      <div class="prompt-label">ChatGPT Prompt</div>
      <div class="prompt-text" id="p3">Design a nostalgic 1990s retro college café-style menu board for Cafe Coffee Day India — CCD, the café that defined a generation of Indian youth. Warm mustard yellow and brick red color palette, retro hand-painted signboard look, slight grunge and distressed texture. CCD square logo in retro illustration style at the top. Menu in bold vintage typewriter font: COFFEE — 'Classic Cappuccino ₹175 | Caramel Latte ₹215 | Cold Coffee with Ice Cream ₹195 | South Indian Filter Coffee ₹155'. BITES — 'Veg Grilled Sandwich ₹175 | Chicken Club Sandwich ₹225 | Chocolate Brownie ₹145 | Masala Maggi ₹135'. FRAPPE & SHAKES — 'Choco Fantasy Frappe ₹225 | Mango Mastani ₹215'. Decorative elements: cassette tape illustration, old Nokia phone doodle, retro bulletin board pins, love note scribbles. Tagline at bottom: 'A lot can happen over coffee.' Warm tungsten bulb lighting mood. Ultra-detailed, print-quality, 2K resolution.</div>
    </div>
    <div class="card-footer">
      <button class="btn-copy" onclick="copyPrompt('p3', this)">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
        Copy Prompt
      </button>
      <button class="btn-expand" onclick="toggleExpand('p3', this)">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
        Expand
      </button>
    </div>
  ...
  <!-- 4. Biryani By Kilo -->
  <div class="prompt-card card-4">
    <div class="card-header">
      <div class="card-left">
        <div class="card-emoji">🍛</div>
        <div class="card-info">
          <div class="card-num">Prompt 04</div>
          <div class="card-brand">Biryani By Kilo</div>
          <div class="card-subtitle">Royal Mughal Feast Menu</div>
        </div>
      </div>
      <a href="https://www.biryanibykilo.com" target="_blank" class="card-link">🔗 View Brand</a>
    </div>
    <div class="prompt-image-wrap">
      <img src="/prompt-images/fourth image.png" alt="Generated Biryani By Kilo prompt preview">
      <span class="image-caption">Generated Preview 04</span>
    </div>
    <div class="card-body">
      <div class="prompt-label">ChatGPT Prompt</div>
      <div class="prompt-text" id="p4">Create a royal Mughal-era feast menu card design for Biryani By Kilo — India's premium handi biryani delivery brand. Rich deep maroon and royal gold color palette. Ornate Mughal arch border with intricate jali lattice pattern, peacock feather motifs in corners. Center top: 'BIRYANI BY KILO' in bold gold calligraphic Urdu-inspired typography, tagline below: 'Dum Pukht. Slow Cooked. Served Fresh in Handi.' Menu listed in two elegant sections: BIRYANI HANDI: 'Lucknowi Chicken Dum Biryani — slow cooked 2-3 hours, saffron, aged basmati, rose water — 500g ₹549', 'Hyderabadi Mutton Biryani — kachchi style, caramelized onion, mint — 500g ₹649', 'Paneer Zafrani Biryani — saffron paneer, dry fruits, kewra — 500g ₹449', 'Chicken Tikka Biryani — chargrilled tikka layered in dum — 500g ₹569'. SIDES: 'Burhani Raita ₹79 | Dal Gosht ₹299 | Shahi Tukda ₹149'. Dum steam rising from a clay handi illustration. Warm candlelight ambiance. Ultra-realistic luxurious print quality, 2K resolution.</div>
    </div>
    <div class="card-footer">
      <button class="btn-copy" onclick="copyPrompt('p4', this)">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
        Copy Prompt
      </button>
      <button class="btn-expand" onclick="toggleExpand('p4', this)">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
        Expand
      </button>
    </div>
  ...
  <!-- 5. Farzi Cafe -->
  <div class="prompt-card card-5">
    <div class="card-header">
      <div class="card-left">
        <div class="card-emoji">🥗</div>
        <div class="card-info">
          <div class="card-num">Prompt 05</div>
          <div class="card-brand">Farzi Café</div>
          <div class="card-subtitle">Molecular Gastronomy Tasting Menu</div>
        </div>
      </div>
      <a href="https://www.farzicafe.com" target="_blank" class="card-link">🔗 View Brand</a>
    </div>
    <div class="prompt-image-wrap">
      <img src="/prompt-images/fifth iamge.png" alt="Generated Farzi Cafe prompt preview">
      <span class="image-caption">Generated Preview 05</span>
    </div>
    <div class="card-body">
      <div class="prompt-label">ChatGPT Prompt</div>
      <div class="prompt-text" id="p5">Design a modern, edgy tasting menu card for Farzi Café — India's most famous molecular gastronomy restaurant by Chef Zorawar Kalra, known for reinventing Indian street food with fine dining techniques. Dark slate grey background, matte finish, rose gold metallic typography, deconstructed Indian art motifs. Header: 'FARZI CAFÉ — The Art of Indian Reinvention'. Menu laid out as a tasting sequence: '01 — Pani Puri Shots — liquid nitrogen cooled spherified tamarind water, mint gel, semolina crisp'. '02 — Dal Baati Churma Deconstructed — smoked dal mousse, baati crumble, churma snow, ghee caviar'. '03 — Butter Chicken Lasagna — slow-cooked makhani sauce, béchamel, fresh pasta sheets, micro herbs — ₹695'. '04 — Gulab Jamun Cheesecake — warm rose syrup gel, saffron cream, pistachio dust — ₹395'. '05 — Pan India Tasting Board — 6 iconic street foods reimagined — ₹1,295'. Side illustration: ink-splash art of a chef mid-plating. Bold contrast, artsy layout. 2K resolution, luxury editorial style.</div>
    </div>
    <div class="card-footer">
      <button class="btn-copy" onclick="copyPrompt('p5', this)">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
        Copy Prompt
      </button>
      <button class="btn-expand" onclick="toggleExpand('p5', this)">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
        Expand
      </button>
    </div>
  ...
  <!-- 6. Saravana Bhavan -->
  <div class="prompt-card card-6">
    <div class="card-header">
      <div class="card-left">
        <div class="card-emoji">🍲</div>
        <div class="card-info">
          <div class="card-num">Prompt 06</div>
          <div class="card-brand">Saravana Bhavan</div>
          <div class="card-subtitle">South Indian Temple Town Menu</div>
        </div>
      </div>
      <a href="https://www.saravanabhavan.com" target="_blank" class="card-link">🔗 View Brand</a>
    </div>
    <div class="prompt-image-wrap">
      <img src="/prompt-images/6th image.png" alt="Generated Saravana Bhavan prompt preview">
      <span class="image-caption">Generated Preview 06</span>
    </div>
    <div class="card-body">
      <div class="prompt-label">ChatGPT Prompt</div>
      <div class="prompt-text" id="p6">Design a traditional South Indian temple-town inspired full menu board for Hotel Saravana Bhavan — one of the world's largest vegetarian restaurant chains, founded in Chennai in 1981. Ivory cream background with deep forest green and vermilion red borders. Kolam rangoli pattern decorating all four corners. Tamil Nadu temple gopuram silhouette as a subtle watermark behind the text. Header in Tamil and English: 'சாரவண பவன் — Saravana Bhavan'. Menu sections in clean serif typography: BREAKFAST: 'Plain Dosa ₹80 | Masala Dosa ₹100 | Rava Kesari ₹60 | Idli Sambar (2 pcs) ₹75 | Vada (2 pcs) ₹70 | Pongal ₹85'. MEALS: 'Full South Indian Meals — rice, rasam, sambar, 3 vegetables, papad, pickle, payasam — ₹195'. TIFFIN: 'Uttapam ₹95 | Appam with Coconut Milk ₹110 | Set Dosa ₹85'. SWEETS: 'Payasam ₹70 | Kesari ₹65 | Mysore Pak ₹90'. Small banana leaf illustration under each section. Warm turmeric and coconut oil-scented mood. Authentic, ultra-detailed, 2K resolution.</div>
    </div>
    <div class="card-footer">
      <button class="btn-copy" onclick="copyPrompt('p6', this)">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
        Copy Prompt
      </button>
      <button class="btn-expand" onclick="toggleExpand('p6', this)">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
        Expand
      </button>
    </div>
  ...
  <!-- 7. Licious -->
  <div class="prompt-card card-7">
    <div class="card-header">
      <div class="card-left">
        <div class="card-emoji">🍗</div>
        <div class="card-info">
          <div class="card-num">Prompt 07</div>
          <div class="card-brand">Licious</div>
          <div class="card-subtitle">Premium Meat Product Poster</div>
        </div>
      </div>
      <a href="https://www.licious.in" target="_blank" class="card-link">🔗 View Brand</a>
    </div>
    <div class="prompt-image-wrap">
      <img src="/prompt-images/7th image.png" alt="Generated Licious prompt preview">
      <span class="image-caption">Generated Preview 07</span>
    </div>
    <div class="card-body">
      <div class="prompt-label">ChatGPT Prompt</div>
      <div class="prompt-text" id="p7">Create a premium product showcase poster for Licious — India's leading fresh meat and seafood delivery brand. Clean modern white background with dark charcoal text, bold red Licious logo in top left corner. Hero center image described as: a perfectly styled, fresh raw chicken curry cut on a dark slate plate, surrounded by whole spices — black cardamom, cloves, green chilli, ginger root, fresh coriander — shot in professional food photography style with dramatic side lighting. Product details alongside: 'CHICKEN CURRY CUT — Farm Fresh | Antibiotic Free | No Preservatives'. Specs in clean typography: 'Weight: 500g | Delivers in 90 minutes | Freshness Guarantee'. Star rating: ★★★★★ 4.8 | 12,400 reviews. Bold red CTA button: 'ORDER NOW — ₹229'. Bottom strip: quality badges — 'Vacuum Packed | Temperature Controlled | Lab Tested'. Clean, minimal, e-commerce product hero poster style. Ultra-photorealistic food photography look, 2K resolution.</div>
    </div>
    <div class="card-footer">
      <button class="btn-copy" onclick="copyPrompt('p7', this)">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
        Copy Prompt
      </button>
      <button class="btn-expand" onclick="toggleExpand('p7', this)">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
        Expand
      </button>
    </div>
  ...
  <div class="prompt-card card-8">
    <div class="card-header">
      <div class="card-left">
        <div class="card-emoji">🧁</div>
        <div class="card-info">
          <div class="card-num">Prompt 08</div>
          <div class="card-brand">The Bombay Canteen</div>
          <div class="card-subtitle">Mumbai Heritage Cocktail Menu</div>
        </div>
      </div>
      <a href="https://www.thebombaycanteen.com" target="_blank" class="card-link">🔗 View Brand</a>
    </div>
    <div class="prompt-image-wrap">
      <img src="/prompt-images/8th image.png" alt="Generated The Bombay Canteen prompt preview">
      <span class="image-caption">Generated Preview 08</span>
    </div>
    <div class="card-body">
      <div class="prompt-label">ChatGPT Prompt</div>
      <div class="prompt-text" id="p8">Design a vintage Mumbai heritage-style cocktail and bites menu card for The Bombay Canteen — Mumbai's iconic farm-to-table modern Indian restaurant. Aged parchment sepia paper texture background. Art deco Bombay colonial era design — geometric borders, old Bombay tram and Victoria carriage illustrations, black and white vintage photography style inserts. Header: 'THE BOMBAY CANTEEN — Est. 2015, Lower Parel, Mumbai' in stamped letterpress typography. COCKTAILS section: 'Kaala Khatta Sour — kala namak vodka, kokum shrub, tamarind foam — ₹695', 'Bombay Mule — Goa cashew feni, ginger beer, lime, curry leaf ice — ₹745', 'Thandai Old Fashioned — spiced thandai whisky, rose bitters, almond milk — ₹795'. SMALL BITES: 'Vada Pav Sliders — house green chutney, garlic chutney, fried green chilli — ₹395', 'Bombil Fry — Bombay duck, rice flour batter, konkani masala — ₹595'. Footer: 'Celebrating the spirit of Bombay, one plate at a time.' Warm sepia lighting, elegant, nostalgic. 2K resolution, luxury print quality.</div>
    </div>
    <div class="card-footer">
      <button class="btn-copy" onclick="copyPrompt('p8', this)">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
        Copy Prompt
      </button>
      <button class="btn-expand" onclick="toggleExpand('p8', this)">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
        Expand
      </button>
    </div>
  ...
  <!-- 9. Paper Boat -->
  <div class="prompt-card card-9">
    <div class="card-header">
      <div class="card-left">
        <div class="card-emoji">🧃</div>
        <div class="card-info">
          <div class="card-num">Prompt 09</div>
          <div class="card-brand">Paper Boat</div>
          <div class="card-subtitle">Nostalgia Drinks Lineup Poster</div>
        </div>
      </div>
      <a href="https://www.paperboatdrinks.com" target="_blank" class="card-link">🔗 View Brand</a>
    </div>
    <div class="prompt-image-wrap">
      <img src="/prompt-images/9th image.png" alt="Generated Paper Boat prompt preview">
      <span class="image-caption">Generated Preview 09</span>
    </div>
    <div class="card-body">
      <div class="prompt-label">ChatGPT Prompt</div>
      <div class="prompt-text" id="p9">Create a stunning product lineup poster for Paper Boat — India's beloved nostalgic drinks brand. Warm cream background, simple flat-illustration style inspired by childhood Indian picture books. Paper Boat logo and tagline 'Drinks and Memories' at the top. Showcase 6 drinks in a horizontal lineup, each bottle/pouch illustrated in Paper Boat's signature illustrated style with their flavors: 'Aam Panna — raw mango, jeera, black salt', 'Jaljeera — tangy cumin, mint, lemon', 'Kokum — coastal Goan sweet-sour kokum', 'Rose Sharbat — gulkand, rose petals, milk', 'Chikki — crushed peanut jaggery smoothie', 'Thandai — badam, kesar, fennel, cardamom'. Each bottle surrounded by hand-drawn illustrations of childhood India — a gulli-danda bat, a kite, marbles, an old radio, a class school bench. Pastel palette: mango yellow, mint green, gulabi pink. Tagline at bottom: 'Har ghoont mein ek yaad.' Ultra-detailed, warm nostalgic mood, 2K resolution.</div>
    </div>
    <div class="card-footer">
      <button class="btn-copy" onclick="copyPrompt('p9', this)">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
        Copy Prompt
      </button>
      <button class="btn-expand" onclick="toggleExpand('p9', this)">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
        Expand
      </button>
    </div>
  ...
  <!-- 10. Kingfisher -->
  <div class="prompt-card card-10">
    <div class="card-header">
      <div class="card-left">
        <div class="card-emoji">🍺</div>
        <div class="card-info">
          <div class="card-num">Prompt 10</div>
          <div class="card-brand">Kingfisher Beer</div>
          <div class="card-subtitle">IPL Cricket Party Menu</div>
        </div>
      </div>
      <a href="https://www.kingfisherworld.com" target="_blank" class="card-link">🔗 View Brand</a>
    </div>
    <div class="prompt-image-wrap">
      <img src="/prompt-images/10th image.png" alt="Generated Kingfisher prompt preview">
      <span class="image-caption">Generated Preview 10</span>
    </div>
    <div class="card-body">
      <div class="prompt-label">ChatGPT Prompt</div>
      <div class="prompt-text" id="p10">Design a bold, energetic IPL cricket season party food and drinks menu poster for Kingfisher Beer — India's most iconic beer brand. Vibrant red, gold and blue color palette. Background: cricket stadium lights bokeh, grass pitch texture at bottom. Large Kingfisher logo with flying kingfisher bird at the top. Bold header: 'KINGFISHER IPL PARTY MENU — The King of Good Times'. DRINKS: 'Kingfisher Premium Pint ₹180 | Kingfisher Ultra Strong ₹200 | Kingfisher Radler — lemon ginger ₹150 | Kingfisher 0.0 Non-Alcoholic ₹120'. MATCH BITES: 'Masala Peanuts & Chivda ₹80 | Crispy Chicken Wings — peri peri, honey sriracha ₹320 | Loaded Nachos — salsa, jalapeños, sour cream ₹280 | Paneer Tikka Platter ₹350 | Seekh Kebab (6 pcs) ₹380'. Footer: 'Watch. Cheer. Eat. Drink. Repeat. 🏏' Cricket ball and bat illustration as design elements. Stadium crowd roar energy. Bold, sporty, ultra-photorealistic, 2K resolution.</div>
    </div>
    <div class="card-footer">
      <button class="btn-copy" onclick="copyPrompt('p10', this)">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
        Copy Prompt
      </button>
      <button class="btn-expand" onclick="toggleExpand('p10', this)">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
        Expand
      </button>
    </div>
...
<!-- FOOTER -->
<footer>
  <div class="footer-handle">@rk.codex</div>
  <p class="footer-sub">Follow for more AI tricks, prompts & tech content 🔥</p>
</footer>
...
<script>
  ...
  function copyPrompt(id, btn) {
    ...
    write.then(() => {
      ...
      btn.classList.add('copied');
      btn.innerHTML = \`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg> Copied!\`;
      showToast();
      setTimeout(() => {
  ...
  function toggleExpand(id, btn) {
    ...
    btn.innerHTML = expanded
      ? \`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 15l-6-6-6 6"/></svg> Collapse\`
      : \`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg> Expand\`;
  }
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="A curated AI tools hub for developers, builders, and creators, with stronger picks across free, freemium, open-source, and paid workflows.">
<meta name="keywords" content="ai tools, developer tools, free ai tools, paid ai tools, coding ai, app builder, ai design tools, rk codex">
<meta name="date" content="2026-05-08T18:40:00+05:30">
<meta name="category" content="Developer Resources">
<meta name="theme-color" content="#080808">
<meta property="article:published_time" content="2026-05-08T18:40:00+05:30">
<meta property="og:image" content="/articles/ai-tools-hub.png">
<title>rk.codex - AI Tools Hub</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Syne:wght@400;600;700;800&family=DM+Mono:wght@300;400;500&family=Cabinet+Grotesk:wght@400;500;700;800&display=swap" rel="stylesheet">
<style>
  :root {
    --bg: #080808;
    --surface: #101010;
    ...
    --muted-2: #525048;
    --accent: #c8f53d;
    --accent-soft: rgba(200, 245, 61, 0.08);
    --accent-strong: rgba(200, 245, 61, 0.2);
    --paid: #f3a33b;
    --paid-soft: rgba(243, 163, 59, 0.12);
    --free: #7cff8d;
    --free-soft: rgba(124, 255, 141, 0.12);
    --oss: #79d7ff;
    --oss-soft: rgba(121, 215, 255, 0.12);
  }
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .cursor-ring {
    width: 36px;
    height: 36px;
    border: 1px solid rgba(200, 245, 61, 0.38);
    transition: transform 0.12s ease, width 0.2s, height 0.2s, border-color 0.2s;
  }

  body:has(a:hover) .cursor-ring,
  body:has(button:hover) .cursor-ring,
  body:has(.tool-card:hover) .cursor-ring {
    width: 52px;
    height: 52px;
    border-color: rgba(200, 245, 61, 0.75);
  }
  ...
  .nav-meta strong { color: var(--accent); font-weight: 500; }
  ...
  .hero-glow {
    ...
    height: 680px;
    border-radius: 50%;
    background: radial-gradient(circle, rgba(200,245,61,0.14) 0%, transparent 68%);
    filter: blur(10px);
  }
  ...
  .chip.free { color: var(--free); border-color: rgba(124,255,141,0.25); background: var(--free-soft); }
  .chip.paid { color: var(--paid); border-color: rgba(243,163,59,0.24); background: var(--paid-soft); }
  .chip.oss { color: var(--oss); border-color: rgba(121,215,255,0.24); background: var(--oss-soft); }
  .chip.accent { color: var(--accent); border-color: var(--accent-strong); background: var(--accent-soft); }
  ...
  .pricing-pill.free { color: var(--free); border-color: rgba(124,255,141,0.28); background: var(--free-soft); }
  .pricing-pill.paid { color: var(--paid); border-color: rgba(243,163,59,0.28); background: var(--paid-soft); }
  .pricing-pill.oss { color: var(--oss); border-color: rgba(121,215,255,0.28); background: var(--oss-soft); }
  .pricing-pill.hybrid { color: var(--accent); border-color: var(--accent-strong); background: var(--accent-soft); }
  ...
  .stack-item span { color: var(--accent); }
  ...
  @media (max-width: 700px) {
    ...
    nav, .hero, .shell, footer { padding-left: 20px; padding-right: 20px; }
    nav { height: auto; min-height: 64px; padding-top: 14px; padding-bottom: 14px; flex-wrap: wrap; gap: 10px; }
    .nav-meta { width: 100%; justify-content: space-between; gap: 12px; }
...
<nav>
  <a href="#" class="nav-logo">rk<span>.codex</span></a>
  <div class="nav-meta">
    <span><strong>27</strong> verified picks</span>
    <a class="nav-link" href="https://instagram.com/rk.codex" target="_blank" rel="noreferrer">@rk.codex</a>
  </div>
</nav>
...
<section class="hero">
  ...
  <div class="hero-inner">
    <div class="eyebrow">AI Tools Hub - Free, Freemium, Paid</div>
    <h1>Do not buy random AI tools.<span>Build a stack</span>that fits the work.</h1>
    <p class="hero-copy">
      Most people waste money because they buy overlapping tools. This hub is the cleaner version:
      a practical shortlist across <strong>coding, research, app building, design, automation, and video</strong>,
      with notes on where free is enough and where paid actually buys you leverage.
    </p>
    <div class="hero-stats">
      <div class="stat">
        <div class="stat-value" id="toolCount">27</div>
        <div class="stat-label">Tools in the hub</div>
      </div>
      <div class="stat">
        <div class="stat-value" id="freeCount">0</div>
        <div class="stat-label">Free or open-source picks</div>
      </div>
      <div class="stat">
        <div class="stat-value" id="paidCount">0</div>
        <div class="stat-label">Paid or pro-tier options</div>
      </div>
      <div class="stat">
        <div class="stat-value">May</div>
        <div class="stat-label">Curated and refreshed</div>
      </div>
    </div>
  </div>
</section>
...
<main class="shell">
  <div class="summary-grid">
    <article class="summary-card">
      ...
      <p>Every pick here is tagged by pricing model and use case. I am intentionally avoiding fake "best for everyone" advice because coding, content, research, and automation have very different needs.</p>
      <div class="inline-list">
        <span class="chip free">Free</span>
        <span class="chip oss">Open source</span>
        <span class="chip accent">Free + Paid</span>
        <span class="chip paid">Paid</span>
      </div>
    </article>
    <article class="summary-card">
      <h3>What to buy first</h3>
      <p>If your main job is software delivery, spend first on your <strong>editor + model + review loop</strong>. If your main job is content, spend on <strong>generation + editing + distribution</strong>. Everything else is secondary.</p>
      <div class="inline-list">
        <span class="chip accent">Editor</span>
        <span class="chip accent">Model</span>
        <span class="chip accent">Review</span>
        <span class="chip accent">Automation</span>
      </div>
    </article>
    <article class="summary-card">
      <h3>My bias in this guide</h3>
      <p>I am optimizing for tools that shorten real work: writing code, shipping UI, reviewing pull requests, finding answers faster, or producing creator assets with less wasted motion.</p>
      <div class="inline-list">
        <span class="chip accent">Less overlap</span>
        <span class="chip accent">Less noise</span>
        <span class="chip accent">More output</span>
      </div>
    </article>
  </div>
  ...
  <div class="section-header">
    <div>
      <div class="section-kicker">Suggested stacks</div>
      <h2>Three combinations that actually make sense.</h2>
    </div>
    <p class="section-note">You do not need all 27 tools. Start with one stack that matches your constraint: budget, speed, or output quality.</p>
  </div>

  <div class="stack-grid">
    <article class="stack-card">
      <h3>Lean builder stack</h3>
      <p>For people who want maximum output with minimum spend.</p>
      <div class="stack-list">
        <div class="stack-item"><span>Continue</span> for in-editor assistance</div>
        <div class="stack-item"><span>Aider</span> for terminal-driven edits</div>
        <div class="stack-item"><span>Gemini</span> or <span>ChatGPT</span> for general reasoning</div>
        <div class="stack-item"><span>n8n</span> for self-hosted automation</div>
      </div>
    </article>
    <article class="stack-card">
      <h3>Shipping fast stack</h3>
      <p>For solo founders and small product teams moving from idea to working UI quickly.</p>
      <div class="stack-list">
        <div class="stack-item"><span>Cursor</span> as the primary IDE</div>
        <div class="stack-item"><span>Claude</span> for high-quality implementation thinking</div>
        <div class="stack-item"><span>v0</span> or <span>Lovable</span> for front-end acceleration</div>
        <div class="stack-item"><span>CodeRabbit</span> for review pressure</div>
      </div>
    </article>
    <article class="stack-card">
      <h3>Creator output stack</h3>
      <p>For reels, carousels, thumbnails, scripts, and high-frequency publishing.</p>
      <div class="stack-list">
        <div class="stack-item"><span>ChatGPT</span> for ideation and drafts</div>
        <div class="stack-item"><span>Canva</span> for quick layout and social packaging</div>
        <div class="stack-item"><span>Runway</span> for motion and editing</div>
        <div class="stack-item"><span>HeyGen</span> for avatar and voice workflows</div>
      </div>
    </article>
  </div>
  ...
  <div class="section-header">
    <div>
      <div class="section-kicker">The hub</div>
      <h2>Free and paid AI tools worth checking right now.</h2>
    </div>
    <p class="section-note">Pricing labels are intentionally broad here because exact plan details move often. The useful question is not the sticker price. It is whether the paid tier unlocks meaningful leverage for your workflow.</p>
  </div>

  <div class="filter-wrap">
    <div class="filter-row">
      <span class="filter-label">Search</span>
      <input id="searchInput" class="search-input" type="text" placeholder="Search by tool, category, use case, or note">
      ...
      <div class="count-badge"><span id="visibleCount">0</span> visible</div>
    </div>
  </div>

  <section class="tools-grid" id="toolsGrid"></section>
  <div class="empty-state" id="emptyState">No tools matched this filter. Clear the search or switch category.</div>

  <div class="section-header">
    <div>
      <div class="section-kicker">Buying notes</div>
      <h2>Where people overspend.</h2>
    </div>
    <p class="section-note">The biggest waste pattern is paying for five tools that all solve the same narrow problem. These are the overlap traps to watch.</p>
  </div>

  <div class="notes-grid">
    <article class="note-card">
      <h3>Do not double-pay for the same coding loop</h3>
      <p>Cursor, Windsurf, Copilot, Continue, and Aider can all touch the same workflow. You probably need <strong>one primary editor assistant</strong> and optionally one terminal-first agent. Not five subscriptions.</p>
    </article>
    <article class="note-card">
      <h3>App builders are leverage, not architecture</h3>
      <p>Tools like Bolt, v0, Replit, and Lovable are strongest for speed. They are not a substitute for judgment around code quality, deployment shape, or long-term maintainability.</p>
    </article>
    <article class="note-card">
      <h3>Free is enough longer than people think</h3>
      <p>For research, docs, ideation, and basic creator workflows, the free or freemium tier is often enough until usage becomes repetitive, team-based, or deadline-heavy.</p>
    </article>
  </div>
  ...
  <div class="section-header">
    ...
    <p class="section-note">This is the compressed version. If you want, I can turn this page into a category-by-category deep dive later.</p>
  </div>

  <div class="faq-grid">
    <article class="faq-card">
      <h3>Which paid coding tool would I start with?</h3>
      <p>If your work is mostly implementation, start with one serious coding surface like Cursor or Copilot, then add Claude or ChatGPT as the reasoning layer around it.</p>
    </article>
    <article class="faq-card">
      <h3>Which free tools punch above their weight?</h3>
      <p>Aider, Continue, n8n, Postman, Figma free tier, Gemini, and ChatGPT free tier all still offer real leverage if you have discipline around scope.</p>
    </article>
    <article class="faq-card">
      <h3>When does paid become worth it?</h3>
      <p>When a tool moves from experimentation to daily production. If a tool saves you repeated manual effort across the week, that is usually when paid starts making sense.</p>
    </article>
  </div>
</main>
...
<footer>
  <div>
    <div class="footer-brand">rk.codex</div>
    <div class="footer-sub">Curated tools, cleaner workflows, less random spending.</div>
  </div>
  <div class="footer-meta">
    Built as a living resource for developers, builders, and creators.<br>
    Re-check vendor pages before buying because plans and limits move.
  </div>
</footer>
...
<script>
  const tools = [
    {
      ...
      category: "Coding IDE",
      pricing: "Paid",
      bestFor: "Developers who want the IDE itself to behave like a fast implementation partner.",
      summary: "Strong in-editor editing, large context workflows, and quick iteration on real codebases.",
      note: "Best if your primary bottleneck is implementation speed inside the editor.",
    ...
    },
    {
      ...
      category: "Coding IDE",
      pricing: "Free + Paid",
      bestFor: "Developers already deep inside GitHub and VS Code or JetBrains workflows.",
      summary: "Good autocomplete, chat, and repo-adjacent assistance without reworking your stack.",
      note: "A safe default if you want less tool switching and tighter GitHub alignment.",
    ...
    },
    {
      ...
      category: "Coding IDE",
      pricing: "Free + Paid",
      bestFor: "Developers who want an AI-first editor experience with strong agent framing.",
      summary: "Fast iteration for coding, debugging, and understanding larger repo surfaces.",
      note: "Worth comparing directly against Cursor before you commit to one editor subscription.",
    ...
    },
    {
      ...
      category: "Coding IDE",
      pricing: "Open source",
      bestFor: "Teams who want flexibility over models and tighter control over how AI is wired into the editor.",
      summary: "Open-source coding assistant that can be shaped around your own model and provider preferences.",
      note: "Strong option when you want control rather than a fixed vendor workflow.",
    ...
    },
    {
      ...
      pricing: "Open source",
      bestFor: "Terminal-first developers who prefer explicit file edits and direct git-oriented workflows.",
      summary: "Lightweight and effective for patching code, multi-file edits, and disciplined CLI work.",
      note: "One of the best open-source picks if you actually like staying in the terminal.",
    ...
    },
    {
      ...
      category: "AI Chat",
      pricing: "Free + Paid",
      bestFor: "Long-form reasoning, implementation planning, code explanation, and structured writing.",
      summary: "Strong for careful thinking, high-context writing, and code-quality-oriented assistance.",
      note: "Best value comes when you use it for harder reasoning, not simple autocomplete.",
    ...
    },
    {
      ...
      category: "AI Chat",
      pricing: "Free + Paid",
      bestFor: "General-purpose ideation, writing, image prompting, and broad workflow coverage.",
      summary: "A flexible all-rounder across text, reasoning, browsing, and multimodal use cases.",
      note: "Often the most useful single paid AI subscription if your work is broad rather than specialized.",
    ...
    },
    {
      ...
      category: "AI Chat",
      pricing: "Free + Paid",
      bestFor: "Google-centric workflows, quick research, and docs-oriented general assistance.",
      summary: "Useful when your workflow is already tied into the Google ecosystem.",
      note: "Good to benchmark against Claude or ChatGPT before assuming you need all three.",
    ...
    },
    {
      ...
      category: "Research",
      pricing: "Free + Paid",
      bestFor: "Fast answer gathering, source-backed summaries, and quicker research triage.",
      summary: "Designed around retrieval and source-first answers rather than pure conversation.",
      note: "Great when the bottleneck is finding, verifying, and compressing information.",
    ...
    },
    {
      ...
      category: "Research",
      pricing: "Free + Paid",
      bestFor: "Developer-focused searching, explanations, and technical troubleshooting.",
      summary: "Still useful for code-heavy search and fast technical context when docs are fragmented.",
      note: "More helpful when the question is technical and external, not purely project-internal.",
    ...
    },
    {
      ...
      pricing: "Paid",
      bestFor: "Rapid app prototyping in the browser when speed beats architecture purity.",
      summary: "Strong for turning prompts into working front-end or full-stack prototypes quickly.",
      note: "Treat output as accelerated scaffolding, not final architecture by default.",
      url: "https://bolt.new"
    },
    {
      name: "v0",
      category: "App Builder",
      pricing: "Free + Paid",
      bestFor: "Generating interface ideas, front-end sections, and shippable React/Tailwind starting points.",
      summary: "Best when UI speed matters and you can refine output with real engineering judgment.",
      note: "Very useful for front-end acceleration, less useful if you expect it to own architecture decisions.",
      url: "https://v0.dev"
    },
    {
      name: "Lovable",
      category: "App Builder",
      pricing: "Free + Paid",
      bestFor: "Prompt-first product assembly and quick MVP generation for founders or non-specialist builders.",
      summary: "Good for compressing idea-to-demo time when you need visible progress fast.",
      note: "Evaluate generated code quality if the project is graduating from prototype to product.",
    ...
    },
    {
      ...
      category: "App Builder",
      pricing: "Free + Paid",
      bestFor: "Browser-based coding, quick deployments, and teaching or lightweight prototyping.",
      summary: "Useful for all-in-one coding, running, and sharing without heavy local setup.",
      note: "Great for speed and convenience, but large production systems still need stronger engineering controls.",
    ...
    },
    {
      ...
      pricing: "Free + Paid",
      bestFor: "Pull-request review loops where teams want constant coverage and faster review throughput.",
      summary: "Adds automated review pressure to PRs and can catch issues before humans miss them.",
      note: "Best when paired with disciplined maintainers who still make the final judgment call.",
    ...
    },
    {
      ...
      category: "Code Review",
      pricing: "Free + Paid",
      bestFor: "Review, generation, and test-adjacent support inside engineering workflows.",
      summary: "Aimed at turning AI into a more systematic engineering helper rather than only a chatbot.",
      note: "Worth considering if your team wants more structure around how AI enters engineering work.",
    ...
    },
    {
      ...
      category: "Security",
      pricing: "Free + Paid",
      bestFor: "Dependency security, vulnerability visibility, and guardrails in the delivery pipeline.",
      summary: "Useful when shipping speed is high enough that security drift becomes real risk.",
      note: "Paid starts making more sense as soon as multiple repos and shared dependencies are involved.",
      url: "https://snyk.io"
    },
    {
      name: "Postman",
      category: "API",
      pricing: "Free + Paid",
      bestFor: "API testing, collections, collaboration, and keeping request flows sane.",
      summary: "Still one of the easiest ways to make API work visible and repeatable across people.",
      note: "Not an AI-first tool, but still central enough to stay in the stack conversation.",
    ...
    },
    {
      ...
      category: "Automation",
      pricing: "Open source",
      bestFor: "Builders who want workflow automation without being fully trapped in a hosted SaaS layer.",
      summary: "Excellent when you want automations, AI steps, and self-hosted control in one place.",
      note: "One of the highest-leverage open-source tools in this whole page.",
      url: "https://n8n.io"
    },
    {
      name: "Zapier",
      category: "Automation",
      pricing: "Free + Paid",
      bestFor: "Business automations, app connectors, and quick no-code wiring across SaaS tools.",
      summary: "Very strong connector breadth, especially when you need non-engineers to participate.",
      note: "You pay for convenience and connector coverage more than deep technical control.",
    ...
    },
    {
      ...
      category: "Design",
      pricing: "Free + Paid",
      bestFor: "UI design, collaborative product thinking, and design system work.",
      summary: "Still the core design surface for many product teams, especially when collaboration matters.",
      note: "Paid becomes worth it when team workflows, libraries, or org-level control matter.",
    ...
    },
    {
      ...
      category: "Design",
      pricing: "Free + Paid",
      bestFor: "Fast social design, decks, thumbnails, and non-designer output that still has to look finished.",
      summary: "Extremely practical for creators, marketers, and engineers who need shippable visuals quickly.",
      note: "If output speed matters more than perfect craft, Canva is hard to beat.",
    ...
    },
    {
      ...
      category: "Video",
      pricing: "Free + Paid",
      bestFor: "Video generation, editing assistance, and AI-enhanced creator production.",
      summary: "Useful for quick motion experiments, concept visuals, and creator-side production acceleration.",
      note: "The value is highest when you are actually publishing video, not just testing one feature once.",
    ...
    },
    {
      ...
      category: "Video",
      pricing: "Paid",
      bestFor: "Avatar videos, talking-head workflows, localization, and repeatable creator pipelines.",
      summary: "Most useful when you need consistent presenter-style output without filming every variation.",
      note: "Worth it for teams or creators with recurring format-driven video needs.",
    ...
    },
    {
      ...
      category: "Imaging",
      pricing: "Paid",
      bestFor: "High-style image generation where aesthetic quality is more important than workflow integration.",
      summary: "Still relevant for strong visual taste and image-first creative generation.",
      note: "Best for finished-looking outputs, less ideal if you want deeply integrated product workflows.",
    ...
    },
    {
      ...
      category: "Docs",
      pricing: "Free + Paid",
      bestFor: "Internal docs, synthesis, note cleanup, and turning scattered information into usable pages.",
      summary: "Most useful when your team already lives inside Notion and wants AI embedded there.",
      note: "Avoid it if your organization is not already committed to Notion as a source of truth.",
    ...
    },
    {
      ...
      category: "Agent",
      pricing: "Paid",
      bestFor: "Teams exploring autonomous or semi-autonomous engineering workflows.",
      summary: "Aimed at heavier agentic development use cases rather than lightweight assistance.",
      note: "Evaluate very carefully against your process maturity and expected ROI before buying.",
      url: "https://devin.ai"
    }
  ];
  ...
  function pricingClass(pricing) {
    ...
    if (pricing === "Open source") return "oss";
  ...
  function renderCounts() {
    ...
    freeCount.textContent = \`\${tools.filter((tool) => tool.pricing === "Free" || tool.pricing === "Open source" || tool.pricing === "Free + Paid").length}\`;
    paidCount.textContent = \`\${tools.filter((tool) => tool.pricing === "Paid" || tool.pricing === "Free + Paid").length}\`;
  }
  ...
  function renderTools() {
    ...
    const filtered = tools.filter((tool) => {
      const haystack = [tool.name, tool.category, tool.bestFor, tool.summary, tool.note, tool.pricing]
        .join(" ")
        .toLowerCase();
    ...
    toolsGrid.innerHTML = filtered.map((tool) => \`
      <article class="tool-card">
        <div class="tool-top">
          ...
          <span class="pricing-pill \${pricingClass(tool.pricing)}">\${tool.pricing}</span>
        </div>
        <p class="tool-summary">\${tool.summary}</p>
        <p class="tool-best"><strong>Best for:</strong> \${tool.bestFor}</p>
        <p class="tool-note"><strong>Why it matters:</strong> \${tool.note}</p>
        <div class="tool-actions">
          <a class="tool-btn" href="\${tool.url}" target="_blank" rel="noreferrer">Open tool</a>
          <button class="tool-copy" type="button" aria-label="Copy link for \${tool.name}" data-link="\${tool.url}">+</button>
        </div>
      </article>
    \`).join("");

    document.querySelectorAll(".tool-copy").forEach((button) => {
  ...
  function copyLink(link) {
    ...
    writer
      ...
      .catch(() => showToast("Copy failed. Open the tool directly."));
  }
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="A practical guide to Career-Ops, the open-source multi-agent job search system that evaluates roles, generates tailored CV PDFs, scans job boards, and tracks your pipeline.">
<meta name="keywords" content="career-ops, claude code, job search automation, ai job search, ats resume, open source, career operations">
<meta name="date" content="2026-05-08T20:10:00+05:30">
<meta name="category" content="Open Source">
<meta name="theme-color" content="#0a0806">
<meta property="article:published_time" content="2026-05-08T20:10:00+05:30">
<meta property="og:image" content="/articles/career-ops-guide.png">
<title>Career-Ops — Open-Source Job Search System | rk.codex</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Space+Mono:ital,wght@0,400;0,700;1,400&family=DM+Sans:wght@400;500;600;700&display=swap" rel="stylesheet">
<style>
:root[data-theme="dark"]{
  --bg:#0a0806;--bg2:#110f0b;--bg3:#181510;--bg4:#231f18;
  --border:rgba(255,200,80,0.08);--border2:rgba(255,200,80,0.16);
  --text:#f5ead8;--muted:#7b6d58;--muted2:#aa9779;
  --acc:#f5a623;--acc-dim:rgba(245,166,35,0.08);--acc-border:rgba(245,166,35,0.26);--acc-text:#ffc85a;
  --blue:#61c7f7;--blue-dim:rgba(97,199,247,0.08);--blue-border:rgba(97,199,247,0.24);--blue-text:#b5e9ff;
  --green:#7cff8d;--green-dim:rgba(124,255,141,0.08);--green-border:rgba(124,255,141,0.24);--green-text:#c5ffd0;
  --red:#c0392b;--red-dim:rgba(192,57,43,0.08);--red-border:rgba(192,57,43,0.25);--red-text:#f07c70;
  --code-bg:#0d0b08;--card-bg:#110f0b;
}
:root[data-theme="light"]{
  --bg:#fcf7ef;--bg2:#f3e9db;--bg3:#eadcc8;--bg4:#e0d0b7;
  --border:rgba(110,80,30,0.08);--border2:rgba(110,80,30,0.16);
  --text:#2d2114;--muted:#907457;--muted2:#6f5336;
  --acc:#c47d0e;--acc-dim:rgba(196,125,14,0.08);--acc-border:rgba(196,125,14,0.22);--acc-text:#8b5800;
  --blue:#2476a8;--blue-dim:rgba(36,118,168,0.08);--blue-border:rgba(36,118,168,0.2);--blue-text:#1d5f87;
  --green:#2e8f43;--green-dim:rgba(46,143,67,0.08);--green-border:rgba(46,143,67,0.18);--green-text:#226c33;
  --red:#922b21;--red-dim:rgba(146,43,33,0.06);--red-border:rgba(146,43,33,0.2);--red-text:#922b21;
  --code-bg:#ede3d5;--card-bg:#fff8ef;
}
*{margin:0;padding:0;box-sizing:border-box;}
html{scroll-behavior:smooth;}
body{background:var(--bg);color:var(--text);font-family:'DM Sans',sans-serif;font-size:15px;line-height:1.72;transition:background .2s,color .2s;position:relative;}
body::before{content:'';position:fixed;inset:0;background-image:url("data:image/svg+xml,%3Csvg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noise)' opacity='0.04'/%3E%3C/svg%3E");pointer-events:none;z-index:999;opacity:.35;}
header{position:sticky;top:0;z-index:100;background:var(--bg);border-bottom:1px solid var(--border);padding:0 24px;height:48px;display:flex;align-items:center;justify-content:space-between;backdrop-filter:blur(8px);}
.h-left{display:flex;align-items:center;gap:6px;font-size:13px;}
.h-brand{font-family:'Space Mono',monospace;font-weight:700;font-size:13px;color:var(--acc-text);letter-spacing:.01em;}
.h-sep{color:var(--border2);font-size:18px;line-height:1;margin:0 2px;}
.h-page{color:var(--muted);font-size:12px;font-family:'Space Mono',monospace;}
.h-right{display:flex;align-items:center;gap:8px;}
.theme-btn{width:30px;height:30px;border-radius:50%;border:1px solid var(--border2);background:var(--bg3);cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:13px;transition:background .15s;font-family:'DM Sans',sans-serif;}
.theme-btn:hover{background:var(--bg4);}
.hero-wrap{position:relative;overflow:hidden;border-bottom:1px solid var(--border);}
.hero-bg-lines{position:absolute;inset:0;background-image:repeating-linear-gradient(0deg,transparent,transparent 39px,var(--border) 39px,var(--border) 40px),repeating-linear-gradient(90deg,transparent,transparent 39px,var(--border) 39px,var(--border) 40px);opacity:.35;pointer-events:none;}
.hero-glow{position:absolute;top:-60px;left:50%;transform:translateX(-50%);width:780px;height:400px;background:radial-gradient(ellipse,rgba(245,166,35,0.06) 0%,transparent 65%);pointer-events:none;}
.hero{max-width:760px;margin:0 auto;padding:72px 24px 60px;position:relative;}
.tool-emoji{font-size:60px;line-height:1;margin-bottom:18px;display:block;filter:drop-shadow(0 4px 24px rgba(245,166,35,0.20));animation:float 3.2s ease-in-out infinite;}
@keyframes float{0%,100%{transform:translateY(0);}50%{transform:translateY(-8px);}}
.badge-row{display:flex;gap:8px;margin-bottom:18px;flex-wrap:wrap;}
.badge{display:inline-flex;align-items:center;gap:6px;border:1px solid var(--border2);border-radius:20px;padding:4px 12px;font-size:11px;font-weight:700;letter-spacing:.07em;color:var(--muted2);background:var(--bg2);text-transform:uppercase;font-family:'Space Mono',monospace;}
.badge.g{border-color:var(--green-border);color:var(--green-text);background:var(--green-dim);}
.badge.b{border-color:var(--blue-border);color:var(--blue-text);background:var(--blue-dim);}
.badge.a{border-color:var(--acc-border);color:var(--acc-text);background:var(--acc-dim);}
.dot{width:5px;height:5px;border-radius:50%;background:var(--acc);display:inline-block;animation:blink 2s infinite;}
@keyframes blink{0%,100%{opacity:1;}50%{opacity:.3;}}
h1{font-family:'Bebas Neue',sans-serif;font-size:clamp(52px,10vw,100px);font-weight:400;line-height:.95;letter-spacing:.02em;margin-bottom:16px;text-transform:uppercase;}
h1 .acc{color:var(--acc);}
h1 .sub-h{display:block;font-size:clamp(20px,4vw,34px);color:var(--muted2);letter-spacing:.04em;margin-top:6px;}
.hero-sub{font-size:16px;color:var(--muted2);max-width:560px;margin-bottom:34px;line-height:1.7;}
.hero-sub strong{color:var(--text);}
.hero-links{display:flex;gap:10px;flex-wrap:wrap;margin-bottom:40px;}
.hero-link{display:inline-flex;align-items:center;justify-content:center;padding:11px 16px;border-radius:10px;text-decoration:none;font-size:13px;font-weight:700;transition:background .15s,border-color .15s;min-height:44px;}
.hero-link.primary{background:var(--acc-dim);color:var(--acc-text);border:1px solid var(--acc-border);}
.hero-link.primary:hover{background:rgba(245,166,35,0.14);}
.hero-link.secondary{background:var(--bg2);color:var(--muted2);border:1px solid var(--border2);}
.hero-link.secondary:hover{background:var(--bg3);color:var(--text);}
.stats-row{display:flex;gap:0;border-top:1px solid var(--border);padding-top:32px;}
.stat{flex:1;padding-right:28px;border-right:1px solid var(--border);margin-right:28px;}
.stat:last-child{border-right:none;margin-right:0;}
.sv{font-family:'Bebas Neue',sans-serif;font-size:48px;color:var(--acc);letter-spacing:.02em;line-height:1;}
.sl{font-size:11px;color:var(--muted);margin-top:2px;font-family:'Space Mono',monospace;}
.page{max-width:760px;margin:0 auto;padding:0 24px 80px;}
.toc{background:var(--card-bg);border:1px solid var(--border);border-radius:14px;padding:24px 28px;margin:40px 0 52px;}
.toc-lbl{font-size:10px;font-weight:700;letter-spacing:.12em;color:var(--muted);text-transform:uppercase;margin-bottom:16px;font-family:'Space Mono',monospace;}
.toc-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px 32px;}
.toc-item{display:flex;align-items:center;gap:10px;font-size:13px;color:var(--muted2);text-decoration:none;transition:color .15s;}
.toc-item:hover{color:var(--text);}
.tn{font-size:11px;color:var(--acc);font-weight:700;min-width:20px;font-family:'Space Mono',monospace;}
.section{margin-bottom:64px;scroll-margin-top:60px;}
.slabel{font-size:10px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:var(--acc);margin-bottom:10px;font-family:'Space Mono',monospace;}
h2{font-family:'Bebas Neue',sans-serif;font-size:36px;font-weight:400;margin-bottom:14px;letter-spacing:.03em;text-transform:uppercase;line-height:1.1;}
h3{font-size:15px;font-weight:600;color:var(--text);margin-bottom:7px;}
p{color:var(--muted2);margin-bottom:12px;font-size:15px;}
.info-box,.note-box,.warn-box{border-radius:10px;padding:14px 18px;font-size:13px;margin:16px 0;line-height:1.65;}
.info-box{background:var(--acc-dim);border:1px solid var(--acc-border);color:var(--acc-text);}
.note-box{background:var(--bg2);border:1px solid var(--border2);color:var(--muted2);}
.warn-box{background:var(--red-dim);border:1px solid var(--red-border);color:var(--red-text);}
.good-box{background:var(--green-dim);border:1px solid var(--green-border);color:var(--green-text);border-radius:10px;padding:14px 18px;font-size:13px;margin:16px 0;line-height:1.65;}
.blue-box{background:var(--blue-dim);border:1px solid var(--blue-border);color:var(--blue-text);border-radius:10px;padding:14px 18px;font-size:13px;margin:16px 0;line-height:1.65;}
.code-block{background:var(--code-bg);border:1px solid var(--border2);border-radius:10px;padding:14px 20px;font-family:'Space Mono',monospace;font-size:13px;margin:12px 0;overflow-x:auto;line-height:2;}
.cmd{color:var(--acc-text);}
.cmd::before{content:'$ ';color:var(--muted);}
code{font-family:'Space Mono',monospace;font-size:12px;background:var(--bg3);color:var(--acc-text);padding:2px 7px;border-radius:4px;border:1px solid var(--border2);}
.steps{margin:24px 0;}
.step{display:grid;grid-template-columns:44px 1fr;gap:0 18px;padding:28px 0;border-bottom:1px solid var(--border);}
.step:first-child{border-top:1px solid var(--border);}
.snum{width:36px;height:36px;border-radius:8px;background:var(--acc-dim);border:1px solid var(--acc-border);display:flex;align-items:center;justify-content:center;font-family:'Bebas Neue',sans-serif;font-size:18px;color:var(--acc-text);margin-top:2px;letter-spacing:.02em;}
.step-body p{font-size:13px;margin-bottom:8px;}
.stat-cards{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin:22px 0;}
.stat-card{background:var(--card-bg);border:1px solid var(--border);border-radius:12px;padding:18px 20px;}
.stat-card .big{font-family:'Bebas Neue',sans-serif;font-size:52px;color:var(--acc);line-height:1;letter-spacing:.02em;}
.stat-card .desc{font-size:12px;color:var(--muted2);margin-top:4px;line-height:1.5;}
.compare-wrap{display:grid;grid-template-columns:1fr 1fr;gap:14px;margin:24px 0;}
.compare-card{border-radius:12px;padding:18px 20px;border:1px solid var(--border2);background:var(--bg2);}
.compare-card.good{border-color:var(--green-border);background:var(--green-dim);}
.compare-card.bad{border-color:var(--red-border);background:var(--red-dim);}
.compare-card .label{font-size:10px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;margin-bottom:10px;font-family:'Space Mono',monospace;}
.compare-card.good .label{color:var(--green-text);}
.compare-card.bad .label{color:var(--red-text);}
.compare-card p{font-size:13px;margin-bottom:0;}
ul.clean{margin:16px 0 0 18px;color:var(--muted2);}
ul.clean li{margin-bottom:8px;}
footer{border-top:1px solid var(--border);padding:24px;max-width:760px;margin:0 auto;display:flex;align-items:center;justify-content:space-between;font-size:12px;color:var(--muted);font-family:'Space Mono',monospace;}
footer a{color:var(--acc-text);text-decoration:none;}
@media(max-width:600px){
  .toc-grid,.compare-wrap,.stat-cards{grid-template-columns:1fr;}
...
<header>
  <div class="h-left">
    <span class="h-brand">rk.codex</span>
    <span class="h-sep">/</span>
    <span class="h-page">career-ops-guide</span>
  </div>
  <div class="h-right">
...
<div class="hero-wrap">
  ...
  <div class="hero">
    ...
    <div class="badge-row">
      <span class="badge g"><span class="dot"></span> Open source</span>
      <span class="badge b">Claude Code + Gemini CLI</span>
      <span class="badge a">Job search ops</span>
    </div>

    <h1>
      Career<span class="acc">-Ops</span>
      <span class="sub-h">The first job search system that behaves like an operating model, not a spreadsheet.</span>
    </h1>

    <p class="hero-sub">
      <strong>Career-Ops</strong> is an open-source, multi-agent job search system built around AI coding CLIs.
      It does not mass-apply for you. It does something more useful: it helps you
      <strong>scan, evaluate, personalize, generate ATS-ready PDFs, and track the pipeline</strong>
      so you spend time on the roles that are actually worth your energy.
    </p>

    <div class="hero-links">
      <a class="hero-link primary" href="https://github.com/santifer/career-ops" target="_blank" rel="noreferrer">Open repository</a>
      <a class="hero-link secondary" href="https://santifer.io/career-ops-system" target="_blank" rel="noreferrer">Read founder case study</a>
    </div>

    <div class="stats-row">
      <div class="stat">
        <div class="sv">740+</div>
        <div class="sl">Listings evaluated in the founder case study</div>
      </div>
      <div class="stat">
        <div class="sv">100+</div>
        <div class="sl">Tailored CV PDFs generated</div>
      </div>
      <div class="stat">
        <div class="sv">45+</div>
        <div class="sl">Pre-configured companies in the scanner setup</div>
      </div>
    </div>
  </div>
</div>
...
<div class="page">
  <div class="toc">
    <div class="toc-lbl">Guide map</div>
    <div class="toc-grid">
      <a class="toc-item" href="#what"><span class="tn">01</span>What Career-Ops actually is</a>
      <a class="toc-item" href="#who"><span class="tn">02</span>Who should use it</a>
      <a class="toc-item" href="#workflow"><span class="tn">03</span>How the pipeline works</a>
      <a class="toc-item" href="#setup"><span class="tn">04</span>Setup in plain English</a>
      <a class="toc-item" href="#customize"><span class="tn">05</span>What to customize first</a>
      <a class="toc-item" href="#commands"><span class="tn">06</span>Commands worth knowing</a>
      <a class="toc-item" href="#strengths"><span class="tn">07</span>Where it is strong</a>
      <a class="toc-item" href="#limits"><span class="tn">08</span>Limits and caveats</a>
    </div>
  </div>

  <section class="section" id="what">
    <div class="slabel">What it is</div>
    <h2>Career-Ops is not an auto-apply bot. That is exactly why it is interesting.</h2>
    <p>
      A lot of AI job search tools optimize for volume. Career-Ops optimizes for
      <strong>selection quality</strong>. That is an important difference.
      The system reads your CV, profile, proof points, tracked companies, and portal configuration,
      then uses an AI coding CLI to evaluate a role in context rather than doing naive keyword matching.
    </p>
    <p>
      From the repo’s own framing, the goal is to help candidates use AI to
      <strong>choose companies</strong>, not to blindly spam applications.
      That creates a better mental model: this is a decision system, a personalization system, and a pipeline system bundled together.
    </p>

    <div class="compare-wrap">
      <div class="compare-card bad">
        <div class="label">What it is not</div>
        <p>A browser bot that blindly applies everywhere, inflates activity metrics, and burns your time on roles that were never a fit.</p>
      </div>
      <div class="compare-card good">
        <div class="label">What it is</div>
        <p>A structured evaluation and job-search operations layer that helps you score, personalize, generate, and track before you decide to apply.</p>
      </div>
    </div>

    <div class="info-box">
      The repo strongly recommends against applying to anything below roughly <strong>4.0 / 5</strong>.
      That philosophy is one of the strongest parts of the project.
    </div>
  </section>

  <section class="section" id="who">
    <div class="slabel">Who it fits</div>
    <h2>This is for serious searches, not casual browsing.</h2>
    <p>
      Career-Ops makes the most sense if you are actively pursuing a defined transition:
      senior IC roles, AI roles, platform roles, technical leadership roles, or any search where
      the cost of applying badly is high. If you have a messy CV, unclear positioning, and no idea what kind of roles you want,
      the system can still help, but only after you put in some profile work first.
    </p>

    <div class="stat-cards">
      <div class="stat-card">
        <div class="big">Best</div>
        <div class="desc">For candidates with a clear target role, real proof points, and enough discipline to review every recommendation manually.</div>
      </div>
      <div class="stat-card">
        <div class="big">Weak</div>
        <div class="desc">For people who want “press button, get hired” automation. That is not what this system is designed for.</div>
      </div>
    </div>

    <div class="note-box">
      The system gets stronger when it knows you well. The README is explicit about this:
      the first evaluations may be mediocre until you feed it your context, story, superpowers, preferences, and anti-goals.
    </div>
  </section>

  <section class="section" id="workflow">
    <div class="slabel">Workflow</div>
    <h2>What happens when you paste a job URL or description</h2>
    <p>
      The architecture is clean enough to explain in one sentence:
      <strong>input goes in, archetype detection happens, a multi-block evaluation runs, then report, PDF, and tracker outputs are generated.</strong>
    </p>
    ...
    <div class="steps">
      <div class="step">
        ...
        <div class="step-body">
          <h3>Input</h3>
          <p>You paste a job URL or JD text. The system extracts content directly or works from pasted text.</p>
        </div>
      </div>
      <div class="step">
        <div class="snum">2</div>
        <div class="step-body">
          ...
          <p>The job is classified into an internal archetype so scoring and framing are role-aware, not generic.</p>
        </div>
      </div>
      <div class="step">
        <div class="snum">3</div>
        <div class="step-body">
          <h3>Six-block evaluation</h3>
          <p>Role summary, CV match, level strategy, compensation research, personalization plan, and interview prep all get generated in one run.</p>
        </div>
      </div>
      <div class="step">
        <div class="snum">4</div>
        <div class="step-body">
          <h3>Artifacts</h3>
          <p>You get a markdown report, an ATS-oriented PDF resume, and a tracker entry that fits into the broader pipeline.</p>
        </div>
      </div>
    </div>

    <div class="blue-box">
      The architecture doc also shows a strong batch story: multiple offers can be processed in parallel through headless workers,
      which matters if your funnel is large and you do not want to manually triage every listing one by one.
    </div>
  </section>

  <section class="section" id="setup">
    <div class="slabel">Setup</div>
    <h2>The setup is not hard, but it assumes you can operate a real project</h2>
    <p>
      Career-Ops is not a consumer SaaS. You are installing a project, editing config, providing your own CV,
      and letting an AI coding CLI work inside that directory. That is a feature, not a bug, but it means the right user is someone comfortable with repositories and files.
    </p>

    <div class="code-block">
<div class="cmd">git clone https://github.com/santifer/career-ops.git</div>
<div class="cmd">cd career-ops && npm install</div>
<div class="cmd">npx playwright install chromium</div>
<div class="cmd">npm run doctor</div>
    </div>
    ...
    <div class="steps">
      <div class="step">
        ...
        <div class="step-body">
          ...
          <p>Node.js is required for the scripts and PDF generation. Playwright Chromium is required for PDF output.</p>
        </div>
      </div>
      <div class="step">
        <div class="snum">2</div>
        <div class="step-body">
          <h3>Copy the profile template</h3>
          <p>Use <code>config/profile.example.yml</code> as the base and turn it into your actual identity source of truth.</p>
        </div>
      </div>
      <div class="step">
        <div class="snum">3</div>
        <div class="step-body">
          <h3>Add your CV</h3>
          <p>Create <code>cv.md</code> in the project root. This is the main context file the system keeps returning to.</p>
        </div>
      </div>
      <div class="step">
        <div class="snum">4</div>
        <div class="step-body">
          <h3>Customize portals</h3>
          <p>Copy <code>templates/portals.example.yml</code> to <code>portals.yml</code> and trim it to your actual role keywords, exclusions, and tracked companies.</p>
        </div>
      </div>
      <div class="step">
        <div class="snum">5</div>
        <div class="step-body">
          <h3>Open your AI CLI in the directory</h3>
          <p>At that point, the system wants you to work inside Claude Code or Gemini CLI and guide it through your career-specific setup.</p>
        </div>
      </div>
    </div>

    <div class="good-box">
      One subtle but smart design choice: the project is built to be customized by the agent itself.
      You ask Claude to change archetypes, update profile data, or edit target companies, and it works on the same files the system runs on.
    </div>
  </section>

  <section class="section" id="customize">
    <div class="slabel">Customize first</div>
    <h2>If you skip customization, the output will feel generic</h2>
    <p>
      The customization guide makes it clear where the leverage is. If I were onboarding this for myself,
      I would spend the first hour cleaning these areas before running serious evaluations.
    </p>

    <ul class="clean">
      <li><strong><code>config/profile.yml</code></strong> — candidate identity, location, target roles, compensation, narrative.</li>
      <li><strong><code>modes/_profile.md</code></strong> — archetype mapping and how your projects get framed against specific role types.</li>
      <li><strong><code>portals.yml</code></strong> — job title filters, negative filters, target companies, and board search queries.</li>
      <li><strong><code>templates/cv-template.html</code></strong> — if the default PDF look is not your style, this is where it changes.</li>
      <li><strong><code>article-digest.md</code></strong> — optional but useful if your strongest proof points live in shipped writing or portfolio work.</li>
    </ul>

    <div class="warn-box">
      If you leave the archetypes untouched while targeting a different market or role family, the scoring logic may be directionally wrong even if the system feels confident.
    </div>
  </section>

  <section class="section" id="commands">
    <div class="slabel">Commands</div>
    <h2>The commands that matter in real use</h2>
    <p>
      The repo exposes a lot, but a few workflows matter more than the rest. If you are evaluating whether this is worth adopting,
      these are the ones to understand first.
    </p>

    <div class="code-block">
<div>/career-ops</div>
<div>/career-ops scan</div>
<div>/career-ops pdf</div>
<div>/career-ops batch</div>
<div>/career-ops tracker</div>
<div>/career-ops pipeline</div>
    </div>

    <div class="info-box">
      Gemini CLI support is not a side note here. The project documents native Gemini CLI usage and also offers a standalone API-script path.
      That makes the repo more durable for people who do not want to be locked into exactly one AI coding interface.
    </div>

    <div class="note-box">
      There is also a Go dashboard TUI for browsing the pipeline visually, with filters and status views.
      That is a strong touch for anyone whose search has already moved beyond a handful of opportunities.
    </div>
  </section>

  <section class="section" id="strengths">
    <div class="slabel">Strengths</div>
    <h2>What makes Career-Ops better than most “AI for job search” ideas</h2>
    <p>
      Three things stand out technically and strategically.
    </p>

    <div class="stat-cards">
      <div class="stat-card">
        <div class="big">1</div>
        <div class="desc">It treats the job search as a pipeline with integrity checks, normalization, merging, and canonical states.</div>
      </div>
      <div class="stat-card">
        <div class="big">2</div>
        <div class="desc">It keeps a human in the loop and explicitly avoids autonomous application spam.</div>
      </div>
      <div class="stat-card">
        <div class="big">3</div>
        <div class="desc">It is configurable enough that the system can become specific to your profile rather than forcing generic templates.</div>
      </div>
      <div class="stat-card">
        <div class="big">4</div>
        <div class="desc">It bundles evaluation, resume generation, tracker management, and scanner workflows instead of scattering them across disconnected tools.</div>
      </div>
    </div>

    <div class="blue-box">
      The batch architecture is especially interesting. Many repos stop at “single input, single answer.”
      Career-Ops actually has a serious opinion about orchestration, workers, state, retries, and pipeline output.
    </div>
  </section>

  <section class="section" id="limits">
    <div class="slabel">Limits</div>
    <h2>This still depends on your judgment, your writing, and your honesty</h2>
    <p>
      There are a few caveats worth being explicit about.
    </p>

    <ul class="clean">
      <li>The project can personalize, but it cannot invent real proof points you do not have.</li>
      <li>If your CV is weak or inconsistent, every downstream output inherits that weakness.</li>
      <li>Compensation research and fit evaluation are useful approximations, not guarantees.</li>
      <li>Portal scanning breadth is helpful, but you still need to decide where to focus and what to ignore.</li>
      <li>The more specialized your target role, the more important profile tuning becomes.</li>
    </ul>

    <div class="warn-box">
      Treat every generated PDF and evaluation as a high-quality draft. Do not outsource final accountability to the system just because the output looks polished.
    </div>
  </section>

  <section class="section">
    <div class="slabel">Verdict</div>
    <h2>My take: this is one of the more mature open-source “AI for work” repos because it has an operating model behind it</h2>
    <p>
      What I like most is that Career-Ops is grounded in a real problem and a real outcome. It is not pretending AI magically gets you hired.
      It is building a system around selection, personalization, and pipeline control.
    </p>
    <p>
      If you are a serious candidate, especially in technical roles, this repo is worth reading even if you never adopt it fully.
      The structure alone will improve how you think about job search operations.
      And if you do adopt it, the real win is not the automation.
      The real win is that it forces your search to become <strong>explicit, reviewable, and strategic</strong>.
    </p>

    <div class="good-box">
      High-signal repo. Strong framing. Worth studying even if you only steal the operating principles and build your own lighter version.
    </div>
  </section>
</div>
...
<footer>
  <div>
    <div>// career-ops-guide //</div>
    <div>// built from repo docs + setup notes //</div>
  </div>
  <a href="https://github.com/santifer/career-ops" target="_blank" rel="noreferrer">github.com/santifer/career-ops</a>
</footer>

<script>
function setTheme(theme){
  document.documentElement.setAttribute('data-theme', theme);
  localStorage.setItem('career_ops_theme', theme);
  document.getElementById('tbtn').textContent = theme === 'dark' ? '☀' : '☾';
}
function toggleTheme(){
...
(function initTheme(){
  const saved = localStorage.getItem('career_ops_theme');
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="Caveman Mode is a no-fluff prompting style that cuts token usage by ~75% while keeping output quality intact.">
<meta name="keywords" content="prompt engineering, token reduction, caveman mode, Claude Code, cost savings, developer workflow">
<meta name="date" content="2026-04-14T10:00:00+05:30">
<meta name="category" content="Prompt Workflow">
<meta name="theme-color" content="#0a0806">
<meta property="article:published_time" content="2026-04-14T10:00:00+05:30">
<meta property="og:image" content="/articles/caveman-mode-guide.png">
<title>Caveman Mode — 75% Fewer Tokens | rk.codex</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Space+Mono:ital,wght@0,400;0,700;1,400&family=DM+Sans:wght@400;500;600;700&display=swap" rel="stylesheet">
<style>
:root[data-theme="dark"]{
  --bg:#0a0806;--bg2:#110f0b;--bg3:#1a1712;--bg4:#221f18;
  --border:rgba(255,200,80,0.07);--border2:rgba(255,200,80,0.15);
  --text:#f5ead8;--muted:#6b5e45;--muted2:#a89070;
  --acc:#f5a623;--acc-dim:rgba(245,166,35,0.08);--acc-border:rgba(245,166,35,0.25);--acc-text:#ffc85a;
  --red:#c0392b;--red-dim:rgba(192,57,43,0.08);--red-border:rgba(192,57,43,0.25);--red-text:#e74c3c;
  --code-bg:#0d0b08;--card-bg:#110f0b;
  --bone:#d4b896;--stone:#8c7b6b;
}
:root[data-theme="light"]{
  --bg:#fdf8f0;--bg2:#f5ede0;--bg3:#ece1d0;--bg4:#e0d1bc;
  --border:rgba(100,70,30,0.08);--border2:rgba(100,70,30,0.15);
  --text:#2a1f0e;--muted:#a08060;--muted2:#6b4f32;
  --acc:#c47d0e;--acc-dim:rgba(196,125,14,0.08);--acc-border:rgba(196,125,14,0.25);--acc-text:#8b5800;
  --red:#922b21;--red-dim:rgba(146,43,33,0.06);--red-border:rgba(146,43,33,0.2);--red-text:#922b21;
  --code-bg:#ede3d5;--card-bg:#fff8ef;
  --bone:#8b6840;--stone:#7a6352;
}
*{margin:0;padding:0;box-sizing:border-box;}
html{scroll-behavior:smooth;}
body{background:var(--bg);color:var(--text);font-family:'DM Sans',sans-serif;font-size:15px;line-height:1.7;transition:background .2s,color .2s;position:relative;}
...
.h-right{display:flex;align-items:center;gap:8px;}
.lang-pill{display:flex;align-items:center;background:var(--bg3);border:1px solid var(--border2);border-radius:20px;padding:2px;gap:2px;}
.lbtn{padding:3px 11px;border-radius:14px;font-size:11px;font-weight:700;cursor:pointer;color:var(--muted);border:none;background:transparent;letter-spacing:.04em;transition:all .15s;font-family:'DM Sans',sans-serif;}
.lbtn.active{background:var(--acc);color:#0a0806;}
.theme-btn{width:30px;height:30px;border-radius:50%;border:1px solid var(--border2);background:var(--bg3);cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:13px;transition:background .15s;font-family:'DM Sans',sans-serif;}
.theme-btn:hover{background:var(--bg4);}

/* HERO */
.hero-wrap{position:relative;overflow:hidden;border-bottom:1px solid var(--border);}
.hero-bg-lines{position:absolute;inset:0;background-image:repeating-linear-gradient(0deg,transparent,transparent 39px,var(--border) 39px,var(--border) 40px),repeating-linear-gradient(90deg,transparent,transparent 39px,var(--border) 39px,var(--border) 40px);opacity:.4;pointer-events:none;}
.hero-glow{position:absolute;top:-80px;left:50%;transform:translateX(-50%);width:800px;height:400px;background:radial-gradient(ellipse,rgba(245,166,35,0.06) 0%,transparent 65%);pointer-events:none;}
.hero{max-width:760px;margin:0 auto;padding:72px 24px 60px;position:relative;}

/* big caveman emoji */
.cave-emoji{font-size:64px;line-height:1;margin-bottom:20px;display:block;filter:drop-shadow(0 4px 24px rgba(245,166,35,0.25));animation:cave-float 3s ease-in-out infinite;}
@keyframes cave-float{0%,100%{transform:translateY(0);}50%{transform:translateY(-8px);}}

.badge-row{display:flex;gap:8px;margin-bottom:20px;flex-wrap:wrap;}
.badge{display:inline-flex;align-items:center;gap:5px;border:1px solid var(--border2);border-radius:20px;padding:4px 12px;font-size:11px;font-weight:700;letter-spacing:.07em;color:var(--muted2);background:var(--bg2);text-transform:uppercase;font-family:'Space Mono',monospace;}
.badge.g{border-color:var(--acc-border);color:var(--acc-text);background:var(--acc-dim);}
.badge.r{border-color:var(--red-border);color:var(--red-text);background:var(--red-dim);}
.dot{width:5px;height:5px;border-radius:50%;background:var(--acc);display:inline-block;animation:blink 2s infinite;}
@keyframes blink{0%,100%{opacity:1;}50%{opacity:.3;}}

h1{font-family:'Bebas Neue',sans-serif;font-size:clamp(52px,10vw,100px);font-weight:400;line-height:.95;letter-spacing:.02em;margin-bottom:18px;text-transform:uppercase;}
h1 .acc{color:var(--acc);}
h1 .sub-h{display:block;font-size:clamp(20px,4vw,38px);color:var(--muted2);letter-spacing:.04em;margin-top:6px;}

.hero-sub{font-size:16px;color:var(--muted2);max-width:520px;margin-bottom:32px;line-height:1.65;}
.hero-sub strong{color:var(--text);}

.install-box{background:var(--code-bg);border:1px solid var(--acc-border);border-radius:10px;padding:16px 20px;margin-bottom:40px;display:inline-block;}
.install-label{font-size:10px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--muted);margin-bottom:8px;font-family:'Space Mono',monospace;}
.install-cmd{font-family:'Space Mono',monospace;font-size:14px;color:var(--acc-text);}
...
.compare-card{border-radius:12px;padding:18px 20px;border:1px solid var(--border2);background:var(--bg2);}
.compare-card.bad{border-color:var(--red-border);background:var(--red-dim);}
.compare-card.good{border-color:var(--acc-border);background:var(--acc-dim);}
.compare-label{font-size:10px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;margin-bottom:10px;font-family:'Space Mono',monospace;}
.compare-card.bad .compare-label{color:var(--red-text);}
.compare-card.good .compare-label{color:var(--acc-text);}
.compare-text{font-family:'Space Mono',monospace;font-size:12px;line-height:1.8;color:var(--text);}
.compare-card.good .compare-text{color:var(--acc-text);}
.token-pill{display:inline-block;margin-top:10px;padding:3px 10px;border-radius:20px;font-size:10px;font-weight:700;font-family:'Space Mono',monospace;letter-spacing:.05em;}
.compare-card.bad .token-pill{background:var(--red-dim);color:var(--red-text);border:1px solid var(--red-border);}
.compare-card.good .token-pill{background:var(--acc-dim);color:var(--acc-text);border:1px solid var(--acc-border);}

.info-box{background:var(--acc-dim);border:1px solid var(--acc-border);border-radius:10px;padding:14px 18px;font-size:13px;color:var(--acc-text);margin:16px 0;line-height:1.65;}
.warn-box{background:var(--red-dim);border:1px solid var(--red-border);border-radius:10px;padding:14px 18px;font-size:13px;color:var(--red-text);margin:16px 0;line-height:1.65;}
.note-box{background:var(--bg2);border:1px solid var(--border2);border-radius:10px;padding:14px 18px;font-size:13px;color:var(--muted2);margin:16px 0;line-height:1.65;}
...
.step:first-child{border-top:1px solid var(--border);}
.snum{width:36px;height:36px;border-radius:8px;background:var(--acc-dim);border:1px solid var(--acc-border);display:flex;align-items:center;justify-content:center;font-family:'Bebas Neue',sans-serif;font-size:18px;color:var(--acc-text);margin-top:2px;letter-spacing:.02em;}
.step-body h3{font-size:15px;font-weight:600;margin-bottom:6px;color:var(--text);}
.step-body p{font-size:13px;margin-bottom:8px;}
...
/* INSTAGRAM SECTION */
.reel-section{margin:40px 0;}
.reel-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-top:20px;}
.reel-embed{border-radius:12px;overflow:hidden;border:1px solid var(--border2);}
.ig-cta{display:flex;align-items:center;gap:12px;background:var(--acc-dim);border:1px solid var(--acc-border);border-radius:12px;padding:16px 20px;margin-top:20px;text-decoration:none;transition:background .15s;}
.ig-cta:hover{background:rgba(245,166,35,0.14);}
.ig-cta .ig-icon{font-size:28px;}
.ig-cta-text .big-label{font-family:'Bebas Neue',sans-serif;font-size:20px;color:var(--acc-text);letter-spacing:.04em;}
.ig-cta-text .sub-label{font-size:12px;color:var(--muted2);}

/* FAQ */
.faq-item{padding:18px 0;border-bottom:1px solid var(--border);}
.faq-item:first-child{border-top:1px solid var(--border);}
.fq{font-size:14px;font-weight:600;margin-bottom:6px;color:var(--text);}
.fa{font-size:13px;color:var(--muted2);}
...
html[data-lang="hi"] .en{display:none;}
html[data-lang="hi"] .hi{display:inline;}
p.hi,div.hi,h2.hi,h3.hi,li.hi{display:none;}
html[data-lang="hi"] p.en,html[data-lang="hi"] div.en,html[data-lang="hi"] h2.en,html[data-lang="hi"] h3.en,html[data-lang="hi"] li.en{display:none;}
html[data-lang="hi"] p.hi,html[data-lang="hi"] div.hi,html[data-lang="hi"] h2.hi,html[data-lang="hi"] h3.hi,html[data-lang="hi"] li.hi{display:block;}
...
<header>
  <div class="h-left">
    <span class="h-brand">rk.codex</span>
    <span class="h-sep">/</span>
    <span class="h-page">caveman-mode-guide</span>
  </div>
  <div class="h-right">
    <div class="lang-pill">
      <button class="lbtn active" id="btn-en" onclick="setLang('en')">EN</button>
...
<div class="hero-wrap">
  ...
  <div class="hero-glow"></div>
  <div class="hero">
    <span class="cave-emoji">🦴</span>
    <div class="badge-row">
      <span class="badge g"><span class="dot"></span> AI Tool of the Day</span>
      <span class="badge">Claude Code</span>
      <span class="badge r">75% Token Savings</span>
    </div>

    <h1>
      <span class="acc">Caveman</span> Mode
      <span class="sub-h en">Brain big. Mouth smaller.</span>
      <span class="sub-h hi">Dimag bada. Muh chhota.</span>
    </h1>

    <p class="hero-sub en">
      <strong>Maine Claude ko caveman bana diya</strong> — aur seriously mera bill 75% kam ho gaya. Same accuracy. Zero fluff. One command install.
    </p>
    <p class="hero-sub hi">
      <strong>Claude ko caveman bana diya</strong> — bill 75% kam ho gaya. Same accuracy. Zero fluff. Ek command install.
    </p>

    <div class="install-box">
      <div class="install-label en">Install for Claude Code / Cursor</div>
      <div class="install-label hi">Claude Code / Cursor ke liye install</div>
      <div class="install-cmd">npx skills add JuliusBrussee/caveman</div>
    </div>

    <div class="stats-row">
      <div class="stat">
        <div class="sv">75%</div>
        <div class="sl en">Fewer tokens per response</div>
        <div class="sl hi">Kam tokens per response</div>
      </div>
      <div class="stat">
        <div class="sv">+26%</div>
        <div class="sl en">Accuracy improvement (Mar 2026)</div>
        <div class="sl hi">Accuracy improvement (Mar 2026)</div>
      </div>
      <div class="stat">
        <div class="sv">14K</div>
        <div class="sl en">GitHub stars · #1 trending</div>
        <div class="sl hi">GitHub stars · #1 trending tha</div>
      </div>
    </div>
  </div>
</div>
...
<div class="page">
  ...
  <div class="toc">
    ...
    <div class="toc-grid">
      <a href="#problem" class="toc-item"><span class="tn">01</span> <span class="en">The Token Problem</span><span class="hi">Token Problem</span></a>
      <a href="#install" class="toc-item"><span class="tn">02</span> <span class="en">Install in 60 Seconds</span><span class="hi">60 Second Install</span></a>
      <a href="#compare" class="toc-item"><span class="tn">03</span> <span class="en">Normal vs Caveman</span><span class="hi">Normal vs Caveman</span></a>
      <a href="#science" class="toc-item"><span class="tn">04</span> <span class="en">The Science</span><span class="hi">Research aur Science</span></a>
      <a href="#reels" class="toc-item"><span class="tn">05</span> <span class="en">Watch the Reel</span><span class="hi">Reel Dekho</span></a>
      <a href="#faq" class="toc-item"><span class="tn">06</span> <span class="en">FAQ</span><span class="hi">FAQ</span></a>
    </div>
  </div>

  <!-- 01 PROBLEM -->
  <div class="section" id="problem">
    <div class="slabel">01 — The Problem</div>
    <h2 class="en">Your AI is costing you <span style="color:var(--acc)">extra money</span> for saying nothing</h2>
    <h2 class="hi">Tumhara AI <span style="color:var(--acc)">extra paisa</span> le raha hai kuch bhi kehne ke liye</h2>

    <p class="en">Every time Claude Code responds, it burns tokens on filler phrases. <strong>"Sure! I'd be happy to help you with that."</strong> — you've seen it a thousand times. These aren't just annoying. They're billable tokens. Tokens = money. And you've been paying for them silently, every single session.</p>
    <p class="hi">Har baar jab Claude Code respond karta hai, filler phrases pe tokens burn hote hain. <strong>"Sure! I'd be happy to help you with that."</strong> — yeh hazaar baar dekha hoga. Yeh sirf irritating nahi — yeh billable tokens hain. Tokens = paisa. Aur tum chup-chaap pay karte raha ho, har session mein.</p>

    <div class="warn-box">
      <span class="en">⚠️ <strong>Token waste is invisible</strong> — it doesn't show up as a line item, but it compounds across every conversation. Heavy Claude Code users can easily waste $30–50/month on filler text alone.</span>
      <span class="hi">⚠️ <strong>Token waste invisible hai</strong> — yeh line item mein nahi dikhta, par har conversation mein compound hota hai. Heavy users easily ₹2500–4000/month waste karte hain sirf filler text pe.</span>
    </div>

    <p class="en">A developer named Julius Brussee had a simple idea: what if Claude spoke like a caveman? Short. Direct. No pleasantries. Just the answer.</p>
    <p class="hi">Julius Brussee naam ke developer ne socha: kya hoga agar Claude caveman ki tarah bole? Short. Direct. No pleasantries. Sirf answer.</p>
  </div>

  <!-- 02 INSTALL -->
  <div class="section" id="install">
    <div class="slabel">02 — Install</div>
    <h2 class="en">One command. <span style="color:var(--acc)">Done.</span></h2>
    <h2 class="hi">Ek command. <span style="color:var(--acc)">Khatam.</span></h2>

    <div class="steps">
      <div class="step">
        <div class="snum">1</div>
        <div class="step-body">
          <h3 class="en">For Claude Code (npx method)</h3>
          <h3 class="hi">Claude Code ke liye (npx method)</h3>
          <p class="en">Run this in your terminal. Node.js required.</p>
          <p class="hi">Terminal mein run karo. Node.js chahiye.</p>
          <div class="code-block">
            <div class="cmd">npx skills add JuliusBrussee/caveman</div>
          </div>
        </div>
      </div>
      ...
      <div class="step">
        <div class="snum">2</div>
        <div class="step-body">
          <h3 class="en">For Claude Code (plugin marketplace)</h3>
          <h3 class="hi">Claude Code (plugin marketplace) ke liye</h3>
          <p class="en">Alternative method via the Claude plugin system:</p>
          <p class="hi">Claude plugin system se alternative method:</p>
          <div class="code-block">
            <div class="cmd">claude plugin marketplace add JuliusBrussee/caveman</div>
          </div>
        </div>
      </div>
      ...
      <div class="step">
        <div class="snum">3</div>
        <div class="step-body">
          <h3 class="en">For Cursor, Windsurf, Copilot</h3>
          <h3 class="hi">Cursor, Windsurf, Copilot ke liye</h3>
          <p class="en">Add the caveman system prompt to your editor's custom instructions / rules section. Works everywhere that accepts system prompts.</p>
          <p class="hi">Caveman system prompt apne editor ke custom instructions / rules section mein daalo. Har jagah kaam karta hai jahan system prompts accept hote hain.</p>
          <div class="info-box">
            <span class="en">🦴 Once installed — auto-activates every session. No config needed.</span>
            <span class="hi">🦴 Install karo ek baar — har session mein auto-activate. Koi config nahi.</span>
          </div>
        </div>
      </div>
    </div>

    <p class="en">GitHub repository: <a href="https://github.com/JuliusBrussee/caveman" target="_blank" style="color:var(--acc-text);text-decoration:none;font-family:'Space Mono',monospace;font-size:13px;">github.com/JuliusBrussee/caveman ↗</a></p>
    <p class="hi">GitHub repository: <a href="https://github.com/JuliusBrussee/caveman" target="_blank" style="color:var(--acc-text);text-decoration:none;font-family:'Space Mono',monospace;font-size:13px;">github.com/JuliusBrussee/caveman ↗</a></p>
  </div>

  <!-- 03 COMPARE -->
  <div class="section" id="compare">
    <div class="slabel">03 — Side by Side</div>
    <h2 class="en">Normal Claude <span style="color:var(--acc)">vs</span> Caveman Mode</h2>
    <h2 class="hi">Normal Claude <span style="color:var(--acc)">vs</span> Caveman Mode</h2>
    <p class="en">Same question. Same correct answer. One is expensive. One is a caveman.</p>
    <p class="hi">Same sawaal. Same sahi jawab. Ek mehenga. Ek caveman.</p>

    <div class="compare-wrap">
      <div class="compare-card bad">
        <div class="compare-label">😩 Normal Claude</div>
        <div class="compare-text">The reason your React component is re-rendering is likely because you're creating a new object reference on each render cycle. I'd recommend using useMemo to memoize the object and prevent unnecessary re-renders.</div>
        <div class="token-pill">~42 tokens</div>
      </div>
      <div class="compare-card good">
        <div class="compare-label">🦴 Caveman Mode</div>
        <div class="compare-text">New object ref each render. Wrap in useMemo.</div>
        <div class="token-pill">~11 tokens • 75% saved</div>
      </div>
    </div>
    ...
    <div class="compare-wrap">
      <div class="compare-card bad">
        <div class="compare-label">😩 Normal Claude</div>
        <div class="compare-text">Great question! The issue with your async function is that you're not awaiting the Promise. I'd be happy to help you fix this — simply add the await keyword before your fetch call.</div>
        <div class="token-pill">~38 tokens</div>
      </div>
      <div class="compare-card good">
        <div class="compare-label">🦴 Caveman Mode</div>
        <div class="compare-text">Missing await before fetch. Add it.</div>
        <div class="token-pill">~7 tokens • 82% saved</div>
      </div>
    </div>

    <div class="note-box">
      <span class="en">💡 <strong>Same fix. Same accuracy.</strong> Caveman strips the fluff, not the knowledge. Claude's brain doesn't get smaller — just its mouth.</span>
      <span class="hi">💡 <strong>Same fix. Same accuracy.</strong> Caveman sirf fluff hataata hai, knowledge nahi. Claude ka dimag chota nahi hota — sirf muh chota hota hai.</span>
    </div>
  </div>
  ...
  <div class="section" id="science">
    ...
    <h2 class="en">It's not just about <span style="color:var(--acc)">cost</span></h2>
    <h2 class="hi">Sirf <span style="color:var(--acc)">paisa</span> ki baat nahi</h2>

    <p class="en">Here's the plot twist: a March 2026 research paper proved that brevity actually <em>improves</em> Claude's accuracy. Fewer words = fewer chances to confuse itself or drift off-topic.</p>
    <p class="hi">Plot twist: March 2026 ke research paper ne prove kiya ki brevity se Claude ki accuracy actually <em>improve</em> hoti hai. Kam words = confusion aur drift ka kam chance.</p>

    <div class="stat-cards">
      <div class="stat-card">
        <div class="big">26<span style="font-size:28px;color:var(--muted2)">pp</span></div>
        <div class="desc en">Accuracy improvement from brief responses (March 2026 paper)</div>
        <div class="desc hi">Brief responses se accuracy improvement (March 2026 paper)</div>
      </div>
      <div class="stat-card">
        <div class="big">75<span style="font-size:28px;color:var(--muted2)">%</span></div>
        <div class="desc en">Average token reduction per response with Caveman Mode</div>
        <div class="desc hi">Caveman Mode se average token reduction per response</div>
      </div>
      <div class="stat-card">
        <div class="big">14K</div>
        <div class="desc en">GitHub stars — organically. No ads. Just developers sharing it.</div>
        <div class="desc hi">GitHub stars — organic. Koi ads nahi. Sirf developers ne share kiya.</div>
      </div>
      <div class="stat-card">
        <div class="big">#1</div>
        <div class="desc en">Trending on GitHub last week across all repositories</div>
        <div class="desc hi">Last week GitHub pe #1 trending tha</div>
      </div>
    </div>

    <div class="info-box">
      <span class="en">🧠 <strong>Brain still big. Mouth smaller.</strong> Caveman mode removes performative helpfulness — not actual capability. The model still has access to everything it knows.</span>
      <span class="hi">🧠 <strong>Dimag bada. Muh chhota.</strong> Caveman mode performative helpfulness hataata hai — actual capability nahi. Model ke paas ab bhi sab kuch hai jo wo jaanta hai.</span>
    </div>
  </div>

  <!-- 05 REELS / INSTAGRAM -->
  <div class="section" id="reels">
    <div class="slabel">05 — Watch it in Action</div>
    <h2 class="en">See the <span style="color:var(--acc)">Reel</span></h2>
    <h2 class="hi"><span style="color:var(--acc)">Reel</span> Dekho</h2>
    <p class="en">Full demo with terminal recording + explanation on Instagram. Follow <strong>@rk.codex</strong> for daily AI tools that actually matter.</p>
    <p class="hi">Full demo terminal recording ke saath Instagram pe hai. Daily AI tools ke liye follow karo <strong>@rk.codex</strong>.</p>

    <div class="reel-section">
      <div class="reel-grid">
        <div class="reel-embed">
          <blockquote class="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/reel/DW_llMRiNVX/?utm_source=ig_embed&utm_campaign=loading" data-instgrm-version="14" style="background:#FFF;border:0;border-radius:0;box-shadow:none;margin:0;max-width:100%;min-width:0;padding:0;width:100%;"><div style="padding:16px;"><a href="https://www.instagram.com/reel/DW_llMRiNVX/" style="background:#FFFFFF;line-height:0;padding:0;text-align:center;text-decoration:none;width:100%;" target="_blank"><div style="display:flex;flex-direction:row;align-items:center;"><div style="background-color:#F4F4F4;border-radius:50%;height:40px;margin-right:14px;width:40px;"></div><div style="display:flex;flex-direction:column;flex-grow:1;justify-content:center;"><div style="background-color:#F4F4F4;border-radius:4px;height:14px;margin-bottom:6px;width:100px;"></div><div style="background-color:#F4F4F4;border-radius:4px;height:14px;width:60px;"></div></div></div><div style="padding:19% 0;"></div><div style="display:block;height:50px;margin:0 auto 12px;width:50px;"><svg width="50px" height="50px" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><g transform="translate(-511,-20)" fill="#000"><path d="M556.869,30.41 C554.814,30.41 553.148,32.076 553.148,34.131 C553.148,36.186 554.814,37.852 556.869,37.852 C558.924,37.852 560.59,36.186 560.59,34.131 C560.59,32.076 558.924,30.41 556.869,30.41 M541,60.657 C535.114,60.657 530.342,55.887 530.342,50 C530.342,44.114 535.114,39.342 541,39.342 C546.887,39.342 551.658,44.114 551.658,50 C551.658,55.887 546.887,60.657 541,60.657 M541,33.886 C532.1,33.886 524.886,41.1 524.886,50 C524.886,58.899 532.1,66.113 541,66.113 C549.9,66.113 557.115,58.899 557.115,50 C557.115,41.1 549.9,33.886 541,33.886 M565.378,62.101 C565.244,65.022 564.756,66.606 564.346,67.663 C563.803,69.06 563.154,70.057 562.106,71.106 C561.058,72.155 560.06,72.803 558.662,73.347 C557.607,73.757 556.021,74.244 553.102,74.378 C549.944,74.521 548.997,74.552 541,74.552 C533.003,74.552 532.056,74.521 528.898,74.378 C525.979,74.244 524.393,73.757 523.338,73.347 C521.94,72.803 520.942,72.155 519.894,71.106 C518.846,70.057 518.197,69.06 517.654,67.663 C517.244,66.606 516.755,65.022 516.623,62.101 C516.479,58.943 516.448,57.996 516.448,50 C516.448,42.003 516.479,41.056 516.623,37.899 C516.755,34.978 517.244,33.391 517.654,32.338 C518.197,30.938 518.846,29.942 519.894,28.894 C520.942,27.846 521.94,27.196 523.338,26.654 C524.393,26.244 525.979,25.756 528.898,25.623 C532.057,25.479 533.004,25.448 541,25.448 C548.997,25.448 549.943,25.479 553.102,25.623 C556.021,25.756 557.607,26.244 558.662,26.654 C560.06,27.196 561.058,27.846 562.106,28.894 C563.154,29.942 563.803,30.938 564.346,32.338 C564.756,33.391 565.244,34.978 565.378,37.899 C565.522,41.056 565.552,42.003 565.552,50 C565.552,57.996 565.522,58.943 565.378,62.101 M570.82,37.631 C570.674,34.438 570.167,32.258 569.425,30.349 C568.659,28.377 567.633,26.702 565.965,25.035 C564.297,23.368 562.623,22.342 560.652,21.575 C558.743,20.834 556.562,20.326 553.369,20.18 C550.169,20.033 549.148,20 541,20 C532.853,20 531.831,20.033 528.631,20.18 C525.438,20.326 523.257,20.834 521.349,21.575 C519.376,22.342 517.703,23.368 516.035,25.035 C514.368,26.702 513.342,28.377 512.574,30.349 C511.834,32.258 511.326,34.438 511.181,37.631 C511.035,40.831 511,41.851 511,50 C511,58.147 511.035,59.17 511.181,62.369 C511.326,65.562 511.834,67.743 512.574,69.651 C513.342,71.625 514.368,73.296 516.035,74.965 C517.703,76.634 519.376,77.658 521.349,78.425 C523.257,79.167 525.438,79.673 528.631,79.82 C531.831,79.965 532.853,80.001 541,80.001 C549.148,80.001 550.169,79.965 553.369,79.82 C556.562,79.673 558.743,79.167 560.652,78.425 C562.623,77.658 564.297,76.634 565.965,74.965 C567.633,73.296 568.659,71.625 569.425,69.651 C570.167,67.743 570.674,65.562 570.82,62.369 C570.966,59.17 571,58.147 571,50 C571,41.851 570.966,40.831 570.82,37.631"/></g></g></svg></div><p style="color:#c9c8cd;font-family:Arial,sans-serif;font-size:14px;margin:8px 0 0;text-align:center;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">A post shared by Rk Codex (@rk.codex)</p></a></div></blockquote>
        </div>
        <div class="reel-embed">
          <blockquote class="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/reel/DW6FmJ3vnya/?utm_source=ig_embed&utm_campaign=loading" data-instgrm-version="14" style="background:#FFF;border:0;border-radius:0;box-shadow:none;margin:0;max-width:100%;min-width:0;padding:0;width:100%;"><div style="padding:16px;"><a href="https://www.instagram.com/reel/DW6FmJ3vnya/" style="background:#FFFFFF;line-height:0;padding:0;text-align:center;text-decoration:none;width:100%;" target="_blank"><div style="display:flex;flex-direction:row;align-items:center;"><div style="background-color:#F4F4F4;border-radius:50%;height:40px;margin-right:14px;width:40px;"></div><div style="display:flex;flex-direction:column;flex-grow:1;justify-content:center;"><div style="background-color:#F4F4F4;border-radius:4px;height:14px;margin-bottom:6px;width:100px;"></div><div style="background-color:#F4F4F4;border-radius:4px;height:14px;width:60px;"></div></div></div><div style="padding:19% 0;"></div><div style="display:block;height:50px;margin:0 auto 12px;width:50px;"><svg width="50px" height="50px" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><g transform="translate(-511,-20)" fill="#000"><path d="M556.869,30.41 C554.814,30.41 553.148,32.076 553.148,34.131 C553.148,36.186 554.814,37.852 556.869,37.852 C558.924,37.852 560.59,36.186 560.59,34.131 C560.59,32.076 558.924,30.41 556.869,30.41 M541,60.657 C535.114,60.657 530.342,55.887 530.342,50 C530.342,44.114 535.114,39.342 541,39.342 C546.887,39.342 551.658,44.114 551.658,50 C551.658,55.887 546.887,60.657 541,60.657 M541,33.886 C532.1,33.886 524.886,41.1 524.886,50 C524.886,58.899 532.1,66.113 541,66.113 C549.9,66.113 557.115,58.899 557.115,50 C557.115,41.1 549.9,33.886 541,33.886 M565.378,62.101 C565.244,65.022 564.756,66.606 564.346,67.663 C563.803,69.06 563.154,70.057 562.106,71.106 C561.058,72.155 560.06,72.803 558.662,73.347 C557.607,73.757 556.021,74.244 553.102,74.378 C549.944,74.521 548.997,74.552 541,74.552 C533.003,74.552 532.056,74.521 528.898,74.378 C525.979,74.244 524.393,73.757 523.338,73.347 C521.94,72.803 520.942,72.155 519.894,71.106 C518.846,70.057 518.197,69.06 517.654,67.663 C517.244,66.606 516.755,65.022 516.623,62.101 C516.479,58.943 516.448,57.996 516.448,50 C516.448,42.003 516.479,41.056 516.623,37.899 C516.755,34.978 517.244,33.391 517.654,32.338 C518.197,30.938 518.846,29.942 519.894,28.894 C520.942,27.846 521.94,27.196 523.338,26.654 C524.393,26.244 525.979,25.756 528.898,25.623 C532.057,25.479 533.004,25.448 541,25.448 C548.997,25.448 549.943,25.479 553.102,25.623 C556.021,25.756 557.607,26.244 558.662,26.654 C560.06,27.196 561.058,27.846 562.106,28.894 C563.154,29.942 563.803,30.938 564.346,32.338 C564.756,33.391 565.244,34.978 565.378,37.899 C565.522,41.056 565.552,42.003 565.552,50 C565.552,57.996 565.522,58.943 565.378,62.101 M570.82,37.631 C570.674,34.438 570.167,32.258 569.425,30.349 C568.659,28.377 567.633,26.702 565.965,25.035 C564.297,23.368 562.623,22.342 560.652,21.575 C558.743,20.834 556.562,20.326 553.369,20.18 C550.169,20.033 549.148,20 541,20 C532.853,20 531.831,20.033 528.631,20.18 C525.438,20.326 523.257,20.834 521.349,21.575 C519.376,22.342 517.703,23.368 516.035,25.035 C514.368,26.702 513.342,28.377 512.574,30.349 C511.834,32.258 511.326,34.438 511.181,37.631 C511.035,40.831 511,41.851 511,50 C511,58.147 511.035,59.17 511.181,62.369 C511.326,65.562 511.834,67.743 512.574,69.651 C513.342,71.625 514.368,73.296 516.035,74.965 C517.703,76.634 519.376,77.658 521.349,78.425 C523.257,79.167 525.438,79.673 528.631,79.82 C531.831,79.965 532.853,80.001 541,80.001 C549.148,80.001 550.169,79.965 553.369,79.82 C556.562,79.673 558.743,79.167 560.652,78.425 C562.623,77.658 564.297,76.634 565.965,74.965 C567.633,73.296 568.659,71.625 569.425,69.651 C570.167,67.743 570.674,65.562 570.82,62.369 C570.966,59.17 571,58.147 571,50 C571,41.851 570.966,40.831 570.82,37.631"/></g></g></svg></div><p style="color:#c9c8cd;font-family:Arial,sans-serif;font-size:14px;margin:8px 0 0;text-align:center;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">A post shared by Rk Codex (@rk.codex)</p></a></div></blockquote>
        </div>
        <div class="reel-embed">
          <blockquote class="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/p/DW5bWzTgUkT/?utm_source=ig_embed&utm_campaign=loading" data-instgrm-version="14" style="background:#FFF;border:0;border-radius:0;box-shadow:none;margin:0;max-width:100%;min-width:0;padding:0;width:100%;"><div style="padding:16px;"><a href="https://www.instagram.com/p/DW5bWzTgUkT/" style="background:#FFFFFF;line-height:0;padding:0;text-align:center;text-decoration:none;width:100%;" target="_blank"><div style="display:flex;flex-direction:row;align-items:center;"><div style="background-color:#F4F4F4;border-radius:50%;height:40px;margin-right:14px;width:40px;"></div><div style="display:flex;flex-direction:column;flex-grow:1;justify-content:center;"><div style="background-color:#F4F4F4;border-radius:4px;height:14px;margin-bottom:6px;width:100px;"></div><div style="background-color:#F4F4F4;border-radius:4px;height:14px;width:60px;"></div></div></div><div style="padding:19% 0;"></div><div style="display:block;height:50px;margin:0 auto 12px;width:50px;"><svg width="50px" height="50px" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><g transform="translate(-511,-20)" fill="#000"><path d="M556.869,30.41 C554.814,30.41 553.148,32.076 553.148,34.131 C553.148,36.186 554.814,37.852 556.869,37.852 C558.924,37.852 560.59,36.186 560.59,34.131 C560.59,32.076 558.924,30.41 556.869,30.41 M541,60.657 C535.114,60.657 530.342,55.887 530.342,50 C530.342,44.114 535.114,39.342 541,39.342 C546.887,39.342 551.658,44.114 551.658,50 C551.658,55.887 546.887,60.657 541,60.657 M541,33.886 C532.1,33.886 524.886,41.1 524.886,50 C524.886,58.899 532.1,66.113 541,66.113 C549.9,66.113 557.115,58.899 557.115,50 C557.115,41.1 549.9,33.886 541,33.886 M565.378,62.101 C565.244,65.022 564.756,66.606 564.346,67.663 C563.803,69.06 563.154,70.057 562.106,71.106 C561.058,72.155 560.06,72.803 558.662,73.347 C557.607,73.757 556.021,74.244 553.102,74.378 C549.944,74.521 548.997,74.552 541,74.552 C533.003,74.552 532.056,74.521 528.898,74.378 C525.979,74.244 524.393,73.757 523.338,73.347 C521.94,72.803 520.942,72.155 519.894,71.106 C518.846,70.057 518.197,69.06 517.654,67.663 C517.244,66.606 516.755,65.022 516.623,62.101 C516.479,58.943 516.448,57.996 516.448,50 C516.448,42.003 516.479,41.056 516.623,37.899 C516.755,34.978 517.244,33.391 517.654,32.338 C518.197,30.938 518.846,29.942 519.894,28.894 C520.942,27.846 521.94,27.196 523.338,26.654 C524.393,26.244 525.979,25.756 528.898,25.623 C532.057,25.479 533.004,25.448 541,25.448 C548.997,25.448 549.943,25.479 553.102,25.623 C556.021,25.756 557.607,26.244 558.662,26.654 C560.06,27.196 561.058,27.846 562.106,28.894 C563.154,29.942 563.803,30.938 564.346,32.338 C564.756,33.391 565.244,34.978 565.378,37.899 C565.522,41.056 565.552,42.003 565.552,50 C565.552,57.996 565.522,58.943 565.378,62.101 M570.82,37.631 C570.674,34.438 570.167,32.258 569.425,30.349 C568.659,28.377 567.633,26.702 565.965,25.035 C564.297,23.368 562.623,22.342 560.652,21.575 C558.743,20.834 556.562,20.326 553.369,20.18 C550.169,20.033 549.148,20 541,20 C532.853,20 531.831,20.033 528.631,20.18 C525.438,20.326 523.257,20.834 521.349,21.575 C519.376,22.342 517.703,23.368 516.035,25.035 C514.368,26.702 513.342,28.377 512.574,30.349 C511.834,32.258 511.326,34.438 511.181,37.631 C511.035,40.831 511,41.851 511,50 C511,58.147 511.035,59.17 511.181,62.369 C511.326,65.562 511.834,67.743 512.574,69.651 C513.342,71.625 514.368,73.296 516.035,74.965 C517.703,76.634 519.376,77.658 521.349,78.425 C523.257,79.167 525.438,79.673 528.631,79.82 C531.831,79.965 532.853,80.001 541,80.001 C549.148,80.001 550.169,79.965 553.369,79.82 C556.562,79.673 558.743,79.167 560.652,78.425 C562.623,77.658 564.297,76.634 565.965,74.965 C567.633,73.296 568.659,71.625 569.425,69.651 C570.167,67.743 570.674,65.562 570.82,62.369 C570.966,59.17 571,58.147 571,50 C571,41.851 570.966,40.831 570.82,37.631"/></g></g></svg></div><p style="color:#c9c8cd;font-family:Arial,sans-serif;font-size:14px;margin:8px 0 0;text-align:center;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">A post shared by Rk Codex (@rk.codex)</p></a></div></blockquote>
        </div>
      </div>

      <a href="https://www.instagram.com/rk.codex/" target="_blank" class="ig-cta">
        <span class="ig-icon">📱</span>
        <div class="ig-cta-text">
          <div class="big-label">Follow @rk.codex on Instagram</div>
          <div class="sub-label en">Daily AI tools that actually matter for developers · Reels every day at 7PM IST</div>
          <div class="sub-label hi">Daily AI tools jo actually kaam aate hain · Roz reels 7PM IST pe</div>
        </div>
      </a>
    </div>
  </div>
  ...
  <div class="section" id="faq">
    <div class="slabel">06 — FAQ</div>
    <h2 class="en">Common <span style="color:var(--acc)">Questions</span></h2>
    <h2 class="hi">Common <span style="color:var(--acc)">Sawaal</span></h2>

    <div class="faq-item">
      <div class="fq"><span class="en">Does Caveman Mode work with Cursor and Windsurf?</span><span class="hi">Kya Caveman Mode Cursor aur Windsurf ke saath kaam karta hai?</span></div>
      <div class="fa"><span class="en">Yes — any IDE or tool that accepts custom system prompts or rules files. Add the caveman prompt to your <code>.cursorrules</code> or equivalent settings.</span><span class="hi">Haan — koi bhi IDE ya tool jo custom system prompts ya rules files accept karta hai. Caveman prompt ko <code>.cursorrules</code> ya equivalent settings mein daalo.</span></div>
    </div>

    <div class="faq-item">
      <div class="fq"><span class="en">Will it break my workflow or miss details?</span><span class="hi">Kya yeh mera workflow break karega ya details miss karega?</span></div>
      <div class="fa"><span class="en">No. Caveman mode strips filler language and unnecessary explanations — it doesn't remove code, logic, or technical detail. All the substance remains, just without the fluff.</span><span class="hi">Nahi. Caveman mode sirf filler language aur unnecessary explanations hataata hai — code, logic, ya technical detail nahi hataata. Saari substance rehti hai, sirf fluff nahi.</span></div>
    </div>

    <div class="faq-item">
      <div class="fq"><span class="en">Do I need to re-install it every session?</span><span class="hi">Kya mujhe har session mein re-install karna hoga?</span></div>
      <div class="fa"><span class="en">No. Install once — it auto-activates in every session through the skills / plugin system. Set and forget.</span><span class="hi">Nahi. Ek baar install karo — har session mein auto-activate ho jaata hai skills / plugin system ke through. Set karo aur bhool jao.</span></div>
    </div>

    <div class="faq-item">
      <div class="fq"><span class="en">How is 75% token reduction calculated?</span><span class="hi">75% token reduction calculate kaise hua?</span></div>
      <div class="fa"><span class="en">Based on community benchmarks comparing identical prompts with and without Caveman Mode. The actual savings vary — simple questions save less, complex multi-step responses save more.</span><span class="hi">Community benchmarks pe based hai — same prompts Caveman Mode ke saath aur bina. Actual savings vary karte hain — simple questions mein kam, complex responses mein zyada.</span></div>
    </div>

    <div class="faq-item">
      <div class="fq"><span class="en">Is this an official Anthropic/Claude feature?</span><span class="hi">Kya yeh official Anthropic/Claude feature hai?</span></div>
      <div class="fa"><span class="en">No — it's a community-built skill by developer Julius Brussee. It's open source on GitHub and has been independently verified to work well. Anthropic has no official affiliation.</span><span class="hi">Nahi — yeh developer Julius Brussee ka community-built skill hai. GitHub pe open source hai aur independently verified hai ki accha kaam karta hai. Anthropic ka koi official affiliation nahi hai.</span></div>
    </div>

    <div class="faq-item">
      <div class="fq"><span class="en">Where's the GitHub repo?</span><span class="hi">GitHub repo kahan hai?</span></div>
      <div class="fa"><a href="https://github.com/JuliusBrussee/caveman" target="_blank" style="color:var(--acc-text);font-family:'Space Mono',monospace;font-size:13px;">github.com/JuliusBrussee/caveman ↗</a> — 14,000+ stars.</div>
    </div>
  </div>
...
<footer>
  <span>Guide by <a href="https://www.instagram.com/rk.codex/" target="_blank">rk.codex</a> · AI Tool of the Day</span>
  <a href="https://github.com/JuliusBrussee/caveman" target="_blank">github.com/JuliusBrussee/caveman ↗</a>
</footer>
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="A curated vault of hallmark-quality prompts for ChatGPT image generation with cinematic posters, brand visuals, and creative content prompts.">
<meta name="keywords" content="chatgpt, image prompts, hallmark prompts, ai image generation, prompt vault, rk codex, creative prompts">
<meta name="date" content="2026-06-03T12:00:00+05:30">
<meta name="category" content="Prompt System">
<meta name="theme-color" content="#0a0a0a">
<meta name="github" content="https://github.com/nutlope/hallmark">
<meta property="article:published_time" content="2026-06-03T12:00:00+05:30">
<meta property="og:image" content="/articles/rk-codex-hallmark-prompts.png">
<title>rk.codex – Hallmark Prompt Vault</title>
...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .stat-label { font-size: 0.75rem; color: var(--muted); margin-top: 2px; letter-spacing: 0.5px; }
  ...
  .section-sub { color: var(--muted); font-size: 0.88rem; margin-bottom: 32px; }
  .filters {
    display: flex;
    gap: 8px;
    flex-wrap: wrap;
  ...
  .prompt-card:hover { border-color: #2a2a2a; transform: translateY(-2px); }
  ...
  .reel-card:hover { border-color: var(--accent2); transform: translateY(-2px); }
  .reel-icon { font-size: 1.6rem; margin-bottom: 10px; }
  .reel-title { font-family: 'Syne', sans-serif; font-size: 0.9rem; font-weight: 700; margin-bottom: 6px; }
  .reel-desc { font-size: 0.75rem; color: var(--muted); line-height: 1.5; }
  ...
  .ads-inner { max-width: 560px; margin: 0 auto; }
  .ads-section h2 {
    font-family: 'Syne', sans-serif;
    font-size: 1.8rem;
    font-weight: 800;
  ...
  .ads-section p { color: var(--muted); font-size: 0.9rem; line-height: 1.7; margin-bottom: 28px; }
  .email-chip {
    display: inline-flex;
    align-items: center;
    gap: 10px;
  ...
  .btn-email:hover { background: #e0a400; transform: translateY(-1px); }
  ...
  .footer-left { font-family: 'Syne', sans-serif; font-weight: 800; font-size: 1rem; }
...
<!-- HEADER -->
<header>
  <div class="logo">rk<span>.</span>codex</div>
  <div class="header-links">
    <a href="https://www.instagram.com/rk.codex" target="_blank">Instagram</a>
    <a href="https://www.youtube.com/@rk-codex" target="_blank">YouTube</a>
    <a href="#ads" class="btn btn-primary" style="padding:8px 16px;font-size:0.78rem;">Drop Ads ↗</a>
  </div>
</header>

<!-- HERO -->
<div class="hero">
  <div class="badge">🔥 Hallmark Prompt Vault</div>
  <h1>Make websites that don't look like <em>AI slop</em></h1>
  <p>50+ hand-picked prompts for Hallmark + Claude Code. Copy, paste, and build websites that actually look designed by a human.</p>
  <div class="hero-actions">
    <a href="https://www.instagram.com/rk.codex" target="_blank" class="btn btn-primary">@rk.codex on Instagram</a>
    <a href="https://www.youtube.com/@rk-codex" target="_blank" class="btn btn-yt">▶ YouTube Channel</a>
    <a href="#ads" class="btn btn-outline">Drop Ads Enquiry</a>
  </div>
</div>

<!-- STATS -->
<div class="stats">
  <div class="stat"><div class="stat-num">50+</div><div class="stat-label">Prompts Inside</div></div>
  <div class="stat"><div class="stat-num">10</div><div class="stat-label">Categories</div></div>
  <div class="stat"><div class="stat-num">0₹</div><div class="stat-label">Completely Free</div></div>
  <div class="stat"><div class="stat-num">∞</div><div class="stat-label">Websites You Can Build</div></div>
</div>

<!-- PROMPTS SECTION -->
<div class="section">
  <div class="section-title">The Prompt Vault</div>
  <div class="section-sub">Click any card to copy the prompt. Use it directly in Claude Code with Hallmark installed.</div>

  <input class="search-bar" type="text" placeholder="Search prompts... e.g. portfolio, saas, dark..." id="searchInput" oninput="filterPrompts()">

  <div class="filters" id="filters">
    <button class="filter-btn active" onclick="setFilter('all',this)">All</button>
    <button class="filter-btn" onclick="setFilter('portfolio',this)">Portfolio</button>
    <button class="filter-btn" onclick="setFilter('saas',this)">SaaS</button>
    <button class="filter-btn" onclick="setFilter('agency',this)">Agency</button>
    <button class="filter-btn" onclick="setFilter('ecommerce',this)">E-commerce</button>
    <button class="filter-btn" onclick="setFilter('landing',this)">Landing Page</button>
    <button class="filter-btn" onclick="setFilter('blog',this)">Blog</button>
    <button class="filter-btn" onclick="setFilter('startup',this)">Startup</button>
    <button class="filter-btn" onclick="setFilter('dark',this)">Dark Theme</button>
    <button class="filter-btn" onclick="setFilter('minimal',this)">Minimal</button>
    <button class="filter-btn" onclick="setFilter('creative',this)">Creative</button>
  </div>
...
<div class="section" style="padding-top:0">
  <div class="section-title">More from rk.codex</div>
  <div class="section-sub">Watch my other reels for more AI tools, tips & tricks</div>
  <div class="reels-grid">
    <a class="reel-card" href="https://www.instagram.com/rk.codex" target="_blank">
      <div class="reel-icon">🎨</div>
      <div class="reel-title">Hallmark Install Guide</div>
      <div class="reel-desc">How to install Hallmark in Claude Code and build stunning websites in seconds.</div>
    </a>
    <a class="reel-card" href="https://www.instagram.com/rk.codex" target="_blank">
      <div class="reel-icon">🎬</div>
      <div class="reel-title">ViMax – AI Video Generator</div>
      <div class="reel-desc">Type one idea. Get a full cinematic video. This tool is insane.</div>
    </a>
    <a class="reel-card" href="https://www.instagram.com/rk.codex" target="_blank">
      <div class="reel-icon">🤖</div>
      <div class="reel-title">Claude Code Tips</div>
      <div class="reel-desc">Hidden Claude Code features most developers don't know about.</div>
    </a>
    <a class="reel-card" href="https://www.youtube.com/@rk-codex" target="_blank">
      <div class="reel-icon">▶️</div>
      <div class="reel-title">Full Tutorials on YouTube</div>
      <div class="reel-desc">Deep dives, full builds, and step-by-step guides on the rk.codex YouTube channel.</div>
    </a>
  </div>
</div>
...
<div class="ads-section" id="ads">
  <div class="ads-inner">
    <div class="badge">🤝 Collaborate</div>
    <h2>Want to advertise with rk.codex?</h2>
    <p>Reach thousands of developers, designers, and AI enthusiasts. Drop a mail and let's talk about promoting your product, tool, or brand on my reels and YouTube channel.</p>
    <div class="email-chip">📩 radhakishanjangid404@gmail.com</div>
    <br><br>
    <a href="mailto:radhakishanjangid404@gmail.com?subject=Ad Enquiry – rk.codex&body=Hi RK, I'd like to discuss an advertising opportunity with you." class="btn-email">📨 Drop Ad Enquiry Now</a>
  </div>
</div>
...
<footer>
  <div>
    <div class="footer-left">rk<span>.</span>codex</div>
    <div class="footer-links" style="margin-top:10px">
      <a href="https://www.instagram.com/rk.codex" target="_blank">Instagram</a>
      <a href="https://www.youtube.com/@rk-codex" target="_blank">YouTube</a>
      <a href="https://github.com/nutlope/hallmark" target="_blank">Hallmark GitHub</a>
    </div>
  </div>
  <div class="footer-right" style="text-align:right">
    <div>Made with ❤️ for the dev community</div>
    <div style="margin-top:6px;color:#333">No AI slop. Only real design.</div>
  </div>
</footer>
...
const prompts = [
  // PORTFOLIO
  { tag:'portfolio', title:'Dark Photographer Portfolio', text:'Build a dark-themed photographer portfolio. Use editorial black & white tones, large full-bleed image galleries, minimal serif typography, and sticky side navigation. No gradients, no purple.' },
  { tag:'portfolio', title:'Brutalist Dev Portfolio', text:'Create a brutalist developer portfolio. Raw grid layout, monospaced fonts, bold black borders, stark white backgrounds, numbered sections. Make it feel like a terminal met a newspaper.' },
  { tag:'portfolio', title:'Designer Portfolio – Editorial', text:'Build an editorial-style designer portfolio. Think magazine spreads: asymmetric grid, pull quotes, large page numbers, unexpected image crops. Font: a sharp serif headline with clean body.' },
  { tag:'portfolio', title:'Minimal Motion Portfolio', text:'Create a minimal portfolio with scroll-triggered animations. Each section slides in with staggered delays. Stick to 2 colors only. Let whitespace do the heavy lifting.' },
  { tag:'portfolio', title:'Architect Portfolio', text:'Build a portfolio for an architect. Brutalist concrete tones, technical grid lines, blueprint-style hover states, clean section titles with thin uppercase tracking.' },

  // SAAS
  { tag:'saas', title:'SaaS Dashboard – Dark Pro', text:'Build a SaaS product landing page with a dark pro aesthetic. Show a mock dashboard screenshot as the hero. Use tight card grids for features, a comparison table, and a sticky pricing section.' },
  { tag:'saas', title:'SaaS – Startup Clean', text:'Create a clean SaaS landing page. White background, sharp black CTAs, feature grid with icons, customer logo bar, FAQ accordion, and one bold testimonial section.' },
  { tag:'saas', title:'AI Tool Landing Page', text:'Design an AI tool landing page. Animated gradient orb in hero (CSS only), feature cards with hover glow, before/after demo section, and a simple 3-tier pricing table.' },
  { tag:'saas', title:'SaaS Waitlist Page', text:'Build a waitlist landing page for a SaaS. One bold headline, email input, live counter "X people waiting", and a features preview section below. Dark background, orange CTA.' },
  { tag:'saas', title:'Analytics SaaS Page', text:'Create a landing page for an analytics SaaS. Show mock charts and graphs in the hero, feature cards with subtle data visuals, and a CTA strip with urgency copy.' },

  // AGENCY
  { tag:'agency', title:'Creative Agency – Maximalist', text:'Build a maximalist creative agency site. Overlapping text and images, bold color blocks, diagonal section breaks, oversized typography, and cursor-following effects.' },
  { tag:'agency', title:'Digital Agency – Minimal Black', text:'Create a minimal black digital agency website. White text on black, numbered services list, large client logos, case study cards, and a footer with social links.' },
  { tag:'agency', title:'Motion Design Agency', text:'Build a motion design agency page. Hero with looping CSS animation, project cards with hover video-preview placeholders, and a bold "Our Process" section.' },
  { tag:'agency', title:'Boutique Branding Studio', text:'Create a boutique branding studio website. Elegant serif fonts, muted cream palette, refined card layouts, studio philosophy section, and an inquiry form at the bottom.' },
  { tag:'agency', title:'Tech Agency – Futuristic', text:'Build a futuristic tech agency website. Glowing neon lines on dark, terminal-style hero text, service cards with animated borders, and a contact section with grid background.' },

  // ECOMMERCE
  { tag:'ecommerce', title:'Luxury Fashion Store', text:'Create a luxury fashion ecommerce homepage. Full-width editorial hero, product grid with hover zoom, featured collection banner, minimal nav, and an email capture modal.' },
  { tag:'ecommerce', title:'Streetwear Brand Page', text:'Build a streetwear ecommerce page. Gritty dark tones, graffiti-inspired typography, product drops section with countdown timers, and lookbook gallery.' },
  { tag:'ecommerce', title:'Organic Food Store', text:'Create an organic food store homepage. Earthy tones, hand-drawn illustration accents, product category grid, trust badges, and a simple "how it works" section.' },
  { tag:'ecommerce', title:'Tech Gadget Product Page', text:'Build a product page for a tech gadget. Dark hero with 3D-style product mockup, spec breakdown accordion, comparison table, review stars section, and a sticky buy CTA.' },
  { tag:'ecommerce', title:'Jewellery Store – Elegant', text:'Create an elegant jewellery store landing. Gold and ivory palette, serif fonts, product spotlight cards, "crafted with care" story section, and a newsletter signup.' },

  // LANDING PAGE
  { tag:'landing', title:'App Download Landing Page', text:'Build an app download landing page. Large phone mockup in hero, feature highlights in 3 columns, testimonial carousel, and dual CTA buttons for App Store and Google Play.' },
  { tag:'landing', title:'Event Landing Page', text:'Create a landing page for a live event or conference. Dark background, countdown timer, speaker cards with photos, schedule accordion, and a ticket purchase CTA.' },
  { tag:'landing', title:'Course Landing Page', text:'Build a course landing page. Bold headline with transformation promise, curriculum accordion, instructor bio, student testimonials, and a pricing card with enroll button.' },
  { tag:'landing', title:'Newsletter Landing Page', text:'Create a newsletter signup landing page. Single-column layout, bold value proposition, recent issue preview, subscriber count social proof, and a simple email form.' },
  { tag:'landing', title:'Startup Coming Soon Page', text:'Build a coming soon page for a startup. Animated countdown, email waitlist form, logo, one-liner about what is coming, and subtle background pattern.' },
  { tag:'landing', title:'Product Hunt Launch Page', text:'Create a Product Hunt-style launch landing page. Bold hero, product GIF placeholder, feature list, founder quote, and an upvote CTA section.' },
  { tag:'landing', title:'Free Tool Landing Page', text:'Build a landing page for a free tool. Show the tool interface as the hero, explain what it does in 3 bullet points, add a "try it free" CTA and FAQ section below.' },

  // BLOG
  { tag:'blog', title:'Tech Blog – Editorial Dark', text:'Create a tech blog homepage. Dark editorial style, featured post hero, article card grid with reading time, category filter tabs, and a sidebar with popular posts.' },
  { tag:'blog', title:'Personal Blog – Minimal', text:'Build a minimal personal blog. White background, serif body font, article list with dates, no images in listing, subtle hover underlines, and a simple about section.' },
  { tag:'blog', title:'Design Inspiration Blog', text:'Create a design blog. Masonry image grid, hover captions, dark background, category tags, and a featured post with a large editorial image.' },
  { tag:'blog', title:'Developer Blog', text:'Build a developer blog layout. Monospace font accents, syntax-highlighted code preview cards, tags like "React" and "TypeScript", and a newsletter signup at the bottom.' },
  { tag:'blog', title:'Newsletter Archive Page', text:'Create a newsletter archive page. List of past issues with date and title, search bar, preview snippet on hover, and subscribe CTA pinned at top.' },

  // STARTUP
  { tag:'startup', title:'B2B SaaS Startup Page', text:'Build a B2B SaaS startup homepage. Clean white layout, pain-point headline, solution features in alternating sections, integration logo bar, pricing table, and demo booking CTA.' },
  { tag:'startup', title:'Fintech Startup Page', text:'Create a fintech startup landing. Trust-first design, clean numbers in hero (saves you $X/mo), how it works 3-step section, security badges, and a dark CTA strip.' },
  { tag:'startup', title:'HealthTech Startup', text:'Build a health tech startup landing page. Calm blue-green palette, doctor/patient illustration section, feature cards, HIPAA badge, and patient testimonials.' },
  { tag:'startup', title:'EdTech Startup', text:'Create an edtech startup homepage. Bright and energetic, feature grid, learning path diagram, student outcome stats, and a free trial CTA.' },
  { tag:'startup', title:'No-Code Tool Startup', text:'Build a no-code tool landing page. Show a drag-drop interface mockup, template showcase, use-case tabs, pricing plans, and a "get started free" hero CTA.' },

  // DARK THEME
  { tag:'dark', title:'Dark Glassmorphism Dashboard', text:'Build a dark dashboard UI with glassmorphism cards. Blurred card backgrounds, neon accent colors, sidebar navigation, stats at top, and a recent activity feed.' },
  { tag:'dark', title:'Cyberpunk Landing Page', text:'Create a cyberpunk-inspired landing page. Neon green on near-black, glitchy text effect, grid lines in background, hero with scanlines, and a stark CTA section.' },
  { tag:'dark', title:'Dark Luxury Brand Page', text:'Build a luxury brand page in dark mode. Gold accents on deep black, serif display font, full-width product images, and refined spacing throughout.' },
  { tag:'dark', title:'Dark Music Artist Page', text:'Create a dark landing page for a music artist. Album artwork hero, track list with play buttons, tour dates table, merch section, and social links in footer.' },
  { tag:'dark', title:'Dark Tool Documentation Page', text:'Build a dark documentation-style landing page. Sidebar with section links, code blocks, command snippets, and a clean header with GitHub link.' },

  // MINIMAL
  { tag:'minimal', title:'Swiss Grid Minimal Site', text:'Build a Swiss-grid inspired minimal website. Strict 12-column grid, red and black only, Helvetica-style bold headers, ruled horizontal lines between sections.' },
  { tag:'minimal', title:'Japanese Minimal Portfolio', text:'Create a Japanese-aesthetic minimal portfolio. Lots of white space, thin lines, small delicate typography, one accent color only, and a haiku-style about section.' },
  { tag:'minimal', title:'Minimal Resume Site', text:'Build a minimal resume/CV website. Single page, left-aligned content, timeline for experience, skills as simple tags, and a contact section with email link only.' },
  { tag:'minimal', title:'Monochrome Landing Page', text:'Create a monochrome (black and white only) landing page. No colors, no gradients. Let typography weight and spacing carry all visual hierarchy.' },
  { tag:'minimal', title:'Text-Only Blog', text:'Build a text-only blog in the style of early web. No images, no icons, just clean typographic hierarchy, wide readable columns, and smart line-height.' },

  // CREATIVE
  { tag:'creative', title:'3D Scroll Experience', text:'Create a landing page with a 3D perspective scroll effect using CSS transforms. Cards tilt on scroll, hero has depth layers, and sections slide in from alternating sides.' },
  { tag:'creative', title:'Retro 90s Website', text:'Build a retro 90s inspired website. Bold colored backgrounds, marquee text, pixelated dividers, Comic Sans (ironically), and a guestbook section at the bottom.' },
  { tag:'creative', title:'Gradient Mesh Landing', text:'Create a landing page with a fluid gradient mesh background. Aurora-like color blobs in motion (CSS animation), frosted glass cards, and a clean centered layout.' },
  { tag:'creative', title:'Magazine Layout Site', text:'Build a website that looks like a printed magazine. Two-column editorial grid, pull quotes, drop caps, page numbers in corners, and a story-driven layout.' },
  { tag:'creative', title:'Handcrafted Art Studio Site', text:'Create an art studio website with a handcrafted feel. Rough textures, hand-drawn underlines, warm paper background, and art displayed in tilted card frames.' },
  { tag:'creative', title:'Newspaper Style Homepage', text:'Build a newspaper-style homepage. Multi-column grid, serif headline font, dateline headers, breaking news banner, and an old-press paper background texture.' },
];
...
function renderPrompts(list) {
  grid.innerHTML = '';
  if (list.length === 0) {
    grid.innerHTML = '<p style="color:var(--muted);font-size:0.85rem;grid-column:1/-1">No prompts found. Try a different search.</p>';
    return;
  }
  list.forEach((p, i) => {
    const card = document.createElement('div');
    ...
    card.innerHTML = \`
      ...
      <button class="copy-btn" onclick="copyPrompt(this, \\\`\${p.text.replace(/\`/g,'\\\\\`')}\\\`)">Copy Prompt</button>
    \`;
    grid.appendChild(card);
  });
}
...
function filterPrompts() {
  ...
  const filtered = prompts.filter(p => {
    ...
    const matchSearch = p.title.toLowerCase().includes(q) || p.text.toLowerCase().includes(q) || p.tag.toLowerCase().includes(q);
    return matchFilter && matchSearch;
  });
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="ViMax is a free open-source agentic video generation tool from Hong Kong University. One prompt to full cinematic video — script, storyboard, camera angles, consistent characters — all automatic.">
<meta name="keywords" content="ViMax, AI video generation, agentic AI, open source, HKUDS, cinematic video, AutoCameo, Idea2Video, rk codex">
<meta name="date" content="2026-06-04T09:30:00+05:30">
<meta name="category" content="AI Tools">
<meta name="theme-color" content="#0a0a0f">
<meta name="github" content="https://github.com/HKUDS/ViMax">
<meta property="article:published_time" content="2026-06-04T09:30:00+05:30">
<meta property="og:image" content="/articles/vimax-agentic-video-generation.png">
<title>ViMax — AI Video Generation Complete Guide | rk.codex</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=JetBrains+Mono:wght@300;400;500;600&family=Syne:wght@400;600;700;800&display=swap" rel="stylesheet">
<style>
:root {
  --bg: #0a0a0f;
  --bg2: #101018;
  ...
  --accent: #f44336;
  --accent2: #ff7043;
  --accent-bg: rgba(244,67,54,0.08);
  --accent-bd: rgba(244,67,54,0.2);
  --blue: #42a5f5;
  --blue-bg: rgba(66,165,245,0.08);
  --blue-bd: rgba(66,165,245,0.18);
  --green: #66bb6a;
  --green-bg: rgba(102,187,106,0.08);
  --green-bd: rgba(102,187,106,0.18);
  --purple: #ab47bc;
  --purple-bg: rgba(171,71,188,0.08);
  --purple-bd: rgba(171,71,188,0.18);
  --amber: #ffca28;
  --amber-bg: rgba(255,202,40,0.08);
  --amber-bd: rgba(255,202,40,0.18);
  --code-bg: #08080e;
  --radius: 10px;
}
...
.lang-btn {
  ...
  color:var(--text3);font-family:'Inter',sans-serif;transition:all .2s;
}
...
.hero::after {
  ...
  background:radial-gradient(circle,rgba(244,67,54,.08) 0%,transparent 70%);
  pointer-events:none;
}
.hero-badge {
  display:inline-flex;align-items:center;gap:8px;
  ...
  padding:7px 18px;border-radius:100px;margin:0 auto 28px;
}
.hero h1 {
  font-family:'Syne',sans-serif;
...
.hero-actions { display:flex;gap:12px;justify-content:center;flex-wrap:wrap; }
.btn {
  padding:13px 26px;border-radius:8px;font-size:.85rem;
  font-weight:600;cursor:pointer;text-decoration:none;
  transition:all .2s;border:none;font-family:'Inter',sans-serif;
  display:inline-flex;align-items:center;gap:8px;
}
.btn-primary { background:var(--accent);color:#fff; }
.btn-primary:hover { background:#e53935;transform:translateY(-1px); }
...
.stat-label { font-size:.72rem;color:var(--text3);margin-top:2px;letter-spacing:.5px; }

/* ── SECTION ── */
.section { max-width:900px;margin:0 auto;padding:72px 32px; }
.section-label {
  display:inline-block;
...
.section h2 {
  ...
  font-weight:800;letter-spacing:-1px;margin-bottom:12px;line-height:1.15;
}
.section h2 em { font-style:normal;color:var(--accent2); }
.section-sub { color:var(--text2);font-size:.95rem;margin-bottom:40px;line-height:1.7; }
...
.ps-card:hover { transform:translateY(-2px);border-color:var(--border2); }
.ps-card .icon { font-size:1.4rem;margin-bottom:10px; }
.ps-card h4 {
  font-size:.9rem;font-weight:700;margin-bottom:6px;
  font-family:'Syne',sans-serif;
}
.ps-card p { font-size:.82rem;color:var(--text2);line-height:1.6; }
.ps-card.problem { border-left:3px solid var(--accent); }
.ps-card.solution { border-left:3px solid var(--green); }
...
.feat-card::before {
  ...
  transition:transform .3s;transform:scaleX(0);transform-origin:left;
}
.feat-card:hover { border-color:var(--border2);transform:translateY(-2px); }
.feat-card:hover::before { transform:scaleX(1); }
.feat-card.red::before { background:var(--accent); }
.feat-card.blue::before { background:var(--blue); }
.feat-card.green::before { background:var(--green); }
.feat-card.purple::before { background:var(--purple); }
.feat-card .feat-icon { font-size:1.5rem;margin-bottom:12px; }
.feat-card h3 {
...
.arch-step:hover { border-color:var(--border2); }
.arch-num {
...
.arch-step h4 { font-size:.88rem;font-weight:700;margin-bottom:4px; }
.arch-step p { font-size:.8rem;color:var(--text2);line-height:1.6; }
...
.code-block {
  ...
  line-height:1.8;color:var(--text2);overflow-x:auto;
  margin:24px 0;position:relative;
}
.code-block .code-label {
  position:absolute;top:8px;right:12px;
  font-size:10px;color:var(--text3);letter-spacing:.5px;text-transform:uppercase;
}
.code-block .hl { color:var(--accent); }
.code-block .hl2 { color:var(--green); }
.code-block .hl3 { color:var(--blue); }
.code-block .hl4 { color:var(--amber); }
...
.idea-card::before {
  content:counter(ideas);position:absolute;left:16px;top:16px;
  font-family:'Syne',sans-serif;font-weight:800;font-size:14px;
  color:var(--accent);opacity:.5;
}
.idea-card:hover { border-color:var(--accent-bd);transform:translateY(-1px); }
.idea-card strong { color:var(--text);font-weight:600; }
.idea-card .idea-style { font-size:.7rem;color:var(--text3);margin-top:4px;display:block; }
...
.cta-section p { color:var(--text2);font-size:.9rem;line-height:1.7;margin-bottom:28px; }
.email-chip {
  display:inline-flex;align-items:center;gap:10px;
  background:var(--card);border:1px solid var(--border);
  padding:14px 22px;border-radius:6px;
  font-family:'JetBrains Mono',monospace;font-size:.82rem;margin-bottom:16px;
}
.btn-email {
...
.btn-email:hover { background:#e53935;transform:translateY(-1px); }
...
.footer-left { font-family:'Syne',sans-serif;font-weight:800;font-size:1rem; }
.footer-left span { color:var(--accent); }
.footer-right { color:var(--text3);font-size:.78rem;text-align:right; }
.footer-links { display:flex;gap:20px;margin-top:8px; }
...
@media(max-width:768px) {
  ...
  .hero h1 { font-size:clamp(1.8rem,8vw,2.6rem); letter-spacing:-1px; }
  .section { padding:48px 20px; }
  .ps-grid,.feat-grid,.ideas-grid { grid-template-columns:1fr; }
...
<!-- LANG MODAL -->
<div class="lang-modal" id="lm">
  <div class="lang-modal-box">
    <div style="font-size:32px;margin-bottom:16px">🎬</div>
    <div style="font-size:22px;font-weight:800;color:var(--text);margin-bottom:8px;letter-spacing:-.025em;font-family:'Syne',sans-serif">Choose your language</div>
    <div style="font-size:14px;color:var(--text3);margin-bottom:24px;line-height:1.6">Read this guide in English or Hinglish.<br><span style="font-size:12px">English ya Hinglish mein padhna chahte ho?</span></div>
    <div style="display:flex;gap:10px">
      <button onclick="setLang('en')" class="btn btn-primary" style="flex:1;padding:13px;font-size:15px">English</button>
      <button onclick="setLang('hi')" class="btn btn-outline" style="flex:1;padding:13px;font-size:15px">Hinglish 🇮🇳</button>
    </div>
  </div>
</div>
...
<!-- NAV -->
<nav>
  <a href="https://radhakishan404.is-a.dev" class="nav-logo">rk.codex</a>
  <div class="nav-right">
    <a href="https://www.instagram.com/rk.codex" target="_blank" class="hide-mobile">Instagram</a>
    <a href="https://www.youtube.com/@rk-codex" target="_blank" class="hide-mobile">YouTube</a>
    <button class="lang-btn on" id="ben" onclick="setLang('en')">EN</button>
    <button class="lang-btn" id="bhi" onclick="setLang('hi')">HI</button>
  </div>
</nav>

<!-- HERO -->
<div class="hero">
  <div class="hero-badge">🎬 Open Source • MIT License • Free</div>
  <h1>
    <span class="en">One Prompt. Full <em>Cinematic Video.</em> Automatically.</span>
    <span class="hi">Ek Prompt. Poori <em>Cinematic Video.</em> Automatic.</span>
  </h1>
  <p class="hero-sub en">ViMax is a free, open-source AI tool from Hong Kong University that turns a single idea into a complete cinematic video — script, storyboard, camera angles, consistent characters — all done by the tool itself.</p>
  <p class="hero-sub hi">ViMax ek free, open-source AI tool hai Hong Kong University se jo ek single idea ko complete cinematic video mein convert karta hai — script, storyboard, camera angles, consistent characters — sab kuch tool khud karta hai.</p>
  <div class="hero-actions">
    <a href="https://github.com/HKUDS/ViMax" target="_blank" class="btn btn-primary">⭐ Star on GitHub</a>
    <a href="https://www.youtube.com/@rk-codex" target="_blank" class="btn btn-yt">▶ Watch Demo</a>
...
<!-- STATS -->
<div class="stats">
  <div class="stat"><div class="stat-num">8,600+</div><div class="stat-label">GitHub Stars</div></div>
  <div class="stat"><div class="stat-num">1,300+</div><div class="stat-label">Forks</div></div>
  <div class="stat"><div class="stat-num">339+</div><div class="stat-label">Commits</div></div>
  <div class="stat"><div class="stat-num">MIT</div><div class="stat-label">License (Free)</div></div>
  <div class="stat"><div class="stat-num">100%</div><div class="stat-label">Python</div></div>
</div>

<!-- WHAT IS VIMAX -->
<div class="section">
  <div class="section-label">What Is ViMax?</div>
  <h2>
    <span class="en">Director, Screenwriter, Producer & Video Generator — <em>All-in-One</em></span>
    <span class="hi">Director, Screenwriter, Producer & Video Generator — <em>Sab Ek Mein</em></span>
  </h2>
  <p class="section-sub en">Most AI video tools generate 5-second clips with characters that change faces mid-video. ViMax is different. It's an agentic system — meaning multiple AI agents work together like a film production crew. You give it an idea. It writes the script, designs storyboards, plans camera angles, creates consistent characters, and generates the final video. End to end. Automatically.</p>
  <p class="section-sub hi">Zyaadatar AI video tools bas 5-second ki clips banate hain aur characters ke face bich mein change ho jaate hain. ViMax alag hai. Ye ek agentic system hai — matlab multiple AI agents milke kaam karte hain jaise ek film production crew. Tum ek idea dete ho. Ye script likhta hai, storyboard design karta hai, camera angles plan karta hai, consistent characters banata hai, aur final video generate karta hai. End to end. Automatically.</p>

  <div class="ps-grid">
    <div class="ps-card problem">
      <div class="icon">❌</div>
      <h4 class="en">Short Clips Only</h4><h4 class="hi">Sirf Short Clips</h4>
      <p class="en">Most AI tools generate only 5-10 seconds of footage. That's useless for storytelling.</p>
      <p class="hi">Zyaadatar AI tools sirf 5-10 seconds ka footage banate hain. Storytelling ke liye ye bekaar hai.</p>
    </div>
    <div class="ps-card solution">
      <div class="icon">✅</div>
      <h4 class="en">Full-Length Videos</h4><h4 class="hi">Poori Video</h4>
      <p class="en">ViMax generates multi-scene, minute-long videos with proper narrative structure.</p>
      <p class="hi">ViMax multi-scene, minute-long videos generate karta hai proper narrative structure ke saath.</p>
    </div>
    <div class="ps-card problem">
      <div class="icon">❌</div>
      <h4 class="en">Consistency Chaos</h4><h4 class="hi">Consistency Ka Masla</h4>
      <p class="en">Characters change appearance, faces morph between shots. Every frame looks different.</p>
      <p class="hi">Characters ka look change ho jaata hai, faces bich mein morph ho jaate hain. Har frame alag dikhta hai.</p>
    </div>
    <div class="ps-card solution">
      <div class="icon">✅</div>
      <h4 class="en">Character Consistency</h4><h4 class="hi">Character Consistency</h4>
      <p class="en">Intelligent reference tracking keeps characters identical across every scene.</p>
      <p class="hi">Intelligent reference tracking se characters har scene mein same dikhte hain.</p>
    </div>
    <div class="ps-card problem">
      <div class="icon">❌</div>
      <h4 class="en">Visual-Only Focus</h4><h4 class="hi">Sirf Visual</h4>
      <p class="en">No script, no storyboard, no audio, no narrative depth. You get a clip and that's it.</p>
      <p class="hi">Koi script nahi, koi storyboard nahi, koi audio nahi, koi narrative depth nahi. Clip milti hai bus.</p>
    </div>
    <div class="ps-card solution">
      <div class="icon">✅</div>
      <h4 class="en">Complete Production</h4><h4 class="hi">Complete Production</h4>
      <p class="en">Script generation, storyboarding, camera planning, audio binding — the whole pipeline.</p>
      <p class="hi">Script generation, storyboarding, camera planning, audio binding — poora pipeline.</p>
    </div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  ...
  <h2>
    <span class="en">4 Ways to Create <em>Videos</em></span>
    <span class="hi">Video Banane Ke <em>4 Tarike</em></span>
  </h2>
  <p class="section-sub en">ViMax gives you multiple entry points — from raw ideas to full screenplays, even novels and your own photos.</p>
  <p class="section-sub hi">ViMax tumhe multiple entry points deta hai — raw ideas se lekar full screenplays, novels aur tumhari apni photos tak.</p>

  <div class="feat-grid">
    <div class="feat-card red">
      <div class="feat-icon">💡</div>
      <h3>Idea2Video</h3>
      <p class="en">Type a simple idea like <em>"a cat and dog are best friends, what happens when they meet a stranger"</em> — and ViMax generates the complete video. Script, shots, characters, everything.</p>
      <p class="hi">Ek simple idea likho jaise <em>"ek cat aur dog best friends hain, kya hoga jab wo ek stranger se milte hain"</em> — aur ViMax complete video generate karta hai. Script, shots, characters, sab kuch.</p>
    </div>
    <div class="feat-card blue">
      <div class="feat-icon">📝</div>
      <h3>Script2Video</h3>
      <p class="en">Already have a screenplay? Write your scenes with dialogue, character descriptions, and settings. ViMax handles all the visual production — storyboard, images, video.</p>
      <p class="hi">Screenplay already ready hai? Apne scenes likho dialogue, character descriptions, aur settings ke saath. ViMax saari visual production handle karta hai.</p>
    </div>
    <div class="feat-card green">
      <div class="feat-icon">📚</div>
      <h3>Novel2Video</h3>
      <p class="en">Feed it an entire novel. ViMax intelligently compresses the narrative, tracks characters across chapters, and generates episodic video content scene by scene.</p>
      <p class="hi">Ek poori novel feed karo. ViMax intelligently narrative ko compress karta hai, characters ko chapters mein track karta hai, aur episodic video content generate karta hai.</p>
    </div>
    <div class="feat-card purple">
      <div class="feat-icon">🤳</div>
      <h3>AutoCameo</h3>
      <p class="en"><strong>This is wild.</strong> Upload your own photo and ViMax puts you inside the video as a character — fully consistent from start to finish. Your face, your appearance, maintained across every single scene.</p>
      <p class="hi"><strong>Ye feature insane hai.</strong> Apni photo upload karo aur ViMax tumhe video mein character bana deta hai — start se finish tak fully consistent. Tumhara face, tumhara look, har scene mein same.</p>
    </div>
  </div>
</div>
...
<div class="section">
  ...
  <h2>
    <span class="en">Multi-Agent <em>Production Pipeline</em></span>
    <span class="hi">Multi-Agent <em>Production Pipeline</em></span>
  </h2>
  <p class="section-sub en">ViMax uses specialized AI agents working together — like a real film crew. Here's the pipeline from your idea to the final video:</p>
  <p class="section-sub hi">ViMax specialized AI agents use karta hai jo saath mein kaam karte hain — jaise ek real film crew. Yahan hai pipeline tumhare idea se final video tak:</p>

  <div class="arch-flow">
    <div class="arch-step">
      <div class="arch-num">1</div>
      <div>
        <h4 class="en">Script Understanding Agent</h4><h4 class="hi">Script Understanding Agent</h4>
        <p class="en">Extracts characters, environments, emotions, and scene boundaries from your input. Understands what the story needs.</p>
        <p class="hi">Tumhare input se characters, environments, emotions, aur scene boundaries extract karta hai. Samajhta hai ki story ko kya chahiye.</p>
      </div>
    </div>
    <div class="arch-step">
      <div class="arch-num">2</div>
      <div>
        <h4 class="en">Storyboard Designer</h4><h4 class="hi">Storyboard Designer</h4>
        <p class="en">Creates shot-level storyboards with cinematographic language — wide shots, close-ups, transitions, pacing, camera movements.</p>
        <p class="hi">Shot-level storyboards banata hai cinematographic language ke saath — wide shots, close-ups, transitions, pacing, camera movements.</p>
      </div>
    </div>
    <div class="arch-step">
      <div class="arch-num">3</div>
      <div>
        <h4 class="en">Visual Asset Planner</h4><h4 class="hi">Visual Asset Planner</h4>
        <p class="en">Intelligently selects and manages reference images. Tracks what characters and environments looked like in previous scenes.</p>
        <p class="hi">Intelligently reference images select aur manage karta hai. Track karta hai ki characters aur environments pehle ke scenes mein kaise dikhte the.</p>
      </div>
    </div>
    <div class="arch-step">
      <div class="arch-num">4</div>
      <div>
        <h4 class="en">Consistency Engine</h4><h4 class="hi">Consistency Engine</h4>
        <p class="en">Generates multiple image candidates in parallel. Uses VLM (Vision Language Model) to pick the most consistent one. Like a human director saying "take 3 was the best."</p>
        <p class="hi">Multiple image candidates parallel mein generate karta hai. VLM (Vision Language Model) use karke most consistent wala choose karta hai. Jaise ek human director bolta hai "take 3 sabse accha tha."</p>
      </div>
    </div>
    <div class="arch-step">
      <div class="arch-num">5</div>
      <div>
        <h4 class="en">Video Synthesis & Assembly</h4><h4 class="hi">Video Synthesis & Assembly</h4>
        <p class="en">Parallel shot generation for maximum speed. Final assembly with timeline, cuts, and transitions. Output: your complete video.</p>
        <p class="hi">Maximum speed ke liye parallel shot generation. Final assembly timeline, cuts, aur transitions ke saath. Output: tumhari complete video.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="section" id="quickstart">
  ...
  <h2>
    <span class="en">Get Running in <em>5 Minutes</em></span>
    <span class="hi"><em>5 Minute</em> Mein Shuru Karo</span>
  </h2>
  <p class="section-sub en">Requirements: Linux or Windows, Python 3.10+, and the uv package manager.</p>
  <p class="section-sub hi">Requirements: Linux ya Windows, Python 3.10+, aur uv package manager.</p>

  <h3 style="margin-bottom:12px;font-size:.95rem">
    <span class="en">Step 1 — Clone & Install</span>
    <span class="hi">Step 1 — Clone & Install</span>
  </h3>
  <div class="code-block">
    <span class="code-label">terminal</span>
    <span class="hl">git clone</span> https://github.com/HKUDS/ViMax.git<br>
    <span class="hl">cd</span> ViMax<br>
    <span class="hl">uv sync</span>
  </div>

  <h3 style="margin-bottom:12px;font-size:.95rem;margin-top:32px">
    <span class="en">Step 2 — Configure API Keys</span>
    <span class="hi">Step 2 — API Keys Configure Karo</span>
  </h3>
  <p class="en" style="font-size:.85rem;color:var(--text2);margin-bottom:16px">Edit <code style="background:var(--code-bg);padding:2px 8px;border-radius:4px;font-size:13px">configs/idea2video.yaml</code>:</p>
  <p class="hi" style="font-size:.85rem;color:var(--text2);margin-bottom:16px"><code style="background:var(--code-bg);padding:2px 8px;border-radius:4px;font-size:13px">configs/idea2video.yaml</code> edit karo:</p>
  <div class="code-block">
    <span class="code-label">yaml</span>
    <span class="hl3">chat_model:</span><br>
    &nbsp;&nbsp;<span class="hl3">init_args:</span><br>
    &nbsp;&nbsp;&nbsp;&nbsp;model: <span class="hl2">google/gemini-2.5-flash-lite</span><br>
    &nbsp;&nbsp;&nbsp;&nbsp;model_provider: <span class="hl2">openai</span><br>
    &nbsp;&nbsp;&nbsp;&nbsp;api_key: <span class="hl">YOUR_API_KEY</span><br>
    &nbsp;&nbsp;&nbsp;&nbsp;base_url: <span class="hl2">https://openrouter.ai/api/v1</span><br>
    <br>
    <span class="hl3">image_generator:</span><br>
    &nbsp;&nbsp;class_path: <span class="hl2">tools.ImageGeneratorNanobananaGoogleAPI</span><br>
    &nbsp;&nbsp;<span class="hl3">init_args:</span><br>
    &nbsp;&nbsp;&nbsp;&nbsp;api_key: <span class="hl">YOUR_GOOGLE_API_KEY</span><br>
    <br>
    <span class="hl3">video_generator:</span><br>
    &nbsp;&nbsp;class_path: <span class="hl2">tools.VideoGeneratorVeoGoogleAPI</span><br>
    &nbsp;&nbsp;<span class="hl3">init_args:</span><br>
    &nbsp;&nbsp;&nbsp;&nbsp;api_key: <span class="hl">YOUR_GOOGLE_API_KEY</span>
  </div>

  <h3 style="margin-bottom:12px;font-size:.95rem;margin-top:32px">
    <span class="en">Step 3 — Generate Your First Video</span>
    <span class="hi">Step 3 — Pehli Video Generate Karo</span>
  </h3>
  <p class="en" style="font-size:.85rem;color:var(--text2);margin-bottom:16px">Edit <code style="background:var(--code-bg);padding:2px 8px;border-radius:4px;font-size:13px">main_idea2video.py</code> with your idea:</p>
  <p class="hi" style="font-size:.85rem;color:var(--text2);margin-bottom:16px"><code style="background:var(--code-bg);padding:2px 8px;border-radius:4px;font-size:13px">main_idea2video.py</code> mein apna idea likho:</p>
  <div class="code-block">
    <span class="code-label">python</span>
    <span class="hl3">idea</span> = <span class="hl4">"""</span><br>
    <span class="hl2">A lonely astronaut discovers music on a distant planet</span><br>
    <span class="hl4">"""</span><br>
    <br>
    <span class="hl3">user_requirement</span> = <span class="hl4">"""</span><br>
    <span class="hl2">Cinematic feel, 4-5 scenes, dramatic lighting</span><br>
    <span class="hl4">"""</span><br>
    <br>
    <span class="hl3">style</span> = <span class="hl4">"Cinematic Realism"</span>
  </div>
  <div class="code-block">
    <span class="code-label">terminal</span>
    <span class="hl">uv run</span> python main_idea2video.py
  </div>
  <p class="en" style="font-size:.85rem;color:var(--text2);margin-top:16px">That's it. ViMax will generate the script, design storyboards, create reference images, check consistency, render shots, and assemble the final video — all automatically.</p>
  <p class="hi" style="font-size:.85rem;color:var(--text2);margin-top:16px">Bas itna hi. ViMax script generate karega, storyboards design karega, reference images banayega, consistency check karega, shots render karega, aur final video assemble karega — sab automatic.</p>
</div>

<!-- IDEAS -->
<div class="section">
  <div class="section-label">Creative Ideas</div>
  <h2>
    <span class="en">20 Ideas You Can Generate With ViMax <em>Right Now</em></span>
    <span class="hi">20 Ideas Jo Tum ViMax Se <em>Abhi Bana Sakte Ho</em></span>
  </h2>
  <p class="section-sub en">Need inspiration? Copy any of these and paste them as your idea prompt.</p>
  <p class="section-sub hi">Inspiration chahiye? Inme se koi bhi copy karo aur idea prompt mein paste karo.</p>

  <div class="ideas-grid">
    <div class="idea-card"><strong>A robot discovers it can dream</strong><span class="idea-style">Sci-fi, Cinematic</span></div>
    <div class="idea-card"><strong>Two rival chefs compete on Mars</strong><span class="idea-style">Comedy, Animated</span></div>
    <div class="idea-card"><strong>A grandma secretly fights crime</strong><span class="idea-style">Action-Comedy, Cartoon</span></div>
    <div class="idea-card"><strong>Trees decide to leave the forest</strong><span class="idea-style">Fantasy, Storybook</span></div>
    <div class="idea-card"><strong>A street cat becomes mayor</strong><span class="idea-style">Wholesome, Pixar-like</span></div>
    <div class="idea-card"><strong>The last library on Earth</strong><span class="idea-style">Dramatic, Cinematic</span></div>
    <div class="idea-card"><strong>A kid teaches AI about friendship</strong><span class="idea-style">Heartwarming, Animated</span></div>
    <div class="idea-card"><strong>Underwater civilization finds the surface</strong><span class="idea-style">Epic, Fantasy</span></div>
    <div class="idea-card"><strong>Musician's notes come alive as people</strong><span class="idea-style">Musical, Abstract Art</span></div>
    <div class="idea-card"><strong>Time-traveling food delivery gone wrong</strong><span class="idea-style">Comedy, Cartoon</span></div>
    <div class="idea-card"><strong>A dog's POV of their human's wedding</strong><span class="idea-style">Emotional, Realistic</span></div>
    <div class="idea-card"><strong>Samurai in modern Tokyo — culture shock</strong><span class="idea-style">Action-Drama, Anime</span></div>
    <div class="idea-card"><strong>Plants vs pollution — nature fights back</strong><span class="idea-style">Environmental, Animated</span></div>
    <div class="idea-card"><strong>A camera that photographs the future</strong><span class="idea-style">Thriller, Noir</span></div>
    <div class="idea-card"><strong>Baby dragon's first day at school</strong><span class="idea-style">Kids, Colorful Cartoon</span></div>
    <div class="idea-card"><strong>A ghost who's afraid of humans</strong><span class="idea-style">Comedy-Horror, Animated</span></div>
    <div class="idea-card"><strong>Two AIs debate the meaning of art</strong><span class="idea-style">Philosophical, Abstract</span></div>
    <div class="idea-card"><strong>Street murals come alive at midnight</strong><span class="idea-style">Magical Realism, Cinematic</span></div>
    <div class="idea-card"><strong>Cat accidentally launches into space</strong><span class="idea-style">Comedy, Pixar-like</span></div>
    <div class="idea-card"><strong>Ancient warrior wakes up in a gaming tournament</strong><span class="idea-style">Action-Comedy, Anime</span></div>
  </div>
</div>
...
<div class="section">
  ...
  <h2>
    <span class="en">Built by <em>Hong Kong University</em> Researchers</span>
    <span class="hi"><em>Hong Kong University</em> Ke Researchers Ne Banaya</span>
  </h2>
  <p class="section-sub en">ViMax comes from HKUDS — the Data Science lab at the Hong Kong University of Science and Technology. The team has published research on graph neural networks, recommendation systems, and now agentic AI for creative content generation. 339+ commits, 1,300+ forks, MIT license, actively maintained with Google AI Studio API support and upcoming agent loop improvements.</p>
  <p class="section-sub hi">ViMax HKUDS se aaya hai — Hong Kong University of Science and Technology ka Data Science lab. Team ne graph neural networks, recommendation systems, aur ab creative content generation ke liye agentic AI pe research publish ki hai. 339+ commits, 1,300+ forks, MIT license, actively maintained hai Google AI Studio API support aur upcoming agent loop improvements ke saath.</p>
</div>

<!-- CTA -->
<div class="cta-section" id="ads">
  <div class="cta-inner">
    <div class="hero-badge" style="margin-bottom:20px">🤝 Collaborate</div>
    <h2>
      <span class="en">Want to advertise with rk.codex?</span>
      <span class="hi">rk.codex ke saath advertise karna hai?</span>
    </h2>
    <p class="en">Reach thousands of developers, designers, and AI enthusiasts. Drop a mail and let's talk about promoting your product, tool, or brand on my reels and YouTube channel.</p>
    <p class="hi">Thousands of developers, designers, aur AI enthusiasts tak pahuncho. Mail karo aur baat karte hain tumhare product, tool, ya brand ko mere reels aur YouTube channel pe promote karne ki.</p>
    <div class="email-chip">📩 radhakishanjangid404@gmail.com</div>
    <br><br>
    <a href="mailto:radhakishanjangid404@gmail.com?subject=Ad Enquiry – rk.codex&body=Hi RK, I'd like to discuss an advertising opportunity with you." class="btn-email">📨 Drop Ad Enquiry Now</a>
  </div>
...
<footer>
  <div>
    ...
    <div class="footer-links" style="margin-top:10px">
      <a href="https://www.instagram.com/rk.codex" target="_blank">Instagram</a>
      <a href="https://www.youtube.com/@rk-codex" target="_blank">YouTube</a>
      <a href="https://github.com/HKUDS/ViMax" target="_blank">ViMax GitHub</a>
      <a href="https://radhakishan404.is-a.dev" target="_blank">Portfolio</a>
    </div>
  </div>
  <div class="footer-right">
    <div>Made with ❤️ for the dev community</div>
    <div style="margin-top:6px;color:var(--text3)">Type one idea. Get a full movie.</div>
  </div>
</footer>
...
function setLang(l) {
  ...
  var isHi = l === 'hi';
  bd.classList.toggle('hindi', isHi);
  document.querySelectorAll('.en').forEach(function(e){ e.style.display = isHi ? 'none' : ''; });
  document.querySelectorAll('.hi').forEach(function(e){ e.style.display = isHi ? '' : 'none'; });
  document.getElementById('ben').classList.toggle('on', !isHi);
  document.getElementById('bhi').classList.toggle('on', isHi);
  localStorage.setItem('rk-lang', l);
}
...
`;function gs(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var ct=gs();function fp(o){ct=o}var it={exec:()=>null};function xe(o,r=""){let s=typeof o=="string"?o:o.source,l={replace:(c,h)=>{let m=typeof h=="string"?h:h.source;return m=m.replace(qe.caret,"$1"),s=s.replace(c,m),l},getRegex:()=>new RegExp(s,r)};return l}var Vm=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),qe={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:o=>new RegExp(`^( {0,3}${o})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}#`),htmlBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}>`)},$m=/^(?:[ \t]*(?:\n|$))+/,Km=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Jm=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,za=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Qm=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,fs=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,vp=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,bp=xe(vp).replace(/bull/g,fs).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Xm=xe(vp).replace(/bull/g,fs).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),vs=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Zm=/^[^\n]+/,bs=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,eg=xe(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",bs).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),ng=xe(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,fs).getRegex(),Kr="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",ys=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,tg=xe("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",ys).replace("tag",Kr).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),yp=xe(vs).replace("hr",za).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Kr).getRegex(),ag=xe(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",yp).getRegex(),xs={blockquote:ag,code:Km,def:eg,fences:Jm,heading:Qm,hr:za,html:tg,lheading:bp,list:ng,newline:$m,paragraph:yp,table:it,text:Zm},_d=xe("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",za).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Kr).getRegex(),rg={...xs,lheading:Xm,table:_d,paragraph:xe(vs).replace("hr",za).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",_d).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Kr).getRegex()},og={...xs,html:xe(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",ys).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:it,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:xe(vs).replace("hr",za).replace("heading",` *#{1,6} *[^
]`).replace("lheading",bp).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},ig=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,sg=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,xp=/^( {2,}|\\)\n(?!\s*$)/,lg=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,qt=/[\p{P}\p{S}]/u,Jr=/[\s\p{P}\p{S}]/u,ws=/[^\s\p{P}\p{S}]/u,cg=xe(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Jr).getRegex(),wp=/(?!~)[\p{P}\p{S}]/u,dg=/(?!~)[\s\p{P}\p{S}]/u,pg=/(?:[^\s\p{P}\p{S}]|~)/u,ug=xe(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Vm?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),kp=/^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,hg=xe(kp,"u").replace(/punct/g,qt).getRegex(),mg=xe(kp,"u").replace(/punct/g,wp).getRegex(),Cp="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",gg=xe(Cp,"gu").replace(/notPunctSpace/g,ws).replace(/punctSpace/g,Jr).replace(/punct/g,qt).getRegex(),fg=xe(Cp,"gu").replace(/notPunctSpace/g,pg).replace(/punctSpace/g,dg).replace(/punct/g,wp).getRegex(),vg=xe("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,ws).replace(/punctSpace/g,Jr).replace(/punct/g,qt).getRegex(),bg=xe(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,qt).getRegex(),yg="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",xg=xe(yg,"gu").replace(/notPunctSpace/g,ws).replace(/punctSpace/g,Jr).replace(/punct/g,qt).getRegex(),wg=xe(/\\(punct)/,"gu").replace(/punct/g,qt).getRegex(),kg=xe(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Cg=xe(ys).replace("(?:-->|$)","-->").getRegex(),Sg=xe("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Cg).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Hr=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+(?!`)[^`]*?`+(?!`)|``+(?=\])|[^\[\]\\`])*?/,Tg=xe(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",Hr).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Sp=xe(/^!?\[(label)\]\[(ref)\]/).replace("label",Hr).replace("ref",bs).getRegex(),Tp=xe(/^!?\[(ref)\](?:\[\])?/).replace("ref",bs).getRegex(),Ag=xe("reflink|nolink(?!\\()","g").replace("reflink",Sp).replace("nolink",Tp).getRegex(),qd=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,ks={_backpedal:it,anyPunctuation:wg,autolink:kg,blockSkip:ug,br:xp,code:sg,del:it,delLDelim:it,delRDelim:it,emStrongLDelim:hg,emStrongRDelimAst:gg,emStrongRDelimUnd:vg,escape:ig,link:Tg,nolink:Tp,punctuation:cg,reflink:Sp,reflinkSearch:Ag,tag:Sg,text:lg,url:it},Ig={...ks,link:xe(/^!?\[(label)\]\((.*?)\)/).replace("label",Hr).getRegex(),reflink:xe(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Hr).getRegex()},is={...ks,emStrongRDelimAst:fg,emStrongLDelim:mg,delLDelim:bg,delRDelim:xg,url:xe(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",qd).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:xe(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",qd).getRegex()},Eg={...is,br:xe(xp).replace("{2,}","*").getRegex(),text:xe(is.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Or={normal:xs,gfm:rg,pedantic:og},ja={normal:ks,gfm:is,breaks:Eg,pedantic:Ig},Pg={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ud=o=>Pg[o];function fn(o,r){if(r){if(qe.escapeTest.test(o))return o.replace(qe.escapeReplace,Ud)}else if(qe.escapeTestNoEncode.test(o))return o.replace(qe.escapeReplaceNoEncode,Ud);return o}function Wd(o){try{o=encodeURI(o).replace(qe.percentDecode,"%")}catch{return null}return o}function Yd(o,r){let s=o.replace(qe.findPipe,(h,m,b)=>{let g=!1,v=m;for(;--v>=0&&b[v]==="\\";)g=!g;return g?"|":" |"}),l=s.split(qe.splitPipe),c=0;if(l[0].trim()||l.shift(),l.length>0&&!l.at(-1)?.trim()&&l.pop(),r)if(l.length>r)l.splice(r);else for(;l.length<r;)l.push("");for(;c<l.length;c++)l[c]=l[c].trim().replace(qe.slashPipe,"|");return l}function Na(o,r,s){let l=o.length;if(l===0)return"";let c=0;for(;c<l&&o.charAt(l-c-1)===r;)c++;return o.slice(0,l-c)}function Mg(o,r){if(o.indexOf(r[1])===-1)return-1;let s=0;for(let l=0;l<o.length;l++)if(o[l]==="\\")l++;else if(o[l]===r[0])s++;else if(o[l]===r[1]&&(s--,s<0))return l;return s>0?-2:-1}function Lg(o,r=0){let s=r,l="";for(let c of o)if(c==="	"){let h=4-s%4;l+=" ".repeat(h),s+=h}else l+=c,s++;return l}function Vd(o,r,s,l,c){let h=r.href,m=r.title||null,b=o[1].replace(c.other.outputLinkReplace,"$1");l.state.inLink=!0;let g={type:o[0].charAt(0)==="!"?"image":"link",raw:s,href:h,title:m,text:b,tokens:l.inlineTokens(b)};return l.state.inLink=!1,g}function Rg(o,r,s){let l=o.match(s.other.indentCodeCompensation);if(l===null)return r;let c=l[1];return r.split(`
`).map(h=>{let m=h.match(s.other.beginningSpace);if(m===null)return h;let[b]=m;return b.length>=c.length?h.slice(c.length):h}).join(`
`)}var _r=class{options;rules;lexer;constructor(o){this.options=o||ct}space(o){let r=this.rules.block.newline.exec(o);if(r&&r[0].length>0)return{type:"space",raw:r[0]}}code(o){let r=this.rules.block.code.exec(o);if(r){let s=r[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:r[0],codeBlockStyle:"indented",text:this.options.pedantic?s:Na(s,`
`)}}}fences(o){let r=this.rules.block.fences.exec(o);if(r){let s=r[0],l=Rg(s,r[3]||"",this.rules);return{type:"code",raw:s,lang:r[2]?r[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):r[2],text:l}}}heading(o){let r=this.rules.block.heading.exec(o);if(r){let s=r[2].trim();if(this.rules.other.endingHash.test(s)){let l=Na(s,"#");(this.options.pedantic||!l||this.rules.other.endingSpaceChar.test(l))&&(s=l.trim())}return{type:"heading",raw:r[0],depth:r[1].length,text:s,tokens:this.lexer.inline(s)}}}hr(o){let r=this.rules.block.hr.exec(o);if(r)return{type:"hr",raw:Na(r[0],`
`)}}blockquote(o){let r=this.rules.block.blockquote.exec(o);if(r){let s=Na(r[0],`
`).split(`
`),l="",c="",h=[];for(;s.length>0;){let m=!1,b=[],g;for(g=0;g<s.length;g++)if(this.rules.other.blockquoteStart.test(s[g]))b.push(s[g]),m=!0;else if(!m)b.push(s[g]);else break;s=s.slice(g);let v=b.join(`
`),y=v.replace(this.rules.other.blockquoteSetextReplace,`
    $1`).replace(this.rules.other.blockquoteSetextReplace2,"");l=l?`${l}
${v}`:v,c=c?`${c}
${y}`:y;let S=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(y,h,!0),this.lexer.state.top=S,s.length===0)break;let T=h.at(-1);if(T?.type==="code")break;if(T?.type==="blockquote"){let B=T,D=B.raw+`
`+s.join(`
`),P=this.blockquote(D);h[h.length-1]=P,l=l.substring(0,l.length-B.raw.length)+P.raw,c=c.substring(0,c.length-B.text.length)+P.text;break}else if(T?.type==="list"){let B=T,D=B.raw+`
`+s.join(`
`),P=this.list(D);h[h.length-1]=P,l=l.substring(0,l.length-T.raw.length)+P.raw,c=c.substring(0,c.length-B.raw.length)+P.raw,s=D.substring(h.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:l,tokens:h,text:c}}}list(o){let r=this.rules.block.list.exec(o);if(r){let s=r[1].trim(),l=s.length>1,c={type:"list",raw:"",ordered:l,start:l?+s.slice(0,-1):"",loose:!1,items:[]};s=l?`\\d{1,9}\\${s.slice(-1)}`:`\\${s}`,this.options.pedantic&&(s=l?s:"[*+-]");let h=this.rules.other.listItemRegex(s),m=!1;for(;o;){let g=!1,v="",y="";if(!(r=h.exec(o))||this.rules.block.hr.test(o))break;v=r[0],o=o.substring(v.length);let S=Lg(r[2].split(`
`,1)[0],r[1].length),T=o.split(`
`,1)[0],B=!S.trim(),D=0;if(this.options.pedantic?(D=2,y=S.trimStart()):B?D=r[1].length+1:(D=S.search(this.rules.other.nonSpaceChar),D=D>4?1:D,y=S.slice(D),D+=r[1].length),B&&this.rules.other.blankLine.test(T)&&(v+=T+`
`,o=o.substring(T.length+1),g=!0),!g){let P=this.rules.other.nextBulletRegex(D),V=this.rules.other.hrRegex(D),R=this.rules.other.fencesBeginRegex(D),G=this.rules.other.headingBeginRegex(D),H=this.rules.other.htmlBeginRegex(D),te=this.rules.other.blockquoteBeginRegex(D);for(;o;){let M=o.split(`
`,1)[0],U;if(T=M,this.options.pedantic?(T=T.replace(this.rules.other.listReplaceNesting,"  "),U=T):U=T.replace(this.rules.other.tabCharGlobal,"    "),R.test(T)||G.test(T)||H.test(T)||te.test(T)||P.test(T)||V.test(T))break;if(U.search(this.rules.other.nonSpaceChar)>=D||!T.trim())y+=`
`+U.slice(D);else{if(B||S.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||R.test(S)||G.test(S)||V.test(S))break;y+=`
`+T}B=!T.trim(),v+=M+`
`,o=o.substring(M.length+1),S=U.slice(D)}}c.loose||(m?c.loose=!0:this.rules.other.doubleBlankLine.test(v)&&(m=!0)),c.items.push({type:"list_item",raw:v,task:!!this.options.gfm&&this.rules.other.listIsTask.test(y),loose:!1,text:y,tokens:[]}),c.raw+=v}let b=c.items.at(-1);if(b)b.raw=b.raw.trimEnd(),b.text=b.text.trimEnd();else return;c.raw=c.raw.trimEnd();for(let g of c.items){if(this.lexer.state.top=!1,g.tokens=this.lexer.blockTokens(g.text,[]),g.task){if(g.text=g.text.replace(this.rules.other.listReplaceTask,""),g.tokens[0]?.type==="text"||g.tokens[0]?.type==="paragraph"){g.tokens[0].raw=g.tokens[0].raw.replace(this.rules.other.listReplaceTask,""),g.tokens[0].text=g.tokens[0].text.replace(this.rules.other.listReplaceTask,"");for(let y=this.lexer.inlineQueue.length-1;y>=0;y--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[y].src)){this.lexer.inlineQueue[y].src=this.lexer.inlineQueue[y].src.replace(this.rules.other.listReplaceTask,"");break}}let v=this.rules.other.listTaskCheckbox.exec(g.raw);if(v){let y={type:"checkbox",raw:v[0]+" ",checked:v[0]!=="[ ]"};g.checked=y.checked,c.loose?g.tokens[0]&&["paragraph","text"].includes(g.tokens[0].type)&&"tokens"in g.tokens[0]&&g.tokens[0].tokens?(g.tokens[0].raw=y.raw+g.tokens[0].raw,g.tokens[0].text=y.raw+g.tokens[0].text,g.tokens[0].tokens.unshift(y)):g.tokens.unshift({type:"paragraph",raw:y.raw,text:y.raw,tokens:[y]}):g.tokens.unshift(y)}}if(!c.loose){let v=g.tokens.filter(S=>S.type==="space"),y=v.length>0&&v.some(S=>this.rules.other.anyLine.test(S.raw));c.loose=y}}if(c.loose)for(let g of c.items){g.loose=!0;for(let v of g.tokens)v.type==="text"&&(v.type="paragraph")}return c}}html(o){let r=this.rules.block.html.exec(o);if(r)return{type:"html",block:!0,raw:r[0],pre:r[1]==="pre"||r[1]==="script"||r[1]==="style",text:r[0]}}def(o){let r=this.rules.block.def.exec(o);if(r){let s=r[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),l=r[2]?r[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",c=r[3]?r[3].substring(1,r[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):r[3];return{type:"def",tag:s,raw:r[0],href:l,title:c}}}table(o){let r=this.rules.block.table.exec(o);if(!r||!this.rules.other.tableDelimiter.test(r[2]))return;let s=Yd(r[1]),l=r[2].replace(this.rules.other.tableAlignChars,"").split("|"),c=r[3]?.trim()?r[3].replace(this.rules.other.tableRowBlankLine,"").split(`
`):[],h={type:"table",raw:r[0],header:[],align:[],rows:[]};if(s.length===l.length){for(let m of l)this.rules.other.tableAlignRight.test(m)?h.align.push("right"):this.rules.other.tableAlignCenter.test(m)?h.align.push("center"):this.rules.other.tableAlignLeft.test(m)?h.align.push("left"):h.align.push(null);for(let m=0;m<s.length;m++)h.header.push({text:s[m],tokens:this.lexer.inline(s[m]),header:!0,align:h.align[m]});for(let m of c)h.rows.push(Yd(m,h.header.length).map((b,g)=>({text:b,tokens:this.lexer.inline(b),header:!1,align:h.align[g]})));return h}}lheading(o){let r=this.rules.block.lheading.exec(o);if(r){let s=r[1].trim();return{type:"heading",raw:r[0],depth:r[2].charAt(0)==="="?1:2,text:s,tokens:this.lexer.inline(s)}}}paragraph(o){let r=this.rules.block.paragraph.exec(o);if(r){let s=r[1].charAt(r[1].length-1)===`
`?r[1].slice(0,-1):r[1];return{type:"paragraph",raw:r[0],text:s,tokens:this.lexer.inline(s)}}}text(o){let r=this.rules.block.text.exec(o);if(r)return{type:"text",raw:r[0],text:r[0],tokens:this.lexer.inline(r[0])}}escape(o){let r=this.rules.inline.escape.exec(o);if(r)return{type:"escape",raw:r[0],text:r[1]}}tag(o){let r=this.rules.inline.tag.exec(o);if(r)return!this.lexer.state.inLink&&this.rules.other.startATag.test(r[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&this.rules.other.endATag.test(r[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&this.rules.other.startPreScriptTag.test(r[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&this.rules.other.endPreScriptTag.test(r[0])&&(this.lexer.state.inRawBlock=!1),{type:"html",raw:r[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:r[0]}}link(o){let r=this.rules.inline.link.exec(o);if(r){let s=r[2].trim();if(!this.options.pedantic&&this.rules.other.startAngleBracket.test(s)){if(!this.rules.other.endAngleBracket.test(s))return;let h=Na(s.slice(0,-1),"\\");if((s.length-h.length)%2===0)return}else{let h=Mg(r[2],"()");if(h===-2)return;if(h>-1){let m=(r[0].indexOf("!")===0?5:4)+r[1].length+h;r[2]=r[2].substring(0,h),r[0]=r[0].substring(0,m).trim(),r[3]=""}}let l=r[2],c="";if(this.options.pedantic){let h=this.rules.other.pedanticHrefTitle.exec(l);h&&(l=h[1],c=h[3])}else c=r[3]?r[3].slice(1,-1):"";return l=l.trim(),this.rules.other.startAngleBracket.test(l)&&(this.options.pedantic&&!this.rules.other.endAngleBracket.test(s)?l=l.slice(1):l=l.slice(1,-1)),Vd(r,{href:l&&l.replace(this.rules.inline.anyPunctuation,"$1"),title:c&&c.replace(this.rules.inline.anyPunctuation,"$1")},r[0],this.lexer,this.rules)}}reflink(o,r){let s;if((s=this.rules.inline.reflink.exec(o))||(s=this.rules.inline.nolink.exec(o))){let l=(s[2]||s[1]).replace(this.rules.other.multipleSpaceGlobal," "),c=r[l.toLowerCase()];if(!c){let h=s[0].charAt(0);return{type:"text",raw:h,text:h}}return Vd(s,c,s[0],this.lexer,this.rules)}}emStrong(o,r,s=""){let l=this.rules.inline.emStrongLDelim.exec(o);if(!(!l||!l[1]&&!l[2]&&!l[3]&&!l[4]||l[4]&&s.match(this.rules.other.unicodeAlphaNumeric))&&(!(l[1]||l[3])||!s||this.rules.inline.punctuation.exec(s))){let c=[...l[0]].length-1,h,m,b=c,g=0,v=l[0][0]==="*"?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(v.lastIndex=0,r=r.slice(-1*o.length+c);(l=v.exec(r))!==null;){if(h=l[1]||l[2]||l[3]||l[4]||l[5]||l[6],!h)continue;if(m=[...h].length,l[3]||l[4]){b+=m;continue}else if((l[5]||l[6])&&c%3&&!((c+m)%3)){g+=m;continue}if(b-=m,b>0)continue;m=Math.min(m,m+b+g);let y=[...l[0]][0].length,S=o.slice(0,c+l.index+y+m);if(Math.min(c,m)%2){let B=S.slice(1,-1);return{type:"em",raw:S,text:B,tokens:this.lexer.inlineTokens(B)}}let T=S.slice(2,-2);return{type:"strong",raw:S,text:T,tokens:this.lexer.inlineTokens(T)}}}}codespan(o){let r=this.rules.inline.code.exec(o);if(r){let s=r[2].replace(this.rules.other.newLineCharGlobal," "),l=this.rules.other.nonSpaceChar.test(s),c=this.rules.other.startingSpaceChar.test(s)&&this.rules.other.endingSpaceChar.test(s);return l&&c&&(s=s.substring(1,s.length-1)),{type:"codespan",raw:r[0],text:s}}}br(o){let r=this.rules.inline.br.exec(o);if(r)return{type:"br",raw:r[0]}}del(o,r,s=""){let l=this.rules.inline.delLDelim.exec(o);if(l&&(!l[1]||!s||this.rules.inline.punctuation.exec(s))){let c=[...l[0]].length-1,h,m,b=c,g=this.rules.inline.delRDelim;for(g.lastIndex=0,r=r.slice(-1*o.length+c);(l=g.exec(r))!==null;){if(h=l[1]||l[2]||l[3]||l[4]||l[5]||l[6],!h||(m=[...h].length,m!==c))continue;if(l[3]||l[4]){b+=m;continue}if(b-=m,b>0)continue;m=Math.min(m,m+b);let v=[...l[0]][0].length,y=o.slice(0,c+l.index+v+m),S=y.slice(c,-c);return{type:"del",raw:y,text:S,tokens:this.lexer.inlineTokens(S)}}}}autolink(o){let r=this.rules.inline.autolink.exec(o);if(r){let s,l;return r[2]==="@"?(s=r[1],l="mailto:"+s):(s=r[1],l=s),{type:"link",raw:r[0],text:s,href:l,tokens:[{type:"text",raw:s,text:s}]}}}url(o){let r;if(r=this.rules.inline.url.exec(o)){let s,l;if(r[2]==="@")s=r[0],l="mailto:"+s;else{let c;do c=r[0],r[0]=this.rules.inline._backpedal.exec(r[0])?.[0]??"";while(c!==r[0]);s=r[0],r[1]==="www."?l="http://"+r[0]:l=r[0]}return{type:"link",raw:r[0],text:s,href:l,tokens:[{type:"text",raw:s,text:s}]}}}inlineText(o){let r=this.rules.inline.text.exec(o);if(r){let s=this.lexer.state.inRawBlock;return{type:"text",raw:r[0],text:r[0],escaped:s}}}},ln=class ss{tokens;options;state;inlineQueue;tokenizer;constructor(r){this.tokens=[],this.tokens.links=Object.create(null),this.options=r||ct,this.options.tokenizer=this.options.tokenizer||new _r,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let s={other:qe,block:Or.normal,inline:ja.normal};this.options.pedantic?(s.block=Or.pedantic,s.inline=ja.pedantic):this.options.gfm&&(s.block=Or.gfm,this.options.breaks?s.inline=ja.breaks:s.inline=ja.gfm),this.tokenizer.rules=s}static get rules(){return{block:Or,inline:ja}}static lex(r,s){return new ss(s).lex(r)}static lexInline(r,s){return new ss(s).inlineTokens(r)}lex(r){r=r.replace(qe.carriageReturn,`
`),this.blockTokens(r,this.tokens);for(let s=0;s<this.inlineQueue.length;s++){let l=this.inlineQueue[s];this.inlineTokens(l.src,l.tokens)}return this.inlineQueue=[],this.tokens}blockTokens(r,s=[],l=!1){for(this.tokenizer.lexer=this,this.options.pedantic&&(r=r.replace(qe.tabCharGlobal,"    ").replace(qe.spaceLine,""));r;){let c;if(this.options.extensions?.block?.some(m=>(c=m.call({lexer:this},r,s))?(r=r.substring(c.raw.length),s.push(c),!0):!1))continue;if(c=this.tokenizer.space(r)){r=r.substring(c.raw.length);let m=s.at(-1);c.raw.length===1&&m!==void 0?m.raw+=`
`:s.push(c);continue}if(c=this.tokenizer.code(r)){r=r.substring(c.raw.length);let m=s.at(-1);m?.type==="paragraph"||m?.type==="text"?(m.raw+=(m.raw.endsWith(`
`)?"":`
`)+c.raw,m.text+=`
`+c.text,this.inlineQueue.at(-1).src=m.text):s.push(c);continue}if(c=this.tokenizer.fences(r)){r=r.substring(c.raw.length),s.push(c);continue}if(c=this.tokenizer.heading(r)){r=r.substring(c.raw.length),s.push(c);continue}if(c=this.tokenizer.hr(r)){r=r.substring(c.raw.length),s.push(c);continue}if(c=this.tokenizer.blockquote(r)){r=r.substring(c.raw.length),s.push(c);continue}if(c=this.tokenizer.list(r)){r=r.substring(c.raw.length),s.push(c);continue}if(c=this.tokenizer.html(r)){r=r.substring(c.raw.length),s.push(c);continue}if(c=this.tokenizer.def(r)){r=r.substring(c.raw.length);let m=s.at(-1);m?.type==="paragraph"||m?.type==="text"?(m.raw+=(m.raw.endsWith(`
`)?"":`
`)+c.raw,m.text+=`
`+c.raw,this.inlineQueue.at(-1).src=m.text):this.tokens.links[c.tag]||(this.tokens.links[c.tag]={href:c.href,title:c.title},s.push(c));continue}if(c=this.tokenizer.table(r)){r=r.substring(c.raw.length),s.push(c);continue}if(c=this.tokenizer.lheading(r)){r=r.substring(c.raw.length),s.push(c);continue}let h=r;if(this.options.extensions?.startBlock){let m=1/0,b=r.slice(1),g;this.options.extensions.startBlock.forEach(v=>{g=v.call({lexer:this},b),typeof g=="number"&&g>=0&&(m=Math.min(m,g))}),m<1/0&&m>=0&&(h=r.substring(0,m+1))}if(this.state.top&&(c=this.tokenizer.paragraph(h))){let m=s.at(-1);l&&m?.type==="paragraph"?(m.raw+=(m.raw.endsWith(`
`)?"":`
`)+c.raw,m.text+=`
`+c.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=m.text):s.push(c),l=h.length!==r.length,r=r.substring(c.raw.length);continue}if(c=this.tokenizer.text(r)){r=r.substring(c.raw.length);let m=s.at(-1);m?.type==="text"?(m.raw+=(m.raw.endsWith(`
`)?"":`
`)+c.raw,m.text+=`
`+c.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=m.text):s.push(c);continue}if(r){let m="Infinite loop on byte: "+r.charCodeAt(0);if(this.options.silent){console.error(m);break}else throw new Error(m)}}return this.state.top=!0,s}inline(r,s=[]){return this.inlineQueue.push({src:r,tokens:s}),s}inlineTokens(r,s=[]){this.tokenizer.lexer=this;let l=r,c=null;if(this.tokens.links){let g=Object.keys(this.tokens.links);if(g.length>0)for(;(c=this.tokenizer.rules.inline.reflinkSearch.exec(l))!==null;)g.includes(c[0].slice(c[0].lastIndexOf("[")+1,-1))&&(l=l.slice(0,c.index)+"["+"a".repeat(c[0].length-2)+"]"+l.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(c=this.tokenizer.rules.inline.anyPunctuation.exec(l))!==null;)l=l.slice(0,c.index)+"++"+l.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let h;for(;(c=this.tokenizer.rules.inline.blockSkip.exec(l))!==null;)h=c[2]?c[2].length:0,l=l.slice(0,c.index+h)+"["+"a".repeat(c[0].length-h-2)+"]"+l.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);l=this.options.hooks?.emStrongMask?.call({lexer:this},l)??l;let m=!1,b="";for(;r;){m||(b=""),m=!1;let g;if(this.options.extensions?.inline?.some(y=>(g=y.call({lexer:this},r,s))?(r=r.substring(g.raw.length),s.push(g),!0):!1))continue;if(g=this.tokenizer.escape(r)){r=r.substring(g.raw.length),s.push(g);continue}if(g=this.tokenizer.tag(r)){r=r.substring(g.raw.length),s.push(g);continue}if(g=this.tokenizer.link(r)){r=r.substring(g.raw.length),s.push(g);continue}if(g=this.tokenizer.reflink(r,this.tokens.links)){r=r.substring(g.raw.length);let y=s.at(-1);g.type==="text"&&y?.type==="text"?(y.raw+=g.raw,y.text+=g.text):s.push(g);continue}if(g=this.tokenizer.emStrong(r,l,b)){r=r.substring(g.raw.length),s.push(g);continue}if(g=this.tokenizer.codespan(r)){r=r.substring(g.raw.length),s.push(g);continue}if(g=this.tokenizer.br(r)){r=r.substring(g.raw.length),s.push(g);continue}if(g=this.tokenizer.del(r,l,b)){r=r.substring(g.raw.length),s.push(g);continue}if(g=this.tokenizer.autolink(r)){r=r.substring(g.raw.length),s.push(g);continue}if(!this.state.inLink&&(g=this.tokenizer.url(r))){r=r.substring(g.raw.length),s.push(g);continue}let v=r;if(this.options.extensions?.startInline){let y=1/0,S=r.slice(1),T;this.options.extensions.startInline.forEach(B=>{T=B.call({lexer:this},S),typeof T=="number"&&T>=0&&(y=Math.min(y,T))}),y<1/0&&y>=0&&(v=r.substring(0,y+1))}if(g=this.tokenizer.inlineText(v)){r=r.substring(g.raw.length),g.raw.slice(-1)!=="_"&&(b=g.raw.slice(-1)),m=!0;let y=s.at(-1);y?.type==="text"?(y.raw+=g.raw,y.text+=g.text):s.push(g);continue}if(r){let y="Infinite loop on byte: "+r.charCodeAt(0);if(this.options.silent){console.error(y);break}else throw new Error(y)}}return s}},qr=class{options;parser;constructor(o){this.options=o||ct}space(o){return""}code({text:o,lang:r,escaped:s}){let l=(r||"").match(qe.notSpaceStart)?.[0],c=o.replace(qe.endingNewline,"")+`
`;return l?'<pre><code class="language-'+fn(l)+'">'+(s?c:fn(c,!0))+`</code></pre>
`:"<pre><code>"+(s?c:fn(c,!0))+`</code></pre>
`}blockquote({tokens:o}){return`<blockquote>
${this.parser.parse(o)}</blockquote>
`}html({text:o}){return o}def(o){return""}heading({tokens:o,depth:r}){return`<h${r}>${this.parser.parseInline(o)}</h${r}>
`}hr(o){return`<hr>
`}list(o){let r=o.ordered,s=o.start,l="";for(let m=0;m<o.items.length;m++){let b=o.items[m];l+=this.listitem(b)}let c=r?"ol":"ul",h=r&&s!==1?' start="'+s+'"':"";return"<"+c+h+`>
`+l+"</"+c+`>
...
`}table(o){let r="",s="";for(let c=0;c<o.header.length;c++)s+=this.tablecell(o.header[c]);r+=this.tablerow({text:s});let l="";for(let c=0;c<o.rows.length;c++){let h=o.rows[c];s="";for(let m=0;m<h.length;m++)s+=this.tablecell(h[m]);l+=this.tablerow({text:s})}return l&&(l=`<tbody>${l}</tbody>`),`<table>
<thead>
`+r+`</thead>
`+l+`</table>
`}tablerow({text:o}){return`<tr>
${o}</tr>
`}tablecell(o){let r=this.parser.parseInline(o.tokens),s=o.header?"th":"td";return(o.align?`<${s} align="${o.align}">`:`<${s}>`)+r+`</${s}>
`}strong({tokens:o}){return`<strong>${this.parser.parseInline(o)}</strong>`}em({tokens:o}){return`<em>${this.parser.parseInline(o)}</em>`}codespan({text:o}){return`<code>${fn(o,!0)}</code>`}br(o){return"<br>"}del({tokens:o}){return`<del>${this.parser.parseInline(o)}</del>`}link({href:o,title:r,tokens:s}){let l=this.parser.parseInline(s),c=Wd(o);if(c===null)return l;o=c;let h='<a href="'+o+'"';return r&&(h+=' title="'+fn(r)+'"'),h+=">"+l+"</a>",h}image({href:o,title:r,text:s,tokens:l}){l&&(s=this.parser.parseInline(l,this.parser.textRenderer));let c=Wd(o);if(c===null)return fn(s);o=c;let h=`<img src="${o}" alt="${fn(s)}"`;return r&&(h+=` title="${fn(r)}"`),h+=">",h}text(o){return"tokens"in o&&o.tokens?this.parser.parseInline(o.tokens):"escaped"in o&&o.escaped?o.text:fn(o.text)}},Cs=class{strong({text:o}){return o}em({text:o}){return o}codespan({text:o}){return o}del({text:o}){return o}html({text:o}){return o}text({text:o}){return o}link({text:o}){return""+o}image({text:o}){return""+o}br(){return""}checkbox({raw:o}){return o}},cn=class ls{options;renderer;textRenderer;constructor(r){this.options=r||ct,this.options.renderer=this.options.renderer||new qr,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new Cs}static parse(r,s){return new ls(s).parse(r)}static parseInline(r,s){return new ls(s).parseInline(r)}parse(r){this.renderer.parser=this;let s="";for(let l=0;l<r.length;l++){let c=r[l];if(this.options.extensions?.renderers?.[c.type]){let m=c,b=this.options.extensions.renderers[m.type].call({parser:this},m);if(b!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(m.type)){s+=b||"";continue}}let h=c;switch(h.type){case"space":{s+=this.renderer.space(h);break}case"hr":{s+=this.renderer.hr(h);break}case"heading":{s+=this.renderer.heading(h);break}case"code":{s+=this.renderer.code(h);break}case"table":{s+=this.renderer.table(h);break}case"blockquote":{s+=this.renderer.blockquote(h);break}case"list":{s+=this.renderer.list(h);break}case"checkbox":{s+=this.renderer.checkbox(h);break}case"html":{s+=this.renderer.html(h);break}case"def":{s+=this.renderer.def(h);break}case"paragraph":{s+=this.renderer.paragraph(h);break}case"text":{s+=this.renderer.text(h);break}default:{let m='Token with "'+h.type+'" type was not found.';if(this.options.silent)return console.error(m),"";throw new Error(m)}}}return s}parseInline(r,s=this.renderer){this.renderer.parser=this;let l="";for(let c=0;c<r.length;c++){let h=r[c];if(this.options.extensions?.renderers?.[h.type]){let b=this.options.extensions.renderers[h.type].call({parser:this},h);if(b!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(h.type)){l+=b||"";continue}}let m=h;switch(m.type){case"escape":{l+=s.text(m);break}case"html":{l+=s.html(m);break}case"link":{l+=s.link(m);break}case"image":{l+=s.image(m);break}case"checkbox":{l+=s.checkbox(m);break}case"strong":{l+=s.strong(m);break}case"em":{l+=s.em(m);break}case"codespan":{l+=s.codespan(m);break}case"br":{l+=s.br(m);break}case"del":{l+=s.del(m);break}case"text":{l+=s.text(m);break}default:{let b='Token with "'+m.type+'" type was not found.';if(this.options.silent)return console.error(b),"";throw new Error(b)}}}return l}},Da=class{options;block;constructor(o){this.options=o||ct}static passThroughHooks=new Set(["preprocess","postprocess","processAllTokens","emStrongMask"]);static passThroughHooksRespectAsync=new Set(["preprocess","postprocess","processAllTokens"]);preprocess(o){return o}postprocess(o){return o}processAllTokens(o){return o}emStrongMask(o){return o}provideLexer(o=this.block){return o?ln.lex:ln.lexInline}provideParser(o=this.block){return o?cn.parse:cn.parseInline}},jg=class{defaults=gs();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=cn;Renderer=qr;TextRenderer=Cs;Lexer=ln;Tokenizer=_r;Hooks=Da;constructor(...o){this.use(...o)}walkTokens(o,r){let s=[];for(let l of o)switch(s=s.concat(r.call(this,l)),l.type){case"table":{let c=l;for(let h of c.header)s=s.concat(this.walkTokens(h.tokens,r));for(let h of c.rows)for(let m of h)s=s.concat(this.walkTokens(m.tokens,r));break}case"list":{let c=l;s=s.concat(this.walkTokens(c.items,r));break}default:{let c=l;this.defaults.extensions?.childTokens?.[c.type]?this.defaults.extensions.childTokens[c.type].forEach(h=>{let m=c[h].flat(1/0);s=s.concat(this.walkTokens(m,r))}):c.tokens&&(s=s.concat(this.walkTokens(c.tokens,r)))}}return s}use(...o){let r=this.defaults.extensions||{renderers:{},childTokens:{}};return o.forEach(s=>{let l={...s};if(l.async=this.defaults.async||l.async||!1,s.extensions&&(s.extensions.forEach(c=>{if(!c.name)throw new Error("extension name required");if("renderer"in c){let h=r.renderers[c.name];h?r.renderers[c.name]=function(...m){let b=c.renderer.apply(this,m);return b===!1&&(b=h.apply(this,m)),b}:r.renderers[c.name]=c.renderer}if("tokenizer"in c){if(!c.level||c.level!=="block"&&c.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let h=r[c.level];h?h.unshift(c.tokenizer):r[c.level]=[c.tokenizer],c.start&&(c.level==="block"?r.startBlock?r.startBlock.push(c.start):r.startBlock=[c.start]:c.level==="inline"&&(r.startInline?r.startInline.push(c.start):r.startInline=[c.start]))}"childTokens"in c&&c.childTokens&&(r.childTokens[c.name]=c.childTokens)}),l.extensions=r),s.renderer){let c=this.defaults.renderer||new qr(this.defaults);for(let h in s.renderer){if(!(h in c))throw new Error(`renderer '${h}' does not exist`);if(["options","parser"].includes(h))continue;let m=h,b=s.renderer[m],g=c[m];c[m]=(...v)=>{let y=b.apply(c,v);return y===!1&&(y=g.apply(c,v)),y||""}}l.renderer=c}if(s.tokenizer){let c=this.defaults.tokenizer||new _r(this.defaults);for(let h in s.tokenizer){if(!(h in c))throw new Error(`tokenizer '${h}' does not exist`);if(["options","rules","lexer"].includes(h))continue;let m=h,b=s.tokenizer[m],g=c[m];c[m]=(...v)=>{let y=b.apply(c,v);return y===!1&&(y=g.apply(c,v)),y}}l.tokenizer=c}if(s.hooks){let c=this.defaults.hooks||new Da;for(let h in s.hooks){if(!(h in c))throw new Error(`hook '${h}' does not exist`);if(["options","block"].includes(h))continue;let m=h,b=s.hooks[m],g=c[m];Da.passThroughHooks.has(h)?c[m]=v=>{if(this.defaults.async&&Da.passThroughHooksRespectAsync.has(h))return(async()=>{let S=await b.call(c,v);return g.call(c,S)})();let y=b.call(c,v);return g.call(c,y)}:c[m]=(...v)=>{if(this.defaults.async)return(async()=>{let S=await b.apply(c,v);return S===!1&&(S=await g.apply(c,v)),S})();let y=b.apply(c,v);return y===!1&&(y=g.apply(c,v)),y}}l.hooks=c}if(s.walkTokens){let c=this.defaults.walkTokens,h=s.walkTokens;l.walkTokens=function(m){let b=[];return b.push(h.call(this,m)),c&&(b=b.concat(c.call(this,m))),b}}this.defaults={...this.defaults,...l}}),this}setOptions(o){return this.defaults={...this.defaults,...o},this}lexer(o,r){return ln.lex(o,r??this.defaults)}parser(o,r){return cn.parse(o,r??this.defaults)}parseMarkdown(o){return(r,s)=>{let l={...s},c={...this.defaults,...l},h=this.onError(!!c.silent,!!c.async);if(this.defaults.async===!0&&l.async===!1)return h(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof r>"u"||r===null)return h(new Error("marked(): input parameter is undefined or null"));if(typeof r!="string")return h(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(r)+", string expected"));if(c.hooks&&(c.hooks.options=c,c.hooks.block=o),c.async)return(async()=>{let m=c.hooks?await c.hooks.preprocess(r):r,b=await(c.hooks?await c.hooks.provideLexer(o):o?ln.lex:ln.lexInline)(m,c),g=c.hooks?await c.hooks.processAllTokens(b):b;c.walkTokens&&await Promise.all(this.walkTokens(g,c.walkTokens));let v=await(c.hooks?await c.hooks.provideParser(o):o?cn.parse:cn.parseInline)(g,c);return c.hooks?await c.hooks.postprocess(v):v})().catch(h);try{c.hooks&&(r=c.hooks.preprocess(r));let m=(c.hooks?c.hooks.provideLexer(o):o?ln.lex:ln.lexInline)(r,c);c.hooks&&(m=c.hooks.processAllTokens(m)),c.walkTokens&&this.walkTokens(m,c.walkTokens);let b=(c.hooks?c.hooks.provideParser(o):o?cn.parse:cn.parseInline)(m,c);return c.hooks&&(b=c.hooks.postprocess(b)),b}catch(m){return h(m)}}}onError(o,r){return s=>{if(s.message+=`
Please report this to https://github.com/markedjs/marked.`,o){let l="<p>An error occurred:</p><pre>"+fn(s.message+"",!0)+"</pre>";return r?Promise.resolve(l):l}if(r)return Promise.reject(s);throw s}}},st=new jg;function ke(o,r){return st.parse(o,r)}ke.options=ke.setOptions=function(o){return st.setOptions(o),ke.defaults=st.defaults,fp(ke.defaults),ke};ke.getDefaults=gs;ke.defaults=ct;ke.use=function(...o){return st.use(...o),ke.defaults=st.defaults,fp(ke.defaults),ke};ke.walkTokens=function(o,r){return st.walkTokens(o,r)};ke.parseInline=st.parseInline;ke.Parser=cn;ke.parser=cn.parse;ke.Renderer=qr;ke.TextRenderer=Cs;ke.Lexer=ln;ke.lexer=ln.lex;ke.Tokenizer=_r;ke.Hooks=Da;ke.parse=ke;ke.options;ke.setOptions;ke.use;ke.walkTokens;ke.parseInline;cn.parse;ln.lex;function Gt(o){return`${o}`.toLowerCase().trim().replace(/&/g,"and").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}ke.setOptions({breaks:!0,gfm:!0});const Ng=Object.assign({"./articles/md/10-coding-projects-you-can-add-to-your-resume.md":Em,"./articles/md/from-repo-to-reader.md":Pm,"./articles/md/javascript-interview-series-plan.md":Mm,"./articles/md/open-source-content-formats-for-dev-creators.md":Lm}),Dg=Object.assign({"./articles/html/100-claude-code-prompts.html":Rm,"./articles/html/100-image-prompts.html":jm,"./articles/html/ai-content-prompterrr.html":Nm,"./articles/html/ai-tools-hub.html":Dm,"./articles/html/bonsai-free-models-guide.html":Fm,"./articles/html/career-ops-guide.html":zm,"./articles/html/caveman-mode-guide.html":Om,"./articles/html/claude-carousel-generator.html":Bm,"./articles/html/free-courses-real-skills-zero-rupees.html":Gm,"./articles/html/free-domain-guide.html":Hm,"./articles/html/gemma-complete-guide.html":_m,"./articles/html/hermes-agent-guide.html":qm,"./articles/html/rk-codex-hallmark-prompts.html":Um,"./articles/html/superpowers-deepdive.html":Wm,"./articles/html/vimax-agentic-video-generation.html":Ym});function Fg(o){return/<html[\s>]/i.test(o)?o:`<!DOCTYPE html><html><head></head><body>${o}</body></html>`}function Ur(o){return o.split("/").pop().replace(/\.(md|html)$/,"")}function Ap(o){return`/articles/${o}.png`}function zg(o){return o.replace(/<[^>]+>/g," ").replace(/\s+/g," ").trim()}function Ip(o){const r=o.trim().split(/\s+/).filter(Boolean).length;return`${Math.max(1,Math.round(r/220))} min read`}function Ss(o){return o?Array.isArray(o)?o.map(r=>`${r}`.trim()).filter(Boolean):`${o}`.replace(/^\[/,"").replace(/\]$/,"").split(",").map(r=>r.replace(/^["']|["']$/g,"").trim()).filter(Boolean):[]}function Ep(o){return`${o}`.trim().toLowerCase()==="true"}function Pp(o){if(!o)return"";const r=new Date(o);return Number.isNaN(r.getTime())?o:new Intl.DateTimeFormat("en-US",{month:"short",day:"numeric",year:"numeric"}).format(r)}function Og(o){if(!o.startsWith("---"))return{attributes:{},body:o};const r=o.indexOf(`
---`,3);if(r===-1)return{attributes:{},body:o};const s=o.slice(3,r).trim(),l=o.slice(r+4).trim(),c={};return s.split(`
`).forEach(h=>{const m=h.indexOf(":");if(m===-1)return;const b=h.slice(0,m).trim(),g=h.slice(m+1).trim();c[b]=g.replace(/^["']|["']$/g,"")}),c.tags&&(c.tags=Ss(c.tags)),{attributes:c,body:l}}function Bg(o,r){return`
        <div class="article-card-markdown-inner">
            <span class="article-preview-type">Markdown</span>
            <h4>${o}</h4>
            <p>${r}</p>
        </div>
    `}function Gg([o,r]){const{attributes:s,body:l}=Og(r),c=l.replace(/^#{1,6}\s+/gm,"").replace(/[*_`>#-]/g," ").replace(/\[(.*?)\]\((.*?)\)/g,"$1").replace(/\s+/g," ").trim(),h=l.match(/^#\s+(.+)$/m),m=s.excerpt||c.slice(0,180).trim(),b=s.title||(h?h[1].trim():Ur(o)),g=s.slug||Gt(Ur(o)),v=Ap(g);return{slug:g,title:b,date:Pp(s.date||""),sortDate:s.date||"",excerpt:m,tags:Ss(s.tags),readingTime:Ip(c),kind:"markdown",category:s.category||"Article",coverImage:v||s.cover||"",accent:s.accent||"",featured:Ep(s.featured||"false"),githubUrl:s.github||"",bodyHtml:ke.parse(l),previewHtml:Bg(b,m)}}function Hg([o,r]){const s=Fg(r),c=new DOMParser().parseFromString(s,"text/html"),h=c.title||Ur(o),m=c.querySelector('meta[name="description"]')?.content||"",b=c.querySelector('meta[name="keywords"]')?.content||"",g=c.querySelector("p")?.textContent?.trim()||"",v=c.querySelector('meta[property="article:published_time"]')?.content||c.querySelector('meta[name="date"]')?.content||"",y=c.querySelector('meta[name="category"]')?.content||"Article",S=Gt(Ur(o)),T=Ap(S)||c.querySelector('meta[property="og:image"]')?.content||c.querySelector('meta[name="cover"]')?.content||"",B=c.querySelector('meta[name="theme-color"]')?.content||"",D=Ep(c.querySelector('meta[name="featured"]')?.content||"false"),P=c.querySelector('meta[name="github"]')?.content||"",V=m||g||"Standalone HTML article rendered inside the React reader.",R=zg(c.body?.innerHTML||r);return{slug:S,title:h,date:Pp(v),sortDate:v,excerpt:V,tags:Ss(b),readingTime:Ip(R),kind:"html",category:y,coverImage:T,accent:B,featured:D,githubUrl:P,raw:s}}const Ht=[...Object.entries(Ng).map(Gg),...Object.entries(Dg).map(Hg)].sort((o,r)=>{if(o.featured!==r.featured)return o.featured?-1:1;const s=o.sortDate?new Date(o.sortDate).getTime():0,l=r.sortDate?new Date(r.sortDate).getTime():0;return s!==l?l-s:o.title.localeCompare(r.title)});function Ts(o){return Ht.find(r=>r.slug===o)}function _g(){return Array.from(new Set(Ht.flatMap(o=>o.tags))).sort((o,r)=>o.localeCompare(r))}function qg(){return Array.from(new Set(Ht.map(o=>o.category||"Article").filter(Boolean))).sort((o,r)=>o.localeCompare(r))}function Ug({max:o=8,scale:r=1.02,speed:s=400}={}){const l=ae.useRef(null),c=ae.useRef(0),h=ae.useCallback(g=>{const v=l.current;!v||window.matchMedia("(prefers-reduced-motion: reduce)").matches||(cancelAnimationFrame(c.current),c.current=requestAnimationFrame(()=>{const y=v.getBoundingClientRect(),S=(g.clientX-y.left)/y.width,B=(.5-(g.clientY-y.top)/y.height)*o,D=(S-.5)*o;v.style.transform=`perspective(800px) rotateX(${B}deg) rotateY(${D}deg) scale3d(${r}, ${r}, ${r})`,v.style.transition=`transform ${s}ms cubic-bezier(0.03, 0.98, 0.52, 0.99)`}))},[o,r,s]),m=ae.useCallback(()=>{const g=l.current;g&&(cancelAnimationFrame(c.current),g.style.transform="",g.style.transition=`transform ${s}ms cubic-bezier(0.03, 0.98, 0.52, 0.99)`)},[s]);return{ref:l,tiltProps:{onMouseMove:h,onMouseLeave:m}}}function Un({children:o,className:r="",as:s="div",...l}){const{ref:c,tiltProps:h}=Ug({max:6,scale:1.03});return p.jsx(s,{ref:c,className:r,...h,...l,children:o})}const lt={hero:"/rk-images/walking-black-suit.png",meta:"/rk-images/walking-black-suit.png",article:"/rk-images/mirror-selfie-black-suit.png"};function Vn(o,r){const s=typeof o=="object"?o:{title:o,description:r};ae.useEffect(()=>{const l=typeof window<"u"?window.location.href:"";s.title&&(document.title=s.title);const c=(b,g)=>{if(!g)return;const v=document.querySelector(b);v&&v.setAttribute("content",g)};s.description&&(c('meta[name="description"]',s.description),c('meta[property="og:description"]',s.description),c('meta[name="twitter:description"]',s.description)),s.title&&(c('meta[property="og:title"]',s.title),c('meta[name="twitter:title"]',s.title)),s.image&&(c('meta[property="og:image"]',s.image),c('meta[name="twitter:image"]',s.image)),l&&c('meta[property="og:url"]',l),c('meta[property="og:type"]',s.type||"website"),c('meta[name="twitter:card"]',s.twitterCard||"summary_large_image");const h=document.querySelector('link[rel="canonical"]');h&&l&&h.setAttribute("href",l);const m=document.querySelector('script[data-dynamic-seo="true"]');if(m&&m.remove(),s.structuredData){const b=document.createElement("script");b.type="application/ld+json",b.dataset.dynamicSeo="true",b.text=JSON.stringify(s.structuredData),document.head.appendChild(b)}},[s.description,s.image,s.structuredData,s.title,s.twitterCard,s.type])}const Wg=[{isCurrent:1,title:"Senior Software Engineer",companyName:"Cachetech Advisor Solutions (USA)",companyLink:"https://www.cachetech.com/",location:"Mumbai, India",from:"February 2024",to:"Present",description:"Working with US-based product and engineering teams to build scalable fintech systems, including workflow management, multi-tenancy architecture, and React Native mobile app delivery."},{isCurrent:0,title:"Manager - Software Engineer",companyName:"Edubridge India Pvt Ltd",companyLink:"https://www.edubridgeindia.com/",location:"Mumbai, India",from:"December 2022",to:"January 2024",description:"Led migration from PHP to MERN stack, built a resume builder platform, and shipped microservice-based products with Jenkins + Docker CI/CD pipelines."},{isCurrent:0,title:"Senior Software Engineer",companyName:"TechStalwarts Software Development LLP",companyLink:"http://www.techstalwarts.com/",location:"Mumbai, India",from:"September 2020",to:"November 2022",description:"Handled ecommerce platform delivery across frontend, backend, AWS deployments, and third-party API integrations for high-traffic production systems."},{isCurrent:0,title:"PHP Web Developer",companyName:"Innovins Softtech Solutions Pvt. Ltd",companyLink:"https://www.innovins.com/",location:"Mumbai, India",from:"July 2019",to:"August 2020",description:"Maintained and developed multiple enterprise portals and internal productivity systems, including API and task management features."},{isCurrent:0,title:"PHP Web Developer with CodeIgniter",companyName:"IMPAQ Technologies Pvt. Ltd",companyLink:"http://impaq.co.in/",location:"Mumbai, India",from:"August 2018",to:"June 2019",description:"Delivered CMS and admission workflow modules, including business logic automation and platform maintenance for multiple client projects."}],Yg=[{skillName:"Professional skills",skillType:[{title:"Front End Development",description:"Good sense of knowledge for <strong>Front End Development</strong>, building complex user interfaces with high level UX for both web and mobile.",skillsList:[{skillTitle:"JavaScript Development",skillDesc:"Learning Architecting and building web/mobile applications with React, JavaScript/TypeScript."},{skillTitle:"Responsive Design",skillDesc:"adapting and optimizing web pages to work on all screen sizes (mobile and tablet devices)."},{skillTitle:"Design to Web",skillDesc:"Converting design files to interactive, responsive and optimized web applications."}]},{title:"Back End Development",description:"Building Node.js web applications and <strong>RESTful API</strong> servers using technologies like <strong>Express, Core PHP and CodeIgniter</strong>.",skillsList:[{skillTitle:"RESTful API",skillDesc:"Experienced in Design and development of RESTful API servers using Node, PHP and CodeIgniter Framework."},{skillTitle:"Web Development",skillDesc:"Experienced in Design and development of Web Application using React Js, PHP, CodeIgniter and Laravel Framework."},{skillTitle:"E-commerce",skillDesc:"Design and development of E-Commerece using React Js, PHP, CodeIgniter and Laravel Framework."},{skillTitle:"Payment Gateway",skillDesc:"Experienced in working on server side payment systems with both PHP and NodeJS platforms."}]},{title:"Mobile App Development",description:"Learning developing native and hybrid mobile applications using <strong>Ionic Framework</strong> and <strong>React Native Framework</strong>.",skillsList:[{skillTitle:"Hybrid mobile apps",skillDesc:"Learning development of hybrid mobile apps for Android, iOS and Windows Phone based on Ionic 3/Cordova or Ionic 4/Capacitor technologies."},{skillTitle:"Native mobile apps",skillDesc:"Learning development of native mobile apps for Android, iOS using React Native Framework."}]}]}],Vg=JSON.parse(`[{"id":12,"title":"MacEdits","description":"Local-first macOS reel editor built with SwiftUI + AVFoundation.","logo":"/images/github.svg","thumbnail":"https://raw.githubusercontent.com/radhakishan404/MacEdits/main/assets/screenshots/home-full.png","gitAvailable":true,"tag":"Open Source, GitHub, Application, UX, Front-end, macOS","technology":"Swift, SwiftUI, AVFoundation, ScreenCaptureKit, macOS","date":"2026","isPackage":false,"onlineLink":"https://github.com/radhakishan404/MacEdits","sliderImages":[{"image":"https://raw.githubusercontent.com/radhakishan404/MacEdits/main/assets/screenshots/home-full.png"},{"image":"https://raw.githubusercontent.com/radhakishan404/MacEdits/main/assets/screenshots/recording-full.png"},{"image":"https://raw.githubusercontent.com/radhakishan404/MacEdits/main/assets/screenshots/editor-full.png"}],"content":[{"contentTitle":"Technical Specification","contentDescription":"MacEdits is a <strong>local-first macOS creator tool</strong> focused on fast reel editing, screen recording, timeline control, and export workflows without a backend dependency.","contentList":[{"isLink":true,"link":"https://github.com/radhakishan404/MacEdits","text":"GitHub repository"}]},{"contentTitle":"Features","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"Recording studio for camera, screen, and screen + camera workflows"},{"isLink":false,"link":"","text":"Timeline editing with trim, split, reorder, and ripple controls"},{"isLink":false,"link":"","text":"Creator-first text, captions, transitions, and export tooling"}]},{"contentTitle":"Responsibilities","contentDescription":"Built and shipped the open source macOS editor from product direction through implementation.","contentList":[{"isLink":false,"link":"","text":"Product concept, workflow design, and feature planning"},{"isLink":false,"link":"","text":"SwiftUI app architecture and AVFoundation-based media workflows"},{"isLink":false,"link":"","text":"Build in public release, documentation, and repository setup"}]}]},{"id":11,"title":"Notch Prompter","description":"A notch-aligned native macOS teleprompter built with SwiftUI.","logo":"/images/github.svg","thumbnail":"https://opengraph.githubassets.com/1/radhakishan404/notch-prompter","gitAvailable":true,"tag":"Open Source, GitHub, Application, UX, Front-end","technology":"SwiftUI, macOS, Product Design","date":"2026","isPackage":false,"onlineLink":"https://notch-prompter.vercel.app","sliderImages":[{"image":"https://opengraph.githubassets.com/1/radhakishan404/notch-prompter"},{"image":"/images/project/POS-1.png"}],"content":[{"contentTitle":"Technical Specification","contentDescription":"Notch Prompter is a <strong>native macOS utility</strong> focused on notch-aligned teleprompter usability with a clean and practical UI.","contentList":[{"isLink":true,"link":"https://notch-prompter.vercel.app","text":"Project website"},{"isLink":true,"link":"https://github.com/radhakishan404/notch-prompter","text":"GitHub repository"}]},{"contentTitle":"Features","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"Native SwiftUI experience"},{"isLink":false,"link":"","text":"Optimized reading layout near notch area"},{"isLink":false,"link":"","text":"Simple interaction model for creators"}]},{"contentTitle":"Responsibilities","contentDescription":"Built this project from idea to public release.","contentList":[{"isLink":false,"link":"","text":"Product concept and UI flow"},{"isLink":false,"link":"","text":"Implementation and testing"},{"isLink":false,"link":"","text":"Release and public showcase"}]}]},{"id":10,"title":"SSHipIt","description":"CD over SSH for Node.js, Next.js and React applications.","logo":"/images/github.svg","thumbnail":"https://opengraph.githubassets.com/1/radhakishan404/sshipit","gitAvailable":true,"tag":"Open Source, GitHub, Node Js, React, JavaScript, DevOps, Back-end, Website","technology":"Node Js, JavaScript, CI/CD, SSH, React, Next.js","date":"2026","isPackage":false,"onlineLink":"https://sshipit.vercel.app/","sliderImages":[{"image":"https://opengraph.githubassets.com/1/radhakishan404/sshipit"},{"image":"/images/project/npm/react-animation-loader.webp"}],"content":[{"contentTitle":"Technical Specification","contentDescription":"SSHipIt is an open source deployment utility to run reliable CD pipelines over SSH for <strong>Node.js, Next.js and React</strong> applications.","contentList":[{"isLink":true,"link":"https://sshipit.vercel.app/","text":"Project website"},{"isLink":true,"link":"https://github.com/radhakishan404/sshipit","text":"GitHub repository"}]},{"contentTitle":"Features","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"SSH-based deployment flow"},{"isLink":false,"link":"","text":"Node.js / Next.js / React support"},{"isLink":false,"link":"","text":"Simple, self-hosted CI/CD pattern"}]},{"contentTitle":"Responsibilities","contentDescription":"Designed and built the project as an open source product.","contentList":[{"isLink":false,"link":"","text":"Architecture and implementation"},{"isLink":false,"link":"","text":"Documentation and onboarding guides"},{"isLink":false,"link":"","text":"Maintenance and enhancements"}]}]},{"id":1,"title":"Nirulas","description":"Nirula's is India's oldest fast food restaurant chain.","logo":"/images/project/nirulas-logo.webp","thumbnail":"/images/project/nirulas-thumb.webp","gitAvailable":false,"tag":"React, Node Js, JavaScript, Front-end, Back-end, REST, UX, Website","technology":"React, Express, Node Js, JavaScript, Redux, Amazon, Google Analytics","date":"November 2020","onlineLink":"https://delivery.nirulas.com/","sliderImages":[{"image":"/images/project/nirulas-slider-5.gif"},{"image":"/images/project/nirulas-slider-1.webp"},{"image":"/images/project/nirulas-slider-2.webp"},{"image":"/images/project/nirulas-slider-3.webp"},{"image":"/images/project/nirulas-slider-4.webp"}],"content":[{"contentTitle":"Technical Specification","contentDescription":"Nirula's is India's oldest fast food restaurant chain. Based in North India and most popular in the <strong>NCR Delhi</strong>. It was Delhi's first fast food restaurant, opening in Connaught Place in 1977. The website was initially build on Angular Js but was later moved to <strong>React and Node Js</strong>. React used on the client-side input handling and Node Js is used for the server-side to handle connectivity between databases. It utilizes some advanced <strong>page transition</strong> and <strong>animations</strong>.","contentList":[{"isLink":true,"link":"https://delivery.nirulas.com/","text":"Link to live demo"}]},{"contentTitle":"Features","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"Product Listing"},{"isLink":false,"link":"","text":"Add to cart with Animation"},{"isLink":false,"link":"","text":"Coupon Apply"},{"isLink":false,"link":"","text":"Place Order"},{"isLink":false,"link":"","text":"OTP verify"},{"isLink":false,"link":"","text":"Live location fetch"},{"isLink":false,"link":"","text":"Location based delivery"}]},{"contentTitle":"Responsibilities","contentDescription":"Responsible for the development of the complete website both front-end and back-end which entailed:","contentList":[{"isLink":false,"link":"","text":"Converting the <strong>HTML/CSS to JSX</strong>"},{"isLink":false,"link":"","text":"Design and Architecture of <strong>React Application</strong>"},{"isLink":false,"link":"","text":"Architecture of <strong>Node Js Application</strong>"},{"isLink":false,"link":"","text":"<strong>REST API</strong> Integration"},{"isLink":false,"link":"","text":"<strong>UI/UX</strong> Improvements"},{"isLink":false,"link":"","text":"Third Party <strong>Google Analytics, Message and Facebook Pixel</strong> API Integration"},{"isLink":false,"link":"","text":"<strong>Implementation of complete Front-end and Back-end</strong>"},{"isLink":false,"link":"","text":"<strong>Deployment</strong> of both React and Node Js Application"}]},{"contentTitle":"Challenges","contentDescription":"The first challenge that I faced <strong>designing and architecting the base structure</strong> of the application. Building a web app for fast and durable react was a perfect choice for future growth and maintainability. <strong>React Components, React-Redux, and Lazy loading modules</strong> made this whole project lot easier by allowing me to separate the app logic by modules (per feature). One of the biggest challenges during development was maintaining the <strong>product customization and pricing module</strong>. I have created a separate component for the customization and called API based on the product by that I handled the <strong>customization and pricing part in Node JS API</strong>. I <strong>learned</strong> many new things while building this project still I am getting new changes and new phases to work on.","contentList":null}]},{"id":8,"title":"Nirulas POS","description":"Nirula's is India's oldest fast food restaurant chain.","logo":"/images/project/nirulas-logo.webp","thumbnail":"/images/project/POS-1.png","gitAvailable":false,"tag":"React, Node Js, JavaScript, Front-end, Back-end, REST, UX, Website","technology":"React, Express, Node Js, JavaScript, Redux, Amazon, Google Analytics","date":"April 2021","onlineLink":"https://delivery.nirulas.com/","sliderImages":[{"image":"/images/project/POS-1.png"},{"image":"/images/project/POS-2.png"},{"image":"/images/project/POS-3.png"},{"image":"/images/project/POS-4.png"},{"image":"/images/project/POS-5.png"}],"content":[{"contentTitle":"Technical Specification","contentDescription":"Nirula's is India's oldest fast food restaurant chain. Based in North India and most popular in the <strong>NCR Delhi</strong>. It was Delhi's first fast food restaurant, opening in Connaught Place in 1977. The website was initially build on Angular Js but was later moved to <strong>React and Node Js</strong>. React used on the client-side input handling and Node Js is used for the server-side to handle connectivity between databases. It utilizes some advanced <strong>page transition</strong> and <strong>animations</strong>.","contentList":[{"isLink":true,"link":"https://branch.nirulas.com/","text":"Link to live demo"}]},{"contentTitle":"Features","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"Product Listing"},{"isLink":false,"link":"","text":"Add to cart with Animation"},{"isLink":false,"link":"","text":"Coupon Apply"},{"isLink":false,"link":"","text":"Place Order"},{"isLink":false,"link":"","text":"OTP verify"},{"isLink":false,"link":"","text":"Product Stock"},{"isLink":false,"link":"","text":"Branch Orders"},{"isLink":false,"link":"","text":"Branch Dashboard"}]},{"contentTitle":"Responsibilities","contentDescription":"Responsible for the development of the complete website both front-end and back-end which entailed:","contentList":[{"isLink":false,"link":"","text":"Converting the <strong>HTML/CSS to JSX</strong>"},{"isLink":false,"link":"","text":"Design and Architecture of <strong>React Application</strong>"},{"isLink":false,"link":"","text":"Architecture of <strong>Node Js Application</strong>"},{"isLink":false,"link":"","text":"<strong>REST API</strong> Integration"},{"isLink":false,"link":"","text":"<strong>UI/UX</strong> Improvements"},{"isLink":false,"link":"","text":"Third Party <strong>Google Analytics, Message and Facebook Pixel</strong> API Integration"},{"isLink":false,"link":"","text":"<strong>Implementation of complete Front-end and Back-end</strong>"},{"isLink":false,"link":"","text":"<strong>Deployment</strong> of both React and Node Js Application"}]},{"contentTitle":"Challenges","contentDescription":"The first challenge that I faced <strong>designing and architecting the base structure</strong> of the application. Building a web app for fast and durable react was a perfect choice for future growth and maintainability. <strong>React Components, React-Redux, and Lazy loading modules</strong> made this whole project lot easier by allowing me to separate the app logic by modules (per feature). One of the biggest challenges during development was maintaining the <strong>product customization and pricing module</strong>. I have created a separate component for the customization and called API based on the product by that I handled the <strong>customization and pricing part in Node JS API</strong>. I <strong>learned</strong> many new things while building this project still I am getting new changes and new phases to work on.","contentList":null}]},{"id":2,"title":"Covid-19 Tracker","description":"Covid-19 Tracker is a simple React Native application.","logo":"/images/project/covid/covid-19-logo.webp","thumbnail":"/images/project/covid/covid-19-thumb.webp","gitAvailable":true,"tag":"React, JavaScript, Application, REST, UX, Design, GitHub","technology":"React Native, Expo, Mathdroid Covid API, Novelcovid API, React Navigation","date":"3 April, 2020 - 13 April, 2020","onlineLink":"http://radhakishan.site/covid-download.php","sliderImages":[{"image":"/images/project/covid/covid-slider-1.webp"},{"image":"/images/project/covid/covid-slider-2.webp"},{"image":"/images/project/covid/covid-slider-3.webp"},{"image":"/images/project/covid/covid-slider-4.webp"}],"content":[{"contentTitle":"Technical Specification","contentDescription":"Covid-19 Tracker is a simple <strong>React Native</strong> application that shows you the Current and <strong>Total Infected, Recovered, and Deaths</strong> of people all around the globe and you can see data based on <strong>country selection</strong>.","contentList":[{"isLink":true,"link":"https://radhakishan.site/covid-download.php","text":"Link to download the apk file"},{"isLink":true,"link":"https://github.com/radhakishan404/covid-19-tracker","text":"Source Code"}]},{"contentTitle":"Features","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"Country Selector"},{"isLink":false,"link":"","text":"React Native Line and Bar Chart"},{"isLink":false,"link":"","text":"Image gallery"},{"isLink":false,"link":"","text":"Stylish Bottom Navigation Bar"},{"isLink":false,"link":"","text":"Search country and get latest data"}]},{"contentTitle":"Responsibilities","contentDescription":"My responsibilities for this project included design and development of a complete application.","contentList":[{"isLink":false,"link":"","text":"Design and Architecture of <strong>React Application</strong>"},{"isLink":false,"link":"","text":"<strong>API</strong> Integration"},{"isLink":false,"link":"","text":"<strong>UI/UX</strong> Improvements"},{"isLink":false,"link":"","text":"<strong>Implementation of complete Application</strong>"}]},{"contentTitle":"Challenges","contentDescription":"This was my first <strong>React Native</strong> Application. I had some problems at the start but later I was able to <strong>understand the problem and solve them</strong>. The biggest challenge for me was the <strong>Image gallery</strong> section for making the images responsive, In the end, I was able to make all images <strong>proper and responsive</strong>.","contentList":null}]},{"id":3,"title":"Health Monitoring System","description":"Health Monitoring System - Patient-Doctor Live Chat!","logo":"/images/project/hms/hms-logo.webp","thumbnail":"/images/project/hms/hms-thumb.webp","gitAvailable":true,"tag":"React, JavaScript, Back-end, REST, UX, Design, PHP, MySql, GitHub","technology":"React Js, React-Redux, PHP, MySql, HTML, CSS, JS, VS Code","date":"1 August, 2020 - 10 August, 2020","onlineLink":"https://healthmonitoring.radhakishan.site/","sliderImages":[{"image":"/images/project/hms/hms-slider-1.webp"},{"image":"/images/project/hms/hms-slider-2.webp"},{"image":"/images/project/hms/hms-slider-3.webp"},{"image":"/images/project/hms/hms-slider-4.webp"},{"image":"/images/project/hms/hms-slider-5.webp"},{"image":"/images/project/hms/hms-slider-6.webp"}],"content":[{"contentTitle":"Technical Specification","contentDescription":"<strong>Health Monitoring System</strong> is a simple web project where <strong>patients</strong> can add their <strong>readings</strong> and <strong>doctors</strong> can check patient's readings and can send direct <strong>messages to each other</strong> through the application. Both patients and doctors need to <strong>log in or register</strong> before proceeds. Both patient and doctors can <strong>live chat</strong> with each other.","contentList":[{"isLink":true,"link":"https://healthmonitoring.radhakishan.site/","text":"Link to live demo"},{"isLink":true,"link":"https://github.com/radhakishan404/Health-Monitoring-System-Live-Chat","text":"Front-end Source Code"},{"isLink":true,"link":"https://github.com/radhakishan404/Health-Monitoring-System-Live-Chat/tree/master/health-monitoring-php","text":"API Source Code"}]},{"contentTitle":"Features","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"Login, Register, Forget Password"},{"isLink":false,"link":"","text":"Add, Edit, Delete, List (CRUD) for patient readings"},{"isLink":false,"link":"","text":"Chart view for Readings"},{"isLink":false,"link":"","text":"Profile Edit"},{"isLink":false,"link":"","text":"Doctors Message List"},{"isLink":false,"link":"","text":"Live Chat with doctors"},{"isLink":false,"link":"","text":"List of patients"},{"isLink":false,"link":"","text":"Live search of patients"},{"isLink":false,"link":"","text":"Chart view details about patients"},{"isLink":false,"link":"","text":"Direct message to patients"},{"isLink":false,"link":"","text":"Live Chat with Patients"}]},{"contentTitle":"How to use?","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"First Install Node Js Version 14.8.0 from <a class='text-gradient' href='https://nodejs.org/en/' rel='nofollow'>Here ↩</a>"},{"isLink":false,"link":"","text":"Clone the repo into your disk <br><strong class='code'>$ git clone git@github.com:ruanyf/react-demos.git</strong>"},{"isLink":false,"link":"","text":"Then go to your project directory using this command. <br><strong class='code'>$ cd project-directory</strong>"},{"isLink":false,"link":"","text":"After navigating to your project directory run this command to download all the node modules. <br><strong class='code'>$ npm install</strong>"},{"isLink":false,"link":"","text":"After the installation successful run this command to run the application. This command will start your react app and run it into the browser. <br><strong class='code'>$ npm start</strong>"},{"isLink":false,"link":"","text":"Hooray! Then play with the source files under the directories."},{"isLink":false,"link":"","text":"<strong>Note:</strong> After the start of the project, you have to integrate the <strong>PHP API</strong> for storing the data in the <strong>database</strong>."}]},{"contentTitle":"Responsibilities","contentDescription":"Responsible for the development of the complete project both front-end and back-end which entailed:","contentList":[{"isLink":false,"link":"","text":"Converting the <strong>HTML/CSS to JSX</strong>"},{"isLink":false,"link":"","text":"Design and Architecture of <strong>React Application</strong>"},{"isLink":false,"link":"","text":"Architecture of <strong>PHP Application</strong>"},{"isLink":false,"link":"","text":"<strong>REST API</strong> Integration"},{"isLink":false,"link":"","text":"<strong>UI/UX</strong> Improvements"},{"isLink":false,"link":"","text":"<strong>Implementation of complete Application</strong>"}]},{"contentTitle":"Challenges","contentDescription":"I had only <strong>two main challenges</strong> in this project, one was the creation of a <strong>chat application between patients and doctors</strong>, and the second was the <strong>handling of two different users</strong> (Patients and Doctors) on the same panel. I used some of the online examples for <strong>chat systems</strong> and also my previous experience in other projects.","contentList":null},{"contentTitle":"Resources","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"ReactJS: Refer to <a href='https://reactjs.org/' class='text-gradient'>https://reactjs.org/</a> to understand the concepts of ReactJS."},{"isLink":false,"link":"","text":"React Bootstrap: Refer to <a class='text-gradient' href='https://react-bootstrap.github.io/getting-started/introduction/'>https://react-bootstrap.github.io/getting-started/introduction/</a> to understand how to use React Bootstrap."}]}]},{"id":4,"title":"react-native-stylish-accordion","description":"Simple Stylish React Native Accordion","logo":"/images/project/npm/npm-logo.webp","thumbnail":"/images/project/npm/react-native-accordion-thumb.webp","gitAvailable":true,"tag":"React, JavaScript, TypeScript, NPM, UX, Design, NPM Packages, GitHub","technology":"React, JavaScript, TypeScript, NPM, VS Code","date":"October 2020","isPackage":true,"onlineLink":"https://github.com/radhakishan404/react-native-stylish-accordion","sliderImages":[{"image":"/images/project/npm/react-native-accordion-thumb.webp"}],"content":[{"contentTitle":"Technical Specification","contentDescription":"<strong>react-native-stylish-accordion</strong> is a simple <strong>React Native NPM Package</strong> that can be used in your <strong>React Native Expo Version Application</strong>. It has a total of <strong>9 versions</strong>, the latest version <strong>1.0.9</strong>. The file size is only <strong>675 kB</strong>.","contentList":[{"isLink":true,"link":"https://github.com/radhakishan404/react-native-stylish-accordion","text":"Link to source code"},{"isLink":true,"link":"https://www.npmjs.com/package/react-native-stylish-accordion","text":"Link to NPM Package"}]},{"contentTitle":"Features","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"Custom Colour"},{"isLink":false,"link":"","text":"Custom Icon"},{"isLink":false,"link":"","text":"Custom Transition Time"},{"isLink":false,"link":"","text":"Custom Icon Size"},{"isLink":false,"link":"","text":"Custom Style"}]},{"contentTitle":"How to use?","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"<strong class='code'>$ npm install react-native-stylish-accordion</strong> OR <strong class='code'>$ yarn add react-native-stylish-accordion</strong>"},{"isLink":false,"link":"","text":"Now we need to install react-native-reanimated and react-native-animatable. If you are using Expo, to ensure that you get the compatible versions of the libraries, run: <br><strong class='code'>$ expo install react-native-reanimated react-native-gesture-handler react-native-redash</strong>"},{"isLink":false,"link":"","text":"If you are not using Expo, run the following: <br><strong class='code'>$ yarn add react-native-reanimated react-native-gesture-handler react-native-redash</strong>"},{"isLink":false,"link":"","text":"<strong>Note</strong>: This is created with the help of <strong>react-native-accordion-view</strong> package."}]},{"contentTitle":"Props","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"<strong>title</strong> (string)"},{"isLink":false,"link":"","text":"<strong>titleStyle</strong> (TextStyle)"},{"isLink":false,"link":"","text":"<strong>iconSize</strong> (number)"},{"isLink":false,"link":"","text":"<strong>headerStyle</strong> (ViewStyle)"},{"isLink":false,"link":"","text":"<strong>subContainerStyle</strong> (ViewStyle)"},{"isLink":false,"link":"","text":"<strong>style</strong> (ViewStyle)"},{"isLink":false,"link":"","text":"<strong>headerComponent</strong> (ReactNode)"},{"isLink":false,"link":"","text":"<strong>open</strong> (boolean)"},{"isLink":false,"link":"","text":"<strong>onPress</strong> (void)"},{"isLink":false,"link":"","text":"<strong>timingTransition</strong> (number default:400) opening speed"},{"isLink":false,"link":"","text":"<strong>containerRadius</strong> (number)"}]}]},{"id":5,"title":"validate-form-in-expo-style","description":"Simple form validation component with floating label for React-Native inspired by react-native-form-validator","logo":"/images/project/npm/npm-logo.webp","thumbnail":"/images/project/npm/validate-form-expo-style-thumb.webp","gitAvailable":true,"tag":"React, JavaScript, NPM, UX, Design, NPM Packages, GitHub","technology":"React, JavaScript, NPM, VS Code","date":"November 2020","isPackage":true,"onlineLink":"https://github.com/radhakishan404/validate-form-in-expo-style","sliderImages":[{"image":"/images/project/npm/validate-form-expo-style-thumb.webp"}],"content":[{"contentTitle":"Technical Specification","contentDescription":"ℹ️ <strong>validate-form-in-expo-style</strong> is a Simple form validation component with floating label for React-Native inspired by <a class='text-gradient' href='https://github.com/NewOldMax/react-native-validator-form' rel='nofollow'>react-native-form-validator</a>. You can add <strong>floating label</strong> with this library and can validate form. I created this package for my personal use you can use it in yours too. <br> <br> My bad, that I don't have Mac or IPhone, so this library is tested only in android. Do check it in Mac and let me know if any problem occurs.","contentList":[{"isLink":true,"link":"https://github.com/radhakishan404/validate-form-in-expo-style","text":"Link to source code"},{"isLink":true,"link":"https://www.npmjs.com/package/validate-form-in-expo-style","text":"Link to NPM Package"},{"isLink":true,"link":"https://youtu.be/y7bkVDu0LVA","text":"Link to Example Video"}]},{"contentTitle":"Features","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"Custom Regexp Rules"},{"isLink":false,"link":"","text":"Custom Valid and Invalid Icon"},{"isLink":false,"link":"","text":"Custom Left Icon"},{"isLink":false,"link":"","text":"Custom Error Messages"},{"isLink":false,"link":"","text":"Custom Style"},{"isLink":false,"link":"","text":"Custom Validation"}]},{"contentTitle":"Install","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"<strong class='code'>$ npm install validate-form-in-expo-style</strong> OR <strong class='code'>$ yarn add validate-form-in-expo-style</strong>"},{"isLink":false,"link":"","text":"Now we need to install react-native-reanimated and react-native-animatable. If you are using Expo, to ensure that you get the compatible versions of the libraries, run: <br><strong class='code'>$ expo install react-native-reanimated react-native-gesture-handler react-native-redash</strong>"},{"isLink":false,"link":"","text":"If you are not using Expo, run the following: <br><strong class='code'>$ yarn add react-native-reanimated react-native-gesture-handler react-native-redash</strong>"}]},{"contentTitle":"How to use?","contentDescription":"","contentList":[{"isLink":true,"link":"https://www.npmjs.com/package/validate-form-in-expo-style#-how-to-use-","text":"Link to the code example"}]},{"contentTitle":"Supoorted types","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"<strong>TextInput</strong>"}]},{"contentTitle":"Default Validation Rules","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"<strong>matchRegexp</strong> (To match any regexp validation)"},{"isLink":false,"link":"","text":"<strong>isEmail</strong> (Is email is valid or not)"},{"isLink":false,"link":"","text":"<strong>isEmpty</strong> (Is field is empty or not)"},{"isLink":false,"link":"","text":"<strong>required</strong> (Is field is required or not)"},{"isLink":false,"link":"","text":"<strong>trim</strong> (Trim the value of field)"},{"isLink":false,"link":"","text":"<strong>isNumber</strong> (Is the value is number or not)"},{"isLink":false,"link":"","text":"<strong>isFloat</strong> (Is the value is float or not)"},{"isLink":false,"link":"","text":"<strong>isPositive</strong> (Is the value is positive or not)"},{"isLink":false,"link":"","text":"<strong>minNumber</strong> (Min number to be entered)"},{"isLink":false,"link":"","text":"<strong>maxNumber</strong> (Max number can be entered)"},{"isLink":false,"link":"","text":"<strong>minFloat</strong> (Min float value to be entered)"},{"isLink":false,"link":"","text":"<strong>maxFloat</strong> (Max float value can be entered)"},{"isLink":false,"link":"","text":"<strong>minStringLength</strong> (Minimum length of string to be entered)"},{"isLink":false,"link":"","text":"<strong>maxStringLength</strong> (Maximum length of string can be entered)"},{"isLink":false,"link":"","text":"<strong>isString</strong> (Is value is string or not)"},{"isLink":false,"link":"","text":"Some rules that are added in validationName can accept extra parameter for validation, like: <br> <strong class='code'><div class='highlight javascript'><pre class='editor editor-colors'><div class='line'><span class='source js'><span class='keyword operator comparison js'><span>&lt;</span></span><span>InputText</span></span></div><div class='line'><span class='source js'><span>&nbsp;&nbsp;&nbsp;</span><span class='meta brace curly js'><span>{</span></span><span class='keyword operator js'><span>...</span></span><span>otherProps</span><span class='meta brace curly js'><span>}</span></span></span></div><div class='line'><span class='source js'><span>&nbsp;&nbsp;&nbsp;validateNames</span><span class='keyword operator assignment js'><span>=</span></span><span class='meta brace curly js'><span>{</span></span><span class='meta brace square js'><span>[</span></span><span class='string quoted single js'><span class='punctuation definition string begin js'><span>'</span></span><span>minNumber:1</span><span class='punctuation definition string end js'><span>'</span></span></span><span class='meta delimiter object comma js'><span>,</span></span><span>&nbsp;</span><span class='string quoted single js'><span class='punctuation definition string begin js'><span>'</span></span><span>maxNumber:255</span><span class='punctuation definition string end js'><span>'</span></span></span><span class='meta delimiter object comma js'><span>,</span></span><span>&nbsp;</span><span class='string quoted single js'><span class='punctuation definition string begin js'><span>'</span></span><span>matchRegexp:^[0-9]$</span><span class='punctuation definition string end js'><span>'</span></span></span><span class='meta brace square js'><span>]</span></span><span class='meta brace curly js'><span>}</span></span></span></div><div class='line'><span class='source js'><span class='keyword operator js'><span>/</span></span><span class='keyword operator comparison js'><span>&gt;</span></span></span></div></pre></div></strong>"}]},{"contentTitle":"Props","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"<strong>Form Props</strong> <br> <table> <thead> <tr> <th>Prop</th> <th>Required</th> <th>Type</th> <th>Default value</th> <th>Description</th> </tr> </thead> <tbody> <tr> <td>onSubmit</td> <td>true</td> <td>function</td> <td></td> <td>Callback for form that fires when all validations are passed</td> </tr> <tr> <td>instantValidate</td> <td>false</td> <td>bool</td> <td>true</td> <td>If true, form will be validated after each field change. If false, form will be validated only after clicking submit button.</td> </tr> <tr> <td>onError</td> <td>false</td> <td>function</td> <td></td> <td>Callback for form that fires when some of validations are not passed. It will return array of elements which not valid.</td> </tr> <tr> <td>debounceTime</td> <td>false</td> <td>number</td> <td>0</td> <td>Debounce time for validation i.e. your validation will run after <code>debounceTime</code> ms when you stop changing your input</td> </tr> </tbody> </table>"},{"isLink":false,"link":"","text":"<strong>InputText Props</strong> <br> <table> <thead> <tr> <th>Prop</th> <th>Required</th> <th>Type</th> <th>Default value</th> <th>Description</th> </tr> </thead> <tbody> <tr> <td>name</td> <td>true</td> <td>string</td> <td></td> <td>Name of input field</td> </tr> <tr> <td>label</td> <td>false</td> <td>string</td> <td></td> <td>Name of input Floating Label</td> </tr> <tr> <td>placeholder</td> <td>false</td> <td>string</td> <td></td> <td>Placeholder of input before any value</td> </tr> <tr> <td>validateNames</td> <td>false</td> <td>array</td> <td></td> <td>Array of validation. See list of default validation rules in above example.</td> </tr> <tr> <td>errorMessages</td> <td>false</td> <td>array</td> <td></td> <td>Array of error messages. Order of messages should be the same as <code>validateNames</code> prop.</td> </tr> <tr> <td>errorStyle</td> <td>false</td> <td>object</td> <td>{ container: { top: 0, left: 0, position: 'absolute' }, text: { color: 'red' }, underlineValidColor: 'gray', underlineInvalidColor: 'red' } }</td> <td>Add your own error styles</td> </tr> <tr> <td>validatorListener</td> <td>false</td> <td>function</td> <td></td> <td>It triggers after each validation. It will return <code>true</code> or <code>false</code></td> </tr> <tr> <td>withRequiredValidator</td> <td>false</td> <td>bool</td> <td></td> <td>Allow to use <code>required</code> validator in any validation trigger, not only form submit</td> </tr> <tr> <td>leftIcon</td> <td>false</td> <td>code, image</td> <td></td> <td>Either include image or add Icon tag code to display left icon see above example</td> </tr> <tr> <td>invalidIcon</td> <td>false</td> <td>code, image</td> <td></td> <td>Either include image or add Icon tag code to display error icon on right side see above example</td> </tr> <tr> <td>validIcon</td> <td>false</td> <td>code, image</td> <td></td> <td>Either include image or add Icon tag code to display success icon on right side see above example</td> </tr> <tr> <td>secureTextEntry</td> <td>false</td> <td>bool</td> <td>false</td> <td>If true than show hide icon will get added automatically</td> </tr> </tbody> </table>"}]},{"contentTitle":"Methods","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"<strong>Form Methods</strong> <br> <table> <thead> <tr> <th>Name</th> <th>Params</th> <th>Return</th> <th>Descriptipon</th> </tr> </thead> <tbody> <tr> <td>resetValidations</td> <td></td> <td></td> <td>Reset validation messages for all validated inputs</td> </tr> <tr> <td>isFormValid</td> <td>dryRun: bool (default true)</td> <td>Promise</td> <td>Get form validation state in a Promise (<code>true</code> if whole form is valid). Run with <code>dryRun = false</code> to show validation errors on form</td> </tr> </tbody> </table>"},{"isLink":false,"link":"","text":"<strong>InputText Methods</strong> <br> <table> <thead> <tr> <th>Name</th> <th>Params</th> <th>Return</th> <th>Descriptipon</th> </tr> </thead> <tbody> <tr> <td>getErrorMessage</td> <td></td> <td></td> <td>Get error validation message</td> </tr> <tr> <td>validate</td> <td>value: any, includeRequired: bool</td> <td></td> <td>Run validation for current component</td> </tr> <tr> <td>isValid</td> <td></td> <td>bool</td> <td>Return current validation state</td> </tr> <tr> <td>makeInvalid</td> <td></td> <td></td> <td>Set invalid validation state</td> </tr> <tr> <td>makeValid</td> <td></td> <td></td> <td>Set valid validation state</td> </tr> </tbody> </table>"}]}]},{"id":6,"title":"react-animation-loader","description":"Simple animation loader with some css animation and an image with moving animation","logo":"/images/project/npm/npm-logo.webp","thumbnail":"/images/project/npm/react-animation-loader-thumb.webp","gitAvailable":true,"tag":"React, JavaScript, CSS, NPM, UX, Design, NPM Packages, GitHub","technology":"React, JavaScript, CSS, NPM, VS Code","date":"December 2020","isPackage":true,"onlineLink":"https://github.com/radhakishan404/react-animation-loader","sliderImages":[{"image":"/images/project/npm/react-animation-loader-thumb.webp"}],"content":[{"contentTitle":"Technical Specification","contentDescription":"<strong>react-animation-loader</strong> simple animation loader with some <strong>css animation</strong> and an image with moving animation. Check it out. It has a total of <strong>5 versions</strong>, the latest version <strong>1.0.5</strong>. The file size is only <strong>11.3 kB</strong>.","contentList":[{"isLink":true,"link":"https://github.com/radhakishan404/react-animation-loader","text":"Link to source code"},{"isLink":true,"link":"https://www.npmjs.com/package/react-animation-loader","text":"Link to NPM Package"}]},{"contentTitle":"Features","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"Custom Colour"},{"isLink":false,"link":"","text":"Custom Image"},{"isLink":false,"link":"","text":"Custom Transition Time"},{"isLink":false,"link":"","text":"Custom Image Size"},{"isLink":false,"link":"","text":"Custom Style"}]},{"contentTitle":"Install","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"<strong class='code'>$ npm install Install</strong> OR <strong class='code'>$ yarn add Install</strong>"}]},{"contentTitle":"Example","contentDescription":"","contentList":[{"isLink":true,"link":"https://github.com/radhakishan404/react-animation-loader#example","text":"Link to code example"}]},{"contentTitle":"Props","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"<strong>isLoading</strong> (bool) (required)"},{"isLink":false,"link":"","text":"<strong>bgColor</strong> (string) (required)"},{"isLink":false,"link":"","text":"<strong>icon</strong> (string)"}]}]},{"id":7,"title":"Stock Money Makers","description":"Stock Money Makers provides the best online stock market courses in india which Includes exclusive banknifty intraday course, technical analysis course, bank nifty option course, stock market courses for beginners & much more.","logo":"/images/project/smm/logo.webp","thumbnail":"/images/project/smm/smm-1.webp","gitAvailable":false,"tag":"PHP, CodeIgniter, jQuery, JavaScript, MySql, HTML5, Mobirise","technology":"PHP, CodeIgniter, jQuery, JavaScript, MySQL, HTML5, Mobirise","date":"February 2020 - March 2020","isPackage":false,"onlineLink":"https://stockmoneymakers.com/","sliderImages":[{"image":"/images/project/smm/smm-1.webp"},{"image":"/images/project/smm/smm-2.webp"},{"image":"/images/project/smm/smm-3.webp"},{"image":"/images/project/smm/smm-4.webp"}],"content":[{"contentTitle":"Technical Specification","contentDescription":"Stock Market Trader/Investor/Consultancy/Financial Advisor. Stock Money Makers Team's Main Purpose Is To Help People Learn About The Stock Market.","contentList":[{"isLink":true,"link":"https://stockmoneymakers.com/","text":"Link to live demo"}]},{"contentTitle":"Features","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"Admin Panel"},{"isLink":false,"link":"","text":"Paid Webinar Courses"},{"isLink":false,"link":"","text":"Blogs"},{"isLink":false,"link":"","text":"Course uploading using plupload"},{"isLink":false,"link":"","text":"Payment Gateway"}]},{"contentTitle":"Responsibilities","contentDescription":"My responsibilities for this project included <strong>design and development</strong> of a complete website.","contentList":[{"isLink":false,"link":"","text":"Layout, UI and UX design"},{"isLink":false,"link":"","text":"Front End Development"},{"isLink":false,"link":"","text":"Back End Development"},{"isLink":false,"link":"","text":"Integration with Google Analytics"},{"isLink":false,"link":"","text":"Responsive Design"},{"isLink":false,"link":"","text":"User Experience"}]},{"contentTitle":"Challenges","contentDescription":"The first challenge that I occurred was <strong>designing and architecting</strong> the base structure of front-end. Building a web app with <strong>CodeIgniter</strong> a perfect choice for future growth and maintainability of a <strong>web application</strong>. CodeIgniter Framework made this a whole lot easier by allowing us to separate the <strong>Logic, Modules and View</strong>. One of the biggest challenges during development was uploading <strong>large video course</strong> of the web app in the back-end.","contentList":null}]},{"id":9,"title":"Bright Wood - Buy Furniture Online","description":"This project was created for one of my friend. He was my relative also so I gave me the best website to manage inventory and orders from site. In this project admin can create multiple variant of product with various type of colors and size of the product.","logo":"/images/project/bright-wood-logo.png","thumbnail":"/images/project/bright-wood-1.png","gitAvailable":false,"tag":"PHP, jQuery, JavaScript, MySql, HTML5, Razorpay","technology":"PHP, jQuery, JavaScript, MySQL, HTML5, Razorpay","date":"July 2021 - September 2021","isPackage":false,"onlineLink":"https://brightwood.in/","sliderImages":[{"image":"/images/project/bright-wood-1.png"},{"image":"/images/project/bright-wood-2.png"},{"image":"/images/project/bright-wood-3.png"},{"image":"/images/project/bright-wood-4.png"}],"content":[{"contentTitle":"Technical Specification","contentDescription":"Bright Wood Provide the best furniture in market, There designs are inspired by the new generation with a classic touch. Brightwood is proud to offer a wide range of solid wood furniture at great prices. Our full array of furniture includes living room, dining room, home office, bedroom, and kids furniture.","contentList":[{"isLink":true,"link":"https://brightwood.in/","text":"Link to live demo"}]},{"contentTitle":"Features","contentDescription":"","contentList":[{"isLink":false,"link":"","text":"Admin Panel"},{"isLink":false,"link":"","text":"Furniture Product"},{"isLink":false,"link":"","text":"Category"},{"isLink":false,"link":"","text":"Online Payment Gateway"},{"isLink":false,"link":"","text":"Filtered Product"}]},{"contentTitle":"Responsibilities","contentDescription":"My responsibilities for this project included <strong>design and development</strong> of a complete website.","contentList":[{"isLink":false,"link":"","text":"Layout, UI and UX design"},{"isLink":false,"link":"","text":"Front End Development"},{"isLink":false,"link":"","text":"Back End Development"},{"isLink":false,"link":"","text":"Integration with Google Analytics"},{"isLink":false,"link":"","text":"Responsive Design"},{"isLink":false,"link":"","text":"User Experience"}]},{"contentTitle":"Challenges","contentDescription":"The first challenge that I occurred was <strong>designing and architecting</strong> the base structure of front-end. Building a ecommerece with <strong>PHP</strong> a perfect choice for future growth and maintainability of a <strong>web application</strong>. PHP made this a whole lot easier by allowing us to create website faster. One of the biggest challenges during development was maintaining <strong>Variants of product</strong> of the web app in the back-end.","contentList":null}]}]`),_t={experience:Wg,skills:Yg,project:Vg};function $g(){const r=new Date().getFullYear()-1998;return Vn("About | Radhakishan Jangid","Experience, technical strengths, and current focus areas."),p.jsx("div",{className:"page-wrap",children:p.jsxs("div",{className:"container",children:[p.jsxs("section",{"data-reveal":!0,children:[p.jsx("h1",{style:{marginBottom:24},children:"About"}),p.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr auto",gap:"clamp(32px, 5vw, 64px)",alignItems:"start"},children:[p.jsxs("p",{className:"about-blurb",children:["I'm Radhakishan, a ",r,"-year-old ",p.jsx("span",{className:"muted",children:"senior software engineer based in Mumbai."})," I build product systems, ",p.jsx("span",{className:"muted",children:"ship React and Node applications,"})," and write technical content ",p.jsx("span",{className:"muted",children:"for developers and creators."})]}),p.jsx("div",{className:"portrait-wrap clip-reveal is-revealed","data-reveal":!0,"data-reveal-delay":"2",children:p.jsx("img",{src:lt.hero,alt:"Radhakishan Jangid"})})]})]}),p.jsxs("section",{className:"page-section",children:[p.jsxs("div",{className:"split-title","data-reveal":!0,children:[p.jsx("h2",{children:"Work"}),p.jsx("span",{className:"split-title-line"}),p.jsx("h2",{children:"Experience"})]}),p.jsx("div",{className:"timeline",children:_t.experience.map((s,l)=>p.jsxs("div",{className:"timeline-item","data-reveal":!0,"data-reveal-delay":`${l+1}`,children:[p.jsxs("div",{className:"timeline-meta",children:[p.jsx("strong",{children:s.title}),p.jsxs("span",{children:[s.from," — ",s.to]}),p.jsx("span",{children:s.location}),p.jsx("div",{className:"timeline-company",children:p.jsx("a",{href:s.companyLink,target:"_blank",rel:"noreferrer",children:s.companyName})})]}),p.jsx("div",{className:"timeline-body",children:p.jsx("p",{children:s.description})})]},`${s.companyName}-${s.from}`))})]}),p.jsxs("section",{className:"page-section",children:[p.jsxs("div",{className:"split-title","data-reveal":!0,children:[p.jsx("h2",{children:"Technical"}),p.jsx("span",{className:"split-title-line"}),p.jsx("h2",{children:"Skills"})]}),p.jsx("div",{className:"skills-grid",children:(_t.skills[0]?.skillType||[]).map((s,l)=>p.jsxs(Un,{className:"skill-card shine-card","data-reveal":!0,"data-reveal-delay":`${l+1}`,children:[p.jsx("h3",{children:s.title}),p.jsx("ul",{children:(s.skillsList||[]).map(c=>p.jsx("li",{children:c.skillTitle},c.skillTitle))})]},s.title))})]})]})})}function $d({slot:o,format:r="auto",responsive:s=!0,className:l=""}){const c=ae.useRef(null),h=ae.useRef(!1);return ae.useEffect(()=>{if(!(h.current||!c.current))try{(window.adsbygoogle=window.adsbygoogle||[]).push({}),h.current=!0}catch{}},[]),p.jsx("div",{className:`ad-slot-wrap ${l}`,children:p.jsx("ins",{className:"adsbygoogle",ref:c,style:{display:"block"},"data-ad-client":"ca-pub-XXXXXXXXXXXXXXXX","data-ad-slot":o,"data-ad-format":r,"data-full-width-responsive":s?"true":"false"})})}function Cn({children:o,className:r="",as:s="button",strength:l=.3,...c}){const h=ae.useRef(null),m=ae.useCallback(g=>{const v=h.current;if(!v||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const y=v.getBoundingClientRect(),S=(g.clientX-y.left-y.width/2)*l,T=(g.clientY-y.top-y.height/2)*l;v.style.transform=`translate(${S}px, ${T}px)`},[l]),b=ae.useCallback(()=>{const g=h.current;g&&(g.style.transform="")},[]);return p.jsx(s,{ref:h,className:r,onMouseMove:m,onMouseLeave:b,style:{transition:"transform 0.3s cubic-bezier(0.03, 0.98, 0.52, 0.99)",...c.style},...c,children:o})}const As="rk-journal-f7c2a91",Is="https://api.countapi.xyz",Kd=new Set;function Mp(o){let r=0;for(let s=0;s<o.length;s+=1)r=(r<<5)-r+o.charCodeAt(s),r|=0;return 180+Math.abs(r)%620}async function Kg(o){const r=await fetch(`${Is}/get/${As}/${o}`),s=await r.json();return r.ok&&typeof s.value=="number"?s.value:null}async function Jg(o){const r=Mp(o),s=new URLSearchParams({namespace:As,key:o,value:`${r}`}),l=await fetch(`${Is}/create?${s.toString()}`),c=await l.json();return l.ok&&typeof c.value=="number"?c.value:r}async function Qg(o){const r=await fetch(`${Is}/hit/${As}/${o}`),s=await r.json();return r.ok&&typeof s.value=="number"?s.value:null}function Xg(o){return typeof o!="number"?"":`${new Intl.NumberFormat("en-US").format(o)} reads`}function Zg(o,r=!1){const[s,l]=ae.useState(null);return ae.useEffect(()=>{let c=!0;async function h(){try{let m=await Kg(o);if(m===null&&(m=await Jg(o)),r&&!Kd.has(o)){Kd.add(o);const b=await Qg(o);typeof b=="number"&&(m=b)}c&&l(m)}catch{c&&l(Mp(o))}}return h(),()=>{c=!1}},[r,o]),ae.useMemo(()=>({views:s,viewsLabel:Xg(s)}),[s])}function ef({match:o}){const r=Ts(o.params.slug),{views:s,viewsLabel:l}=Zg(o.params.slug,!0),c=typeof window<"u"?window.location.origin:"https://radhakishan404.is-a.dev";return Vn({title:r?`${r.title} | Articles | Radhakishan Jangid`:"Article | Radhakishan Jangid",description:r?.excerpt||"Article detail",image:r?.coverImage||lt.article,type:"article",structuredData:r?{"@context":"https://schema.org","@type":"Article",headline:r.title,description:r.excerpt,datePublished:r.sortDate||void 0,author:{"@type":"Person",name:"Radhakishan Jangid"},publisher:{"@type":"Person",name:"Radhakishan Jangid"},mainEntityOfPage:`${c}/articles/${r.slug}/`,image:r.coverImage?`${c}${r.coverImage}`:`${c}${lt.article}`,keywords:r.tags.join(", "),interactionStatistic:typeof s=="number"?{"@type":"InteractionCounter",interactionType:"https://schema.org/ReadAction",userInteractionCount:s}:void 0}:void 0}),r?p.jsx("div",{className:"page-wrap",children:p.jsxs("div",{className:"container",children:[p.jsx(Re,{className:"back-link",to:"/articles",children:"Back to Articles"}),p.jsxs("div",{className:"article-detail-header","data-reveal":!0,children:[p.jsxs("div",{className:"article-detail-meta",children:[p.jsx("span",{className:"badge",children:r.category||"Article"}),p.jsx("span",{children:r.readingTime}),r.date&&p.jsx("span",{children:r.date}),l&&p.jsx("span",{children:l})]}),p.jsx("h1",{children:r.title}),p.jsx("p",{style:{color:"var(--color-text-muted)",fontSize:18},children:r.excerpt}),(r.tags.length>0||r.githubUrl)&&p.jsxs("div",{className:"article-detail-actions",children:[r.tags.length>0&&p.jsx("div",{className:"tag-row",children:r.tags.map(h=>p.jsx("span",{className:"tag",children:h},h))}),r.githubUrl&&p.jsxs(Cn,{as:"a",className:"btn btn-github",href:r.githubUrl,target:"_blank",rel:"noreferrer",children:[p.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"currentColor",style:{marginRight:8},children:p.jsx("path",{d:"M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z"})}),"View on GitHub"]})]})]}),p.jsx($d,{slot:"ARTICLE_TOP_SLOT",className:"article-ad-slot"}),p.jsx("article",{className:"article-prose","data-reveal":!0,dangerouslySetInnerHTML:{__html:r.bodyHtml}}),p.jsx($d,{slot:"ARTICLE_BOTTOM_SLOT",className:"article-ad-slot"}),p.jsxs("div",{className:"article-footer-nav","data-reveal":!0,children:[r.githubUrl&&p.jsx("a",{className:"btn",href:r.githubUrl,target:"_blank",rel:"noreferrer",style:{marginRight:12},children:"View Source Code"}),p.jsx(Re,{className:"btn",to:"/articles",children:"Browse All Articles"})]})]})}):p.jsx(Ot,{to:"/articles"})}const nf=[{value:"newest",label:"Newest First"},{value:"oldest",label:"Oldest First"},{value:"title-az",label:"Title A–Z"},{value:"title-za",label:"Title Z–A"},{value:"reading-time",label:"Quick Reads First"}];function tf(){const o=typeof window<"u"?window.location.origin:"https://radhakishan404.is-a.dev",[r,s]=ae.useState(""),[l,c]=ae.useState("all"),[h,m]=ae.useState("all"),[b,g]=ae.useState("newest"),v=qg(),y=_g(),S=ae.useMemo(()=>{const P=r.trim().toLowerCase(),R=[...Ht.filter(G=>!(P&&!G.title.toLowerCase().includes(P)&&!G.excerpt.toLowerCase().includes(P)||l!=="all"&&(G.category||"Article")!==l||h!=="all"&&!G.tags.includes(h)))];switch(b){case"oldest":R.sort((G,H)=>{const te=G.sortDate?new Date(G.sortDate).getTime():0,M=H.sortDate?new Date(H.sortDate).getTime():0;return te-M});break;case"title-az":R.sort((G,H)=>G.title.localeCompare(H.title));break;case"title-za":R.sort((G,H)=>H.title.localeCompare(G.title));break;case"reading-time":R.sort((G,H)=>{const te=parseInt(G.readingTime)||0,M=parseInt(H.readingTime)||0;return te-M});break}return R},[r,l,h,b]),T=b==="newest"&&S.find(P=>P.featured)||S[0],B=S.filter(P=>P!==T),D=l!=="all"||h!=="all"||b!=="newest"||r.trim();return Vn({title:"Articles | Radhakishan Jangid",description:"AI prompts, developer content systems, carousel workflows, public write-ups, and practical technical articles for developers and creators.",image:T?.coverImage||lt.article,type:"website",structuredData:{"@context":"https://schema.org","@type":"CollectionPage",name:"Articles by Radhakishan Jangid",description:"AI prompts, developer content systems, public write-ups, and practical technical articles.",url:`${o}/articles/`,mainEntity:S.slice(0,10).map(P=>({"@type":"Article",headline:P.title,url:`${o}/articles/${P.slug}/`,datePublished:P.sortDate||void 0}))}}),p.jsx("div",{className:"page-wrap",children:p.jsxs("div",{className:"container",children:[p.jsxs("section",{"data-reveal":!0,children:[p.jsx("p",{className:"page-eyebrow",children:"Blog & Guides"}),p.jsx("h1",{style:{marginBottom:12},children:"Articles"}),p.jsx("p",{style:{color:"var(--color-text-muted)",fontSize:18,maxWidth:640,marginBottom:40},children:"AI prompts, developer content systems, and practical technical articles for developers and creators."})]}),p.jsxs("div",{className:"article-filters","data-reveal":!0,children:[p.jsxs("div",{className:"article-filters-row",children:[p.jsx("input",{type:"search",className:"filter-search",value:r,onChange:P=>s(P.target.value),placeholder:"Search articles..."}),p.jsxs("select",{className:"filter-select",value:l,onChange:P=>c(P.target.value),children:[p.jsx("option",{value:"all",children:"All Categories"}),v.map(P=>p.jsx("option",{value:P,children:P},P))]}),p.jsxs("select",{className:"filter-select",value:h,onChange:P=>m(P.target.value),children:[p.jsx("option",{value:"all",children:"All Tags"}),y.map(P=>p.jsx("option",{value:P,children:P},P))]}),p.jsx("select",{className:"filter-select",value:b,onChange:P=>g(P.target.value),children:nf.map(P=>p.jsx("option",{value:P.value,children:P.label},P.value))})]}),p.jsxs("div",{className:"article-filters-info",children:[p.jsxs("span",{className:"filter-count",children:[S.length," article",S.length!==1?"s":""]}),D&&p.jsx("button",{type:"button",className:"filter-clear",onClick:()=>{s(""),c("all"),m("all"),g("newest")},children:"Clear filters"})]})]}),T&&p.jsxs(Re,{className:"article-featured",to:`/articles/${T.slug}`,"data-reveal":!0,children:[p.jsx("div",{className:"article-featured-img",children:p.jsx("img",{src:T.coverImage,alt:T.title,loading:"eager",onError:P=>{P.target.style.display="none"}})}),p.jsxs("div",{className:"article-featured-body",children:[p.jsxs("div",{className:"article-featured-badges",children:[T.featured&&p.jsx("span",{className:"badge badge--featured",children:"Featured"}),p.jsx("span",{className:"badge",children:T.category||"Article"})]}),p.jsx("h2",{children:T.title}),p.jsx("p",{children:T.excerpt}),p.jsxs("div",{className:"article-featured-meta",children:[p.jsx("span",{children:T.readingTime}),T.date&&p.jsx("span",{children:T.date})]})]})]}),p.jsx("div",{className:"article-card-grid",children:B.map((P,V)=>p.jsx(Un,{className:"article-card shine-card","data-reveal":!0,"data-reveal-delay":`${V%3+1}`,children:p.jsxs(Re,{to:`/articles/${P.slug}`,className:"article-card-link",children:[p.jsxs("div",{className:"article-card-cover",children:[p.jsx("img",{src:P.coverImage,alt:P.title,loading:"lazy",onError:R=>{R.target.style.display="none"}}),p.jsx("span",{className:"article-card-category",children:P.category||"Article"})]}),p.jsxs("div",{className:"article-card-body",children:[p.jsx("h3",{children:P.title}),p.jsxs("p",{children:[P.excerpt.slice(0,120),P.excerpt.length>120?"...":""]}),p.jsxs("div",{className:"article-card-meta",children:[p.jsx("span",{children:P.readingTime}),P.date&&p.jsx("span",{children:P.date})]})]})]})},P.slug))}),S.length===0&&p.jsx("p",{style:{color:"var(--color-text-muted)",textAlign:"center",padding:"60px 0"},"data-reveal":!0,children:"No articles match your filters."})]})})}const af="modulepreload",rf=function(o){return"/"+o},Jd={},of=function(r,s,l){let c=Promise.resolve();if(s&&s.length>0){let g=function(v){return Promise.all(v.map(y=>Promise.resolve(y).then(S=>({status:"fulfilled",value:S}),S=>({status:"rejected",reason:S}))))};document.getElementsByTagName("link");const m=document.querySelector("meta[property=csp-nonce]"),b=m?.nonce||m?.getAttribute("nonce");c=g(s.map(v=>{if(v=rf(v),v in Jd)return;Jd[v]=!0;const y=v.endsWith(".css"),S=y?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${v}"]${S}`))return;const T=document.createElement("link");if(T.rel=y?"stylesheet":af,y||(T.as="script"),T.crossOrigin="",T.href=v,b&&T.setAttribute("nonce",b),document.head.appendChild(T),y)return new Promise((B,D)=>{T.addEventListener("load",B),T.addEventListener("error",()=>D(new Error(`Unable to preload CSS for ${v}`)))})}))}function h(m){const b=new Event("vite:preloadError",{cancelable:!0});if(b.payload=m,window.dispatchEvent(b),!b.defaultPrevented)throw m}return c.then(m=>{for(const b of m||[])b.status==="rejected"&&h(b.reason);return r().catch(h)})};function sf(){const o=ae.useRef(null),[r,s]=ae.useState("idle");Vn("Contact | Radhakishan Jangid","Get in touch for engineering work, collaboration, and consulting.");const l=async c=>{c.preventDefault(),s("sending");try{await(await of(()=>import("./index-DB619KJ3.js").then(m=>m.i),[])).sendForm("service_sn6cjfe","template_ai5s6x5",o.current,"user_dGsNFmNHFtCMCgJzZ"),s("success"),o.current.reset()}catch{s("error")}};return p.jsx("div",{className:"page-wrap",children:p.jsxs("div",{className:"container",children:[p.jsxs("section",{"data-reveal":!0,children:[p.jsx("h1",{style:{marginBottom:12},children:"Let's work together"}),p.jsx("p",{style:{color:"var(--color-text-muted)",fontSize:18,maxWidth:540,marginBottom:48},children:"Have a project, question, or collaboration idea? Reach out and I'll get back to you."})]}),p.jsxs("div",{className:"contact-layout",children:[p.jsxs("div",{"data-reveal":!0,children:[p.jsx("h3",{style:{marginBottom:8},children:"Direct links"}),p.jsx("p",{style:{color:"var(--color-text-muted)",fontSize:15,marginBottom:16},children:"You can also reach me through any of these channels."}),p.jsx("div",{className:"contact-links-list",children:ym.map((c,h)=>p.jsx("a",{href:c.href,target:c.external?"_blank":void 0,rel:c.external?"noreferrer":void 0,"data-reveal":!0,"data-reveal-delay":`${h+1}`,children:c.label},c.label))})]}),p.jsxs("form",{ref:o,className:"contact-form",onSubmit:l,"data-reveal":!0,"data-reveal-delay":"2",children:[p.jsxs("div",{className:"form-row",children:[p.jsx("input",{name:"name",type:"text",placeholder:"Name",required:!0}),p.jsx("input",{name:"email",type:"email",placeholder:"Email",required:!0})]}),p.jsx("input",{name:"subject",type:"text",placeholder:"Subject"}),p.jsx("textarea",{name:"message",placeholder:"Your message...",rows:"5",required:!0}),p.jsx(Cn,{type:"submit",className:"btn btn-filled",disabled:r==="sending",children:r==="sending"?"Sending...":"Send Message"}),r==="success"&&p.jsx("p",{className:"form-status",children:"Message sent successfully."}),r==="error"&&p.jsx("p",{className:"form-status form-status-error",children:"Something went wrong. Please try again."})]})]})]})})}function lf(o){const r=String(o),s=r.match(/^(\d+)/);return s?{num:parseInt(s[1],10),suffix:r.slice(s[0].length)}:{num:0,suffix:r}}function ts({value:o,duration:r=1200,className:s=""}){const{num:l,suffix:c}=lf(o),[h,m]=ae.useState(0),b=ae.useRef(null),g=ae.useRef(!1);return ae.useEffect(()=>{const v=b.current;if(!v||g.current)return;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){m(l),g.current=!0;return}const S=new IntersectionObserver(([T])=>{if(!T.isIntersecting||g.current)return;g.current=!0,S.disconnect();const B=performance.now(),D=P=>{const V=P-B,R=Math.min(V/r,1),G=1-Math.pow(1-R,3);m(Math.round(G*l)),R<1&&requestAnimationFrame(D)};requestAnimationFrame(D)},{threshold:.3});return S.observe(v),()=>S.disconnect()},[l,r]),p.jsxs("span",{ref:b,className:s,children:[h,c]})}const cf=[{type:"ring",size:80,top:"12%",left:"8%",duration:22,delay:0,rot:0},{type:"diamond",size:24,top:"25%",right:"12%",duration:19,delay:2,rot:45},{type:"circle",size:120,bottom:"18%",left:"5%",duration:26,delay:5,rot:0},{type:"ring",size:50,top:"60%",right:"8%",duration:20,delay:1,rot:0},{type:"diamond",size:18,top:"40%",left:"15%",duration:17,delay:3,rot:45},{type:"circle",size:40,bottom:"30%",right:"18%",duration:24,delay:7,rot:0},{type:"ring",size:35,top:"75%",left:"22%",duration:21,delay:4,rot:0},{type:"diamond",size:30,top:"15%",left:"45%",duration:23,delay:6,rot:45}];function df(){return p.jsx("div",{className:"floating-shapes","aria-hidden":"true",children:cf.map((o,r)=>{const s={width:o.size,height:o.size,top:o.top,left:o.left,right:o.right,bottom:o.bottom,"--duration":`${o.duration}s`,"--delay":`${o.delay}s`,"--rot":`${o.rot}deg`};return p.jsx("div",{className:`float-shape float-shape--${o.type}`,style:s},r)})})}function Qd({items:o=[],separator:r=" // ",speed:s=30}){const l=o.join(r)+r,c={"--marquee-duration":`${s}s`};return p.jsx("div",{className:"marquee",style:c,"aria-hidden":"true",children:p.jsxs("div",{className:"marquee-track",children:[p.jsx("span",{className:"marquee-text",children:l}),p.jsx("span",{className:"marquee-text",children:l})]})})}const pf="radhakishan404.github.io",uf=new Set([pf,"radhakishan404.is-a.dev","radhakishan404","react-native-stylish-accordion-import"]);function Lp(){const[o,r]=ae.useState([]),[s,l]=ae.useState(!0);return ae.useEffect(()=>{let c=!0;async function h(){try{const b=await(await fetch("https://api.github.com/users/radhakishan404/repos?per_page=100&sort=updated")).json();if(!Array.isArray(b)||!c)return;const g=b.filter(v=>!v.fork&&!v.archived&&!uf.has(v.name)).filter(v=>v.description||v.homepage||v.stargazers_count>0).sort((v,y)=>{const S=new Date(v.updated_at).getTime(),T=new Date(y.updated_at).getTime();if(S!==T)return T-S;const B=v.stargazers_count*5+(v.homepage?2:0);return y.stargazers_count*5+(y.homepage?2:0)-B}).slice(0,6);r(g)}catch{}finally{c&&l(!1)}}return h(),()=>{c=!1}},[]),{repos:o,loading:s}}function hf(){const o=typeof window<"u"?window.location.origin:"https://radhakishan404.is-a.dev",r=ae.useRef(null),s=ae.useRef(null),l=ae.useRef(null),c=ae.useRef(null),h=_t.project.slice(0,4),m=[...Ht].sort((v,y)=>{const S=v.sortDate?new Date(v.sortDate).getTime():0;return(y.sortDate?new Date(y.sortDate).getTime():0)-S}).slice(0,6),{repos:b}=Lp();ae.useEffect(()=>{const v=r.current,y=s.current,S=l.current;if(!v||!y||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const T=()=>{const B=v.getBoundingClientRect(),D=Math.min(1,Math.max(0,-B.top/(B.height*.6))),P=1+D*.3;y.style.transform=`scale(${P})`,S&&(S.style.transform=`translateY(${D*-80}px)`,S.style.opacity=`${1-D*.9}`)};return window.addEventListener("scroll",T,{passive:!0}),()=>window.removeEventListener("scroll",T)},[]);const g=ae.useCallback(v=>{const y=c.current,S=s.current;if(!y||!S||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const T=(v.clientX/window.innerWidth-.5)*2,B=(v.clientY/window.innerHeight-.5)*2;S.style.objectPosition=`${50+T*2}% ${50+B*2}%`},[]);return Vn({title:"Radhakishan Jangid",description:"Senior software engineer building product systems, frontend experiences, public software projects, and AI-focused technical content.",image:lt.hero,type:"website",structuredData:{"@context":"https://schema.org","@graph":[{"@type":"Person",name:"Radhakishan Jangid",jobTitle:"Senior Software Engineer",url:`${o}/`,image:`${o}${lt.hero}`,sameAs:["https://github.com/radhakishan404","https://www.linkedin.com/in/radhakishanjangid","https://dev.to/radhakishanjangid404","https://www.instagram.com/rk.codex","https://www.youtube.com/@rk-codex"]},{"@type":"WebSite",name:"Radhakishan Jangid",url:`${o}/`}]}}),p.jsxs(p.Fragment,{children:[p.jsxs("section",{className:"hero",ref:r,onMouseMove:g,children:[p.jsx("div",{className:"hero-bg",children:p.jsx("div",{className:"hero-bg-sticky",children:p.jsx("img",{ref:s,src:"/images/moon-hero.jpg",alt:"",loading:"eager"})})}),p.jsx("div",{className:"hero-overlay",ref:c}),p.jsx(df,{}),p.jsxs("div",{className:"hero-content",ref:l,children:[p.jsxs("h1",{className:"hero-name",children:["Radhakishan",p.jsx("br",{}),"Jangid"]}),p.jsx("p",{className:"hero-subtitle",children:"Senior software engineer. Building product systems, React frontends, Node backends, and AI-focused technical content."}),p.jsxs("div",{style:{marginTop:32,display:"flex",gap:16,justifyContent:"center",flexWrap:"wrap"},children:[p.jsx(Cn,{as:Re,className:"btn btn-filled",to:"/projects",children:"View Projects"}),p.jsx(Cn,{as:Re,className:"btn",to:"/articles",children:"Read Articles"})]})]}),p.jsx("div",{className:"hero-scroll-hint",children:"Scroll"})]}),p.jsx(Qd,{items:["Development","Engineering","React","Node.js","Mobile Apps","AI Content","Product Systems","Open Source"],speed:35}),p.jsxs("section",{className:"page-section",style:{background:"#000",position:"relative",overflow:"hidden"},children:[p.jsx("div",{className:"perspective-grid"}),p.jsxs("div",{className:"container",style:{position:"relative",zIndex:1},children:[p.jsx("div",{"data-reveal-3d":!0,children:p.jsxs("p",{className:"about-blurb",children:["Mumbai based. ",p.jsx("span",{className:"muted",children:"Focused on React, Node.js, mobile apps,"})," internal systems, ",p.jsx("span",{className:"muted",children:"and public-facing"})," product builds ",p.jsx("span",{className:"muted",children:"with 7+ years of experience."})]})}),p.jsxs("div",{className:"stats-row","data-reveal-3d":!0,children:[p.jsxs("div",{className:"stat-item",children:[p.jsx(ts,{value:"7+",className:"stat-value"}),p.jsx("span",{className:"stat-label",children:"Years experience"})]}),p.jsxs("div",{className:"stat-item",children:[p.jsx(ts,{value:`${_t.project.length}`,className:"stat-value"}),p.jsx("span",{className:"stat-label",children:"Projects shipped"})]}),p.jsxs("div",{className:"stat-item",children:[p.jsx(ts,{value:`${Ht.length}`,className:"stat-value"}),p.jsx("span",{className:"stat-label",children:"Articles published"})]})]})]})]}),p.jsx("section",{className:"page-section",children:p.jsxs("div",{className:"container",children:[p.jsxs("div",{className:"split-title","data-reveal":!0,children:[p.jsx("h2",{children:"Selected"}),p.jsx("span",{className:"split-title-line"}),p.jsx("h2",{children:"Work"})]}),p.jsx("div",{className:"project-grid",children:h.map((v,y)=>p.jsx(Un,{className:"project-card shine-card","data-reveal":!0,"data-reveal-delay":`${y+1}`,children:p.jsxs(Re,{to:`/projects/${Gt(v.title)}`,style:{display:"contents"},children:[p.jsx("div",{className:"project-card-visual tilt-image",children:p.jsx("img",{src:v.thumbnail,alt:`${v.title} preview`})}),p.jsxs("div",{className:"project-card-body",children:[p.jsx("h3",{children:v.title}),p.jsx("p",{children:v.description}),p.jsx("div",{className:"tag-row",children:v.technology.split(",").slice(0,4).map(S=>p.jsx("span",{className:"tag",children:S.trim()},S))})]})]})},v.id))}),p.jsx("div",{style:{textAlign:"center",marginTop:48},"data-reveal":!0,children:p.jsx(Cn,{as:Re,className:"btn",to:"/projects",children:"View All Projects"})})]})}),p.jsx(Qd,{items:["Latest Articles","Technical Writing","AI Prompts","Developer Content","Practical Guides"],speed:40}),p.jsx("section",{className:"page-section",style:{background:"var(--color-bg-raised)"},children:p.jsxs("div",{className:"container",children:[p.jsxs("div",{className:"split-title","data-reveal":!0,children:[p.jsx("h2",{children:"Latest"}),p.jsx("span",{className:"split-title-line"}),p.jsx("h2",{children:"Articles"})]}),p.jsx("div",{className:"article-list",children:m.map((v,y)=>p.jsxs(Re,{className:"article-list-item",to:`/articles/${v.slug}`,"data-reveal":!0,"data-reveal-delay":`${y+1}`,children:[p.jsx("h3",{children:v.title}),p.jsxs("div",{className:"article-list-meta",children:[p.jsx("span",{children:v.readingTime}),v.date?p.jsx("span",{children:v.date}):null]})]},v.slug))}),p.jsx("div",{style:{textAlign:"center",marginTop:48},"data-reveal":!0,children:p.jsx(Cn,{as:Re,className:"btn",to:"/articles",children:"All Articles"})})]})}),p.jsx("section",{className:"page-section creator-section",children:p.jsxs("div",{className:"container",children:[p.jsxs("div",{className:"split-title","data-reveal":!0,children:[p.jsx("h2",{children:"Content"}),p.jsx("span",{className:"split-title-line"}),p.jsx("h2",{children:"Creator"})]}),p.jsxs("div",{className:"creator-grid",children:[p.jsxs(Un,{className:"creator-card shine-card","data-reveal":!0,"data-reveal-delay":"1",children:[p.jsxs("span",{className:"creator-card-badge",children:[p.jsx("span",{className:"badge-dot badge-dot--ig"}),"Instagram"]}),p.jsx("h3",{children:"@rk.codex"}),p.jsx("p",{children:"Coding reels, dev tips, behind-the-scenes, and tech content for developers and creators."}),p.jsx("div",{className:"reel-grid",children:xm.map(v=>p.jsxs("a",{className:"reel-card",href:v.url,target:"_blank",rel:"noreferrer",children:[p.jsx("div",{className:"reel-card-play"}),p.jsx("span",{className:"reel-card-label",children:v.title})]},v.id))}),p.jsx(Cn,{as:"a",className:"btn",href:"https://www.instagram.com/rk.codex",target:"_blank",rel:"noreferrer",style:{marginTop:8},children:"Follow on Instagram"})]}),p.jsxs(Un,{className:"creator-card shine-card","data-reveal":!0,"data-reveal-delay":"2",children:[p.jsxs("span",{className:"creator-card-badge",children:[p.jsx("span",{className:"badge-dot badge-dot--yt"}),"YouTube"]}),p.jsx("h3",{children:"@rk-codex"}),p.jsx("p",{children:"Longer-form coding tutorials, project walkthroughs, tech reviews, and engineering deep-dives."}),p.jsx("div",{className:"yt-video-grid",children:wm.map(v=>p.jsxs("a",{className:"yt-thumb-card",href:v.url,target:"_blank",rel:"noreferrer",children:[p.jsx("img",{src:`https://img.youtube.com/vi/${v.embedId}/hqdefault.jpg`,alt:v.title,loading:"lazy"}),p.jsx("div",{className:"yt-thumb-play"})]},v.id))}),p.jsx(Cn,{as:"a",className:"btn",href:"https://www.youtube.com/@rk-codex",target:"_blank",rel:"noreferrer",style:{marginTop:8},children:"Subscribe on YouTube"})]})]})]})}),b.length>0&&p.jsx("section",{className:"page-section",children:p.jsxs("div",{className:"container",children:[p.jsxs("div",{className:"split-title","data-reveal":!0,children:[p.jsx("h2",{children:"Open"}),p.jsx("span",{className:"split-title-line"}),p.jsx("h2",{children:"Source"})]}),p.jsx("div",{className:"public-grid",children:b.slice(0,3).map((v,y)=>p.jsxs(Un,{className:"public-card shine-card","data-reveal":!0,"data-reveal-delay":`${y+1}`,children:[p.jsxs("div",{className:"public-card-header",children:[p.jsx("h3",{children:v.name}),p.jsxs("span",{className:"public-star",children:["★ ",v.stargazers_count]})]}),p.jsx("p",{children:v.description||"Public GitHub repository."}),p.jsxs("div",{className:"public-card-footer",children:[p.jsx("a",{className:"text-link",href:v.html_url,target:"_blank",rel:"noreferrer",children:"View Repo"}),v.homepage?p.jsx("a",{className:"text-link",href:v.homepage,target:"_blank",rel:"noreferrer",children:"Live Demo"}):null]})]},v.id))})]})})]})}function mf({match:o}){const r=Ts(o.params.slug),s=pp(),l=ae.useRef(null),c=ae.useRef([]);return Vn({title:r?`${r.title} | rk.codex`:"Article | rk.codex",description:r?.excerpt||"",image:r?.coverImage||"",type:"article"}),ae.useEffect(()=>{if(!r?.raw||!l.current)return;const h=document.getElementById("root"),b=new DOMParser().parseFromString(r.raw,"text/html");h.style.display="none";const g=l.current;document.body.appendChild(g),g.style.display="block";const v=[];b.head.querySelectorAll("style, link[rel='stylesheet'], link[rel='preconnect']").forEach(P=>{const V=document.importNode(P,!0);document.head.appendChild(V),v.push(V)}),c.current=v;const y=b.body.className,S=b.body.getAttribute("style")||"";y&&(document.body.className=y),S&&document.body.setAttribute("style",S);const T=b.querySelector(":root")?.getAttribute("style");T&&document.documentElement.setAttribute("style",T),Array.from(b.body.childNodes).map(P=>document.importNode(P,!0)).forEach(P=>g.appendChild(P)),g.querySelectorAll("script").forEach(P=>{const V=document.createElement("script");P.src?V.src=P.src:V.textContent=P.textContent,P.parentNode.replaceChild(V,P)});const D=document.createElement("a");return D.textContent="← Back to Articles",D.href="/articles",Object.assign(D.style,{position:"fixed",bottom:"24px",right:"24px",zIndex:"9999",background:"rgba(0,0,0,0.85)",color:"#fff",padding:"10px 20px",borderRadius:"8px",fontSize:"13px",fontFamily:"system-ui, sans-serif",fontWeight:"600",textDecoration:"none",backdropFilter:"blur(12px)",border:"1px solid rgba(255,255,255,0.1)",cursor:"pointer",transition:"opacity 0.2s"}),D.addEventListener("click",P=>{P.preventDefault(),s.push("/articles")}),g.appendChild(D),()=>{c.current.forEach(P=>P.remove()),c.current=[],g.textContent="",g.style.display="none",document.body.className="",document.body.removeAttribute("style"),document.documentElement.removeAttribute("style"),h.style.display="",document.body.prepend(h)}},[r?.slug]),!r||r.kind!=="html"?p.jsx(Ot,{to:r?`/articles/${r.slug}`:"/articles"}):p.jsx("div",{ref:l,id:"html-article-root",style:{display:"none"}})}function gf({match:o}){const r=_t.project.find(l=>Gt(l.title)===o.params.topic),s=typeof window<"u"?window.location.origin:"https://radhakishan404.is-a.dev";return Vn({title:r?`${r.title} | Projects | Radhakishan Jangid`:"Project | Radhakishan Jangid",description:r?.description||"Project detail",image:r?.thumbnail||"",type:"website",structuredData:r?{"@context":"https://schema.org","@type":"CreativeWork",name:r.title,description:r.description,url:`${s}/projects/${Gt(r.title)}/`,author:{"@type":"Person",name:"Radhakishan Jangid"},image:r.thumbnail?`${s}${r.thumbnail}`:void 0}:void 0}),r?p.jsx("div",{className:"page-wrap",children:p.jsxs("div",{className:"container",children:[p.jsx(Re,{className:"back-link",to:"/projects",children:"Back to Projects"}),p.jsxs("section",{"data-reveal":!0,children:[p.jsx("h1",{style:{marginBottom:16},children:r.title}),p.jsx("p",{style:{color:"var(--color-text-muted)",fontSize:18,maxWidth:700,marginBottom:24},children:r.description}),p.jsx("div",{className:"tag-row",style:{marginBottom:40},children:r.technology.split(",").map(l=>p.jsx("span",{className:"tag",children:l.trim()},l))})]}),r.thumbnail&&p.jsx("div",{className:"project-hero-visual tilt-image","data-reveal":!0,children:p.jsx("img",{src:r.thumbnail,alt:`${r.title} preview`})}),p.jsxs("div",{className:"project-detail-layout",children:[p.jsx("div",{className:"project-gallery",children:(r.sliderImages||[]).map((l,c)=>p.jsx("figure",{className:"project-shot tilt-image","data-reveal":!0,children:p.jsx("img",{src:l.image,alt:`${r.title} screenshot ${c+1}`})},`${r.id}-${c}`))}),p.jsxs("aside",{className:"project-sidebar","data-reveal":!0,children:[r.onlineLink&&p.jsx(Cn,{as:"a",className:"btn btn-filled",href:r.onlineLink,target:"_blank",rel:"noreferrer",style:{width:"100%",marginBottom:16},children:"Visit Project"}),p.jsxs("div",{className:"sidebar-block",children:[p.jsx("div",{className:"sidebar-label",children:"Date"}),p.jsx("strong",{style:{color:"var(--color-text)"},children:r.date||"Available on request"})]}),p.jsxs("div",{className:"sidebar-block",children:[p.jsx("div",{className:"sidebar-label",children:"Tags"}),p.jsx("p",{style:{color:"var(--color-text-muted)",fontSize:14},children:r.tag})]})]})]}),(r.content||[]).length>0&&p.jsx("section",{className:"page-section",style:{maxWidth:900},children:r.content.map(l=>p.jsxs("div",{className:"project-content-section","data-reveal":!0,children:[p.jsx("h2",{children:l.contentTitle}),l.contentDescription&&p.jsx("p",{children:l.contentDescription.replace(/<[^>]+>/g,"")}),l.contentList?.length>0&&p.jsx("ul",{className:"clean-list",children:l.contentList.map(c=>p.jsx("li",{children:c.isLink?p.jsx("a",{href:c.link,target:"_blank",rel:"noreferrer",children:c.text}):p.jsx("span",{children:c.text.replace(/<[^>]+>/g,"")})},`${l.contentTitle}-${c.text}`))})]},l.contentTitle))})]})}):p.jsx(Ot,{to:"/projects"})}function ff(){const{repos:o,loading:r}=Lp();return Vn({title:"Projects | Radhakishan Jangid",description:"Selected projects across product UI, web applications, shipped client work, and public software tools.",image:lt.meta,type:"website"}),p.jsx("div",{className:"page-wrap",children:p.jsxs("div",{className:"container",children:[p.jsxs("section",{"data-reveal":!0,children:[p.jsx("h1",{style:{marginBottom:12},children:"Projects"}),p.jsx("p",{style:{color:"var(--color-text-muted)",fontSize:18,maxWidth:640,marginBottom:48},children:"A cleaner index with visuals, direct links, and detail pages where deeper context exists."})]}),p.jsxs("div",{className:"split-title","data-reveal":!0,children:[p.jsx("h2",{children:"Case"}),p.jsx("span",{className:"split-title-line"}),p.jsx("h2",{children:"Studies"})]}),p.jsx("div",{className:"project-grid",children:_t.project.map((s,l)=>p.jsx(Un,{className:"project-card shine-card","data-reveal":!0,"data-reveal-delay":`${l%4+1}`,children:p.jsxs(Re,{to:`/projects/${Gt(s.title)}`,style:{display:"contents"},children:[p.jsx("div",{className:"project-card-visual tilt-image",children:p.jsx("img",{src:s.thumbnail,alt:`${s.title} preview`})}),p.jsxs("div",{className:"project-card-body",children:[p.jsx("h3",{children:s.title}),p.jsx("p",{children:s.description}),p.jsx("div",{className:"tag-row",children:s.tag.split(",").slice(0,4).map(c=>p.jsx("span",{className:"tag",children:c.trim()},c))}),p.jsxs("div",{className:"project-card-links",children:[p.jsx("span",{className:"text-link",children:"View Details"}),s.onlineLink?p.jsx("a",{className:"text-link",href:s.onlineLink,target:"_blank",rel:"noreferrer",onClick:c=>c.stopPropagation(),children:"Live Link"}):null]})]})]})},s.id))}),o.length>0&&p.jsxs("section",{className:"page-section",children:[p.jsxs("div",{className:"split-title","data-reveal":!0,children:[p.jsx("h2",{children:"Public"}),p.jsx("span",{className:"split-title-line"}),p.jsx("h2",{children:"Repositories"})]}),p.jsx("div",{className:"public-grid",children:o.map((s,l)=>p.jsxs(Un,{className:"public-card shine-card","data-reveal":!0,"data-reveal-delay":`${l%3+1}`,children:[p.jsxs("div",{className:"public-card-header",children:[p.jsx("h3",{children:s.name}),p.jsxs("span",{className:"public-star",children:["★ ",s.stargazers_count]})]}),p.jsx("p",{children:s.description||"Public GitHub repository."}),p.jsxs("div",{className:"public-card-footer",children:[p.jsx("a",{className:"text-link",href:s.html_url,target:"_blank",rel:"noreferrer",children:"View Repo"}),s.homepage?p.jsx("a",{className:"text-link",href:s.homepage,target:"_blank",rel:"noreferrer",children:"Live Demo"}):null]})]},s.id))}),!r&&!o.length&&p.jsx("p",{style:{color:"var(--color-text-muted)",marginTop:20},children:"GitHub data is unavailable right now."})]})]})})}const Xd="G-N8PLTL59Z1";function vf(){if(typeof window>"u"||window.gtag)return;window.dataLayer=window.dataLayer||[],window.gtag=function(){window.dataLayer.push(arguments)};const o=document.createElement("script");o.async=!0,o.src=`https://www.googletagmanager.com/gtag/js?id=${Xd}`,document.head.appendChild(o),window.gtag("js",new Date),window.gtag("config",Xd,{send_page_view:!1})}function Zd(o){typeof window>"u"||!window.gtag||window.gtag("event","page_view",{page_location:window.location.href,page_path:o.pathname+o.search,page_title:document.title})}function bf(){const o=pp();return ae.useEffect(()=>(vf(),Zd(o.location),o.listen(s=>{Zd(s)})),[o]),null}function yf({match:o}){return Ts(o.params.slug)?.kind==="html"?p.jsx(mf,{match:o}):p.jsx(gp,{children:p.jsx(ef,{match:o})})}function xf(){return p.jsxs(Gd,{children:[p.jsx(sn,{exact:!0,path:"/articles/:slug",component:yf}),p.jsx(sn,{children:p.jsx(gp,{children:p.jsxs(Gd,{children:[p.jsx(sn,{exact:!0,path:"/",component:hf}),p.jsx(sn,{exact:!0,path:"/about",component:$g}),p.jsx(sn,{exact:!0,path:"/projects",component:ff}),p.jsx(sn,{exact:!0,path:"/projects/:topic",component:gf}),p.jsx(sn,{exact:!0,path:"/portfolio",render:()=>p.jsx(Ot,{to:"/projects"})}),p.jsx(sn,{exact:!0,path:"/portfolio/:topic",render:({match:o})=>p.jsx(Ot,{to:`/projects/${o.params.topic}`})}),p.jsx(sn,{exact:!0,path:"/articles",component:tf}),p.jsx(sn,{exact:!0,path:"/contact",component:sf}),p.jsx(sn,{render:()=>p.jsx(Ot,{to:"/"})})]})})})]})}function wf(){return p.jsxs(gm,{children:[p.jsx(bf,{}),p.jsx(xf,{})]})}Lh.render(p.jsx(ve.StrictMode,{children:p.jsx(wf,{})}),document.getElementById("root"));export{Wr as g};
